...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_TopHeader_vue__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../components/TopHeader.vue */ "./web_src/vuepages/pages/tech/components/TopHeader.vue");
/* harmony import */ var _apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ~/apis/modules/tech */ "./web_src/vuepages/apis/modules/tech.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    TopHeader: _components_TopHeader_vue__WEBPACK_IMPORTED_MODULE_21__["default"]
  },
  methods: {
    ...
    checkRepoAlias: function checkRepoAlias() {
      var reg = /^[\u4E00-\u9FA5A-Za-z0-9_.-]{1,100}$/;
      var res = reg.test(this.form.repo_alias);
      this.form.alias_err = !res;
      return res;
    },
    checkRepoName: function checkRepoName() {
      var reg = /^[A-Za-z0-9_.-]{1,100}$/;
      var res = reg.test(this.form.repo_name);
      this.form.name_err = !res;
      return res;
    },
    checkTopic: function checkTopic() {
      this.form.topic_err = this.form.topics.length == 0;
      return !this.form.topic_err;
    },
    checkDescr: function checkDescr() {
      this.form.descr_err = !this.form.description;
      return !this.form.descr_err;
    },
    checkTech: function checkTech() {
      this.form.tech_err = !this.form.tech_obj;
      return !this.form.tech_err;
    },
    checkinstitution: function checkinstitution() {
    ...
    changeUrl: function changeUrl() {
      ...
      var owner = this.ownerSelect.Name;
      var urlAdd = location.href.split("/")[0] + "//" + location.href.split("/")[2];
      var repoValue = this.form.url.match(/^(.*\/)?((.+?)(\.git)?)$/)[3];
      this.form.repo_alias = repoValue;
      this.checkRepoAlias();
      (0,_apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.getCheckRepoName)({
        owner: owner,
        q: repoValue
      }).then(function (res) {
        var repo_name = res.data.name;
        _this.form.repo_name = repo_name;
        _this.form.repo_url = "".concat(urlAdd, "/").concat(owner, "/").concat(repo_name, ".git");

        _this.checkRepoName();
      })["catch"](function (err) {
        console.log(err);
        _this.form.repo_name = '';
        _this.form.repo_url = '';
      });
    },
    changeAlias: function changeAlias() {
      ...
      var owner = this.ownerSelect.Name;
      var aliasValue = this.form.repo_alias;
      var urlAdd = location.href.split("/")[0] + "//" + location.href.split("/")[2];
      ...
      if (aliasValue && this.checkRepoAlias()) {
        (0,_apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.getCheckRepoName)({
          ...
          var repo_name = res.data.name;
          _this2.form.repo_name = repo_name;
          _this2.form.repo_url = "".concat(urlAdd, "/").concat(owner, "/").concat(repo_name, ".git");
        })["catch"](function (err) {
          console.log(err);
          _this2.form.repo_name = '';
          _this2.form.repo_url = '';
        });
      } else {
        this.form.repo_name = '';
        this.form.repo_url = '';
    ...
    changeOwner: function changeOwner(value) {
      this.ownerSelect = this.ownerList.filter(function (item) {
        return item.value == value;
      })[0];
      this.form.repo_name && this.changeRepoName();
    },
    changeRepoName: function changeRepoName() {
      var owner = this.ownerSelect.Name;
      var repo_name = this.form.repo_name;
      var urlAdd = location.href.split("/")[0] + "//" + location.href.split("/")[2];

      if (this.checkRepoName()) {
        this.form.repo_url = "".concat(urlAdd, "/").concat(owner, "/").concat(repo_name, ".git");
      } else {
        this.form.repo_url = '';
      }
    },
    searchTopics: function searchTopics(query) {
      var _this3 = this;

      if (query !== '') {
        this.form.topicLoading = true;
        (0,_apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.getTopics)({
          q: query
        }).then(function (res) {
          _this3.form.topicLoading = false;
          var topics = res.data.topics || [];
          _this3.topicsList = topics.map(function (item) {
            return {
    ...
    goSelectTechPrj: function goSelectTechPrj() {
      this.form.tech_search_sel = '0';
      this.form.tech_search_keyword = '';
      this.tableData = [];
    ...
    clearTechPrj: function clearTechPrj() {
      this.form.institution = [];
      this.institutionList = [];
      this.form.tech_show = '';
      this.form.tech_obj = null;
    ...
    searchTechList: function searchTechList() {
      var _this4 = this;

      this.loading = true;
      (0,_apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.getTechs)({
    ...
    selectedTechPrj: function selectedTechPrj(item) {
      this.form.institution = [];
      this.institutionList = item.all_institution.split(',').map(function (item, index) {
        return {
          key: item,
          value: item
        };
      });
      this.form.tech_show = "\u3010".concat(item.no, "\u3011 ").concat(item.name);
    ...
    submit: function submit() {
      ...
      if (this.form.type == 'openi') {
        setApi = _apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.setOpenIApply;
        var r1 = this.checkUrl();
        var r2 = this.checkTech();
        var r3 = this.checkinstitution();
        ...
        setApi = _apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.setNoOpenIApply;

        var _r = this.checkUrl();

        var _r2 = this.checkTech();

        var _r3 = this.checkinstitution();

        var r4 = this.checkRepoAlias();
        var r5 = this.checkRepoName();
        var r6 = this.checkTopic();
        var r7 = this.checkDescr();

        if (_r && _r2 && _r3 && r4 && r5 && r6 && r7) {
          subData.url = this.form.url;
          subData.uid = this.form.uid;
          subData.alias = this.form.repo_alias;
          subData.repo_name = this.form.repo_name;
          subData.topics = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_20___default()(this.form.topics);
      ...
      setApi(subData).then(function (res) {
  ...
  beforeMount: function beforeMount() {
    ...
    (0,_apis_modules_tech__WEBPACK_IMPORTED_MODULE_22__.getCreateRepoUser)().then(function (res) {
      var data = res.data.Data || [];
      _this6.ownerList = data.map(function (item) {
        return _objectSpread({
          value: item.ID,
          label: item.FullName || item.Name
        }, item);
      });
      _this6.ownerSelect = _this6.ownerList.length ? _this6.ownerList[0] : {};
      _this6.form.uid = _this6.ownerList.length ? _this6.ownerList[0].value : '';
    })["catch"](function (err) {
      console.log(err);
    });
  },
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/tech/create/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_552f5fa0_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=552f5fa0&scoped=true */ "./web_src/vuepages/pages/tech/create/index.vue?vue&type=template&id=552f5fa0&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/tech/create/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_552f5fa0_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less */ "./web_src/vuepages/pages/tech/create/index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_552f5fa0_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_552f5fa0_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "552f5fa0",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/tech/create/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./web_src/vuepages/pages/tech/create/index.vue?vue&type=script&lang=js":
/*!******************************************************************************!*\
  !*** ./web_src/vuepages/pages/tech/create/index.vue?vue&type=script&lang=js ***!
  \******************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/tech/create/index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less":
/*!***************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/tech/create/index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less ***!
  \***************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_552f5fa0_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=style&index=0&id=552f5fa0&scoped=true&lang=less");
...
/***/ "./web_src/vuepages/pages/tech/create/index.vue?vue&type=template&id=552f5fa0&scoped=true":
/*!************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/tech/create/index.vue?vue&type=template&id=552f5fa0&scoped=true ***!
  \************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_552f5fa0_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_552f5fa0_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_552f5fa0_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=552f5fa0&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=template&id=552f5fa0&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=template&id=552f5fa0&scoped=true":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/tech/create/index.vue?vue&type=template&id=552f5fa0&scoped=true ***!
  \***************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("TopHeader", { attrs: { menu: "" } }),
      _vm._v(" "),
      _c("div", { staticClass: "ui container" }, [
        _c("div", { staticClass: "title" }, [
          _vm._v("您申请的项目将在科技2030项目页面展示")
        ]),
        _vm._v(" "),
        _c(
          "div",
            ...
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: !_vm.selectTechPrj,
                expression: "!selectTechPrj"
              }
            ],
            staticClass: "form-c"
          },
            ...
            _c("div", { staticClass: "form-wrap" }, [
              ...
              _c("div", { staticClass: "form-content" }, [
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "row-label required" }, [
                    _vm._v("申请项目存放于")
                  ]),
                  _vm._v(" "),
                  _c(
                ...
                _c(
                  "div",
                  {
                    ...
                    class: _vm.form.url_err ? "form-row-err" : ""
                  },
                  [
                    _c("div", { staticClass: "row-label required" }, [
                      _vm._v("现项目地址")
                      ...
                      [
                        _c("el-input", {
                          ...
                          attrs: {
                            size: "medium",
                            placeholder:
                              '请输入现有项目的 HTTP(s) 或 Git " clone" URL，如：https://openi.pcl.ac.cn/OpenI/aiforge'
                          },
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.form.type == "no-openi",
                        expression: "form.type == 'no-openi'"
                      }
                    ]
                  },
                  [
                    _c(
                      ...
                      {
                        staticClass: "form-row",
                        class: _vm.form.alias_err ? "form-row-err" : ""
                      },
                      [
                        _c(
                          "div",
                          { staticClass: "row-label required baseline" },
                          [_vm._v("启智项目名称")]
                        ),
                        _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c("el-input", {
                                staticClass: "can-err",
                                attrs: { size: "medium" },
                                on: { input: _vm.changeAlias },
                                model: {
                                  value: _vm.form.repo_alias,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form, "repo_alias", $$v)
                                  },
                                  expression: "form.repo_alias"
                                }
                              })
                            ],
                            1
                    ...
                    _c(
                      ...
                      {
                        staticClass: "form-row",
                        class: _vm.form.name_err ? "form-row-err" : ""
                      },
                      [
                        _c(
                          "div",
                        ...
                        _c("div", { staticClass: "row-content" }, [
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      _c("img", {
                                        staticClass: "owner-img",
                                        attrs: {
                                          src: _vm.ownerSelect.RelAvatarLink
                                        }
                                      })
                                    ]
                                  ),
                                  _vm._v(" "),
                                  _vm._l(_vm.ownerList, function(item) {
                                    return _c(
                                      "el-option",
                                      {
                                        key: item.value,
                              ...
                              _c("el-input", {
                                staticClass: "can-err",
                                attrs: { size: "medium" },
                                on: { input: _vm.changeRepoName },
                                model: {
                                  value: _vm.form.repo_name,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form, "repo_name", $$v)
                                  },
                                  expression: "form.repo_name"
                                }
                              })
                            ],
                            1
                          ...
                          _c("div", { staticClass: "tips" }, [
                            _vm._v("\n                  启智项目地址："),
                            _c("span", { staticClass: "openi-repo-url" }, [
                              _vm._v(_vm._s(_vm.form.repo_url))
                            ])
                          ])
                        ])
                      ]
                    ...
                    _c(
                      ...
                      {
                        staticClass: "form-row",
                        class: _vm.form.topic_err ? "form-row-err" : ""
                      },
                      [
                        _c("div", { staticClass: "row-label required" }, [
                          _vm._v("关键词")
                            ...
                            _c(
                              "el-select",
                              {
                                ...
                                attrs: {
                                  ...
                                  placeholder: "请选择标签",
                                  "remote-method": _vm.searchTopics,
                                  loading: _vm.form.topicLoading
                                },
                                model: {
                                  value: _vm.form.topics,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form, "topics", $$v)
                                  },
                    ...
                    _c(
                      ...
                      {
                        staticClass: "form-row",
                        class: _vm.form.descr_err ? "form-row-err" : ""
                      },
                      [
                        _c(
                          "div",
                ...
                _c(
                  ...
                  {
                    staticClass: "form-row",
                    class: _vm.form.tech_err ? "form-row-err" : ""
                  },
                  [
                    _c("div", { staticClass: "row-label required" }, [
                      _vm._v("科技项目")
                      ...
                      [
                        _c(
                          "el-input",
                          {
                            ...
                            model: {
                              value: _vm.form.tech_show,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "tech_show", $$v)
                              },
                              expression: "form.tech_show"
                            }
                          },
                          [
                            _c(
                              "el-button",
                              {
                                ...
                                attrs: { slot: "append", size: "medium" },
                                on: { click: _vm.goSelectTechPrj },
                                slot: "append"
                              },
                              [_vm._v("选择科技项目")]
                            ),
                ...
                _c(
                  ...
                  {
                    staticClass: "form-row",
                    class: _vm.form.institution_err ? "form-row-err" : ""
                  },
                  [
                    _c("div", { staticClass: "row-label required" }, [
                      _vm._v("成果贡献单位")
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          _vm._l(_vm.institutionList, function(item) {
                            return _c("el-option", {
                              key: item.key,
        ...
        _c(
          "div",
          {
            ...
            staticClass: "form-select-tech-prj"
          },
          [
            _c("div", { staticClass: "form-wrap" }, [
              _c("div", { staticClass: "form-header" }, [
                _c("span", [_vm._v("选择科技项目")]),
                _vm._v(" "),
                _c(
                  "span",
                  [
              ...
              _c("div", { staticClass: "form-content" }, [
                        ...
                        "el-input",
                        {
                          ...
                          nativeOn: {
                            keyup: function($event) {
                              ...
                              return _vm.searchTechList($event)
                            }
                          },
                          model: {
                            value: _vm.form.tech_search_keyword,
                            callback: function($$v) {
                              _vm.$set(_vm.form, "tech_search_keyword", $$v)
                            },
                            expression: "form.tech_search_keyword"
                          }
                        },
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              slot: "prepend",
                              model: {
                                value: _vm.form.tech_search_sel,
                                callback: function($$v) {
                                  _vm.$set(_vm.form, "tech_search_sel", $$v)
                                },
                                expression: "form.tech_search_sel"
                              }
                            },
                            [
                              _c("el-option", {
                                attrs: { label: "项目立项编号", value: "0" }
                              }),
                              _vm._v(" "),
                              _c("el-option", {
                                attrs: { label: "参与单位", value: "1" }
                              }),
                              _vm._v(" "),
                              _c("el-option", {
                                attrs: { label: "项目名称", value: "2" }
                              })
                            ],
                            1
                          ),
                ...
                _c("div", { staticClass: "form-table" }, [
                  _c(
                    "div",
                    { staticStyle: { margin: "0 20px 30px 20px" } },
                    [
                      _c(
                        "el-table",
                        {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/tech/create/vp-tech-create.js"); })
