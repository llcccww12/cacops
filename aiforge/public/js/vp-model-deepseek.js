...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/ChatMenu.vue?vue&type=script&lang=js":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/ChatMenu.vue?vue&type=script&lang=js ***!
  \****************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_es_date_now__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/es.date.now */ "./node_modules/core-js/modules/es.date.now.js");
/* harmony import */ var core_js_modules_es_date_now__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_date_now__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _apis_modules_deepseek__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ~/apis/modules/deepseek */ "./web_src/vuepages/apis/modules/deepseek.js");
/* harmony import */ var _pages_model_llms_componenes_SessionWindow_vue__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ~/pages/model/llms/componenes/SessionWindow.vue */ "./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue");
/* harmony import */ var _ChatMenu_vue__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./ChatMenu.vue */ "./web_src/vuepages/pages/model/deepseek/ChatMenu.vue");
/* harmony import */ var _apis_modules_common__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ~/apis/modules/common */ "./web_src/vuepages/apis/modules/common.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SessionWindow: _pages_model_llms_componenes_SessionWindow_vue__WEBPACK_IMPORTED_MODULE_28__["default"],
    ChatMenu: _ChatMenu_vue__WEBPACK_IMPORTED_MODULE_29__["default"]
  },
  data: function data() {
    return {
      prompt: '',
      ...
      c2netErrMsg: '',
      c2netContent: {},
      promotePath: "model/modelexperiencedeepseeknpu".concat(document.documentElement.attributes["lang"].nodeValue == "zh-CN" ? '' : '_en', ".json"),
      imgContent: {},
      regexConfig: {}
    };
  },
  ...
  computed: {
    imgValue: function imgValue() {
      // 方法一：使用 for...of 提前返回
      for (var _i = 0, _Object$keys = Object.keys(this.imgContent); _i < _Object$keys.length; _i++) {
    ...
    messagesSubVal: function messagesSubVal() {
  ...
  methods: {
    generateName: function generateName(name) {
      ...
      str = str.slice(0, 5);
      var now = Date.now();
      return str + dayjs__WEBPACK_IMPORTED_MODULE_31___default()(now).format('YYYYMMDDHH') + (now / 1000).toFixed(0).slice(-5);
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.isAutoScroll = true;

                _this2.scrollBottom(); // this.$refs.childMenu.sendPamras()


                re = new RegExp("^[ ]+$");

                if (!(!_this2.prompt || re.test(_this2.prompt))) {
                  _context.next = 6;
                  break;
                }

                _this2.$message.error(_this2.$t('modelSquare.inputNotEmpty'));
              ...
              case 6:
                ...
                _this2.$message.error(_this2.$t('modelSquare.sessionChating'));

                return _context.abrupt("return");

              case 9:
                _this2.params.chat_id = _this2.generateName(_this2.loginName);
                newMessage = {
                  role: "user",
                  content: _this2.prompt.trim()
                };
                _this2.params.messages = [];

                _this2.params.messages.push(newMessage);

                _this2.prompt = '';

                _this2.sessionRecordData.push({
                  "role": "user",
                  "content": _this2.params.messages[_this2.params.messages.length - 1].content
                });
    ...
    stopGeneration: function stopGeneration() {
      if (this.abortController) {
        ...
        this.$message({
          type: 'success',
          message: this.$t('modelSquare.stopedChat')
        });
      }
    },
    refreshAnswer: function refreshAnswer(index) {
      ...
      this.sessionRecordData.splice(index, 1, {
        "role": "assistant",
        "content": '',
        "loading": true,
        "c2netNameTips": '',
      ...
      var messagesCopy = Array.from(this.messagesSubVal);
      params.messages = messagesCopy.splice(0, index); // this.params.flag = true
    ...
    chat: function chat() {
      ...
      var customParams = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      var targetIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      this.chatFlag = true; // 创建 AbortController

      this.abortController = new AbortController();
      var vm = this;
      (0,_apis_modules_deepseek__WEBPACK_IMPORTED_MODULE_27__.llmChat)(customParams, {
        ...
        if (targetIndex !== null) {
          popData = _this3.sessionRecordData[targetIndex];
        }

        var isDoneTriggered = false;
        var c2netName = '';
        var buffer = ''; // 新增缓冲区

        var ERROR_MARKER = '[ERROR]';
        var ERROR_MARKER_LENGTH = ERROR_MARKER.length;

        var processBinaryData = /*#__PURE__*/function () {
          var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_26___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().mark(function _callee2() {
            var _yield$reader$read, done, value, errorIndex, chars, err, doneIndex, regex, match, result, i, postDone, hasError, _errorIndex, maxKeep, keepLength, output;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    if (isDoneTriggered) {
                      // 处理流结束时的剩余内容
                      errorIndex = buffer.indexOf(ERROR_MARKER);
                    ...
                    if (targetIndex === null) {
                      if (!popData.content) {
                        _this3.params.messages.pop();
                      } else {
                        _this3.params.messages.push({
                          role: "assistant",
                          content: popData.content
                        });
                      }
                    } else {
                      _this3.params.messages.splice(targetIndex, 1, {
                        role: "assistant",
                        content: popData.content
                      });

                      console.log(_this3.params.messages);
                    }
                  ...
                  case 14:
                    ...
                    _this3.prompt = _this3.params.messages[_this3.params.messages.length - 1].content;
                    vm.chatFlag = false;
                    popData.loading = false;
                  ...
                  case 24:
                    // 1. 处理[DONE]标记（仅在首次触发）
                    if (!isDoneTriggered) {
                      doneIndex = buffer.indexOf('[DONE]');

                      if (doneIndex !== -1) {
                        isDoneTriggered = true;
                        c2netName = buffer.substring(0, doneIndex);
                        regex = new RegExp(vm.regexConfig.pattern);
                        match = c2netName.match(regex);

                        if (match) {
                          result = vm.regexConfig.template;

                          for (i = 1; i < match.length; i++) {
                            result = result.replace(new RegExp("\\$".concat(i), 'g'), match[i]);
                          }
                        ...
                        postDone = buffer.substring(doneIndex + '[DONE]'.length);
                  ...
                  case 27:
                    _errorIndex = buffer.indexOf(ERROR_MARKER);
                  ...
                  case 30:
                    // 发现错误标记
                    popData.content += buffer.substring(0, _errorIndex);
                    buffer = '';
                  ...
                  case 35:
                    if (!hasError) {
                      ...
                      maxKeep = ERROR_MARKER_LENGTH - 1;
                      keepLength = Math.min(maxKeep, buffer.length);
                      output = buffer.substring(0, buffer.length - keepLength);
        ...
        vm.chatFlag = false;
        var popData = vm.sessionRecordData[vm.sessionRecordData.length - 1];
        popData.content += buffer;
        popData.loading = false;

        if (err.name === 'AbortError') {
          // 用户主动停止
          vm.params.messages.push({
            role: 'assistant',
            content: popData.content
          });
          vm.scrollBottom();
    ...
    onScroll: function onScroll() {
      ...
      this.delayTimer = setTimeout(function () {
        _this5.isAutoScroll = true;
      }, 3500);
    },
    getConfig: function getConfig() {
      var _this6 = this;

      (0,_apis_modules_common__WEBPACK_IMPORTED_MODULE_30__.getPromoteData)(this.promotePath).then(function (res) {
        var data = JSON.parse(res.data);
        _this6.c2netList = data.c2netList;
        _this6.c2netErrMsg = data.errorMessage;
        _this6.c2netContent = data.headerContent;
        _this6.imgContent = data.imgList;
        console.log(data.regexConfig['auto']);
        _this6.regexConfig = data.regexConfig['auto']; // if(this.modelName === 'DeepSeek'){
...
/***/ "./web_src/vuepages/pages/model/deepseek/vp-model-deepseek.js":
/*!********************************************************************!*\
  !*** ./web_src/vuepages/pages/model/deepseek/vp-model-deepseek.js ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Index_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Index.vue */ "./web_src/vuepages/pages/model/deepseek/Index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=style&index=0&id=3ed129d5&lang=less&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=style&index=0&id=3ed129d5&lang=less&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/model/deepseek/ChatMenu.vue":
/*!************************************************************!*\
  !*** ./web_src/vuepages/pages/model/deepseek/ChatMenu.vue ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _
************************************************************************************!*\
  !*** ./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=template&id=3ed129d5&scoped=true ***!
  \***************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_3ed129d5_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_3ed129d5_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_3ed129d5_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Index.vue?vue&type=template&id=3ed129d5&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=template&id=3ed129d5&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/ChatMenu.vue?vue&type=template&id=1b195ca4&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/ChatMenu.vue?vue&type=template&id=1b195ca4&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                        ...
                        _c(
                          ...
                          [
                            _c("el-input", {
                              ...
                              model: {
                                value: _vm.params.messages[0].content,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.params.messages[0],
                                    "content",
                                    $$v
                                  )
                                },
                                expression: "params.messages[0].content"
                              }
                            })
                          ],
                          1
                    ...
                    ? [
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("el-switch", {
                              attrs: { disabled: _vm.config[key].disabled },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=template&id=3ed129d5&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/deepseek/Index.vue?vue&type=template&id=3ed129d5&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", [
    _vm.isMobileMenuOpen
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "ui container chat-wrap" }, [
      ...
      _c("div", { staticClass: "main-container" }, [
        _c(
          "div",
          {
            staticClass: "main-left-menu",
            class: { "mobile-menu-active": _vm.isMobileMenuOpen }
          },
          [
            _c("div", { staticClass: "menu-wrap" }, [
              _c("div", { staticClass: "sidbar-header" }, [
                _c("div", { staticClass: "sidbar-title" }, [
                  _c("div", [
                    _vm._v(" ⭐ " + _vm._s(_vm.c2netContent.mainTitle) + " ")
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "sidbar-sub-title" }, [
                  _vm._v(_vm._s(_vm.c2netContent.subTitle))
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "sidbar-body" }, [
                _c(
                  "div",
                  { staticClass: "sidbar-main" },
                  _vm._l(_vm.c2netList, function(item) {
                    return _c(
                      "a",
                      {
                        key: item.name,
                        staticClass: "sidebar-item",
                        attrs: { href: item.address, target: "_blank" }
                      },
              ...
              _vm._v(" "),
              _c("div", { staticClass: "sidbar-footer" }, [
                _c("img", { attrs: { src: "/img/model/c2net.png", alt: "" } }),
                _vm._v(" "),
                _c("img", { attrs: { src: "/img/model/openi.png", alt: "" } }),
                _vm._v(" "),
                _c(
                  "div",
                  {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "main-code-wrap" }, [
            ...
            _c("div", { staticClass: "main-code-body" }, [
              _c("div", { staticClass: "output-text" }, [
                _c(
                  ...
                  [
                    _c("div", { staticClass: "out-header-wrap" }, [
                      _c(
                        "div",
                        {
                          staticClass: "c2net-support-list",
                          on: { click: _vm.toggleMobileMenu }
                        },
                        [
                          _c("span", [_vm._v("算力")]),
                      ...
                      _c("div", { staticClass: "output-welcome-banner" }, [
                        _vm.modelName === "DeepSeek"
                          ? _c("div", [
                              _vm._v(
                                _vm._s(_vm.$t("modelSquare.deepseekHeaderTips"))
                              )
                            ])
                          : _c("div", [
                              _vm._v(
                      ...
                      [
                        _c("SessionWindow", {
                          ...
                          attrs: {
                            img: _vm.imgValue,
                            useLoading: true,
                            opFlag: _vm.modelName === "DeepSeek"
                          },
                          on: {
                            stopGeneration: _vm.stopGeneration,
                            refreshAnswer: _vm.refreshAnswer
                          }
                        })
                      ],
                      1
            ...
            _c(
              ...
              [
                ...
                _c("div", { staticClass: "input-container" }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "tips-privacy" }, [
                    _c("span", [
                      _c(
                        "a",
                        {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/model/deepseek/vp-model-deepseek.js"); })
