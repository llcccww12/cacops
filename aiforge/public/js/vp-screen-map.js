...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/slicedToArray.js");
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__);
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_24__);
/* harmony import */ var _apis_modules_homemap__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ~/apis/modules/homemap */ "./web_src/vuepages/apis/modules/homemap.js");
/* harmony import */ var echarts__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! echarts */ "./node_modules/echarts/index.js");
/* harmony import */ var echarts_extension_bmap_bmap__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! echarts/extension/bmap/bmap */ "./node_modules/echarts/extension/bmap/bmap.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getOption: function getOption() {
      this.options = {
        ...
        color: ['#5470c6', '#0191FF', '#fac858', '#ee6666', '#73c0de', '#3ba272', '#fc8452', '#9a60b4', '#ea7ccc'],
        bmap: {
        ...
        series: [{
          ...
          itemStyle: {
            ...
            shadowOffsetY: 5,
            color: new echarts__WEBPACK_IMPORTED_MODULE_26__.graphic.RadialGradient(0.4, 0.3, 1, [{
              offset: 0,
    ...
    roamMap: function roamMap(flag) {
      var currentZoom = this.myChart.getOption().bmap[0].zoom; // 当前的缩放比例   
    ...
    getAiCenterInfo: function getAiCenterInfo() {
      var _this = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_24___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_19___default().mark(function _callee() {
        var allPromise, reslut, _reslut, AiCenterInfo, localtionInfo, GeomapData, cardAndJobCount, cardAndJobCountSort, sumDuration, sumTask, schedulingTasks;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_19___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                allPromise = Promise.allSettled([(0,_apis_modules_homemap__WEBPACK_IMPORTED_MODULE_25__.getAiCenterOverview)(), (0,_apis_modules_homemap__WEBPACK_IMPORTED_MODULE_25__.getAiLocation)()]);
                _context.prev = 1;
                _context.next = 4;
                return allPromise;

              case 4:
                reslut = _context.sent;
                _this.showFlag = true;
                _reslut = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22___default()(reslut, 2), AiCenterInfo = _reslut[0], localtionInfo = _reslut[1];

                if (AiCenterInfo.status === 'fulfilled') {
                  GeomapData = AiCenterInfo.value.data.locationInfo;
                  _this.CCRFTETW = GeomapData['东数西算'].map(function (item) {
                    return {
                      name: item.name,
                      value: [Number(item.longitude), Number(item.latitude), item.value]
                    };
                  });
                  _this.C2NET = GeomapData['智算中心'].map(function (item) {
                    return {
                      name: item.name,
                      value: [Number(item.longitude), Number(item.latitude), item.value]
                    };
                  });
                  _this.SuperCompute = GeomapData['超算中心'].map(function (item) {
                    return {
                      name: item.name,
                      value: [Number(item.longitude), Number(item.latitude), item.value]
                    };
                  });
                  cardAndJobCount = AiCenterInfo.value.data.cardAndJobCount;

                  if (cardAndJobCount.length !== 0) {
                    _this.showData = true;
                    cardAndJobCountSort = cardAndJobCount.map(function (_ref) {
                      var num = _ref.num;
                      return Number(num);
                    });
                    sumDuration = Number(cardAndJobCount[0].card_duration);
                    sumTask = Math.max.apply(Math, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_21___default()(cardAndJobCountSort));
                    _this.cardAndJobCountList = cardAndJobCount.map(function (item) {
                      var obj = {
                        percentDuration: (Number(item.card_duration) / sumDuration).toFixed(2) * 100,
                        percentTask: (Number(item.num) / sumTask).toFixed(2) * 100
                      };
                ...
                if (localtionInfo.status === 'fulfilled') {
                  schedulingTasks = localtionInfo.value.data;

                  if (schedulingTasks.length === 0) {
                    _this.TaskLine = [];
                  } else {
                    _this.TaskLine = schedulingTasks.map(function (item) {
                      return {
                        coords: [[Number(item.from_longitude), Number(item.from_latitude)], [Number(item.to_longitude), Number(item.to_latitude)]]
                      };
                    });
                  }
                } else {}
  ...
  mounted: function mounted() {
    ...
    this.myChart = echarts__WEBPACK_IMPORTED_MODULE_26__.init(chartDom);
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/home/screenmap/index.vue");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");



new vue__WEBPACK_IMPORTED_MODULE_2__["default"]({
  i18n: _langs__WEBPACK_IMPORTED_MODULE_1__.i18n,
...
function dataToCoordSize(dataSize, dataItem) {
  ...
  return echarts__WEBPACK_IMPORTED_MODULE_0__.util.map([0, 1], function (dimIdx) {
...
BMapCoordSys.create = function (ecModel, api) {
  ...
  ecModel.eachComponent('bmap', function (bmapModel) {
    ...
    if (!bmapModel.__bmap) {
      ...
      if (mapOptions) {
        mapOptions = echarts__WEBPACK_IMPORTED_MODULE_0__.util.clone(mapOptions); // Not support `mapType`, use `bmap.setMapType(MapType)` instead.
...
/* harmony default export */ __webpack_exports__["default"] = (BMapCoordSys);
  ...
  render: function (bMapModel, ecModel, api) {
    ...
    if (JSON.stringify(originalStyle) !== mapStyleStr) {
      ...
      if (!isEmptyObject(newMapStyle)) {
        bmap.setMapStyle(echarts__WEBPACK_IMPORTED_MODULE_0__.util.clone(newMapStyle));
      }
    ...
    if (JSON.stringify(originalStyle2) !== mapStyleStr2) {
      ...
      if (!isEmptyObject(newMapStyle2)) {
        bmap.setMapStyleV2(echarts__WEBPACK_IMPORTED_MODULE_0__.util.clone(newMapStyle2));
      }
...
/* harmony export */ });
/* harmony import */ var echarts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! echarts */ "./node_modules/echarts/index.js");
/* harmony import */ var _BMapCoordSys_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BMapCoordSys.js */ "./node_modules/echarts/extension/bmap/BMapCoordSys.js");
/* harmony import */ var _BMapModel_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./BMapModel.js */ "./node_modules/echarts/extension/bmap/BMapModel.js");
/* harmony import */ var _BMapView_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./BMapView.js */ "./node_modules/echarts/extension/bmap/BMapView.js");
...
echarts__WEBPACK_IMPORTED_MODULE_0__.registerCoordinateSystem('bmap', _BMapCoordSys_js__WEBPACK_IMPORTED_MODULE_1__["default"]); // Action

echarts__WEBPACK_IMPORTED_MODULE_0__.registerAction({
  type: 'bmapRoam',
  event: 'bmapRoam',
  update: 'updateLayout'
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_51d1b12b_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=51d1b12b&scoped=true */ "./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=template&id=51d1b12b&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_51d1b12b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_51d1b12b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "51d1b12b",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/home/screenmap/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=script&lang=js":
/*!*********************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=script&lang=js ***!
  \*********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=template&id=51d1b12b&scoped=true":
/*!***************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=template&id=51d1b12b&scoped=true ***!
  \***************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_51d1b12b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_51d1b12b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_51d1b12b_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=51d1b12b&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=template&id=51d1b12b&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=template&id=51d1b12b&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/screenmap/index.vue?vue&type=template&id=51d1b12b&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "__home_screemap1" }, [
    _vm.showFlag
      ? _c(
          "button",
          {
            staticClass: "screemap_button_add",
            on: {
              click: function($event) {
                return _vm.roamMap(0)
              }
            }
          },
          [_vm._v("+")]
    ...
    _vm.showFlag
      ? _c(
          "button",
          {
            staticClass: "screemap_button_min",
            on: {
              click: function($event) {
                return _vm.roamMap(1)
              }
            }
          },
          [_vm._v("-")]
    ...
    _vm._v(" "),
    _vm.showData
      ? _c("div", { staticClass: "screemap_content_wrap" }, [
          _c("div", { staticClass: "screemap_content_part1" }, [
            _c("div", { staticClass: "text_wrap_right" }, [
              _c("span", [_vm._v(_vm._s(_vm.$t("handleTask")))])
            ]),
            _vm._v(" "),
            _c("div", { staticStyle: { width: "100px" } }),
            _vm._v(" "),
            _c("div", { staticClass: "text_wrap_left" }, [
              _c("span", [_vm._v(_vm._s(_vm.$t("freeCompute")))])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "screemap_content_part2" }, [
            _c("div", { staticClass: "inner-container" }, [
              _c(
                "div",
                { staticClass: "container_wrap" },
                _vm._l(_vm.cardAndJobCountList, function(item) {
                  return _c("div", { staticClass: "content_container" }, [
                    _c("div", { staticStyle: { width: "145px" } }, [
                      _c("div", {
                        staticClass: "left_task_num",
                        style: {
                          width: item.percentTask + "%",
                          padding: item.num == 0 ? "0px" : ""
                        },
                        attrs: { tooltip: item.num + "个", position: "left" }
                      })
                    ]),
                    _vm._v(" "),
                    _c(
                      "div",
                      {
                        ...
                        attrs: { title: item.ai_center }
                      },
                      [_vm._v(_vm._s(item.ai_center.slice(0, 6)))]
                    ),
                    _vm._v(" "),
                    _c("div", { staticStyle: { width: "145px" } }, [
                      _c("div", {
                        staticClass: "right_card_duration",
                        style: {
                          width: item.percentDuration + "%",
                          padding: item.card_duration == 0.0 ? "0px" : ""
                        },
                        attrs: {
                          tooltip: item.card_duration + "卡时",
                          position: "right"
                        }
                      })
                    ])
    ...
    _vm._v(" "),
    _c("div", {
      staticStyle: { width: "100%", height: "759px" },
      attrs: { id: "main" }
    })
  ])
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/home/screenmap/vp-screen-map.js"); })
