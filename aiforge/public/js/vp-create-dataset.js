...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=script&lang=js":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=script&lang=js ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_CreateForm_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/CreateForm.vue */ "./web_src/vuepages/pages/guide/components/CreateForm.vue");
/* harmony import */ var _components_FileUpload_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/FileUpload.vue */ "./web_src/vuepages/pages/guide/components/FileUpload.vue");
...
/* harmony import */ var _pages_dataset_square_constant_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ~/pages/dataset/square/constant.js */ "./web_src/vuepages/pages/dataset/square/constant.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    CreateForm: _components_CreateForm_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    FileUpload: _components_FileUpload_vue__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  data: function data() {
    var _this = this;
    ...
    return {
      ...
      loading: true,
      Category: _pages_dataset_square_constant_js__WEBPACK_IMPORTED_MODULE_11__.Category,
      Task: _pages_dataset_square_constant_js__WEBPACK_IMPORTED_MODULE_11__.Task,
      License: _pages_dataset_square_constant_js__WEBPACK_IMPORTED_MODULE_11__.License,
      rules: {
        name: [{
          required: true,
          ...
          validator: function validator(rule, value, callback) {
            if (/^[a-zA-Z0-9][a-zA-Z0-9-_.]{0,98}[a-zA-Z0-9]$/.test(value) == false) {
              callback(new Error(_this.$t('datasetObj.dataset_name_required2')));
            } else {
              callback();
            }
          },
  ...
  methods: {
    createDataset: function createDataset() {
      ...
      this.$refs['form'].validate(function (valid) {
        if (valid) {
          ...
          _this2.postCreateDataset();
        } else {
          return false;
        }
      });
    },
    postCreateDataset: function postCreateDataset() {
      var _this3 = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_7___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee() {
        var response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_10__.createDatasets)(_this3.form);
              ...
              case 3:
                ...
                if (response.data.code === 0) {
                  _this3.active = 1;
                  _this3.datasetID = response.data.data.id;
                  _this3.datasetObj = response.data.data;
                } else {
              ...
              case 9:
                ...
                _this3.$message.error(_context.t0);
    ...
    cancelDataset: function cancelDataset() {
      if (this.cancelUrl) {
    ...
    getUsersList: function getUsersList() {
      ...
      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_7___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee2() {
        var response, res, orgOwner;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_10__.getAvailableUsers)({
                  org: _this4.orgId
                });
              ...
              case 3:
                ...
                _this4.owners = res.data.users || [];

                if (!(_this4.owners.length === 0)) {
                  _context2.next = 11;
                  break;
                }
              ...
              case 11:
                if (_this4.orgId) {
                  ...
                  orgOwner = _this4.owners.find(function (item) {
                    return item.ID === +_this4.orgId;
                  });
                  _this4.form.owner_id = orgOwner ? orgOwner.ID : _this4.owners[0].ID;
                } else {
                  _this4.form.owner_id = _this4.owners[0].ID;
                }
              ...
              case 18:
                ...
                _this4.$message.error(_context2.t0);
    ...
    cancelUpload: function cancelUpload() {
      location.href = "/datasets/detail/".concat(this.datasetObj.owner_name, "/").concat(this.datasetObj.name);
    },
    uploadFinish: function uploadFinish() {
      var _this5 = this;

      window.setTimeout(function () {
        location.href = "/datasets/detail/".concat(_this5.datasetObj.owner_name, "/").concat(_this5.datasetObj.name, "?tab=files");
      }, 1000);
    }
  },
  mounted: function mounted() {},
  beforeMount: function beforeMount() {
    ...
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_7___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee3() {
      var urlParams;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              urlParams = (0,_utils__WEBPACK_IMPORTED_MODULE_12__.getUrlSearchParams)();

              if (urlParams.backurl) {
                _this6.cancelUrl = urlParams.backurl;
              }

              if (urlParams.org) {
                _this6.orgId = urlParams.org;
                console.log(urlParams.org);
              }

              _context3.next = 5;
              return _this6.getUsersList();
...
/***/ "./web_src/vuepages/pages/guide/createDataset/vp-create-dataset.js":
/*!*************************************************************************!*\
  !*** ./web_src/vuepages/pages/guide/createDataset/vp-create-dataset.js ***!
  \*************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/guide/createDataset/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=0&id=10615214&lang=css":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=0&id=10615214&lang=css ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/guide/createDataset/index.vue":
/*!**************************************************************!*\
  !*** ./web_src/vuepages/pages/guide/createDataset/index.vue ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_10615214_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=10615214&scoped=true */ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=template&id=10615214&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_10615214_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=10615214&lang=css */ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=0&id=10615214&lang=css");
/* harmony import */ var _index_vue_vue_type_style_index_1_id_10615214_lang_less_scoped_true__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true */ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_4__["default"])(
  ...
  _index_vue_vue_type_template_id_10615214_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_10615214_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "10615214",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/guide/createDataset/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=script&lang=js":
/*!**************************************************************************************!*\
  !*** ./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=script&lang=js ***!
  \**************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=0&id=10615214&lang=css":
/*!**********************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=0&id=10615214&lang=css ***!
  \**********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_10615214_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=10615214&lang=css */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=0&id=10615214&lang=css");


/***/ }),

/***/ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true":
/*!***********************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true ***!
  \***********************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_10615214_lang_less_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=style&index=1&id=10615214&lang=less&scoped=true");
...
/***/ "./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=template&id=10615214&scoped=true":
/*!********************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=template&id=10615214&scoped=true ***!
  \********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_10615214_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_10615214_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_10615214_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=10615214&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=template&id=10615214&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=template&id=10615214&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/guide/createDataset/index.vue?vue&type=template&id=10615214&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    ...
    [
      ...
      _c(
        "create-form",
        {
          ...
          attrs: { title: _vm.title, active: _vm.active }
        },
        [
          _vm.active === 0
            ? _c(
                  ...
                  _c(
                    ...
                    [
                            ...
                            [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(
                                    _vm.$t(
                                      "datasetObj.dataset_name_cn_tooltips"
                                    )
                                  ) +
                                  "\n                    "
                              )
                          ...
                          _c(
                            ...
                            [
                              _c("el-radio", { attrs: { label: false } }, [
                                _vm._v(
                                  _vm._s(
                                    _vm.$t("modelManage.modelAccessPublic")
                                  )
                                )
                              ]),
                              _vm._v(" "),
                      ...
                      _c(
                        ...
                        {
                          attrs: {
                            label: _vm.$t("datasetObj.category"),
                            prop: "tags"
                          }
                        },
                        [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            [_vm._v(_vm._s(_vm.$t("cloudbrainObj.nextStep")))]
                          )
                        ],
                        1
                      )
          ...
          _vm.active === 1
            ? _c(
                ...
                [
                  _c("FileUpload", {
                    attrs: { modelId: _vm.datasetID },
                    on: {
                      cancel: _vm.cancelUpload,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/guide/createDataset/vp-create-dataset.js"); })
