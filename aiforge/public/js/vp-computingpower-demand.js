...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var core_js_modules_es_string_includes__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! core-js/modules/es.string.includes */ "./node_modules/core-js/modules/es.string.includes.js");
...
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js");
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26__);
/* harmony import */ var _apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ~/apis/modules/computingpower */ "./web_src/vuepages/apis/modules/computingpower.js");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      isZh: _langs__WEBPACK_IMPORTED_MODULE_28__.lang == 'zh-CN',
      isLogin: false,
      filterShow: true,
      computeResourceList: [{
        k: '',
  ...
  watch: {
    active: {
      handler: function handler(newValue, oValue) {
        if (newValue) {
          this.getData();
        }
      }
  ...
  methods: {
    changeConds: function changeConds(value, type) {
      var _this = this;

      if (type == 'compute_resource') {
        this.cardTypeList.splice(1, Infinity);

        for (var key in this.cardTypeMap) {
          if (value && value != key) continue;
          this.cardTypeMap[key].forEach(function (item) {
            if (!_this.cardTypeList.find(function (itm) {
              return itm.k == item;
            })) {
              _this.cardTypeList.push({
                k: item,
                v: item
              });
            }
        ...
        for (var _key in this.cardNumMap) {
          if (value && value != _key) continue;

          this.cardNumMap[_key].forEach(function (item) {
            if (!_this.cardNumList.find(function (itm) {
              return itm.k == item;
            })) {
              _this.cardNumList.push({
                k: item,
                v: item
              });
            }
    ...
    goBuy: function goBuy(item) {
      if (this.isLogin) {
        ...
        window.location.href = "/user/login?redirect_to=".concat(encodeURIComponent(window.location.href + '?active=1'));
      }
    },
    getData: function getData() {
      ...
      (0,_apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_27__.getPayResourceList)({}).then(function (res) {
        res = res.data;

        if (res.Code == 0) {
          var resourceTypes = res.Data.resourceTypes || [];

          _this2.computeResourceList.splice(1, Infinity);

          _this2.cardTypeList.splice(1, Infinity);

          _this2.cardNumList.splice(1, Infinity);

          for (var i = 0, iLen = resourceTypes.length; i < iLen; i++) {
            var resourceTypesI = resourceTypes[i];
            var computeSource = {
              k: resourceTypesI.category,
              v: resourceTypesI.label
            };
            var computeSourceKey = computeSource.k;
            _this2.computeResourceMap[computeSourceKey] = computeSource;
            var cardList = resourceTypesI.cardTypes || [];
            var cardCounts = resourceTypesI.cardCounts || [];
            var providers = resourceTypesI.providers || [];

            if (_this2.cardTypeMap[computeSourceKey]) {
              var _this2$cardTypeMap$co;

              (_this2$cardTypeMap$co = _this2.cardTypeMap[computeSourceKey]).push.apply(_this2$cardTypeMap$co, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default()(cardList));
            } else {
              _this2.cardTypeMap[computeSourceKey] = cardList;
            }

            if (_this2.cardNumMap[computeSourceKey]) {
              var _this2$cardNumMap$com;

              (_this2$cardNumMap$com = _this2.cardNumMap[computeSourceKey]).push.apply(_this2$cardNumMap$com, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default()(cardCounts));
            } else {
              _this2.cardNumMap[computeSourceKey] = cardCounts;
            }

            if (_this2.providerMap[computeSourceKey]) {
              var _this2$providerMap$co;

              (_this2$providerMap$co = _this2.providerMap[computeSourceKey]).push.apply(_this2$providerMap$co, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default()(providers));
            } else {
              _this2.providerMap[computeSourceKey] = providers;
            }
          }

          for (var key in _this2.computeResourceMap) {
            var _computeSource = _this2.computeResourceMap[key];

            _this2.computeResourceList.push(_computeSource);

            _this2.computeResourceMap[key] = [_computeSource.k];
          }

          for (var _key2 in _this2.cardTypeMap) {
            _this2.cardTypeMap[_key2] = Array.from(new Set(_this2.cardTypeMap[_key2]));

            _this2.cardTypeMap[_key2].forEach(function (item) {
              if (!_this2.cardTypeList.find(function (itm) {
                return itm.k == item;
              })) {
                _this2.cardTypeList.push({
                  k: item,
                  v: item
                });
              }
          ...
          for (var _key3 in _this2.cardNumMap) {
            _this2.cardNumMap[_key3] = Array.from(new Set(_this2.cardNumMap[_key3]));

            _this2.cardNumMap[_key3].forEach(function (item) {
              if (!_this2.cardNumList.find(function (itm) {
                return itm.k == item;
              })) {
                _this2.cardNumList.push({
                  k: item,
                  v: item
                });
              }
          ...
          for (var _key4 in _this2.providerMap) {
            _this2.providerMap[_key4] = Array.from(new Set(_this2.providerMap[_key4]));

            _this2.providerMap[_key4].forEach(function (item) {
              if (!_this2.providerList.find(function (itm) {
                return itm.k == item;
              })) {
          ...
          var dataList = res.Data.products || [];
          _this2.list = dataList.map(function (item) {
    ...
    search: function search() {
      ...
      this.loading = true;
      var useList = this.list.filter(function (item) {
        var check1 = true,
            check2 = true,
            check3 = true,
            check4 = true;
        ...
        if (params.accCardNum != -1) {
          if (params.accCardNum == 'other') {
            check3 = !_this3.cardNumList.slice(1, _this3.cardNumList.length - 1).map(function (itm) {
              return itm.k;
            }).includes(item.cardNum);
          } else {
  ...
  mounted: function mounted() {
    // this.search();
    var element = document.querySelector('.filter-mobile-show');

    if (element) {
      var displayValue = window.getComputedStyle(element).getPropertyValue('display'); // 判断是否为移动端，当为移动端时，默认不显示筛选条件
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ~/apis/modules/computingpower */ "./web_src/vuepages/apis/modules/computingpower.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    (0,_apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_0__.getPartners)({}).then(function (res) {
      res = res.data;

      if (res.Code == 0) {
        var data = res.Data;
        _this.computingPlatform = data.computing_platform || [];
        _this.chipVendor = data.chip_vendor || [];
        _this.aiCenter = data.ai_center || [];
      }
    })["catch"](function (err) {
      console.log(err);
    });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=script&lang=js":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=script&lang=js ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js");
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26__);
/* harmony import */ var _JumpButton_vue__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./JumpButton.vue */ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue");
/* harmony import */ var _apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ~/apis/modules/computingpower */ "./web_src/vuepages/apis/modules/computingpower.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    JumpButton: _JumpButton_vue__WEBPACK_IMPORTED_MODULE_27__["default"]
  },
  data: function data() {
    return {
      filterShow: true,
      ...
      cardNumList: [{
        k: '',
        v: this.$t('all')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default()([1, 2, 4, 8].map(function (itm) {
        return {
          k: itm,
          v: itm
        };
  ...
  methods: {
      ...
      if (type == 'compute_resource') {
        ...
        for (var key in this.cardTypeMap) {
          ...
          this.cardTypeMap[key].forEach(function (item) {
            _this.cardTypeList.push({
              k: item,
              v: (0,_utils__WEBPACK_IMPORTED_MODULE_30__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_29__.ACC_CARD_TYPE, item)
            });
          });
        }
    ...
    inputPrice: function inputPrice(type) {
    ...
    clearPriceConds: function clearPriceConds() {
      this._price_start = this.conds.price_start = '';
      this._price_end = this.conds.price_end = '';
      this.conds.page = 1;
      this.search();
    ...
    search: function search() {
      ...
      var params = {
        ...
        excludeAccCardNums: this.conds.acc_cards_num == 9999 ? this.cardNumList.slice(1, this.cardNumList.length - 1).map(function (itm) {
          return itm.k;
        }).join('|') : undefined,
      ...
      this.loading = true;
      (0,_apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_28__.getResourceList)(params).then(function (res) {
        _this2.loading = false;
        res = res.data;

        if (res.code == 0) {
          var data = res.data || {};
          _this2.paginationInfo.total = data.total;
          _this2.list = (data.list || []).map(function (item) {
            return _objectSpread({
              AccCardTypeShow: (0,_utils__WEBPACK_IMPORTED_MODULE_30__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_29__.ACC_CARD_TYPE, item.AccCardType)
            }, item);
          });
        }
      })["catch"](function (err) {
    ...
    goAiTask: function goAiTask(item) {
      var spec = {
      ...
      window.location.href = "/cloudbrains/create?spec=".concat(encodeURIComponent(JSON.stringify(spec)));
    },
    setConds: function setConds() {
  ...
  created: function created() {
    ...
    // this.setConds();
    (0,_apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_28__.getAccCardList)().then(function (res) {
      res = res.data;

      if (res.code == 0) {
        _this3.computeResourceList.splice(1, Infinity);

        _this3.cardTypeList.splice(1, Infinity);

        var data = res.data.list || [];

        for (var i = 0, iLen = data.length; i < iLen; i++) {
          var item = data[i];
          var computeSource = item.ComputeSource;
          var cardList = item.CardList;
          var computeSourceKey = computeSource.indexOf('-GPGPU') > 0 ? 'GPGPU' : computeSource;

          if (_this3.computeResourceMap[computeSourceKey]) {
            _this3.computeResourceMap[computeSourceKey].push(computeSource);
          } else {
            _this3.computeResourceMap[computeSourceKey] = [computeSource];
          }

          if (_this3.cardTypeMap[computeSourceKey]) {
            var _this3$cardTypeMap$co;

            (_this3$cardTypeMap$co = _this3.cardTypeMap[computeSourceKey]).push.apply(_this3$cardTypeMap$co, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_26___default()(cardList));
          } else {
            _this3.cardTypeMap[computeSourceKey] = cardList;
          }
        }

        for (var key in _this3.computeResourceMap) {
          _this3.computeResourceMap[key] = Array.from(new Set(_this3.computeResourceMap[key]));

          _this3.computeResourceList.push({
            k: key,
            v: key
          });
        }

        for (var _key in _this3.cardTypeMap) {
          _this3.cardTypeMap[_key] = Array.from(new Set(_this3.cardTypeMap[_key]));

          _this3.cardTypeMap[_key].forEach(function (item) {
            _this3.cardTypeList.push({
              k: item,
              v: (0,_utils__WEBPACK_IMPORTED_MODULE_30__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_29__.ACC_CARD_TYPE, item)
            });
          });
    ...
    (0,_apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_28__.getAvailableAiCenterList)().then(function (res) {
      res = res.data;

      if (res.code == 0) {
        var _res, _res$data;

        _this3.aiCenterList.splice(1, Infinity);

        var data = ((_res = res) === null || _res === void 0 ? void 0 : (_res$data = _res.data) === null || _res$data === void 0 ? void 0 : _res$data.list) || [];

        for (var i = 0, iLen = data.length; i < iLen; i++) {
          var item = data[i];

          _this3.aiCenterList.push({
            k: item.AiCenterCode,
            v: item.AiCenterName
          });
        }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_Resources_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/Resources.vue */ "./web_src/vuepages/pages/computingpower/components/Resources.vue");
/* harmony import */ var _components_ExtraResources_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/ExtraResources.vue */ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue");
/* harmony import */ var _components_JumpButton_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/JumpButton.vue */ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue");
/* harmony import */ var _components_Partner_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/Partner.vue */ "./web_src/vuepages/pages/computingpower/components/Partner.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Resources: _components_Resources_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    ExtraResources: _components_ExtraResources_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    JumpButton: _components_JumpButton_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    Partner: _components_Partner_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  methods: {
  ...
  mounted: function mounted() {
    ...
    var active = Number(searchParams.get('active') || 0);

    if (active) {
      this.$nextTick(function () {
        _this.changeTab(active);
      });
    }
  },
...
/* harmony export */   getAccCardList: function() { return /* binding */ getAccCardList; },
/* harmony export */   getAiCenterList: function() { return /* binding */ getAiCenterList; },
/* harmony export */   getAvailableAiCenterList: function() { return /* binding */ getAvailableAiCenterList; },
/* harmony export */   getDemandCreationRequired: function() { return /* binding */ getDemandCreationRequired; },
/* harmony export */   getDemandList: function() { return /* binding */ getDemandList; },
/* harmony export */   getDemandMyList: function() { return /* binding */ getDemandMyList; },
/* harmony export */   getDomesticCardData: function() { return /* binding */ getDomesticCardData; },
/* harmony export */   getPartners: function() { return /* binding */ getPartners; },
/* harmony export */   getPayResourceList: function() { return /* binding */ getPayResourceList; },
/* harmony export */   getResQueueCode: function() { return /* binding */ getResQueueCode; },
/* harmony export */   getResourceList: function() { return /* binding */ getResourceList; },
/* harmony export */   getSpecificationList: function() { return /* binding */ getSpecificationList; },
/* harmony export */   postDemand: function() { return /* binding */ postDemand; },
/* harmony export */   updateDemand: function() { return /* binding */ updateDemand; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_array_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.array.filter */ "./node_modules/core-js/modules/es.array.filter.js");
...
var getAvailableAiCenterList = function getAvailableAiCenterList() {
...
var getSpecificationList = function getSpecificationList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var getAccCardList = function getAccCardList() {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var getResourceList = function getResourceList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
    url: "/explore/card_request/resource/list",
    method: 'get',
    params: _objectSpread({}, params),
    paramsSerializer: function paramsSerializer(_params) {
      return qs__WEBPACK_IMPORTED_MODULE_11___default().stringify(_params, {
        arrayFormat: 'repeat'
      });
    }
  });
...
var getPayResourceList = function getPayResourceList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var getPartners = function getPartners(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var getDemandCreationRequired = function getDemandCreationRequired(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var postDemand = function postDemand(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var updateDemand = function updateDemand(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
    url: "/explore/card_request/update/".concat(data.id),
    method: 'put',
    params: {},
    data: _objectSpread({}, data)
  });
...
var getDemandList = function getDemandList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var getDemandMyList = function getDemandMyList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
var getDomesticCardData = function getDomesticCardData(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_10__["default"])({
...
/***/ "./web_src/vuepages/pages/computingpower/demand/vp-computingpower-demand.js":
/*!**********************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/demand/vp-computingpower-demand.js ***!
  \**********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/computingpower/demand/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ExtraResources_vue_vue_type_template_id_180b3e58_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true */ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true");
/* harmony import */ var _ExtraResources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExtraResources.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=script&lang=js");
/* harmony import */ var _ExtraResources_vue_vue_type_style_index_0_id_180b3e58_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less */ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ExtraResources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _ExtraResources_vue_vue_type_template_id_180b3e58_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _ExtraResources_vue_vue_type_template_id_180b3e58_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "180b3e58",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/computingpower/components/ExtraResources.vue"
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _JumpButton_vue_vue_type_template_id_aa77213a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./JumpButton.vue?vue&type=template&id=aa77213a&scoped=true */ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=template&id=aa77213a&scoped=true");
/* harmony import */ var _JumpButton_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./JumpButton.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=script&lang=js");
/* harmony import */ var _JumpButton_vue_vue_type_style_index_0_id_aa77213a_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less */ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _JumpButton_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _JumpButton_vue_vue_type_template_id_aa77213a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _JumpButton_vue_vue_type_template_id_aa77213a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "aa77213a",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/computingpower/components/JumpButton.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Partner_vue_vue_type_template_id_12973116_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Partner.vue?vue&type=template&id=12973116&scoped=true */ "./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=template&id=12973116&scoped=true");
/* harmony import */ var _Partner_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Partner.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=script&lang=js");
/* harmony import */ var _Partner_vue_vue_type_style_index_0_id_12973116_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less */ "./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Partner_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Partner_vue_vue_type_template_id_12973116_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Partner_vue_vue_type_template_id_12973116_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "12973116",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/computingpower/components/Partner.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Resources_vue_vue_type_template_id_7edba112_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Resources.vue?vue&type=template&id=7edba112&scoped=true */ "./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=template&id=7edba112&scoped=true");
/* harmony import */ var _Resources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Resources.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=script&lang=js");
/* harmony import */ var _Resources_vue_vue_type_style_index_0_id_7edba112_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less */ "./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Resources_vue_vue_type_template_id_7edba112_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Resources_vue_vue_type_template_id_7edba112_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "7edba112",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/computingpower/components/Resources.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_621fefd4_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=621fefd4&scoped=true */ "./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=template&id=621fefd4&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_621fefd4_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less */ "./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_621fefd4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_621fefd4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "621fefd4",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/computingpower/demand/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraResources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ExtraResources.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraResources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=script&lang=js":
/*!*************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_JumpButton_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./JumpButton.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_JumpButton_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=script&lang=js":
/*!**********************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Partner_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Partner.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Partner_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=script&lang=js":
/*!************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=script&lang=js ***!
  \************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Resources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Resources_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=script&lang=js":
/*!****************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=script&lang=js ***!
  \****************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less":
/*!**************************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less ***!
  \**************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraResources_vue_vue_type_style_index_0_id_180b3e58_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=style&index=0&id=180b3e58&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less":
/*!**********************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less ***!
  \**********************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_JumpButton_vue_vue_type_style_index_0_id_aa77213a_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=style&index=0&id=aa77213a&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less":
/*!*******************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less ***!
  \*******************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_Partner_vue_vue_type_style_index_0_id_12973116_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=style&index=0&id=12973116&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less":
/*!*********************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less ***!
  \*********************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_Resources_vue_vue_type_style_index_0_id_7edba112_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=style&index=0&id=7edba112&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less":
/*!*************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less ***!
  \*************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_621fefd4_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=style&index=0&id=621fefd4&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true":
/*!***********************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true ***!
  \***********************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraResources_vue_vue_type_template_id_180b3e58_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraResources_vue_vue_type_template_id_180b3e58_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraResources_vue_vue_type_template_id_180b3e58_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=template&id=aa77213a&scoped=true":
/*!*******************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=template&id=aa77213a&scoped=true ***!
  \*******************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_JumpButton_vue_vue_type_template_id_aa77213a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_JumpButton_vue_vue_type_template_id_aa77213a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_JumpButton_vue_vue_type_template_id_aa77213a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./JumpButton.vue?vue&type=template&id=aa77213a&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=template&id=aa77213a&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=template&id=12973116&scoped=true":
/*!****************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=template&id=12973116&scoped=true ***!
  \****************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Partner_vue_vue_type_template_id_12973116_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Partner_vue_vue_type_template_id_12973116_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Partner_vue_vue_type_template_id_12973116_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Partner.vue?vue&type=template&id=12973116&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=template&id=12973116&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=template&id=7edba112&scoped=true":
/*!******************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=template&id=7edba112&scoped=true ***!
  \******************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Resources_vue_vue_type_template_id_7edba112_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Resources_vue_vue_type_template_id_7edba112_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Resources_vue_vue_type_template_id_7edba112_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Resources.vue?vue&type=template&id=7edba112&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=template&id=7edba112&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=template&id=621fefd4&scoped=true":
/*!**********************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=template&id=621fefd4&scoped=true ***!
  \**********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_621fefd4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_621fefd4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_621fefd4_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=621fefd4&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=template&id=621fefd4&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/ExtraResources.vue?vue&type=template&id=180b3e58&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "resources-c", class: _vm.isZh ? "zh" : "" },
    [
      _c(
        "el-checkbox",
        {
          staticClass: "filter-mobile-show",
          model: {
        ...
        [
          _vm._v(
            "\n    " +
              _vm._s(_vm.$t("computingPowerObj.displayFilteringConditions")) +
              "\n  "
          )
        ]
      ),
      _vm._v(" "),
      _vm.filterShow
        ? _c("div", { staticClass: "conds-c" }, [
            _c("div", { staticClass: "conds-item" }, [
              _c("div", { staticClass: "conds-item-tit" }, [
                _vm._v(
                  _vm._s(_vm.$t("resourcesManagement.computeResource")) + "："
                )
              ]),
              _vm._v(" "),
              _c(
                "div",
                { staticClass: "conds-item-content" },
                _vm._l(_vm.computeResourceList, function(item, index) {
                  return _c(
                    "div",
                    {
                      key: index,
                      staticClass: "sel-item",
                      class:
                        item.k == _vm.conds.compute_resource ? "active" : "",
                      on: {
                        click: function($event) {
                          return _vm.changeConds(item.k, "compute_resource")
                        }
                      }
                    },
                    [_vm._v("\n          " + _vm._s(item.v) + "\n        ")]
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.cardTypeList.length > 1,
                    expression: "cardTypeList.length > 1"
                  }
                ],
                staticClass: "conds-item"
              },
              [
                _c("div", { staticClass: "conds-item-tit" }, [
                  _vm._v(
                    _vm._s(_vm.$t("resourcesManagement.accCardType")) + "："
                  )
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  { staticClass: "conds-item-content" },
                  _vm._l(_vm.cardTypeList, function(item, index) {
                    return _c(
                      "div",
                      {
                        key: index,
                        staticClass: "sel-item",
                        class: item.k == _vm.conds.card_type ? "active" : "",
                        on: {
                          click: function($event) {
                            return _vm.changeConds(item.k, "card_type")
                          }
                        }
                      },
                      [_vm._v("\n          " + _vm._s(item.v) + "\n        ")]
            ...
            _c(
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.cardNumList.length > 2,
                    expression: "cardNumList.length > 2"
                  }
                ],
                staticClass: "conds-item"
              },
              [
                _c("div", { staticClass: "conds-item-tit" }, [
                  _vm._v(
                    _vm._s(_vm.$t("computingPowerObj.accCardCount")) + "："
                  )
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  { staticClass: "conds-item-content" },
                  _vm._l(_vm.cardNumList, function(item, index) {
                    return _c(
                      "div",
                      {
                        key: index,
                        staticClass: "sel-item",
                        class:
                          item.k == _vm.conds.acc_cards_num ? "active" : "",
                        on: {
                          click: function($event) {
                            return _vm.changeConds(item.k, "acc_cards_num")
                          }
                        }
                      },
                      [_vm._v("\n          " + _vm._s(item.v) + "\n        ")]
            ...
            _c(
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.providerList.length > 2,
                    expression: "providerList.length > 2"
                  }
                ],
                staticClass: "conds-item"
              },
              [
                _c("div", { staticClass: "conds-item-tit" }, [
                  _vm._v(_vm._s(_vm.$t("computingPowerObj.provider")) + "：")
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  ...
                  _vm._l(_vm.providerList, function(item, index) {
                    return _c(
                      "div",
                      {
                        key: index,
                        staticClass: "sel-item",
                        class: item.k == _vm.conds.provider ? "active" : "",
                        on: {
                          click: function($event) {
                            return _vm.changeConds(item.k, "provider")
                          }
                        }
                      },
                      [_vm._v("\n          " + _vm._s(item.v) + "\n        ")]
              ...
              return _c("div", { key: index, staticClass: "list-item" }, [
                      ...
                      item.source_type
                        ? _c(
                            "div",
                            {
                              staticClass: "type",
                              class:
                                item.source_type == "独享" ? "exclusive" : ""
                            },
                            [_vm._v(_vm._s(item.source_type))]
                          )
                        : _vm._e()
                    ])
                  ]),
                          ...
                          return item[attr] !== undefined
                            ? _c("div", { staticClass: "attribute" }, [
                                _c("span", { staticClass: "tit" }, [
                                  _vm._v(_vm._s(_vm.attrTitle[attr]) + "：")
                                ]),
                ...
                _c("div", { staticClass: "bottom" }, [
                  ...
                  _c(
                    ...
                    [_vm._v(_vm._s(_vm.$t("computingPowerObj.buyNow")))]
                  )
                ])
              ])
            }),
            _vm._v(" "),
            !_vm.showList.length && !_vm.loading
              ? _c("div", { staticClass: "demand-item no-data" }, [
        ...
        [
          _c("el-pagination", {
            attrs: {
              ...
              "current-page": _vm.conds.page,
              "page-size": _vm.conds.page_size,
              "page-sizes": _vm.paginationInfo.pageSizes,
              total: _vm.paginationInfo.total
            },
            on: {
              "update:currentPage": function($event) {
                return _vm.$set(_vm.conds, "page", $event)
              },
              "update:current-page": function($event) {
                return _vm.$set(_vm.conds, "page", $event)
              },
              "update:pageSize": function($event) {
                return _vm.$set(_vm.conds, "page_size", $event)
              },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=template&id=aa77213a&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/JumpButton.vue?vue&type=template&id=aa77213a&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=template&id=12973116&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Partner.vue?vue&type=template&id=12973116&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "partner-c" }, [
    _c("div", { staticClass: "title-c" }, [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "tit" }, [
        _vm._v(_vm._s(_vm.$t("computingPowerObj.computingPowerPartner")))
      ]),
      _vm._v(" "),
      _vm._m(1)
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "part-title-c" }, [
      _c("div", { staticClass: "part-title" }, [
        _c("div", { staticClass: "l" }),
        _vm._v(" "),
        _c("div", { staticClass: "tit" }, [
          _vm._v(
            _vm._s(_vm.$t("computingPowerObj.computingPowerOperationPlatform"))
          )
        ]),
        _vm._v(" "),
    ...
    _c(
      "div",
      { staticClass: "computing-platform-c" },
      _vm._l(_vm.computingPlatform, function(item, index) {
    ...
    _c("div", { staticClass: "part-title-c" }, [
      _c("div", { staticClass: "part-title" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "tit" }, [
          _vm._v(_vm._s(_vm.$t("computingPowerObj.chipManufacturers")))
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "r" })
      ])
    ...
    _c(
      "div",
      { staticClass: "chip-vendor-c" },
      _vm._l(_vm.chipVendor, function(item, index) {
        return _c("div", { key: index, staticClass: "item" }, [
          _c("img", {
            style: item.height ? "height:" + item.height + "px" : "",
            attrs: { src: item.logo, alt: "" }
    ...
    _c("div", { staticClass: "part-title-c" }, [
      _c("div", { staticClass: "part-title" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "tit" }, [
          _vm._v(_vm._s(_vm.$t("resourcesManagement.aiCenter")))
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "r" })
      ])
    ...
    _c(
      "div",
      { staticClass: "ai-center-c" },
      _vm._l(_vm.aiCenter, function(item, index) {
        return _c("div", { key: index, staticClass: "item" }, [
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "l" }, [
      _c("img", {
        attrs: { src: "/img/computingpower/title-decoration.png", alt: "" }
      })
    ])
  },
  function() {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=template&id=7edba112&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/components/Resources.vue?vue&type=template&id=7edba112&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    ...
    [
      ...
      _vm.filterShow
        ? _c("div", { staticClass: "conds-c" }, [
            ...
            _c("div", { staticClass: "conds-item" }, [
              _c("div", { staticClass: "conds-item-tit" }, [
                _vm._v(_vm._s(_vm.$t("resourcesManagement.accCardType")) + "：")
              ]),
              _vm._v(" "),
              _c(
                "div",
            ...
            _c("div", { staticClass: "conds-item" }, [
              _c("div", { staticClass: "conds-item-tit" }, [
                _vm._v(_vm._s(_vm.$t("computingPowerObj.accCardCount")) + "：")
              ]),
              _vm._v(" "),
              _c(
                "div",
                ...
                _vm._l(_vm.cardNumList, function(item, index) {
                  return _c(
                    "div",
                    {
                      key: index,
                      staticClass: "sel-item",
                      class: item.k == _vm.conds.acc_cards_num ? "active" : "",
                      on: {
                        click: function($event) {
                          return _vm.changeConds(item.k, "acc_cards_num")
                        }
            ...
            _c("div", { staticClass: "conds-item" }, [
              ...
              _c(
                "div",
                { staticClass: "conds-item-content" },
                _vm._l(_vm.aiCenterList, function(item, index) {
                  return _c(
                    "div",
                    {
                      key: index,
                      staticClass: "sel-item",
                      class: item.k == _vm.conds.ai_center ? "active" : "",
                      on: {
                        click: function($event) {
                          return _vm.changeConds(item.k, "ai_center")
                        }
                      }
                    },
                    [_vm._v("\n          " + _vm._s(item.v) + "\n        ")]
            ...
            _c("div", { staticClass: "conds-item" }, [
              _c("div", { staticClass: "conds-item-tit" }, [
                _vm._v(_vm._s(_vm.$t("computingPowerObj.priceRange")) + "：")
              ]),
              _vm._v(" "),
              _c(
                "div",
                  ...
                  _c("el-input", {
                    ...
                    on: {
                      input: function($event) {
                        return _vm.inputPrice("price_start")
                      },
                      blur: function($event) {
                        return _vm.checkPrice("price_start")
                      }
                    },
                    model: {
                      value: _vm.conds.price_start,
                      callback: function($$v) {
                        _vm.$set(_vm.conds, "price_start", $$v)
                      },
                      expression: "conds.price_start"
                    }
                  }),
                  _c("span", { staticClass: "to" }, [_vm._v(" - ")]),
                  _c("el-input", {
                    staticClass: "price-e",
                    on: {
                      input: function($event) {
                        return _vm.inputPrice("price_end")
                      },
                      blur: function($event) {
                        return _vm.checkPrice("price_end")
                      }
                    },
                    model: {
                      value: _vm.conds.price_end,
                      callback: function($$v) {
                        _vm.$set(_vm.conds, "price_end", $$v)
                      },
                      expression: "conds.price_end"
                    }
                  }),
                  _c("span", { staticClass: "unit" }, [
                    _vm._v(_vm._s(_vm.$t("computingPowerObj.point_hr")))
                  ]),
                  _vm._v(" "),
                  _vm.conds.price_start != "" || _vm.conds.price_end != ""
                    ? _c(
                        "el-button",
                        {
                          attrs: { type: "primary", size: "mini" },
                          on: { click: _vm.clearPriceConds }
                        },
              ...
              return _c("div", { key: index, staticClass: "list-item" }, [
                _c("div", { staticClass: "top" }, [
                  _c("div", { staticClass: "left" }, [
                    _c("div", { staticClass: "title" }, [
                      _c("div", { staticClass: "name" }, [
                        _vm._v(_vm._s(item.AccCardTypeShow || item.AccCardType))
                      ])
                    ])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "right" }, [
                    _c("span", { staticClass: "price" }, [
                      _vm._v(_vm._s(item.UnitPrice.toFixed(2)))
                    ]),
                    _vm._v(
                      _vm._s(_vm.$t("computingPowerObj.point_hr")) +
                        "\n            "
                    ),
                    _c(
                      "div",
                      { staticClass: "right use-position-mobile-show" },
                      [
                        _c("JumpButton", {
                          attrs: {
                            title: _vm.$t("computingPowerObj.use"),
                            size: "small",
                            tooltip: _vm.$t(
                              "computingPowerObj.createComputingTask"
                            )
                          },
                          on: {
                            click: function($event) {
                              return _vm.goAiTask(item)
                            }
                          }
                        })
                      ],
                ...
                _c("div", { staticClass: "mid" }, [
                  _c("div", { staticClass: "left" }, [
                    _c("div", { staticClass: "attributes" }, [
                      _c("div", { staticClass: "attribute" }, [
                        _c("span", { staticClass: "tit" }, [
                          _vm._v(_vm._s(item.ComputeResource) + "：")
                        ]),
                        _c("span", { staticClass: "val" }, [
                          _vm._v(
                            _vm._s(item.AccCardsNum) +
                              " * " +
                              _vm._s(item.AccCardTypeShow || item.AccCardType)
                          ),
                          item.GPUMemGiB
                            ? _c("span", [
                                _c("span", { staticClass: "val" }, [
                                  _vm._v(
                                    "(" +
                                      _vm._s(
                                        _vm.$t("resourcesManagement.gpuMem")
                                      ) +
                                      ":"
                                  )
                                ]),
                                _c("span", { staticClass: "val" }, [
                                  _vm._v(_vm._s(item.GPUMemGiB) + "GB)")
                                ])
                              ])
                            : _vm._e()
                        ])
                ...
                _c("div", { staticClass: "bottom" }, [
                  _c(
                    "div",
                    { staticClass: "left" },
                    _vm._l(item.AICenterList, function(center) {
                      return _c(
                        "div",
                        {
                          key: center.AiCenterCode,
                          staticClass: "ai-center",
                          attrs: { title: center.AiCenterName }
                        },
                        [
                          _vm._v(
                            "\n              " +
                              _vm._s(center.AiCenterName) +
                              "\n            "
                          )
                        ]
                      )
                  ...
                  _c(
                    "div",
                    { staticClass: "right use-position-mobile-hide" },
                    [
                      _c("JumpButton", {
                        attrs: {
                          title: _vm.$t("computingPowerObj.use"),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=template&id=621fefd4&scoped=true":
/*!*************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/demand/index.vue?vue&type=template&id=621fefd4&scoped=true ***!
  \*************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "demand-c" }, [
    _vm._m(0),
    _vm._v(" "),
    _c("div", { staticClass: "ui container" }, [
      _c("div", { staticClass: "top-head only-mobile-hidden" }, [
        _c("div", { staticClass: "title" }, [
          _vm._v(_vm._s(_vm.$t("computingPowerObj.computeResource")))
        ]),
        _vm._v(" "),
        _c(
          "div",
          {
            staticClass: "descr",
            staticStyle: { color: "transparent", "user-select": "none" }
          },
          [
            _vm._v(
              _vm._s(_vm.$t("computingPowerObj.computeResourceDescr")) +
                "\n      "
            )
          ]
        )
        ...
        _c("div", { staticClass: "top-area" }, [
          _c("div", { staticClass: "tab-c" }, [
            _c(
              ...
              [_vm._v(_vm._s(_vm.$t("computingPowerObj.freeComputingPower")))]
            ),
            _vm._v(" "),
            _c(
              "div",
              ...
              [
                _vm._v(
                  "\n            " +
                    _vm._s(_vm.$t("computingPowerObj.paidComputingPower")) +
                    "\n            "
                ),
                _c(
                  "el-tooltip",
                  ...
                  [
                    _c("div", { attrs: { slot: "content" }, slot: "content" }, [
                      _vm._v(
                        _vm._s(
                          _vm.$t("computingPowerObj.paidComputingPowerTip")
                        ) + " "
                      )
                    ]),
                    _vm._v(" "),
                      ...
                      [
                        ...
                        _c("g", [
                          _c("path", {
                            attrs: {
                              d:
                                "M16 29.333c-7.364 0-13.333-5.969-13.333-13.333s5.969-13.333 13.333-13.333 13.333 5.969 13.333 13.333-5.969 13.333-13.333 13.333zM16 26.667c5.891 0 10.667-4.776 10.667-10.667s-4.776-10.667-10.667-10.667v0c-5.891 0-10.667 4.776-10.667 10.667s4.776 10.667 10.667 10.667v0zM14.667 20h2.667v2.667h-2.667v-2.667zM17.333 17.807v0.86h-2.667v-2c0-0.736 0.597-1.333 1.333-1.333v0c1.105-0 2-0.895 2-2s-0.895-2-2-2c-0.966 0-1.772 0.685-1.959 1.595l-0.002 0.013-2.616-0.524c0.442-2.155 2.323-3.752 4.577-3.752 2.578 0 4.668 2.090 4.668 4.668 0 2.103-1.39 3.881-3.302 4.465l-0.033 0.009z"
                            }
                          })
                        ])
                      ]
          ...
          _c(
            "div",
            { staticClass: "operate-c only-mobile-hidden" },
            [
              _c("JumpButton", {
                attrs: {
                  title: _vm.$t("computingPowerObj.createNewComputingTask")
                },
                on: { click: _vm.goAiTask }
              })
            ],
            1
          )
          ...
          _c(
            ...
            [
              _c(
                ...
                [_c("Resources", { attrs: { active: _vm.activeTab == 0 } })],
                1
              ),
              _vm._v(" "),
              _c(
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "bg only-mobile-hidden" }, [
      _c("img", { attrs: { src: "/img/cp-resource-bg.jpg", alt: "" } })
    ])
  }
]
render._withStripped = true
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/computingpower/demand/vp-computingpower-demand.js"); })
