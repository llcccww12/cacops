...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=script&lang=js":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=script&lang=js ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _WindowAssistant_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./WindowAssistant.vue */ "./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue");
/* harmony import */ var _WindowUser_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./WindowUser.vue */ "./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue");
/* harmony import */ var _WindowTts_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./WindowTts.vue */ "./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue");
/* harmony import */ var _apis_modules_deepseek__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ~/apis/modules/deepseek */ "./web_src/vuepages/apis/modules/deepseek.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    WindowUser: _WindowUser_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    WindowAssistant: _WindowAssistant_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    WindowTts: _WindowTts_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  data: function data() {
    return {
      sessionRecordData: [],
  ...
  methods: {
    setSessionRecord: function setSessionRecord(val) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 16:
                ...
                console.error('复制操作失败:', _context.t0);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                val = context.split('</think>\n\n')[1];
                console.log(val);
                _context2.next = 4;
                return _this.copyToClipboard(val);

              case 4:
                success = _context2.sent;

                if (success) {
                  _this.$message.success("文本复制成功");
                }
    ...
    feedGood: function feedGood(index) {
      if (this.isGood) {
    ...
    feedBad: function feedBad(index) {
      if (this.isBad) {
        this.cancelFeedback(index, null);
      } else {
    ...
    submitFeedback: function submitFeedback(index, flag) {
      this.simulateRequest(index, flag, 'submit');
    },
    cancelFeedback: function cancelFeedback(index, flag) {
      this.simulateRequest(index, flag, 'cancel');
    },
    simulateRequest: function simulateRequest(index, flag, action) {
      var _this2 = this;
      ...
      (0,_apis_modules_deepseek__WEBPACK_IMPORTED_MODULE_9__.llmChatFeedBack)(params).then(function (res) {
        console.log(res);
    ...
    refreshAnswer: function refreshAnswer(index) {
      this.isGood = false;
      this.isBad = false;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _apis_modules_llmchat__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ~/apis/modules/llmchat */ "./web_src/vuepages/apis/modules/llmchat.js");
...
/* harmony import */ var dropzone_dist_dropzone_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! dropzone/dist/dropzone.css */ "./node_modules/dropzone/dist/dropzone.css");
...
(dropzone__WEBPACK_IMPORTED_MODULE_8___default().autoDiscover) = false;
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'SDMenu',
  props: {
    config: {
  ...
  methods: {
    ...
    changeSpeaker: function changeSpeaker(item, index) {
      this.speakIndex = index;
      this.params.speaker_id = item.id;
    },
    sendPamras: function sendPamras() {
      if (this.tabIndex == 0) {
    ...
    getVoice: function getVoice(item) {
      var _this2 = this;
      ...
      (0,_apis_modules_llmchat__WEBPACK_IMPORTED_MODULE_7__.getSpeakerVoice)(params).then(function (res) {
        var blob = new Blob([res.data], {
          type: 'audio/wav'
        });
        var url = URL.createObjectURL(blob);
        var audio = document.createElement("audio"); //创建标签
    ...
    initDropZone: function initDropZone() {
      ...
      this.dropzoneHandler = new (dropzone__WEBPACK_IMPORTED_MODULE_8___default())('#myDropzone', {
        url: "/",
      ...
      this.dropzoneHandler.on("maxfilesexceeded", function (file) {
        _this3.dropzoneHandler.removeFile(file);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue?vue&type=script&lang=js":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue?vue&type=script&lang=js ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./render */ "./web_src/vuepages/pages/model/llms/componenes/render.js");
...
var thinkStart = ['<', '<t', '<th', '<thi', '<thin', '<think', '<think'];
var thinkStop = ['<', '</', '</t', '</th', '</thi', '</thin', '</think', '</think'];
var md = null;
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    content: {
      ...
      handler: function handler(val) {
        ...
        var regex = /^<think>([\S\s]*?)/im;
        var match = val.match(regex);

        if (match) {
          val = val.replace('<think>', '');
          var valueList = val.split('</think>');
          var flag = false;
          thinkStop.map(function (item) {
            var lastIndex = valueList[0].lastIndexOf(item);
          ...
          var quote = valueList[0].trim() ? valueList[0].trim().split('\n').map(function (item) {
            return '> ' + item;
          }).join('\n') : '';
  ...
  mounted: function mounted() {},
  created: function created() {
    md = (0,_render__WEBPACK_IMPORTED_MODULE_9__["default"])();
  }
});

/***/ }),

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue?vue&type=script&lang=js":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var wavesurfer_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! wavesurfer.js */ "./node_modules/wavesurfer.js/dist/wavesurfer.esm.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    format_time: function format_time(seconds) {
      ...
      var padded_minutes = "".concat(minutes < 10 ? "0" : "").concat(minutes);
      var padded_seconds = "".concat(seconds_remainder < 10 ? "0" : "").concat(seconds_remainder);

      if (hours > 0) {
        return "".concat(hours, ":").concat(padded_minutes, ":").concat(padded_seconds);
      }

      return "".concat(minutes, ":").concat(padded_seconds);
    },
    ...
    initWaveSurfer: function initWaveSurfer() {
      ...
      this.waveSurfer = wavesurfer_js__WEBPACK_IMPORTED_MODULE_17__["default"].create(_objectSpread({
        container: this.$refs.waveform
      }, options));
      this.waveSurfer.on('click', function () {
        _this.waveSurfer.play();
      });
      /** When audio starts loading */

      this.waveSurfer.on('load', function (url) {});
      /** During audio loading */

      this.waveSurfer.on('loading', function (percent) {});
      this.waveSurfer.on('decode', function (duration) {
        _this.duration = _this.format_time(duration);
        _this.loading = false;
      });
      ...
      this.waveSurfer.on('timeupdate', function (currentTime) {
        _this.currentTime = _this.format_time(currentTime);
      });
      /** When the user drags the cursor */

      this.waveSurfer.on('drag', function (relativeX) {});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    opStop: function opStop() {
      var _this = this;

      clearInterval(this.timer);
      this.maskLoading = true;
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_12__.stopAiTask)(this.taskparams, {
        model_experience: true
      }).then(function (res) {
        if (res.data.code === 0) {
          _this.$message.success(_this.$t('modelSquare.experienceStopSuccess'));
    ...
    initParams: function initParams() {
      var _this$config, _this$config2, _this$config2$configs, _this$config3, _this$config3$configs;

      this.modelDesc = (_this$config = this.config) === null || _this$config === void 0 ? void 0 : _this$config.descr;
      this.taskparams.repoName = (_this$config2 = this.config) === null || _this$config2 === void 0 ? void 0 : (_this$config2$configs = _this$config2.configs) === null || _this$config2$configs === void 0 ? void 0 : _this$config2$configs.repo_name;
      this.taskparams.repoOwnerName = (_this$config3 = this.config) === null || _this$config3 === void 0 ? void 0 : (_this$config3$configs = _this$config3.configs) === null || _this$config3$configs === void 0 ? void 0 : _this$config3$configs.repo_owner_name;
      this.getTaskInfo();
    },
    timeToMinutes: function timeToMinutes(timeString) {
      // 使用正则表达式分割字符串
      var _timeString$split$map = timeString.split(':').map(Number),
          _timeString$split$map2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_11___default()(_timeString$split$map, 3),
          hours = _timeString$split$map2[0],
          minutes = _timeString$split$map2[1],
          seconds = _timeString$split$map2[2]; // 将小时转换为分钟并加上分钟和秒转换为分钟的部分
    ...
    getTaskInfo: function getTaskInfo() {
      ...
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_12__.getAiTask)(this.taskparams).then(function (res) {
        res = res.data;
        ...
        if (res.code == 0) {
          ...
          _this2.canStop = data.can_experience;

          var totalMinutes = _this2.timeToMinutes(data.task.formatted_duration);

          _this2.minutes = totalMinutes;
          var vm = _this2;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
...
/* harmony import */ var _componenes_headerModel_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../componenes/headerModel.vue */ "./web_src/vuepages/pages/model/llms/componenes/headerModel.vue");
/* harmony import */ var _apis_modules_llmchat__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ~/apis/modules/llmchat */ "./web_src/vuepages/apis/modules/llmchat.js");
/* harmony import */ var _componenes_SessionWindow_vue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../componenes/SessionWindow.vue */ "./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue");
/* harmony import */ var _componenes_TtsMenu_vue__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../componenes/TtsMenu.vue */ "./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue");
/* harmony import */ var _apis_modules_common__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ~/apis/modules/common */ "./web_src/vuepages/apis/modules/common.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    headerModel: _componenes_headerModel_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    SessionWindow: _componenes_SessionWindow_vue__WEBPACK_IMPORTED_MODULE_17__["default"],
    TtsMenu: _componenes_TtsMenu_vue__WEBPACK_IMPORTED_MODULE_18__["default"]
  },
  data: function data() {
    return {
      prompt: '',
  ...
  watch: {
    sessionRecordData: function sessionRecordData(val) {
      var _this = this;
  ...
  methods: {
    ...
    carriageReturn: function carriageReturn(event) {
    ...
    submit: function submit() {
      ...
      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_14___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_12___default().mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_12___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.$refs.childMenu.sendPamras();
    ...
    chat: function chat(params) {
      ...
      this.chatFlag = true;
      var popData = this.sessionRecordData[this.sessionRecordData.length - 1];
      (0,_apis_modules_llmchat__WEBPACK_IMPORTED_MODULE_16__.getSynthesize)(fd).then(function (res) {
        _this3.chatFlag = false;
        var blob = new Blob([res.data], {
          type: 'audio/wav'
        });
        var url = URL.createObjectURL(blob);
    ...
    scrollBottom: function scrollBottom() {
      ...
      this.$nextTick(function () {
        if (!_this4.isAutoScroll) return;
        var scrollDom = _this4.$refs.chatContainer;
        scrollDom.scrollTop = scrollDom.scrollHeight; // animation(scrollDom, scrollDom.scrollHeight);
      });
    },
    onScroll: function onScroll() {
      var scrollDom = this.$refs.chatContainer;
      var scrollTop = scrollDom.scrollTop;
      var offsetHeight = scrollDom.offsetHeight;
      var scrollHeight = scrollDom.scrollHeight; // 当滚动到底部，设置 isAutoScroll 为 true
    ...
    getConfig: function getConfig() {
      ...
      (0,_apis_modules_common__WEBPACK_IMPORTED_MODULE_19__.getPromoteData)('model/modelexperiencenew.json').then(function (res) {
        var data = JSON.parse(res.data);
        var DepModelInfo = data.filter(function (item) {
          return item.name === _this5.modelName;
        });
        _this5.config = DepModelInfo[0];
        _this5.parametersConfig = _this5.config.parameters;
      })["catch"](function (err) {
...
/***/ "./web_src/vuepages/apis/modules/deepseek.js":
/*!***************************************************!*\
  !*** ./web_src/vuepages/apis/modules/deepseek.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   llmChat: function() { return /* binding */ llmChat; },
/* harmony export */   llmChatFeedBack: function() { return /* binding */ llmChatFeedBack; }
/* harmony export */ });
...
var csrf = window.config ? window.config.csrf : ""; // llm 模型对话

var llmChat = function llmChat(data) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      signal = _ref.signal;

  return fetch("/api/v1/llm/chat/deepseek?_csrf=".concat(csrf), {
    headers: {
...
var llmChatFeedBack = function llmChatFeedBack(data) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getAllCaptionText: function() { return /* binding */ getAllCaptionText; },
/* harmony export */   getAllImages: function() { return /* binding */ getAllImages; },
/* harmony export */   getCaptionStatus: function() { return /* binding */ getCaptionStatus; },
/* harmony export */   getCaptionText: function() { return /* binding */ getCaptionText; },
/* harmony export */   getExampleImages: function() { return /* binding */ getExampleImages; },
/* harmony export */   getLoraGenerateImgProcess: function() { return /* binding */ getLoraGenerateImgProcess; },
/* harmony export */   getLoraStage: function() { return /* binding */ getLoraStage; },
/* harmony export */   getSpeakerVoice: function() { return /* binding */ getSpeakerVoice; },
/* harmony export */   getSynthesize: function() { return /* binding */ getSynthesize; },
/* harmony export */   getTrainLoraProcess: function() { return /* binding */ getTrainLoraProcess; },
/* harmony export */   llmAgree: function() { return /* binding */ llmAgree; },
/* harmony export */   llmChat: function() { return /* binding */ llmChat; },
/* harmony export */   llmChatCompletion: function() { return /* binding */ llmChatCompletion; },
/* harmony export */   llmCount: function() { return /* binding */ llmCount; },
/* harmony export */   llmKbChat: function() { return /* binding */ llmKbChat; },
/* harmony export */   llmKbDelete: function() { return /* binding */ llmKbDelete; },
/* harmony export */   llmKbDeleteDoc: function() { return /* binding */ llmKbDeleteDoc; },
/* harmony export */   llmKbFileList: function() { return /* binding */ llmKbFileList; },
/* harmony export */   llmKbList: function() { return /* binding */ llmKbList; },
/* harmony export */   llmKbUploadDoc: function() { return /* binding */ llmKbUploadDoc; },
/* harmony export */   llmKbUploadDocUrl: function() { return /* binding */ llmKbUploadDocUrl; },
/* harmony export */   llmKbcreate: function() { return /* binding */ llmKbcreate; },
/* harmony export */   llmRecreateVectorStore: function() { return /* binding */ llmRecreateVectorStore; },
/* harmony export */   onlineExperience: function() { return /* binding */ onlineExperience; },
/* harmony export */   postAllAcaption: function() { return /* binding */ postAllAcaption; },
/* harmony export */   postClearImagesId: function() { return /* binding */ postClearImagesId; },
/* harmony export */   postDeleteImagesId: function() { return /* binding */ postDeleteImagesId; },
/* harmony export */   postLoraGenerateImg: function() { return /* binding */ postLoraGenerateImg; },
/* harmony export */   postMakeCaption: function() { return /* binding */ postMakeCaption; },
/* harmony export */   postSingleCaption: function() { return /* binding */ postSingleCaption; },
/* harmony export */   postTrainLora: function() { return /* binding */ postTrainLora; },
/* harmony export */   sdLorauploadImages: function() { return /* binding */ sdLorauploadImages; },
/* harmony export */   sdLorauploadZip: function() { return /* binding */ sdLorauploadZip; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ "./node_modules/core-js/modules/es.object.to-string.js");
...
var csrf = window.config ? window.config.csrf : ''; //下载预设speaker音频

var getSpeakerVoice = function getSpeakerVoice(params) {
...
var getSynthesize = function getSynthesize(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var onlineExperience = function onlineExperience(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmAgree = function llmAgree(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmCount = function llmCount(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmChat = function llmChat(data) {
  return fetch("/api/v1/llm/chat/completion?_csrf=".concat(csrf), {
    headers: {
      'Content-Type': 'application/json'
    },
    method: 'POST',
...
var llmKbChat = function llmKbChat(data, model_name) {
  return fetch("/api/v1/llm/chat/knowledge_base_chat?_csrf=".concat(csrf, "&model_name=").concat(model_name), {
    headers: {
      'Content-Type': 'application/json'
    },
    method: 'POST',
...
var llmKbcreate = function llmKbcreate(data, params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmKbDelete = function llmKbDelete(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmKbDeleteDoc = function llmKbDeleteDoc(data, params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmKbList = function llmKbList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmKbUploadDocUrl = function llmKbUploadDocUrl(params, data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmKbUploadDoc = function llmKbUploadDoc(url, data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: url,
    method: 'post',
    params: {},
...
var llmChatCompletion = function llmChatCompletion(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmKbFileList = function llmKbFileList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var llmRecreateVectorStore = function llmRecreateVectorStore(params) {
  return fetch("/api/v1/llm/knowledge_base/recreate_vector_store?_csrf=".concat(csrf, "&knowledge_base_name=").concat(params.knowledge_base_name, "&model_name=").concat(params.model_name), {
    headers: {
      'Content-Type': 'application/json'
    },
    method: 'POST'
...
var getLoraStage = function getLoraStage(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var sdLorauploadImages = function sdLorauploadImages(url, data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/upload_images"),
    headers: {
...
var sdLorauploadZip = function sdLorauploadZip(url, data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/upload_zip"),
    headers: {
      'Content-Type': 'multipart/form-data'
    },
    method: 'post',
...
var postClearImagesId = function postClearImagesId(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/clear_all_uuids"),
    method: 'post',
    params: {}
  });
};
var postDeleteImagesId = function postDeleteImagesId(url, uuid) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/delete/").concat(uuid),
    method: 'post',
    params: {}
  });
};
var postMakeCaption = function postMakeCaption(url, params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/make_captions"),
    method: 'post',
    params: params
  });
};
var getCaptionStatus = function getCaptionStatus(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/captions_status"),
    method: 'get',
    params: {}
  });
};
var getCaptionText = function getCaptionText(url, uuid) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/get_caption/").concat(uuid),
    method: 'get',
    params: {}
  });
};
var getAllCaptionText = function getAllCaptionText(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/get_all_captions"),
    method: 'get',
    params: {}
  });
};
var getAllImages = function getAllImages(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/list_all_uuids"),
    method: 'get',
    params: {}
  });
};
var postAllAcaption = function postAllAcaption(url, params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/add_all_captions"),
    method: 'post',
    params: params
  });
};
var postSingleCaption = function postSingleCaption(url, uuid, params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/modify_caption/").concat(uuid),
    method: 'post',
    params: params
  });
};
var postTrainLora = function postTrainLora(params, data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var getTrainLoraProcess = function getTrainLoraProcess(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/lora_process"),
    method: 'get',
    params: {}
  });
};
var postLoraGenerateImg = function postLoraGenerateImg(params, data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
...
var getLoraGenerateImgProcess = function getLoraGenerateImgProcess(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/text2img_process"),
    method: 'get',
    params: {}
  });
};
var getExampleImages = function getExampleImages(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_4__["default"])({
    url: "".concat(url, "/load_sample_dataset"),
    method: 'post',
    params: {}
  });
};
...
/***/ "./web_src/vuepages/pages/model/llms/tts/vp-model-tts.js":
/*!***************************************************************!*\
  !*** ./web_src/vuepages/pages/model/llms/tts/vp-model-tts.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var element_ui_lib_locale_lang_zh_CN__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! element-ui/lib/locale/lang/zh-CN */ "./node_modules/element-ui/lib/locale/lang/zh-CN.js");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
/* harmony import */ var _Index_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Index.vue */ "./web_src/vuepages/pages/model/llms/tts/Index.vue");
...
vue__WEBPACK_IMPORTED_MODULE_7__["default"].use((element_ui__WEBPACK_IMPORTED_MODULE_0___default()), {
  locale: _langs__WEBPACK_IMPORTED_MODULE_5__.lang === 'zh-CN' ? element_ui_lib_locale_lang_zh_CN__WEBPACK_IMPORTED_MODULE_4__["default"] : element_ui_lib_locale_lang_en__WEBPACK_IMPORTED_MODULE_3__["default"],
  size: 'medium'
});
new vue__WEBPACK_IMPORTED_MODULE_7__["default"]({
  i18n: _langs__WEBPACK_IMPORTED_MODULE_5__.i18n,
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=style&index=0&id=8ec4e732&lang=less&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=style&index=0&id=8ec4e732&lang=less&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue?vue&type=style&index=0&id=74985e1a&lang=less&scoped=true":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue?vue&type=style&index=0&id=74985e1a&lang=less&scoped=true ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue?vue&type=style&index=0&id=3e1194cf&scoped=true&lang=less":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue?vue&type=style&index=0&id=3e1194cf&scoped=true&lang=less ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue?vue&type=style&index=0&id=7fc36fb8&scoped=true&lang=less":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue?vue&type=style&index=0&id=7fc36fb8&scoped=true&lang=less ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=style&index=0&id=625f5eea&scoped=true&lang=less":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=style&index=0&id=625f5eea&scoped=true&lang=less ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=style&index=0&id=1d2d763d&lang=less&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=style&index=0&id=1d2d763d&lang=less&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=style&index=0&id=710ed70a&lang=less&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=style&index=0&id=710ed70a&lang=less&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _SessionWindow_vue_vue_type_template_id_8ec4e732_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SessionWindow.vue?vue&type=template&id=8ec4e732&scoped=true */ "./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=template&id=8ec4e732&scoped=true");
/* harmony import */ var _SessionWindow_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SessionWindow.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=script&lang=js");
/* harmony import */ var _SessionWindow_vue_vue_type_style_index_0_id_8ec4e732_lang_less_scoped_true__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SessionWindow.vue?vue&type=style&index=0&id=8ec4e732&lang=less&scoped=true */ "./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=style&index=0&id=8ec4e732&lang=less&scoped=true");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _SessionWindow_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _SessionWindow_vue_vue_type_template_id_8ec4e732_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _SessionWindow_vue_vue_type_template_id_8ec4e732_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "8ec4e732",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue":
/*!******************************************************************!*\
  !*** ./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var
scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WindowUser.vue?vue&type=template&id=625f5eea&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=template&id=625f5eea&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=template&id=1d2d763d&scoped=true":
/*!****************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=template&id=1d2d763d&scoped=true ***!
  \****************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_headerModel_vue_vue_type_template_id_1d2d763d_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_headerModel_vue_vue_type_template_id_1d2d763d_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_headerModel_vue_vue_type_template_id_1d2d763d_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./headerModel.vue?vue&type=template&id=1d2d763d&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=template&id=1d2d763d&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=template&id=710ed70a&scoped=true":
/*!***************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=template&id=710ed70a&scoped=true ***!
  \***************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_710ed70a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_710ed70a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Index_vue_vue_type_template_id_710ed70a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Index.vue?vue&type=template&id=710ed70a&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=template&id=710ed70a&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=template&id=8ec4e732&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/SessionWindow.vue?vue&type=template&id=8ec4e732&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.sessionRecordData, function(item, index) {
      return _c(
        "div",
        { key: index },
        [
          item.role === "assistant"
            ? _c("WindowAssistant", {
                ...
                on: {
                  stopGeneration: function($event) {
                    return _vm.$emit("stopGeneration")
                  }
                }
              })
            : _vm._e(),
          _vm._v(" "),
          item.role === "user"
            ? _c("WindowUser", { attrs: { content: item.content } })
            : _vm._e(),
          _vm._v(" "),
          item.role === "tts"
            ? _c("WindowTts", { attrs: { content: item.content } })
            : _vm._e(),
          _vm._v(" "),
          item.role === "assistant" && !item.loading && _vm.opFlag
            ? _c(
                "div",
                { staticClass: "chat-op-wrap" },
                [
                  _c(
                    "el-tooltip",
                    {
                    ...
                    [
                      _c("i", {
                        staticClass: "ri-file-copy-line",
                        on: {
                          click: function($event) {
                            return _vm.copy(item.content)
                          }
                        }
                      })
                    ]
                  ...
                  _c(
                    "el-tooltip",
                    {
                      ...
                      attrs: {
                        effect: "dark",
                        content: _vm.$t("modelSquare.refreshChat"),
                        placement: "top"
                      }
                    },
                    [
                      _c("i", {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.refreshAnswer(index)
                          }
                        }
                      })
                    ]
                  ...
                  _c(
                    "el-tooltip",
                    {
                      ...
                      attrs: {
                        effect: "dark",
                        content: _vm.$t("modelSquare.like"),
                        placement: "top"
                      }
                    },
                    [
                      _c("i", {
                        class: [
                          _vm.isGood ? "ri-thumb-up-fill" : "ri-thumb-up-line"
                        ],
                        on: {
                          click: function($event) {
                            return _vm.feedGood(index, true)
                          }
                        }
                      })
                    ]
                  ...
                  _c(
                    "el-tooltip",
                    {
                      ...
                      attrs: {
                        effect: "dark",
                        content: _vm.$t("modelSquare.unlike"),
                        placement: "top"
                      }
                    },
                    [
                      _c("i", {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.feedBad(index, false)
                          }
                        }
                      })
                    ]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue?vue&type=template&id=74985e1a&scoped=true":
/*!***************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/TtsMenu.vue?vue&type=template&id=74985e1a&scoped=true ***!
  \***************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "menu-area" }, [
    _c("div", { staticClass: "menu-select-container" }, [
      _c("div", [
        _c("div", { staticClass: "text-select-container" }, [
          _c(
            "div",
                  ...
                  key === "lang"
                    ? [
                        _c(
                          ...
                          [
                            _c("span", [
                              _vm._v(_vm._s(_vm.$t("modelSquare.language")))
                            ]),
                            _vm._v(" "),
                            _c(
                              "el-tooltip",
                          ...
                          [
                            _c(
                              "el-select",
                              {
                                ...
                                model: {
                                  value: _vm.params.lang,
                                  callback: function($$v) {
                                    _vm.$set(_vm.params, "lang", $$v)
                                  },
                                  expression: "params.lang"
                                }
                              },
                              _vm._l(_vm.config.lang.opt, function(
                                item,
                                index
                              ) {
                                return _c("el-option", {
                  ...
                  key === "speakers"
                    ? [
                        _c(
                          ...
                          [
                            _c("span", [
                              _vm._v(_vm._s(_vm.$t("modelSquare.soundStyle")))
                            ]),
                            _vm._v(" "),
                            _c(
                              "el-tooltip",
                        ...
                        _c("div", [
                          _c("div", { staticClass: "tab-item-c" }, [
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(_vm.$t("modelSquare.systemDefault"))
                                )
                              ]
                            ),
                            _vm._v(" "),
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(_vm.$t("modelSquare.uploadSound1"))
                                )
                              ]
                            )
                          ]),
                          ...
                          _c("div", { staticClass: "tab-content-c" }, [
                            _c(
                              ...
                              _vm._l(_vm.config.speakers.opt, function(
                                item,
                                index
                              ) {
                                return _c(
                                  "div",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.changeSpeaker(item, index)
                                      }
                                    }
                                  },
                                  [
                                    _c("div", { staticClass: "speak-wrap" }, [
                                      _c(
                                        "div",
                                        {
                                          staticClass: "speak-name",
                                          class: {
                                            active: index === _vm.speakIndex
                                          }
                                        },
                                        [
                                          _vm._v(
                                ...
                                _c(
                                  ...
                                  [
                                    _c(
                                      ...
                                      {
                                        staticClass:
                                          "am-text-success dz-message"
                                      },
                                      [
                                        _vm._v(
                                          "\n                                                 " +
                                            _vm._s(
                                              _vm.$t("modelSquare.dragDrop")
                                            )
                                        ),
                                        _c("br"),
                                        _vm._v(
                          ...
                          _c(
                            ...
                            [
                              _c("span", [_vm._v("*")]),
                              _vm._v(
                                _vm._s(_vm.$t("modelSquare.soundTemplateTips3"))
                              )
                            ]
                          )
                        ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue?vue&type=template&id=3e1194cf&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowAssistant.vue?vue&type=template&id=3e1194cf&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "chat-main-content" }, [
      _c("img", { attrs: { src: _vm.img, alt: "" } }),
      _vm._v(" "),
      _c("div", { staticClass: "chat-output-wrapper" }, [
        _c("div", { staticClass: "chat-container" }, [
          _c(
            ...
            [
              _vm.useLoading && !_vm.htmlContent && _vm.data.loading
              ...
              _vm._v(" "),
              _c("div", {
                staticClass: "file-view markdown chat",
    ...
    _vm._v(" "),
    !!_vm.htmlContent && _vm.data.loading
      ? _c(
          "div",
          {
            staticClass: "chat-c2net-stop",
            on: {
              click: function($event) {
                return _vm.$emit("stopGeneration")
              }
          ...
          [
            _c(
              "el-button",
              { staticStyle: { "font-size": "12px" }, attrs: { type: "text" } },
              [_vm._v(_vm._s(_vm.$t("modelSquare.stopChat")))]
            )
          ],
          1
        )
    ...
    _vm._v(" "),
    _c("div", {
      staticClass: "chat-c2net-tips",
      domProps: { innerHTML: _vm._s(_vm.data.c2netNameTips) }
    })
  ])
}
var staticRenderFns = []
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue?vue&type=template&id=7fc36fb8&scoped=true":
/*!*****************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowTts.vue?vue&type=template&id=7fc36fb8&scoped=true ***!
  \*****************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      staticClass: "tts-container"
    },
    [
      _c("label", { staticClass: "tts-label" }, [
        _vm._v(
          "\n        " + _vm._s(_vm.$t("modelSquare.outputAduio")) + "\n    "
        )
      ]),
      _vm._v(" "),
      _c(
        ...
        [
          _c("div", { staticClass: "waveform-container" }, [
            _c("div", { ref: "waveform", attrs: { id: "waveform" } })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "timestamps" }, [
            _c("time", { attrs: { id: "time" } }, [
              _vm._v(_vm._s(_vm.currentTime))
            ]),
            _vm._v(" "),
            _c("div", [
              _c("time", { attrs: { id: "duration" } }, [
                _vm._v(_vm._s(_vm.duration))
              ])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "waveform-controls" }, [
            _c("div", { staticClass: "control-wrapper" }, [
              _c(
                "div",
                { staticClass: "volume-icon", on: { click: _vm.offVolume } },
                [
                  _vm.volumeValue && _vm.onVolume
                    ? _c("i", { staticClass: "ri-volume-up-line" })
                    : _c("i", { staticClass: "ri-volume-mute-line" })
                ]
              ),
              _vm._v(" "),
              _c("input", {
                ...
                domProps: { value: _vm.volumeValue },
                on: {
                  input: function($event) {
                    return _vm.sliderChange($event)
                  },
                  __r: function($event) {
                    _vm.volumeValue = $event.target.value
                  }
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "play-pause-icon" }, [
              _c(
                "div",
                { staticClass: "skip-left-icon", on: { click: _vm.skipBack } },
                [_c("i", { staticClass: "ri-rewind-fill 1" })]
              ),
              _vm._v(" "),
              _vm.playing
                ? _c(
                    "div",
                    { staticClass: "play-icon", on: { click: _vm.playPause } },
                    [_c("i", { staticClass: "ri-play-fill" })]
                  )
                : _c(
                    "div",
                    { staticClass: "pause-icon", on: { click: _vm.playPause } },
                    [_c("i", { staticClass: "ri-pause-line" })]
                  ),
              _vm._v(" "),
              _c(
                "div",
                {
                  staticClass: "skip-right-icon",
                  on: { click: _vm.skipForward }
                },
                [_c("i", { staticClass: "ri-speed-fill" })]
              )
            ]),
            _vm._v(" "),
            _c(
              "div",
              { staticClass: "download-icon", on: { click: _vm.download } },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=template&id=625f5eea&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/WindowUser.vue?vue&type=template&id=625f5eea&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "chat-input-wrapper" }, [
    _c("img", {
      attrs: {
        src:
          "data:image/png;base64,",
        alt: ""
      }
    }),
    _vm._v(" "),
    _c("div", { staticClass: "chat-me" }, [_vm._v(_vm._s(_vm.content))])
  ])
}
var staticRenderFns = []
render._withStripped = true
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=template&id=1d2d763d&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/componenes/headerModel.vue?vue&type=template&id=1d2d763d&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticStyle: { "min-height": "164px", "padding-top": "24px" } },
        [
          _c(
            "div",
            {
            ...
            [
              ...
              _c(
                "div",
                { staticClass: "countdouwn" },
                [
                  _vm.minutes
                    ? _c("div", [
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.$t("modelSquare.experienceDuration")) +
                              "："
                          )
                        ]),
                        _vm._v(" "),
                        _c("span", { staticStyle: { color: "#f2711c" } }, [
                          _vm._v(_vm._s(_vm.minutes) + " ")
                        ]),
                        _vm._v(
                          _vm._s(_vm.$t("timeObj.raw_minutes")) + "\n        "
                        )
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                    ...
                    ? _c(
                        ...
                        [
                          _c("span", { staticStyle: { "font-size": "14px" } }, [
                            _vm._v(_vm._s(_vm.$t("modelSquare.stopExperience")))
                          ])
                        ]
                      )
                    : _vm._e()
          ...
          _vm._v(" "),
          _c("div", { staticClass: "model-text-wrapper" }, [
            _c("p", { staticClass: "model-title" }, [
              _vm._v(
                _vm._s(_vm.modelName) +
                  " " +
                  _vm._s(_vm.$t("modelSquare.llmHeader"))
              )
            ]),
            _vm._v(" "),
            _c("p", { staticClass: "model-desc" }, [
              _vm._v(_vm._s(_vm.modelDesc))
            ])
          ])
        ]
      ),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=template&id=710ed70a&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/llms/tts/Index.vue?vue&type=template&id=710ed70a&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticStyle: { height: "100%" } }, [
    ...
    _c(
      "div",
      { staticClass: "ui container __content-box" },
      [
        _c("headerModel", {
          attrs: { config: _vm.config, modelName: _vm.modelName }
        }),
        _vm._v(" "),
        _c(
          "div",
          ...
          [
            _c("TtsMenu", {
              ref: "childMenu",
              attrs: { config: _vm.parametersConfig },
              on: { changeParams: _vm.changeParams, changeLang: _vm.changeLang }
            }),
            _vm._v(" "),
            _c("div", { staticStyle: { position: "relative" } }, [
              _c("div", { staticClass: "main-code-body" }, [
                _c("div", { staticClass: "output-text" }, [
                  _c(
                    "div",
                    {
                      ref: "chatContainer",
                    ...
                    [
                      _c("div", { staticClass: "output-welcome-banner" }, [
                        _c("div", [
                          _vm._v(
                            _vm._s(
                              _vm.$t("modelSquare.chatHeaderTips", {
                      ...
                      _c(
                        ...
                        [_c("SessionWindow", { ref: "sessionWindow" })],
                        1
                      )
                    ]
                  )
              ...
              _c(
                "div",
                { staticClass: "main-code-input" },
                [
                  _c(
                    "el-button",
                    { attrs: { type: "text" }, on: { click: _vm.clearChat } },
                    [_vm._v(_vm._s(_vm.$t("modelSquare.newChat")))]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "input-container" }, [
                    _c("div", { staticClass: "input-box" }, [
                      _c("div", { staticClass: "ask-input" }, [
                        _c("textarea", {
                          directives: [
                            {
                              name: "model",
                          ...
                          attrs: {
                            ...
                            placeholder: _vm.$t("modelSquare.ttsPlaceholder")
                          },
                          ...
                          on: {
                            keydown: function($event) {
                              ...
                              return _vm.carriageReturn($event)
                            },
                            input: function($event) {
        ...
        _c("div", { staticStyle: { "text-align": "center" } }, [
          _c("span", [
            _c(
              "a",
              { attrs: { href: "/home/model_privacy", target: "_blank" } },
              [_vm._v(_vm._s(_vm.$t("modelSquare.modelProvide")))]
            )
          ])
        ])
      ],
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/model/llms/tts/vp-model-tts.js"); })
