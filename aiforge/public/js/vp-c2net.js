...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/App.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/App.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _apis_modules_homemap__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ~/apis/modules/homemap */ "./web_src/vuepages/apis/modules/homemap.js");
/* harmony import */ var _collapseMenu_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./collapseMenu.vue */ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils */ "./web_src/vuepages/pages/home/c2net/utils.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    collapseMenuVue: _collapseMenu_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  methods: {
    timeString: function timeString(timestamp) {
      var date = new Date(timestamp);
      return "".concat(date.getFullYear(), "-").concat(date.getMonth() + 1, "-").concat(date.getDate());
    },
    renderCardType: function renderCardType(cardType) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_11__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_10__.ACC_CARD_TYPE, cardType);
    },
    selectedCard: function selectedCard(item, index) {
      var _this = this;
    ...
    initCardInfo: function initCardInfo() {
      var _this2 = this;

      (0,_apis_modules_homemap__WEBPACK_IMPORTED_MODULE_7__.getAiCenterCardInfo)().then(function (res) {
        var data = res.data;
        ...
        if (data.code === 0) {
          ...
          List.forEach(function (item) {
            _this2.cpResource.push(item);

            item.CardList.forEach(function (card) {
              cardTempList.push(card);
            });
            item.CardList.unshift('所有');
          });
          _this2.cardType = cardTempList.sort(_utils__WEBPACK_IMPORTED_MODULE_9__.sortData);

          _this2.cardType.unshift('所有');

          _this2.cpResource[0].CardList = _this2.cardType;
        }
      });
    },
    initAiCenter: function initAiCenter() {
      var _this3 = this;

      (0,_apis_modules_homemap__WEBPACK_IMPORTED_MODULE_7__.getAiActivate)().then(function (res) {
        var data = res.data;

        if (data.code === 0) {
          _this3.aiCenterList = data.data.list;

          _this3.flitersListFunc(_this3.queryPamras);
        }
      });
    },
    flitersListFunc: function flitersListFunc(params) {
      var fliteredList = this.aiCenterList.filter(function (item) {
      ...
      var siwperFliteredList = fliteredList;
      this.updateSwiper(siwperFliteredList);
      this.data = (0,_utils__WEBPACK_IMPORTED_MODULE_9__.handelData)(fliteredList);
      this.getOption();
    },
    updateSwiper: function updateSwiper(newData) {
      var _this4 = this;

      // 销毁旧的Swiper实例
      this.swiperHandler.destroy(true); // 更新数据源

      this.swiperList = newData; // 下一帧重新挂载Swiper实例

      this.$nextTick(function () {
        var loop = _this4.aiCenterCount <= 5 ? false : true;

        _this4.initSwiper(loop);
      });
    },
    ...
    deleteComputeSource: function deleteComputeSource() {
      this.cpIndex = 0;
      this.cardIndex = 0;
    ...
    deleteAccCardType: function deleteAccCardType() {
      this.cardIndex = 0;
      this.selectedCardIndex = -1;
      this.queryPamras.AccCardTypeList = '所有';
      this.flitersListFunc(this.queryPamras);
    },
    cpResourceClick: function cpResourceClick(item, index) {
      var selectItem = item.ComputeSource;
      this.cpIndex = index;
      this.cardType = this.cpResource[this.cpIndex].CardList;
      this.queryPamras.AccCardTypeList = '所有';
      this.cardIndex = 0;
    ...
    cardTypeClick: function cardTypeClick(item, index) {
      var selectItem = item;
    ...
    resizeEcharts: function resizeEcharts() {
      this.myChart.resize();
    }
  },
  computed: {},
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=script&lang=js":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=script&lang=js ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _apis_modules_homemap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ~/apis/modules/homemap */ "./web_src/vuepages/apis/modules/homemap.js");
/* harmony import */ var _collapseMenu_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./collapseMenu.vue */ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils */ "./web_src/vuepages/pages/home/c2net/utils.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    collapseMenuVue: _collapseMenu_vue__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  methods: {
    timeString: function timeString(timestamp) {
    ...
    renderCardType: function renderCardType(cardType) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_12__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_11__.ACC_CARD_TYPE, cardType);
    },
    selectedCard: function selectedCard(item, index) {
      var _this = this;
    ...
    initCardInfo: function initCardInfo() {
      ...
      (0,_apis_modules_homemap__WEBPACK_IMPORTED_MODULE_8__.getAiCenterCardInfo)().then(function (res) {
        var data = res.data;
        ...
        if (data.code === 0) {
          ...
          _this2.cardType = cardTempList.sort(_utils__WEBPACK_IMPORTED_MODULE_10__.sortData);
    ...
    initAiCenter: function initAiCenter() {
      ...
      (0,_apis_modules_homemap__WEBPACK_IMPORTED_MODULE_8__.getAiActivate)().then(function (res) {
        var data = res.data;
    ...
    flitersListFunc: function flitersListFunc(params) {
      ...
      var siwperFliteredList = fliteredList;
      this.updateSwiper(siwperFliteredList);
      this.data = (0,_utils__WEBPACK_IMPORTED_MODULE_10__.handelData)(fliteredList);
      this.getOption();
    },
    updateSwiper: function updateSwiper(newData) {
      var _this4 = this;
...
/* harmony export */   getAiActivate: function() { return /* binding */ getAiActivate; },
/* harmony export */   getAiCenterCardInfo: function() { return /* binding */ getAiCenterCardInfo; },
/* harmony export */   getAiCenterOverview: function() { return /* binding */ getAiCenterOverview; },
/* harmony export */   getAiLocation: function() { return /* binding */ getAiLocation; }
/* harmony export */ });
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../service */ "./web_src/vuepages/apis/service.js");
 // 获取中心详细情况
// 

var getAiCenterOverview = function getAiCenterOverview() {
  return (0,_service__WEBPACK_IMPORTED_MODULE_0__["default"])({
    url: "/api/v1/cloudbrainboard/ai_center_overview",
    method: "get"
  });
};
var getAiLocation = function getAiLocation() {
  return (0,_service__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
var getAiCenterCardInfo = function getAiCenterCardInfo() {
  return (0,_service__WEBPACK_IMPORTED_MODULE_0__["default"])({
    url: '/api/v1/resources/ai_center/card_info/active',
    method: "get"
  });
};
var getAiActivate = function getAiActivate(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
/***/ "./web_src/vuepages/pages/home/c2net/utils.js":
/*!****************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/utils.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handelData: function() { return /* binding */ handelData; },
...
var kvArray = [["guangxi", "广西"], ["guangdong", "广东"], ["hainan", "海南"], ["jiangxi", "江西"], ["fujian", "福建"], ["zhejiang", "浙江"], ["anhui", "安徽"], ["jiangsu", "江苏"], ["shanghai", "上海"], ["shandong", "山东"], ["henan", "河南"], ["hebei", "河北"], ["shanxi", "山西"], ["neimenggu", "内蒙古"], ["liaoning", "辽宁"], ["heilongjiang", "黑龙江"], ["jilin", "吉林"], ["hubei", "湖北"], ["hunan", "湖南"], ["guizhou", "贵州"], ["sichuan", "四川"], ["yunnan", "云南"], ["xijiang", "新疆"], ["qinghai", "青海"], ["gansu", "甘肃"], ["ningxia", "宁夏"], ["taiwan", "台湾"], ["hongkong", "香港"], ["macau", "澳门"], ["beijing", "北京"], ["tianjin", "天津"], ["chongqing", "重庆"], ["xizang", "西藏"], ["shaanxi", "陕西"]];
var ProvinceKey = new Map(kvArray);
var handelData = function handelData(r) {
  var v = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_8___default()(r);
...
/***/ "./web_src/vuepages/pages/home/c2net/vp-c2net.js":
/*!*******************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/vp-c2net.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _App_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App.vue */ "./web_src/vuepages/pages/home/c2net/App.vue");
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/home/c2net/index.vue");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
/* harmony import */ var echarts_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! echarts/core */ "./node_modules/echarts/lib/extension.js");
/* harmony import */ var echarts_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! echarts/core */ "./node_modules/echarts/lib/core/echarts.js");
/* harmony import */ var echarts_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! echarts/core */ "./node_modules/echarts/core.js");
/* harmony import */ var echarts_charts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! echarts/charts */ "./node_modules/echarts/lib/chart/map/install.js");
/* harmony import */ var echarts_renderers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! echarts/renderers */ "./node_modules/echarts/lib/renderer/installCanvasRenderer.js");
/* harmony import */ var echarts_components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! echarts/components */ "./node_modules/echarts/lib/component/visualMap/install.js");
/* harmony import */ var _china_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./china.json */ "./web_src/vuepages/pages/home/c2net/china.json");
...
echarts_core__WEBPACK_IMPORTED_MODULE_4__.use([echarts_charts__WEBPACK_IMPORTED_MODULE_5__.install, echarts_renderers__WEBPACK_IMPORTED_MODULE_6__.install, echarts_components__WEBPACK_IMPORTED_MODULE_7__.install]);
echarts_core__WEBPACK_IMPORTED_MODULE_8__.registerMap('china', _china_json__WEBPACK_IMPORTED_MODULE_3__);
vue__WEBPACK_IMPORTED_MODULE_9__["default"].prototype.$echarts = echarts_core__WEBPACK_IMPORTED_MODULE_10__;
var UA = navigator.userAgent;
var View = _App_vue__WEBPACK_IMPORTED_MODULE_0__["default"];
if (/(Android|webOS|iPhone|iPod|tablet|BlackBerry|Mobile)/i.test(UA)) View = _index_vue__WEBPACK_IMPORTED_MODULE_1__["default"];
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/home/c2net/App.vue":
/*!***************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/App.vue ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _App_vue_vue_type_template_id_361f66b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App.vue?vue&type=template&id=361f66b8&scoped=true */ "./web_src/vuepages/pages/home/c2net/App.vue?vue&type=template&id=361f66b8&scoped=true");
/* harmony import */ var _App_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/home/c2net/App.vue?vue&type=script&lang=js");
/* harmony import */ var _App_vue_vue_type_style_index_0_id_361f66b8_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=0&id=361f66b8&scoped=true&lang=less */ "./web_src/vuepages/pages/home/c2net/App.vue?vue&type=style&index=0&id=361f66b8&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _App_vue_vue_type_template_id_361f66b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _App_vue_vue_type_template_id_361f66b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "361f66b8",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/home/c2net/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue":
/*!************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/collapseMenu.vue ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _collapseMenu_vue_vue_type_template_id_1d2b7385__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./collapseMenu.vue?vue&type=template&id=1d2b7385 */ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=template&id=1d2b7385");
/* harmony import */ var _collapseMenu_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./collapseMenu.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _collapseMenu_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _collapseMenu_vue_vue_type_template_id_1d2b7385__WEBPACK_IMPORTED_MODULE_0__.render,
  _collapseMenu_vue_vue_type_template_id_1d2b7385__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/home/c2net/collapseMenu.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/index.vue":
/*!*****************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/index.vue ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_69db9149_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=69db9149&scoped=true */ "./web_src/vuepages/pages/home/c2net/index.vue?vue&type=template&id=69db9149&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/home/c2net/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_69db9149_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less */ "./web_src/vuepages/pages/home/c2net/index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_69db9149_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_69db9149_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "69db9149",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/home/c2net/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/App.vue?vue&type=script&lang=js":
/*!***************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/App.vue?vue&type=script&lang=js ***!
  \***************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=script&lang=js":
/*!************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=script&lang=js ***!
  \************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_collapseMenu_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./collapseMenu.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_collapseMenu_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/index.vue?vue&type=script&lang=js":
/*!*****************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/index.vue?vue&type=script&lang=js ***!
  \*****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/home/c2net/App.vue?vue&type=style&index=0&id=361f66b8&scoped=true&lang=less":
/*!************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/App.vue?vue&type=style&index=0&id=361f66b8&scoped=true&lang=less ***!
  \************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_style_index_0_id_361f66b8_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./App.vue?vue&type=style&index=0&id=361f66b8&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/App.vue?vue&type=style&index=0&id=361f66b8&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less":
/*!**************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less ***!
  \**************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_69db9149_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=style&index=0&id=69db9149&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/App.vue?vue&type=template&id=361f66b8&scoped=true":
/*!*********************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/App.vue?vue&type=template&id=361f66b8&scoped=true ***!
  \*********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_template_id_361f66b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_template_id_361f66b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_template_id_361f66b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./App.vue?vue&type=template&id=361f66b8&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/App.vue?vue&type=template&id=361f66b8&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=template&id=1d2b7385":
/*!******************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=template&id=1d2b7385 ***!
  \******************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_collapseMenu_vue_vue_type_template_id_1d2b7385__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_collapseMenu_vue_vue_type_template_id_1d2b7385__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_collapseMenu_vue_vue_type_template_id_1d2b7385__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./collapseMenu.vue?vue&type=template&id=1d2b7385 */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=template&id=1d2b7385");


/***/ }),

/***/ "./web_src/vuepages/pages/home/c2net/index.vue?vue&type=template&id=69db9149&scoped=true":
/*!***********************************************************************************************!*\
  !*** ./web_src/vuepages/pages/home/c2net/index.vue?vue&type=template&id=69db9149&scoped=true ***!
  \***********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_69db9149_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_69db9149_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_69db9149_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=69db9149&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=template&id=69db9149&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/App.vue?vue&type=template&id=361f66b8&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/App.vue?vue&type=template&id=361f66b8&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "c2map" }, [
    _c("div", { staticStyle: { width: "100%" } }, [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "__home_screemap_wrap" }, [
        _c("div", { staticClass: "__home_screemap" }, [
          _c("div", { staticClass: "left_container" }, [
            _c("div", { staticClass: "left_box_wrap" }, [
              _c(
                "div",
                [
                  _c("collapseMenuVue", { attrs: { open: true } }, [
                    _c(
                      "div",
                      _vm._l(_vm.cpResource, function(item, index) {
                        return _c(
                          "p",
                          {
                            key: item.ComputeSource,
                            class: { active: _vm.cpIndex == index },
                            on: {
                              click: function($event) {
                                return _vm.cpResourceClick(item, index)
                              }
                            }
                          },
                          [_vm._v(_vm._s(item.ComputeSource))]
                        )
                      }),
                      0
                    )
                      ...
                      _c(
                        ...
                        _vm._l(_vm.cardType, function(item, index) {
                          return _c(
                            ...
                            {
                              key: item,
                              class: { active: _vm.cardIndex == index },
                              on: {
                                click: function($event) {
                                  return _vm.cardTypeClick(item, index)
                                }
                              }
                            },
                            [_vm._v(_vm._s(_vm.renderCardType(item)))]
                          )
                        }),
                        0
                      )
          ...
          _vm._v(" "),
          _c("div", { staticClass: "middel_box_wrap" }, [
            _c("div", { staticClass: "context-wrap" }, [
              _vm.queryPamras.ComputeSourceList !== "所有"
                ? _c(
                    "div",
                    { staticClass: "ui right icon label basic content" },
                    [
                      _c("span", { staticClass: "text" }, [
                        _vm._v("计算资源："),
                        _c("span", [
                          _vm._v(_vm._s(_vm.queryPamras.ComputeSourceList))
                        ])
                      ]),
                      _vm._v(" "),
                      _c("i", {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.deleteComputeSource()
                          }
                        }
                      })
                    ]
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.queryPamras.AccCardTypeList !== "所有"
                ? _c(
                    "div",
                    { staticClass: "ui right icon label basic content" },
                    [
                      _c("span", { staticClass: "text" }, [
                        ...
                        _c("span", [
                          _vm._v(
                            _vm._s(
                              _vm.renderCardType(
                                _vm.queryPamras.AccCardTypeList
                              )
                            )
                          )
                        ])
              ...
              _c(
                ...
                _vm._l(_vm.swiperList, function(item, index) {
                  return _c(
                    "div",
                    {
                      key: item.AICenterCode,
                      staticClass: "swiper-slide item"
                    },
                    [
                      _c(
                        "div",
                        {
                          ...
                          class: { active: _vm.selectedCardIndex == index },
                          on: {
                            click: function($event) {
                              return _vm.selectedCard(item, index)
                            }
                          }
                        },
                        [
                          index === 0
                            ? _c("div", { staticClass: "card-icon" }, [
                                _c("img", {
                                  attrs: { src: "/img/model/first.png" }
                                })
                              ])
                            : index === 1
                            ? _c("div", { staticClass: "card-icon" }, [
                                _c("img", {
                                  attrs: { src: "/img/model/second.png" }
                                })
                              ])
                            : index === 2
                            ? _c("div", { staticClass: "card-icon" }, [
                                _c("img", {
                                  attrs: { src: "/img/model/third.png" }
                                })
                              ])
                            : _c("div", { staticClass: "card-icon" }, [
                                _c("img", {
                                  attrs: { src: "/img/model/common_awrad.png" }
                                })
                              ]),
                          _vm._v(" "),
                          _c("div", { staticStyle: { overflow: "hidden" } }, [
                            _c("div", [
                              _c("div", { staticClass: "title" }, [
                                _vm._v(_vm._s(item.AICenterName))
                              ]),
                              _vm._v(" "),
                              _c(
                                "div",
                                  ...
                                  _c("span", [
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          _vm._s(
                                            _vm.timeString(item.AccessTime)
                                          )
                                        )
                                      ]
                                    )
                            ...
                            _c(
                              ...
                              _vm._l(item.ComputeSourceList, function(item) {
                                return _c(
                                  "div",
                            ...
                            _c(
                              "div",
                              { staticClass: "label-wrap" },
                              _vm._l(item.AccCardTypeList, function(item) {
                                return _c(
                                  "div",
                                  {
                                    staticClass: "label-item",
                                    staticStyle: { background: "#e9e9e9" }
                                  },
                                  [_vm._v(_vm._s(_vm.renderCardType(item)))]
                                )
                              }),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ui center am-pt-30 am-pb-30" }, [
      _c("h2", [_vm._v("算力中心")]),
      _vm._v(" "),
      _c("p", [
        _c("span", { staticClass: "ui text grey" }, [
          _vm._v(
            "我们已广泛接入全国各地智算中心、超算中心与大数据中心等，为用户提供普惠算力资源。感谢各位算力合作伙伴，为启智AI协作平台提供算力支持。"
          )
        ])
      ])
    ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=template&id=1d2b7385":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/collapseMenu.vue?vue&type=template&id=1d2b7385 ***!
  \*********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "nav-bar-content" }, [
    _c(
      "div",
      {
      ...
      [
        ...
        _vm._v(" "),
        _c("i", {
          staticClass: "ri-arrow-right-s-line arrow",
          class: { open: _vm.openFlag }
        })
      ]
    ),
    _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=template&id=69db9149&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/home/c2net/index.vue?vue&type=template&id=69db9149&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "__home_screemap" }, [
      ...
      _c(
        "div",
        { staticClass: "left_box_wrap" },
        [
          _c("collapseMenuVue", { staticStyle: { "margin-right": "10px" } }, [
            _c(
              "div",
              _vm._l(_vm.cpResource, function(item, index) {
                return _c(
          ...
          _vm._v(" "),
          _c("collapseMenuVue", { attrs: { title: "卡类型" } }, [
            _c(
              "div",
              _vm._l(_vm.cardType, function(item, index) {
                return _c(
      ...
      _c("div", { staticClass: "middel_box_wrap" }, [
        _c("div", { staticClass: "context-wrap" }, [
          _vm.queryPamras.ComputeSourceList !== "所有"
            ? _c("div", { staticClass: "ui right icon label basic content" }, [
                _c("span", { staticClass: "text" }, [
                  _vm._v("计算资源："),
                  _c("span", [
                    _vm._v(_vm._s(_vm.queryPamras.ComputeSourceList))
            ...
            ? _c("div", { staticClass: "ui right icon label basic content" }, [
                _c("span", { staticClass: "text" }, [
                  ...
                  _c("span", [
                    _vm._v(
                      _vm._s(
                        _vm.renderCardType(_vm.queryPamras.AccCardTypeList)
                      )
                    )
                  ])
                ]),
        ...
        _c("div", { staticClass: "swiper-container" }, [
          _c(
            ...
            _vm._l(_vm.swiperList, function(item, index) {
              return _c(
                "div",
                { key: item.AICenterCode, staticClass: "swiper-slide item" },
                [
                  _c(
                    "div",
                    {
                    ...
                    [
                      ...
                      _c("div", { staticStyle: { overflow: "hidden" } }, [
                        _c("div", [
                          ...
                          _c("div", { staticStyle: { "font-size": "12px" } }, [
                            _c("span", [
                              ...
                              _c(
                                "span",
                                { staticStyle: { color: "rgba(16,16,16,1)" } },
                                [_vm._v(_vm._s(item.City))]
                              )
                            ]),
                            _vm._v(" "),
                            _c("span", [
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm.timeString(item.AccessTime))
                                  )
                                ]
                              )
                            ])
                        ...
                        _c(
                          ...
                          { staticClass: "label-wrap" },
                          _vm._l(item.ComputeSourceList, function(item) {
                            return _c("div", { staticClass: "label-item" }, [
                              _vm._v(_vm._s(item || "--"))
                            ])
                          }),
                          0
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/home/c2net/vp-c2net.js"); })
