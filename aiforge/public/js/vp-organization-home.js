...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/DeleteConfirmModal.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/DeleteConfirmModal.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    baseTypeCap: function baseTypeCap() {
      return this.capitalizeFirstLetter(this.getBaseType(this.type));
    },
    // 根据类型计算国际化key
    titleKey: function titleKey() {
      return this.customKeys.titleKey || "".concat(this.iPrefix, ".deleteThis").concat(this.baseTypeCap);
    },
    notice2Key: function notice2Key() {
      return this.customKeys.notice2Key || "".concat(this.iPrefix, ".delete_notices_2");
    },
    notice2Params: function notice2Params() {
      return _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()({}, this.getBaseType(this.type), this.dataObj.alias);
    },
    confirmNameKey: function confirmNameKey() {
      return this.customKeys.confirmNameKey || "".concat(this.iPrefix, ".sure").concat(this.baseTypeCap, "Name");
    },
    nameLabelKey: function nameLabelKey() {
      return this.customKeys.nameLabelKey || "".concat(this.iPrefix, ".").concat(this.getBaseType(this.type), "_name1");
    },
    nameErrorKey: function nameErrorKey() {
      return this.customKeys.nameErrorKey || "".concat(this.iPrefix, ".delete").concat(this.baseTypeCap, "NameError");
    },
    inputId: function inputId() {
      return "".concat(this.type, "_name");
    },
  ...
  methods: {
    ...
    showModal: function showModal() {
      this.name = '';
      $("#".concat(this.modalId)).modal({
        onDeny: function onDeny() {// this.$emit('cancel')
        },
        onApprove: function onApprove() {// 不在这里处理，由按钮事件处理
        },
        onHidden: function onHidden() {// this.$emit('modal-hidden')
        }
      }).modal('show');
    },
    ...
    resetForm: function resetForm() {
      ...
      // 重置表单状态
      this.name = ''; // 如果使用jQuery的form，可以这样重置

      (_$$ = $("#".concat(this.modalId, " form"))[0]) === null || _$$ === void 0 ? void 0 : _$$.reset();
    },
    handleDelete: function handleDelete() {
      var _this = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_6___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(_this.name !== _this.dataObj.alias)) {
                  _context.next = 3;
                  break;
                }

                _this.$message.error(_this.$t(_this.nameErrorKey));
              ...
              case 3:
                ...
                try {
                  ...
                  _this.$emit('confirm-delete', {
                    type: _this.type,
                    data: _this.dataObj,
                    callback: _this.handleDeleteCallback
                  });
                } catch (error) {
                  _this.delLoading = false;

                  _this.$emit('delete-error', error);
                }
    ...
    handleDeleteCallback: function handleDeleteCallback(result) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightItem.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightItem.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
...
/* harmony import */ var _apis_modules_modelsquare__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ~/apis/modules/modelsquare */ "./web_src/vuepages/apis/modules/modelsquare.js");
/* harmony import */ var _apis_modules_dataset__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ~/apis/modules/dataset */ "./web_src/vuepages/apis/modules/dataset.js");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      isSetting: false,
      hasOnlineUrl: 0,
      lang: _langs__WEBPACK_IMPORTED_MODULE_15__.lang
    };
  },
  watch: {
  ...
  methods: {
    getItemLink: function getItemLink(data) {
      ...
      var safeId = "".concat(data.owner_name, "/").concat(data.name); // // 确保路径拼接正确

      var url = new URL(location.origin); // url.pathname = url.pathname.replace(/\/$/, '') + '/' + safeId;

      if (this.type === 'dataset') {
        url.pathname = "/datasets/detail/".concat(safeId);
      } else {
        url.pathname = "/models/detail/".concat(safeId);
      }
    ...
    changeFav: function changeFav(item) {
      ...
      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_12___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default().mark(function _callee() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(_this.isSetting || !_this.canChangeFav)) {
                  _context.next = 2;
                  break;
                }
              ...
              case 2:
                ...
                _context.prev = 3;
                params = _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_10___default()({}, _this.type === 'dataset' ? 'dataset_id' : 'aimodel_id', item.id);
                ...
                _context.next = 8;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_14__.unsetFavorite)(params, _this.type);
              ...
              case 11:
                _context.next = 13;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_14__.setFavorite)(params, _this.type);

              case 13:
                res = _context.sent;

              case 14:
                console.log(res); // 检查返回状态码
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/DatasetList.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/DatasetList.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_square_RightItem_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ~/components/square/RightItem.vue */ "./web_src/vuepages/components/square/RightItem.vue");
/* harmony import */ var _apis_modules_organization__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ~/apis/modules/organization */ "./web_src/vuepages/apis/modules/organization.js");
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    DatasetItem: _components_square_RightItem_vue__WEBPACK_IMPORTED_MODULE_20__["default"]
  },
  data: function data() {
    return {
      loading: false,
  ...
  methods: {
    onChangeFav: function onChangeFav(id) {
    ...
    getListData: function getListData() {
      ...
      filter.forEach(function (item) {
        var _item$split = item.split('|'),
            _item$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_19___default()(_item$split, 2),
            type = _item$split2[0],
      ...
      (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_21__.getOrgDatasetList)(requestParams).then(function (res) {
        res = res.data;
        _this.loading = false;

        if (res.code === 0) {
          var list = res.data.datasets || [];
          console.log("xxxxxxxxx", list);
          _this.list = list.map(function (item) {
            return _objectSpread(_objectSpread({}, item), {}, {
              updateTimeStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_22__.formatDate)(new Date(item.updated_unix * 1000), 'yyyy-MM-dd')
            });
          });
    ...
    getLabelList: function getLabelList() {
      ...
      (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_21__.getOrgLabel)({
        ...
        if (res.code === 0) {
          ...
          var orgTopics = res.data;
          var category = (orgTopics.Tag || []).filter(function (item) {
            return item.trim() != '';
          }).map(function (item) {
            return {
              k: ["tags|".concat(item)],
              v: _this2.$t('datasets.' + item)
            };
          });
          var task = (orgTopics.Task || []).filter(function (item) {
            return item.trim() != '';
          }).map(function (item) {
            return {
              k: ["tasks|".concat(item)],
          ...
          var license = (orgTopics.License || []).filter(function (item) {
            return item.trim() != '';
          }).map(function (item) {
            return {
              k: ["license|".concat(item)],
              v: item
            };
          });
          _this2.labels = [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(category), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(task), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(license));

          _this2.$emit('update-labels', _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(_this2.labels));
        }
      })["catch"](function (err) {
        console.log(err);
      });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/LabelSelect.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/LabelSelect.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getLabels: function getLabels(newLabels) {
      if (!newLabels) return;
      var _labels = [{
        k: '',
        v: this.$t('all')
      }];
      var labels = newLabels.map(function (item) {
        return _objectSpread({}, item);
      });
      this.list = [].concat(_labels, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_11___default()(labels));
    ...
    checkExpandStatus: function checkExpandStatus() {
      var _this = this;

      this.showExpand = false;
      this.isExpand = false;
      var labelSelectRef = this.$refs.labelSelectRef;
      this.$nextTick(function () {
        _this.showExpand = labelSelectRef.offsetHeight < labelSelectRef.scrollHeight;
      });
    }
  },
  mounted: function mounted() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Members.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Members.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/ModelList.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/ModelList.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_square_RightItem_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ~/components/square/RightItem.vue */ "./web_src/vuepages/components/square/RightItem.vue");
/* harmony import */ var _apis_modules_organization__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ~/apis/modules/organization */ "./web_src/vuepages/apis/modules/organization.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
    ...
    }, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "sort", 'recentupdate'), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "sortList", [{
      key: 'recentupdate',
      label: this.$t('datasets.recentupdate')
    }, {
      key: 'newest',
      ...
      key: 'alias',
      label: this.$t('datasets.alphabetdesc')
    }]), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "list", []), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "labels", []), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "iPageSizes", [12]), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "iPageSize", 12), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "iPage", 1), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_19___default()(_ref, "total", 0), _ref;
  },
  methods: {
    onChangeFav: function onChangeFav(id) {
      this.$emit('refreshFav', id);
    ...
    getListData: function getListData() {
      ...
      filter.forEach(function (item) {
        var _item$split = item.split('|'),
            _item$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_18___default()(_item$split, 2),
            type = _item$split2[0],
            value = _item$split2[1];

        if (type === 'engine' && value) {
          requestParams.engine = +value;
        } else if (type === 'label' && value) {
          requestParams.label = value;
        }
      });
      (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_21__.getOrgModelList)(requestParams).then(function (res) {
        res = res.data;
        _this.loading = false;
        _this.total = res.data.total || 0;
        _this.list = (res.data.aimodels || []).map(function (item) {
          return _objectSpread(_objectSpread({}, item), {}, {
            labels: item.tags ? item.tags.trim().split(/\s+/) : [],
            tags: '',
            licenses: '',
            engineName: (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_22__.MODEL_ENGINES, item.engine),
            updateTimeStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_24__.formatDate)(new Date(item.updated_unix * 1000), 'yyyy-MM-dd')
          });
        });

        if (!_this.labels.length) {
          _this.labels = (res.orgTopics || []).map(function (item) {
            return {
              k: item,
              v: item
            };
          ...
          _this.$emit('update-labels', _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(_this.labels));
        }
      })["catch"](function (err) {
        console.log(err);
        _this.loading = false;
    ...
    getLabelList: function getLabelList() {
      ...
      (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_21__.getOrgLabel)({
        orgName: this.pageData.Org.Name
      }, 'aimodel').then(function (res) {
        res = res.data;

        if (res.code === 0) {
          console.log(res.data);
          var orgTopics = res.data;
          var engine = (orgTopics.Engine || []).map(function (item) {
            return {
              k: ["engine|".concat(item)],
              v: (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_22__.MODEL_ENGINES, item)
            };
          });
          var label = (orgTopics.Label || []).filter(function (item) {
            return item.trim() != '';
          }).map(function (item) {
            return {
              k: ["label|".concat(item)],
          ...
          _this2.labels = [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(engine), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_17___default()(label));
          console.log(_this2.labels);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoItem.vue?vue&type=script&lang=js":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoItem.vue?vue&type=script&lang=js ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoList.vue?vue&type=script&lang=js":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoList.vue?vue&type=script&lang=js ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _pages_repos_square_components_Item_vue__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ~/pages/repos/square/components/Item.vue */ "./web_src/vuepages/pages/repos/square/components/Item.vue");
/* harmony import */ var _apis_modules_organization__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ~/apis/modules/organization */ "./web_src/vuepages/apis/modules/organization.js");
/* harmony import */ var _utils_letteravatar__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ~/utils/letteravatar */ "./web_src/vuepages/utils/letteravatar.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ReposItem: _pages_repos_square_components_Item_vue__WEBPACK_IMPORTED_MODULE_19__["default"]
  },
  data: function data() {
    return {
      loading: false,
  ...
  methods: {
    getListData: function getListData() {
      ...
      this.loading = true;
      (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_20__.getOrgRepoList)({
        orgName: this.pageData.Org.Name,
        q: this.q.trim(),
        ...
        if (res.code == 0) {
          ...
          _this.list = list.map(function (item) {
            ...
            return _objectSpread(_objectSpread({}, item), {}, {
              NameShow: item.Alias,
              // this.handlerSearchStr(item.Alias, this.conds.q),
              DescriptionShow: item.Description,
              // this.handlerSearchStr(item.Description, this.conds.q),
          ...
          _this.$nextTick(function () {
            _utils_letteravatar__WEBPACK_IMPORTED_MODULE_21__["default"].transform();
          });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_BaseDialog_vue__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ~/components/BaseDialog.vue */ "./web_src/vuepages/components/BaseDialog.vue");
/* harmony import */ var _RepoItem_vue__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./RepoItem.vue */ "./web_src/vuepages/pages/organization/home/components/RepoItem.vue");
/* harmony import */ var _utils_letteravatar__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ~/utils/letteravatar */ "./web_src/vuepages/utils/letteravatar.js");
/* harmony import */ var _apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ~/apis/modules/organization */ "./web_src/vuepages/apis/modules/organization.js");
...
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
/* harmony import */ var _components_square_RightItem_vue__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ~/components/square/RightItem.vue */ "./web_src/vuepages/components/square/RightItem.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    BaseDialog: _components_BaseDialog_vue__WEBPACK_IMPORTED_MODULE_23__["default"],
    RepoItem: _RepoItem_vue__WEBPACK_IMPORTED_MODULE_24__["default"],
    DatasetItem: _components_square_RightItem_vue__WEBPACK_IMPORTED_MODULE_30__["default"]
  },
  computed: {
  ...
  methods: {
    ishaveDataset: function ishaveDataset(id) {
      var findEl = this.dataList.some(function (item) {
        return item.id === id;
      });
    ...
    getData: function getData() {
      ...
      if (this.type == 'repo') {
        this.loading = true;
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.getOrgSelectedRepoList)({
          orgName: this.pageData.Org.Name
        }).then(function (res) {
          res = res.data;
          _this.loading = false;
          ...
          if (res.code == 0) {
            ...
            var list = ((_res$data$ = res.data[0]) === null || _res$data$ === void 0 ? void 0 : _res$data$.RepoList) || [];
            _this.dataList = list.map(function (item) {
              item.Contributors = (item.Contributors || []).map(function (_item) {
                return _objectSpread(_objectSpread({}, _item), {}, {
                  bgColor: _this.randomColor((_item.Email[0] || '').toLocaleUpperCase())
                });
            ...
            _this.$nextTick(function () {
              _utils_letteravatar__WEBPACK_IMPORTED_MODULE_25__["default"].transform();
            });
          }
        })["catch"](function (err) {
          console.log(err);
      ...
      if (this.type == 'model') {
        this.loading = true;
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.getOrgSelectedModelList)({
          orgName: this.pageData.Org.Name
        }).then(function (res) {
          res = res.data;
          _this.loading = false;
          _this.dataList = (res.data.aimodels || []).map(function (item) {
            return _objectSpread(_objectSpread({}, item), {}, {
              labels: item.tags ? item.tags.trim().split(/\s+/) : [],
              tags: '',
              licenses: '',
              engineName: (0,_utils__WEBPACK_IMPORTED_MODULE_28__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_27__.MODEL_ENGINES, item.engine),
              updateTimeStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_29__.formatDate)(new Date(item.updated_unix * 1000), 'yyyy-MM-dd')
            });
          });
        })["catch"](function (err) {
          console.log(err);
      ...
      if (this.type == 'dataset') {
        this.loading = true;
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.getOrgSelectedDatasetList)({
          orgName: this.pageData.Org.Name
        }).then(function (res) {
          res = res.data;
          _this.loading = false;
          ...
          if (res.code === 0) {
            _this.dataList = (res.data.datasets || []).map(function (item) {
              return _objectSpread(_objectSpread({}, item), {}, {
                updateTimeStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_29__.formatDate)(new Date(item.updated_unix * 1000), 'yyyy-MM-dd')
              });
            });
    ...
    open: function open() {
      ...
      if (this.type == 'repo') {
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.getOrgSelectedRepoSetList)({
          orgName: this.pageData.Org.Name
        }).then(function (res) {
          res = res.data;
          var data = res.data || [];
          _this2.olist = data.map(function (item) {
            return {
              id: item.RepoID,
              name: item.RepoName,
      ...
      if (this.type == 'model') {
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.getOrgSelectedModelSetList)({
          orgName: this.pageData.Org.Name
        }).then(function (res) {
          res = res.data;

          if (res.code == 0) {
            var data = res.data.aimodels || [];
            _this2.olist = data.map(function (item) {
              return {
                id: item.ModelID,
                name: item.ModelName,
      ...
      if (this.type == 'dataset') {
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.getOrgSelectedDatasetSetList)({
          orgName: this.pageData.Org.Name
        }).then(function (res) {
          res = res.data;
          console.log(res);
    ...
    stateInit: function stateInit() {
      ...
      this.searchChange();
      this.checkList = this.list.filter(function (item) {
        return item.selected;
      }).map(function (item) {
        return item.id;
      });
      this.oCheckList = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_21___default()(this.checkList);
    },
    searchChange: function searchChange() {
      ...
      this.list = this.list.map(function (item) {
        return _objectSpread(_objectSpread({}, item), {}, {
          show: item.name.toLowerCase().includes(_this3.searchKey.toLowerCase())
        });
      });
    },
    renderMatchText: function renderMatchText(string) {
      var searchKey = this.searchKey.trim();
      if (!searchKey) return string;
      var reg = new RegExp(searchKey, 'gi');
      return string.replace(reg, function (txt) {
        return "<span style=\"color:red\">".concat(txt, "</span>");
      });
    },
    ...
    closed: function closed() {},
    handleChange: function handleChange(checkedList) {
      if (this.remaining < 0) {
        checkedList.pop();
    ...
    save: function save() {
      ...
      if (this.type == 'repo') {
        ...
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.setOrgSelectedRepo)({
          orgName: this.pageData.Org.Name,
          list: this.checkList
        }).then(function (res) {
          res = res.data;
          ...
          _this4.$message.error(_this4.$t('submittedFailed'));
        });
      }

      if (this.type == 'model') {
        this.setLoading = true;
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.setOrgSelectedModel)({
          orgName: this.pageData.Org.Name,
          list: this.checkList
        }).then(function (res) {
          res = res.data;
      ...
      if (this.type == 'dataset') {
        this.setLoading = true;
        (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_26__.setOrgSelectedDataset)({
          orgName: this.pageData.Org.Name,
          list: this.checkList
        }).then(function (res) {
          res = res.data;
  ...
  beforeMount: function beforeMount() {
    if (this.type == 'repo') {
      this.lang = {
        ...
        dlgMaxCountTip: this.$t('org.maxProjects', {
          num: this.maxCount
        })
      };
    }
    ...
    if (this.type == 'model') {
      this.lang = {
        ...
        dlgMaxCountTip: this.$t('org.maxModels', {
          num: this.maxCount
        })
      };
    }
    ...
    if (this.type == 'dataset') {
      this.lang = {
        ...
        dlgMaxCountTip: this.$t('org.maxDatasets', {
          num: this.maxCount
        })
      };
    }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Teams.vue?vue&type=script&lang=js":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Teams.vue?vue&type=script&lang=js ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/index.vue?vue&type=script&lang=js":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/index.vue?vue&type=script&lang=js ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_SpecailSelect_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/SpecailSelect.vue */ "./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue");
/* harmony import */ var _components_LabelSelect_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/LabelSelect.vue */ "./web_src/vuepages/pages/organization/home/components/LabelSelect.vue");
/* harmony import */ var _components_Members_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Members.vue */ "./web_src/vuepages/pages/organization/home/components/Members.vue");
/* harmony import */ var _components_Teams_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Teams.vue */ "./web_src/vuepages/pages/organization/home/components/Teams.vue");
/* harmony import */ var _components_RepoList_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/RepoList.vue */ "./web_src/vuepages/pages/organization/home/components/RepoList.vue");
/* harmony import */ var _components_ModelList_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/ModelList.vue */ "./web_src/vuepages/pages/organization/home/components/ModelList.vue");
/* harmony import */ var _components_DatasetList_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/DatasetList.vue */ "./web_src/vuepages/pages/organization/home/components/DatasetList.vue");
/* harmony import */ var _pages_storage_index_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ~/pages/storage/index.vue */ "./web_src/vuepages/pages/storage/index.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SpecailSelect: _components_SpecailSelect_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    LabelSelect: _components_LabelSelect_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    RepoList: _components_RepoList_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    ModelList: _components_ModelList_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    DatasetList: _components_DatasetList_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    Members: _components_Members_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    Teams: _components_Teams_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    StorageList: _pages_storage_index_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  methods: {
    ...
    updateLabels: function updateLabels(labels) {
      this.labels = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(labels);
    },
    onRefreshFav: function onRefreshFav(id) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/repos/square/components/Item.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/repos/square/components/Item.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/storage/index.vue?vue&type=script&lang=js":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/storage/index.vue?vue&type=script&lang=js ***!
  \******************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! core-js/modules/es.promise.finally */ "./node_modules/core-js/modules/es.promise.finally.js");
/* harmony import */ var core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var _components_cloudbrain_LoadingMask_vue__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ~/components/cloudbrain/LoadingMask.vue */ "./web_src/vuepages/components/cloudbrain/LoadingMask.vue");
/* harmony import */ var _components_square_DeleteConfirmModal_vue__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ~/components/square/DeleteConfirmModal.vue */ "./web_src/vuepages/components/square/DeleteConfirmModal.vue");
...
/* harmony import */ var _apis_modules_storage__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ~/apis/modules/storage */ "./web_src/vuepages/apis/modules/storage.js");
/* harmony import */ var _apis_modules_organization__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ~/apis/modules/organization */ "./web_src/vuepages/apis/modules/organization.js");
/* harmony import */ var _apis_modules_dataset__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ~/apis/modules/dataset */ "./web_src/vuepages/apis/modules/dataset.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    LoadingMask: _components_cloudbrain_LoadingMask_vue__WEBPACK_IMPORTED_MODULE_23__["default"],
    DeleteConfirmModal: _components_square_DeleteConfirmModal_vue__WEBPACK_IMPORTED_MODULE_24__["default"]
  },
  computed: {
    // remainingBytes() {
    ...
    formattedModel: function formattedModel() {
    ...
    formattedTotal: function formattedTotal() {
      ...
      return "".concat(value, " ").concat(UNITS[unitIndex]);
    },
    // 状态判断
    ...
    // 进度条计算
    dataDisplayWidth: function dataDisplayWidth() {
      if (this.isOverflow) {
        var _ratio = this.dataUsage / this.userStorage * 100;

        return "".concat(this.toPrecision(_ratio, 3), "%");
      }

      var ratio = this.dataUsage / this.totalStorage * 100;
      return "".concat(this.toPrecision(ratio, 3), "%");
    },
    modelDisplayWidth: function modelDisplayWidth() {
      if (this.isOverflow) {
        var _ratio2 = this.modelUsage / this.userStorage * 100;

        return "".concat(this.toPrecision(_ratio2, 3), "%");
      }

      var ratio = this.modelUsage / this.totalStorage * 100;
      return "".concat(this.toPrecision(ratio, 3), "%");
    },
    // 百分比显示
    dataPercentage: function dataPercentage() {
      if (this.dataUsage === this.totalStorage || this.totalStorage === 0) return '100%';
      return "".concat(this.toPrecision(this.dataUsage / this.totalStorage * 100, 2), "%");
    },
    modelPercentage: function modelPercentage() {
      if (this.modelUsage === this.totalStorage || this.totalStorage === 0) return '100%';
      return "".concat(this.toPrecision(this.modelUsage / this.totalStorage * 100, 2), "%");
    },
    // 剩余空间百分比（带精度处理）
    remainingPercentage: function remainingPercentage() {
      ...
      var dataPct = this.dataUsage / this.totalStorage * 100;
      var modelPct = this.modelUsage / this.totalStorage * 100;
      var roundedDataStr = this.toPrecision(dataPct, 2);
      var roundedModelStr = this.toPrecision(modelPct, 2); // 处理 "<0.01" 的情况，将其视为 0

      var roundedData = roundedDataStr === '≤0.01' ? 0 : Number(roundedDataStr);
      var roundedModel = roundedModelStr === '≤0.01' ? 0 : Number(roundedModelStr);
      var roundedRemaining = 100 - roundedData - roundedModel;
      return "".concat(roundedRemaining.toFixed(2), "%");
    },
  ...
  methods: {
    selectDataChange: function selectDataChange(taskList) {
      var _this = this;
    ...
    selectModelChange: function selectModelChange(taskList) {
      var _this2 = this;

      this.multipleSelection = [];
      taskList.forEach(function (item) {
        _this2.multipleSelection.push(item.id);
      });
    },
    batchDelete: function batchDelete() {
      ...
      var confirmTitle = this.$t('tips');
      var confirmMessage = this.tabIndex === 0 ? this.$t('storage.deleteBatchData') : this.$t('storage.deleteBatchModel');
      this.$confirm(confirmMessage, confirmTitle, {
        ...
        _this3.maskLoadingContent = _this3.$t('storage.deletingTips');
        var isDataSetTab = _this3.tabIndex === 0;
        var params = isDataSetTab ? {
          dataset_ids: _this3.multipleSelection.join(',')
        } : {
          aimodel_ids: _this3.multipleSelection.join(',')
        };
        var apiCall = isDataSetTab ? (0,_apis_modules_storage__WEBPACK_IMPORTED_MODULE_26__.batchDelStorageDataset)(params, 'dataset') : (0,_apis_modules_storage__WEBPACK_IMPORTED_MODULE_26__.batchDelStorageDataset)(params, 'aimodel');
        apiCall.then(function (res) {
          var _res$data$data$succes;

          console.log("res", res.data);
          var deletedCount = ((_res$data$data$succes = res.data.data.success) === null || _res$data$data$succes === void 0 ? void 0 : _res$data$data$succes.length) || 0;

          if (_this3.shouldDecrementPage(deletedCount)) {
            _this3.pageInfo.curpage -= 1;
          }

          _this3.getSummaryInfo();

          isDataSetTab ? _this3.getTableData() : _this3.getTableData('aimodel'); // Reset loading and selection

          _this3.maskLoading = false;
          _this3.multipleSelection = [];
        })["catch"](function (err) {
          _this3.handleDeleteError(err);
        });
      })["catch"](function () {
        _this3.$message({
          type: 'info',
     ...
     * 统一错误处理
     */
    handleDeleteError: function handleDeleteError(error) {
      var _error$response, _error$response$data;

      this.maskLoading = false;
      this.$message.error((error === null || error === void 0 ? void 0 : (_error$response = error.response) === null || _error$response === void 0 ? void 0 : (_error$response$data = _error$response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message) || error || this.$t('operationFailed'));
    },
    shouldDecrementPage: function shouldDecrementPage(deletedCount) {
      var newTotal = this.pageInfo.total - deletedCount;
      var newTotalPages = Math.ceil(newTotal / this.pageInfo.pageSize);
      return this.pageInfo.curpage > newTotalPages && this.pageInfo.curpage > 1;
    },
    sortTableFun: function sortTableFun(column) {
      var orderMapping = {
        ascending: 'size_asc',
        descending: 'size'
      };
    ...
    tabChange: function tabChange(index) {
      ...
      if (index === 0) {
        this.getTableData();
        this.$nextTick(function () {
          if (_this4.$refs.tableRef) {
            _this4.$refs.tableRef.clearSelection();
          }
        });
      } else {
        this.getTableData('aimodel');
        this.$nextTick(function () {
          if (_this4.$refs.tableModelRef) {
            _this4.$refs.tableModelRef.clearSelection();
          }
        });
      }
    },
    dateFormat: function dateFormat(unix) {
      return dayjs__WEBPACK_IMPORTED_MODULE_25___default()(unix * 1000).format('YYYY-MM-DD HH:mm:ss');
    },
    // 精确小数处理
    toPrecision1: function toPrecision1(value) {
      ...
      var rounded = Number(value.toFixed(decimals)); // 避免 100% 溢出（如 99.999 四舍五入为 100）
    ...
    toPrecision: function toPrecision(value) {
      ...
      var roundedValue = Number(value.toFixed(decimals)); // 检查四舍五入后是否为100.00且原始值小于100
    ...
    formatBytes: function formatBytes(bytes) {
      var _value, _totalInSameUnit;

      var unitIndex = 0;
      var value = bytes;
      var totalInSameUnit = this.totalStorage; // 总存储的初始单位（字节）
      ...
      var decimals = 2;
      var roundedValue = Number((_value = value) === null || _value === void 0 ? void 0 : _value.toFixed(decimals)) || 0;
      var totalRounded = Number((_totalInSameUnit = totalInSameUnit) === null || _totalInSameUnit === void 0 ? void 0 : _totalInSameUnit.toFixed(decimals)) || 0; // 条件1：四舍五入后等于总存储的显示值，但实际值小于总存储
      // 条件2：四舍五入后等于1024，但实际值小于1024

      if (roundedValue === totalRounded && value < totalInSameUnit || roundedValue === 1024.00 && value < 1024) {
        var factor = Math.pow(10, decimals);
        var truncated = Math.floor(value * factor) / factor;
        return "".concat(truncated.toFixed(decimals), " ").concat(UNITS[unitIndex]);
      } else {
        return "".concat(roundedValue.toFixed(decimals), " ").concat(UNITS[unitIndex]);
      }
    },
    goToPreview: function goToPreview(row) {
      //datasets/dirs/{{.UUID}}?type={{$.Type}}
      var url = "/".concat(row.repo_owner, "/").concat(row.repo_name, "/datasets/dirs/").concat(row.uuid, "?type=-1");
      window.open(url, '_blank');
    },
    getFeedUrl: function getFeedUrl(row) {
      var url = 'https://openi.pcl.ac.cn/zeizei/OpenI_Learning/issues/new';
      var issuetitle = "".concat(this.$t('modelManage.datasetfile'), "\uFF1A").concat(row.name, " ").concat(this.$t('datasetObj.dataset_unzip_failed'));
      var body = "".concat(this.$t('modelManage.project'), "\uFF1A").concat(row.repo_owner, "/").concat(row.repo_name, " ").concat(this.$t('modelManage.datasetfile'), "\uFF1A").concat(row.name);
      return "".concat(url, "?issuetitle=").concat(issuetitle, "&body=").concat(body);
    },
    deleteDataSet: function deleteDataSet(row) {
    ...
    handleDeleteModel: function handleDeleteModel(_ref) {
      var _this5 = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_22___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_20___default().mark(function _callee() {
        var type, data, callback, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_20___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                type = _ref.type, data = _ref.data, callback = _ref.callback;
                _context.prev = 1;
                ...
                _context.next = 5;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_28__.delDataset)({
                  dataset_id: data.id
                });
              ...
              case 11:
                if (response.data.code === 0) {
                  callback({
                    success: true,
                    message: _this5.$t('imagesObj.deleteSuccessTips')
                  });
                } else {
                  callback({
                    success: false,
    ...
    // 删除成功后的回调
    handleDeleteSuccess: function handleDeleteSuccess() {
    ...
    getSummaryInfo: function getSummaryInfo() {
      ...
      var queryParams = this.type === 'user' ? (0,_apis_modules_storage__WEBPACK_IMPORTED_MODULE_26__.getStorageSummary)({}) : (0,_apis_modules_organization__WEBPACK_IMPORTED_MODULE_27__.getOrgStorageSummary)(this.orgName, {});
      queryParams.then(function (res) {
        var data = _this6.type === 'user' ? res.data : res.data.data;
        console.log("xxx", data);
        _this6.dataUsage = data.dataset_used_storage;
        _this6.modelUsage = data.model_used_storage;
        _this6.totalStorage = data.storage_limit;
        _this6.remainingUsage = data.remaining_storage;
        _this6.userStorage = data.used_storage;
      })["catch"](function (err) {
    ...
    getTableData: function getTableData() {
      ...
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'dataset';
      this.loading = true;
      var baseParams = {
      ...
      var getDatasetQuery = this.type === 'user' ? _apis_modules_storage__WEBPACK_IMPORTED_MODULE_26__.getStorageDataset : _apis_modules_organization__WEBPACK_IMPORTED_MODULE_27__.getOrgStorageDatasetList;
      var params = this.type === 'user' ? baseParams : _objectSpread({
        owner_name: this.orgName
      }, baseParams);
      getDatasetQuery(params, type).then(function (res) {
        ...
        if (data.code === 0) {
          ...
          if (type === 'dataset') {
            var _this7$tableData;

            (_this7$tableData = _this7.tableData).splice.apply(_this7$tableData, [0, Infinity].concat(tableData));
          } else {
            var _this7$tableModel;

            (_this7$tableModel = _this7.tableModel).splice.apply(_this7$tableModel, [0, Infinity].concat(tableData));
          }

          _this7.pageInfo.total = data.data.total;
        } else {
          _this7.$message.error(data.msg);
        }

        _this7.$nextTick(function () {
          (0,_utils__WEBPACK_IMPORTED_MODULE_29__.initClipboard)('.clipboard-model-name');
        });
      })["catch"](function (err) {
        ...
        _this7.tableData.splice(0, Infinity);
      })["finally"](function () {
        _this7.loading = false;
      });
    }
...
/***/ "./web_src/vuepages/pages/organization/home/vp-organization-home.js":
/*!**************************************************************************!*\
  !*** ./web_src/vuepages/pages/organization/home/vp-organization-home.js ***!
  \**************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/organization/home/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/DatasetList.vue?vue&type=style&index=0&id=7536484e&scoped=true&lang=less":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/DatasetList.vue?vue&type=style&index=0&id=7536484e&scoped=true&lang=less ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/LabelSelect.vue?vue&type=style&index=0&id=0ba21ab3&scoped=true&lang=less":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/LabelSelect.vue?vue&type=style&index=0&id=0ba21ab3&scoped=true&lang=less ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Members.vue?vue&type=style&index=0&id=f3854888&scoped=true&lang=less":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Members.vue?vue&type=style&index=0&id=f3854888&scoped=true&lang=less ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/ModelList.vue?vue&type=style&index=0&id=3de3af6c&scoped=true&lang=less":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/ModelList.vue?vue&type=style&index=0&id=3de3af6c&scoped=true&lang=less ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoItem.vue?vue&type=style&index=0&id=7649d2dc&scoped=true&lang=less":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoItem.vue?vue&type=style&index=0&id=7649d2dc&scoped=true&lang=less ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoList.vue?vue&type=style&index=0&id=623ee2c6&scoped=true&lang=less":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoList.vue?vue&type=style&index=0&id=623ee2c6&scoped=true&lang=less ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue?vue&type=style&index=0&id=2c30eb30&scoped=true&lang=less":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue?vue&type=style&index=0&id=2c30eb30&scoped=true&lang=less ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Teams.vue?vue&type=style&index=0&id=63c6ac99&scoped=true&lang=less":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Teams.vue?vue&type=style&index=0&id=63c6ac99&scoped=true&lang=less ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/index.vue?vue&type=style&index=0&id=b8d70c74&scoped=true&lang=less":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/index.vue?vue&type=style&index=0&id=b8d70c74&scoped=true&lang=less ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/repos/square/components/Item.vue?vue&type=style&index=0&id=5f1aa890&scoped=true&lang=less":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/repos/square/components/Item.vue?vue&type=style&index=0&id=5f1aa890&scoped=true&lang=less ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages
************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "ui small modal", attrs: { id: _vm.modalId } },
    [
      _c("div", { staticClass: "header" }, [
        _vm._v("\n    " + _vm._s(_vm.$t(_vm.titleKey)) + "\n  ")
      ]),
      _vm._v(" "),
      _c(
        "div",
        ...
        [
          _c("div", { staticClass: "ui warning message text left" }, [
            _c("p", {
              domProps: {
            ...
            _c("p", {
              domProps: {
                innerHTML: _vm._s(_vm.$t(_vm.notice2Key, _vm.notice2Params))
              }
            })
          ]),
          _vm._v(" "),
            ...
            [
              _c("div", { staticClass: "field" }, [
                _c("label", [
                  _vm._v(
                    "\n          " +
                      _vm._s(_vm.$t(_vm.confirmNameKey)) +
                      "\n          "
                  ),
              ...
              _c("div", { staticClass: "required field" }, [
                _c("label", { attrs: { for: _vm.inputId } }, [
                  _vm._v(_vm._s(_vm.$t(_vm.nameLabelKey)))
                ]),
                _vm._v(" "),
                _c("input", {
                  directives: [
                  ...
                  attrs: { id: _vm.inputId, name: _vm.inputName, required: "" },
              ...
              _c("div", { staticClass: "text right actions" }, [
                ...
                _c(
                  "button",
                  {
                    ...
                    attrs: { disabled: !_vm.name || _vm.delLoading },
                    on: { click: _vm.handleDelete }
                  },
                  [
                    _vm._v(
                      "\n          " + _vm._s(_vm.$t("confirm1")) + "\n        "
                    )
                  ]
                )
              ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightItem.vue?vue&type=template&id=6e00cce9&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightItem.vue?vue&type=template&id=6e00cce9&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass: "item",
      class: "item__" + _vm.type,
      attrs: { target: "_blank", href: _vm.getItemLink(_vm.data) }
    },
    [
        ...
        _c("div", { staticClass: "top-head" }, [
          _c("div", { staticClass: "name nowrap" }, [
            _c(
              ...
              {
                attrs: {
                  title: _vm.lang == "en-US" ? _vm.data.name : _vm.data.alias
                }
              },
              [
                _vm._v(
                  _vm._s(_vm.lang == "en-US" ? _vm.data.name : _vm.data.alias)
                )
              ]
            )
          ]),
          ...
          _vm.data.recommend
            ? _c("div", { staticClass: "reconmend-icon" }, [
                _c(
                  "svg",
                  {
                    staticClass: "dZJqQS svg-icon-path-icon fill",
                    attrs: {
      ...
      _c("div", { staticClass: "footer" }, [
        _c("div", { staticClass: "footer-l" }, [
          _vm.data.Owner && _vm.data.Owner.Name
            ? _c(
                "a",
                {
                  staticClass: "avatar-c",
                  attrs: { href: "/" + _vm.data.Owner.Name }
                },
                [
                  _c("img", {
                    staticClass: "avatar",
                    attrs: { src: _vm.data.Owner.RelAvatarLink }
                  })
                ]
              )
            : _vm._e(),
          ...
          [
            _c(
              "div",
              {
                ...
                class: _vm.canChangeFav || _vm.isSetting ? "" : "fav-disabled",
                on: {
              ...
              [
                ...
                _vm.isCollected
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _c("span", [_vm._v(_vm._s(_vm.collected_count))])
              ]
            ),
            _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/DatasetList.vue?vue&type=template&id=7536484e&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/DatasetList.vue?vue&type=template&id=7536484e&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return _c("div", { staticClass: "list-container" }, [
    _c("div", { staticClass: "list-head" }, [
      _c("div", { staticClass: "title" }, [
        _vm._v(_vm._s(_vm.$t("repos.dataset")))
      ]),
      _vm._v(" "),
      _c(
        "div",
          ...
          _c(
            ...
            [
              _c(
                "el-input",
                {
                  attrs: { placeholder: _vm.$t("org.searchDatasets") },
                  nativeOn: {
              ...
              _c(
                ...
                _vm._l(_vm.sortList, function(item) {
                  return _c(
                    ...
                    {
                      key: item.key,
                      class: _vm.sort == item.key ? "active" : "",
                      nativeOn: {
                        click: function($event) {
      ...
      [
        _vm._l(_vm.list, function(item, index) {
          return _c(
            ...
            [
              _c("DatasetItem", {
                attrs: { data: item, canChangeFav: true },
                on: { changeFav: _vm.onChangeFav }
              })
            ],
            1
          )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/LabelSelect.vue?vue&type=template&id=0ba21ab3&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/LabelSelect.vue?vue&type=template&id=0ba21ab3&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.showExpand,
              expression: "showExpand"
            }
          ],
          ...
          !_vm.isExpand
            ? _c(
                ...
                [
                  ...
                  _vm._v(_vm._s(_vm.$t("org.unfold")))
                ]
              )
            : _c(
                "span",
                ...
                [
                  _c("i", { staticClass: "ri-arrow-up-s-line" }),
                  _vm._v(_vm._s(_vm.$t("org.fold")))
                ]
              )
        ]
      )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Members.vue?vue&type=template&id=f3854888&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Members.vue?vue&type=template&id=f3854888&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "members-c" }, [
    _c("div", { staticClass: "members-head" }, [
      _c("div", { staticClass: "members-head-l" }, [
        _c("i", { staticClass: "icon ri-user-line" }),
        _vm._v(_vm._s(_vm.$t("org.orgMember")))
      ]),
      _vm._v(" "),
      _c(
        "a",
        {
          staticClass: "members-head-r",
          attrs: { href: _vm.pageData.OrgLink + "/members" }
        },
        [
          _vm._v("\n      " + _vm._s(_vm.pageData.MembersTotal) + " "),
          _c("i", { staticClass: "icon ri-arrow-right-s-line" })
        ]
      )
    ]),
    _vm._v(" "),
    _c(
      ...
      _vm._l(_vm.pageData.Members, function(item, index) {
        return _c(
          "a",
          {
            staticClass: "members-item",
            attrs: {
              href: item.HomeLink,
              title:
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/ModelList.vue?vue&type=template&id=3de3af6c&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/ModelList.vue?vue&type=template&id=3de3af6c&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
          ...
          _c(
            ...
            [
              _c(
                "el-input",
                {
                  attrs: { placeholder: _vm.$t("org.searchModels") },
                  nativeOn: {
                    keyup: function($event) {
                      if (
                        !$event.type.indexOf("key") &&
      ...
      [
        _vm._l(_vm.list, function(item, index) {
          return _c(
            ...
            [
              _c("DatasetItem", {
                attrs: { data: item, canChangeFav: true, type: "aimodel" },
                on: { changeFav: _vm.onChangeFav }
              })
            ],
            1
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoItem.vue?vue&type=template&id=7649d2dc&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoItem.vue?vue&type=template&id=7649d2dc&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "a",
    {
      ...
      attrs: { href: "/" + _vm.data.OwnerName + "/" + _vm.data.Name }
    },
    [
      _c("div", { staticClass: "title-c" }, [
        _c("div", { staticClass: "repo-icon" }, [
          _vm.data.Avatar
            ? _c("img", {
                staticClass: "avatar",
                attrs: { src: "/repo-avatars/" + _vm.data.Avatar }
              })
            : _c("img", {
                staticClass: "avatar",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoList.vue?vue&type=template&id=623ee2c6&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/RepoList.vue?vue&type=template&id=623ee2c6&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
          ...
          _c(
            ...
            [
              _c(
                "el-input",
                {
                  attrs: { placeholder: _vm.$t("org.searchRepos") },
                  nativeOn: {
                    keyup: function($event) {
                      if (
                        !$event.type.indexOf("key") &&
      ...
      [
        _vm._l(_vm.list, function(item, index) {
          return _c(
            "div",
            { key: item.ID, staticClass: "item-container" },
            [_c("ReposItem", { key: item.ID, attrs: { data: item } })],
            1
          )
        }),
        _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue?vue&type=template&id=2c30eb30&scoped=true":
/*!****************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/SpecailSelect.vue?vue&type=template&id=2c30eb30&scoped=true ***!
  \****************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      directives: [
        {
          name: "show",
          rawName: "v-show",
          value: _vm.pageData.IsOrganizationOwner || _vm.dataList.length,
          expression: "pageData.IsOrganizationOwner || dataList.length"
        }
      ],
      staticClass: "special-select-c"
    },
    [
      _c("div", { staticClass: "head" }, [
        _c("div", { staticClass: "head-l" }, [
          _vm._v("\n      ⭐️ "),
          _c("span", [_vm._v(_vm._s(_vm.lang.headTitle))])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "head-r" }, [
          _vm.pageData.IsOrganizationOwner
            ? _c(
                "div",
                {
                  staticClass: "btn-c",
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("span", [_vm._v(_vm._s(_vm.$t("org.customize")))])
                ]
              )
            : _vm._e()
        ])
      ...
      _vm.type == "repo"
        ? _c(
            "div",
            { staticClass: "body list-item-container repo-c" },
            _vm._l(_vm.dataList, function(item, index) {
              return _c(
                "div",
                { key: item.ID, staticClass: "item-container" },
                [_c("RepoItem", { attrs: { data: item } })],
                1
              )
            }),
            0
      ...
      _vm.type == "model"
        ? _c(
            "div",
            { staticClass: "body list-item-container model-c" },
            _vm._l(_vm.dataList, function(item, index) {
              return _c(
                "div",
                { key: item.ID, staticClass: "item-container" },
                [
                  _c("DatasetItem", {
                    attrs: { data: item, canChangeFav: false, type: "aimodel" }
                  })
                ],
                1
              )
      ...
      _vm.type == "dataset"
        ? _c(
            "div",
            { staticClass: "body list-item-container dataset-c" },
            _vm._l(_vm.dataList, function(item, index) {
              return _c(
                "div",
                { key: item.id, staticClass: "item-container" },
                [
                  _c("DatasetItem", {
                    attrs: { data: item, canChangeFav: false }
                  })
                ],
                1
              )
      ...
      _c(
        "BaseDialog",
        {
          staticClass: "model-dlg",
          attrs: {
            visible: _vm.dlgShow,
            title: _vm.lang.dlgTitle,
            width: "1000px",
            modal: true,
        ...
        [
          _c("div", { staticClass: "dlg-content" }, [
            _c("div", { staticClass: "tips" }, [
              _vm._v(_vm._s(_vm.lang.dlgMaxCountTip))
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "search-bar" }, [
              _c("input", {
                ...
                attrs: { type: "text", placeholder: _vm.$t("org.searching") },
                  ...
                  _vm._l(_vm.list, function(item) {
                    return _c(
                      "el-checkbox",
                      {
                        ...
                        key: item.id,
                        staticClass: "item",
                        attrs: { label: item.id, title: item.name }
                      },
                      [
                        _c("span", {
                          domProps: {
                            innerHTML: _vm._s(_vm.renderMatchText(item.name))
                          }
                        })
                      ]
                    )
            ...
            _vm._v(" "),
            _c("div", { staticClass: "tips-remaining" }, [
              _vm._v(_vm._s(_vm.$t("org.remainNum", { num: _vm.remaining })))
            ]),
            _vm._v(" "),
            _c(
              "div",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Teams.vue?vue&type=template&id=63c6ac99&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/components/Teams.vue?vue&type=template&id=63c6ac99&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.pageData.IsOrganizationMember
    ? _c("div", { staticClass: "teams-c" }, [
        _c("div", { staticClass: "teams-head" }, [
          _c("div", { staticClass: "teams-head-l" }, [
            _c("i", { staticClass: "icon ri-group-line" }),
            _vm._v(_vm._s(_vm.$t("org.orgTeam")))
          ]),
          _vm._v(" "),
          _c(
            "a",
            {
              staticClass: "teams-head-r",
              attrs: { href: _vm.pageData.OrgLink + "/teams" }
            },
            [
              _vm._v("\n      " + _vm._s(_vm.pageData.NumTeams) + " "),
              _c("i", { staticClass: "icon ri-arrow-right-s-line" })
            ]
          )
        ]),
        ...
        _c(
          ...
          _vm._l(_vm.pageData.Teams, function(item) {
            return _c("div", { staticClass: "teams-item" }, [
              _c("div", [
                _c(
                  "a",
                  {
                    attrs: {
                      href: _vm.pageData.OrgLink + "/teams/" + item.LowerName,
                      title: item.Name
                    }
                  },
              ...
              _c("p", [
                _c(
                  ...
                  [
                    _c("strong", [_vm._v(_vm._s(item.NumMembers))]),
                    _vm._v(
                      "\n          " +
                        _vm._s(
                          item.NumMembers > 1
                            ? _vm.$t("org.numMembers")
                            : _vm.$t("org.numMember")
                        ) +
                        "\n        "
                    )
                ...
                _c(
                  ...
                  [
                    _c("strong", [_vm._v(_vm._s(item.NumRepos))]),
                    _vm._v(
                      "\n          " +
                        _vm._s(
                          item.NumRepos > 1
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/index.vue?vue&type=template&id=b8d70c74&scoped=true":
/*!*********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/organization/home/index.vue?vue&type=template&id=b8d70c74&scoped=true ***!
  \*********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "org-area-c" }, [
    _c(
      "div",
      { staticClass: "org-area-l" },
      [
        _vm.pageType !== "storage"
          ? _c("SpecailSelect", {
              ref: "curatedData",
              attrs: { type: _vm.pageType, pageData: _vm.pageData }
            })
          : _vm._e(),
        _vm._v(" "),
        _c("LabelSelect", {
        ...
        _vm.pageType == "repo"
          ? _c("RepoList", {
              attrs: { conds: _vm.conds, pageData: _vm.pageData },
              on: { "update-labels": _vm.updateLabels }
            })
          : _vm._e(),
        _vm._v(" "),
        _vm.pageType == "model"
          ? _c("ModelList", {
              attrs: { conds: _vm.conds, pageData: _vm.pageData },
              on: {
                "update-labels": _vm.updateLabels,
                refreshFav: _vm.onRefreshFav
              }
            })
          : _vm._e(),
        _vm._v(" "),
        _vm.pageType == "dataset"
          ? _c("DatasetList", {
              attrs: { conds: _vm.conds, pageData: _vm.pageData },
              on: {
                "update-labels": _vm.updateLabels,
        ...
        _vm._v(" "),
        _vm.pageType == "storage"
          ? _c("div", { staticStyle: { margin: "20px", float: "right" } }, [
              _vm._v(_vm._s(_vm.$t("storage.storageOrgTips1")) + "\n      "),
              _c(
                "a",
                {
                  attrs: {
                    download: "",
                    href:
                      "/OpenIOSSG/promote/raw/branch/master/%e5%90%af%e6%99%baAI%e5%8d%8f%e4%bd%9c%e5%b9%b3%e5%8f%b0%e7%bb%84%e7%bb%87%e8%b4%a6%e6%88%b7%e5%ad%98%e5%82%a8%e9%85%8d%e9%a2%9d%e7%94%b3%e8%af%b7%e8%a1%a8.docx"
                  }
                },
                [_vm._v(_vm._s(_vm.$t("storage.storageOrgTips2")))]
              ),
              _vm._v(
                "，\n      " +
                  _vm._s(_vm.$t("storage.storageOrgTips3")) +
                  "\n    "
              )
            ])
          : _vm._e(),
        ...
        _vm.pageType == "storage"
          ? _c("StorageList", {
              attrs: { type: "org", orgName: _vm.pageData.Org.Name }
            })
          : _vm._e()
      ],
      1
    ...
    _c(
      "div",
      { staticClass: "org-area-r", staticStyle: { display: "none" } },
      [
        _c("Members", { attrs: { pageData: _vm.pageData } }),
        _vm._v(" "),
        _vm.pageData.IsOrganizationMember && _vm.pageData.Teams.length
          ? _c("div", { staticClass: "line" })
          : _vm._e(),
        _vm._v(" "),
        _c("Teams", { attrs: { pageData: _vm.pageData } })
      ],
      1
    )
  ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/repos/square/components/Item.vue?vue&type=template&id=5f1aa890&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/repos/square/components/Item.vue?vue&type=template&id=5f1aa890&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    ...
    [
      _c("div", { staticClass: "top" }, [
        _c("div", { staticClass: "top-head" }, [
          ...
          _c(
            ...
            {
              staticClass: "name",
              attrs: { title: _vm.data.OwnerName + "/" + _vm.data.Name }
            },
            [
        ...
        _c("div", { staticClass: "top-descr" }, [
          _c("div", {
            ...
            staticClass: "descr",
            attrs: { title: _vm.data.DescriptionShow },
            domProps: { innerHTML: _vm._s(_vm.data.DescriptionShow) }
          })
        ]),
        _vm._v(" "),
      ...
      _c("div", { staticClass: "footer" }, [
        ...
        _c("div", { staticClass: "footer-r" }, [
          _c(
            "span",
            { staticClass: "r-item", attrs: { title: _vm.$t("repos.watch") } },
            [
          ...
          _c(
            "span",
            { staticClass: "r-item", attrs: { title: _vm.$t("repos.star") } },
            [
          ...
          _c(
            "span",
            { staticClass: "r-item", attrs: { title: _vm.$t("repos.fork") } },
            [
              _c(
                "svg",
                {
                  staticClass: "svg octicon-repo-forked",
                  attrs: { width: "13", height: "13", "aria-hidden": "true" }
                },
                [_c("use", { attrs: { "xlink:href": "#octicon-repo-forked" } })]
              ),
              _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/storage/index.vue?vue&type=template&id=6832c806&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/storage/index.vue?vue&type=template&id=6832c806&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "__mobile-tip" }, [
        _c("img", {
          staticStyle: { width: "132px", height: "97px" },
          attrs: { src: "/img/model/pc-view.png", alt: "" }
        }),
        _vm._v(" "),
        _c("div", { staticStyle: { "margin-top": "2rem" } }, [
          _vm._v(_vm._s(_vm.$t("useInPcWeb")))
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "__reward-pointer-c __content-box" }, [
        _c("div", { staticClass: "ui container" }, [
          _c("div", { staticClass: "__r_p_header" }, [
            _c("div", [
              _c("p", { staticClass: "__title" }, [
                _vm._v(_vm._s(_vm.$t("storage.capacity_details")))
              ])
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "__r_p_summary" }, [
            _c("div", { staticClass: "__r_p_summary-item" }, [
              _c(
                "div",
                { staticClass: "__r_p_summary-progress __r_p-total-usage" },
                [
                  _c("div", {
                    staticClass: "__r_p-data-usage",
                    style: { width: _vm.dataDisplayWidth }
                  }),
                  _vm._v(" "),
                  _c("div", {
                    staticClass: "__r_p-model-usage",
                    style: {
                      left: _vm.dataDisplayWidth,
                      width: _vm.modelDisplayWidth
                    }
                  })
                ]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "__r_p_summary-total" }, [
                _vm._v(
                  _vm._s(_vm.$t("storage.quota")) +
                    "：" +
            ...
            _vm._v(" "),
            _c("div", { staticClass: "__r_p_-storage-info" }, [
              _c("div", { staticClass: "__r_p_-storage-item" }, [
                _c("span", { staticClass: "color-block __r_p-data-usage" }),
                _vm._v(" "),
                _c("span", [
                  _vm._v(_vm._s(_vm.$t("storage.data_usaged")) + "："),
                  _c("span", { staticClass: "_ehance-color" }, [
                    _vm._v(_vm._s(_vm.formattedData))
                  ]),
                  _vm._v(" (" + _vm._s(_vm.dataPercentage) + ")")
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "__r_p_-storage-item" }, [
                _c("span", { staticClass: "color-block __r_p-model-usage" }),
                _vm._v(" "),
                _c("span", [
                  _vm._v(_vm._s(_vm.$t("storage.model_usaged")) + "："),
                  _c("span", { staticClass: "_ehance-color" }, [
                    _vm._v(_vm._s(_vm.formattedModel))
                  ]),
                  _vm._v(" (" + _vm._s(_vm.modelPercentage) + ")")
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "__r_p_-storage-item" }, [
                _c("span", { staticClass: "color-block __r_p-total-usage" }),
                _vm._v(" "),
                _c("span", [
                  _vm._v(_vm._s(_vm.$t("storage.remaining_available")) + "："),
                  _c("span", { staticClass: "_ehance-color" }, [
                    _vm._v(_vm._s(_vm.formattedRemaining))
                  ]),
                  _vm._v(
                    "\n              (" + _vm._s(_vm.remainingPercentage) + ")"
                  )
                ])
              ])
            ])
          ...
          _vm._v(" "),
          _c("div", { staticClass: "__r_p_tab" }, [
            _c(
              "div",
              {
                staticClass: "__r_p_tab-item",
                class: _vm.tabIndex === 0 ? "__focus" : "",
            ...
            _c(
              ...
              {
                staticClass: "__r_p_tab-item",
                class: _vm.tabIndex === 1 ? "__focus" : "",
                staticStyle: { "border-radius": "0px 5px 5px 0px" },
                on: {
                  click: function($event) {
              ...
              [
                _vm._v(
                  "\n          " + _vm._s(_vm.$t("repos.model")) + "\n        "
                )
              ]
            )
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "__r_p_table" }, [
            _c(
              "div",
              {
                directives: [
                ...
                _vm.tableData.length
                  ? _c(
                      "el-table",
                      {
                        ...
                        on: {
                          "sort-change": _vm.sortTableFun,
                          "selection-change": _vm.selectDataChange
                        }
                      },
                      [
                        _c("el-table-column", {
                        ...
                        _c("el-table-column", {
                          attrs: {
                            "column-key": "alias",
                            prop: "alias",
                            label: _vm.$t("datasetObj.dataset_name1"),
                            "min-width": "300"
                          },
                          scopedSlots: _vm._u(
                            [
                            ...
                            [
                              {
                                ...
                                fn: function(scope) {
                                  return [
                                    _vm._v(
                                      _vm._s(_vm.formatBytes(scope.row.size))
                                    )
                                  ]
                                }
                              }
                                            ...
                                            _c(
                                              ...
                                              [
                                                _vm._v(
                                                  _vm._s(
                                                    _vm.$t(
                                                      "modelManage.modelAccessPrivate"
                                                    )
                                                  )
                                                )
                                              ]
                                                ...
                                                _c("g", [
                                                  _c("path", {
                                                    attrs: {
                                                      fill: "#27b148",
                                                      d:
                                                        "M29.696 14.464v15.040c0 0.288-0.224 0.48-0.48 0.48h-17.28c-0.288 0-0.512-0.192-0.512-0.48v-15.040c0-0.256 0.224-0.48 0.512-0.48h1.344c0.288 0 0.512-0.096 0.512-0.256v-0.224c-0.032-1.6 0-3.2-0.032-4.8-0.096-2.112-2.016-3.936-4.128-4.064-2.208-0.096-4.16 1.408-4.608 3.552-0.061 0.331-0.096 0.711-0.096 1.1 0 0.007 0 0.014 0 0.021v-0.001 4.416s-0.224 0.16-0.48 0.16h-1.664c-0.256 0-0.48-0.224-0.48-0.512 0-1.632-0.032-3.264 0.032-4.864 0.16-2.976 2.336-5.504 5.216-6.272 4.032-1.088 8.16 1.6 8.768 5.76 0.096 0.672 0.096 1.408 0.096 2.080v3.68s0.224 0.224 0.48 0.224h12.32c0.256 0 0.48 0.224 0.48 0.48z"
                                                    }
                                                  })
                                                ])
                                              ]
                                ...
                                fn: function(scope) {
                                  return [
                                    _c("span", [
                                      _vm._v(
                                        _vm._s(
                                          _vm.dateFormat(scope.row.updated_unix)
                                        )
                                      )
                                    ])
                                  ]
                  ...
                  : _c("el-empty", {
                      attrs: {
                        "image-size": 140,
                        description: _vm.$t("modelObj.model_square_empty")
                      }
                    })
              ],
              1
                ...
                _vm.tableModel.length
                  ? _c(
                      "el-table",
                      {
                        ...
                        on: {
                          "sort-change": _vm.sortTableFun,
                          "selection-change": _vm.selectModelChange
                        }
                      },
                      [
                        _c("el-table-column", {
                        ...
                        _c("el-table-column", {
                          attrs: {
                            "column-key": "alias",
                            prop: "alias",
                            label: _vm.$t("modelManage.modelName"),
                            "min-width": "300"
                          },
                          scopedSlots: _vm._u(
                            [
                                    ...
                                    _c("div", { staticClass: "op-wrap" }, [
                                      _c(
                                        "a",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.deleteModel(scope.row)
                                            }
                                          }
                                        },
                                        [
            ...
            _vm._v(" "),
            _vm.showFooter
              ? _c("div", { staticClass: "__r_p_pagination" }, [
                  _c("div", { staticStyle: { "margin-top": "2rem" } }, [
                    _c(
                      "div",
                      ...
                      [
                        _c(
                          ...
                          [_vm._v(_vm._s(_vm.$t("cloudbrainObj.batchDelete")))]
                        ),
                        _vm._v(" "),
                        _c("el-pagination", {
                          ...
                          attrs: {
                            ...
                            "page-sizes": _vm.pageInfo.pageSizes,
      ...
      _c("delete-confirm-modal", {
        ref: "deleteModal",
        attrs: { type: _vm.dataType, "data-obj": _vm.dataObj },
        on: {
          "confirm-delete": _vm.handleDeleteModel,
          "delete-success": _vm.handleDeleteSuccess
        }
      }),
      _vm._v(" "),
      _c("LoadingMask", {
        attrs: { loading: _vm.maskLoading, content: _vm.maskLoadingContent }
      })
    ],
    1
  )
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/organization/home/vp-organization-home.js"); })
