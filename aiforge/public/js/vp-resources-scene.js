...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_BaseDialog_vue__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ~/components/BaseDialog.vue */ "./web_src/vuepages/components/BaseDialog.vue");
/* harmony import */ var _SpecSelect_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./SpecSelect.vue */ "./web_src/vuepages/pages/resources/components/SpecSelect.vue");
/* harmony import */ var _apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ~/apis/modules/resources */ "./web_src/vuepages/apis/modules/resources.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    BaseDialog: _components_BaseDialog_vue__WEBPACK_IMPORTED_MODULE_19__["default"],
    SpecSelect: _SpecSelect_vue__WEBPACK_IMPORTED_MODULE_20__["default"]
  },
  data: function data() {
    return {
      dialogShow: false,
      dataInfo: {},
      taskTypeList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(_const__WEBPACK_IMPORTED_MODULE_22__.JOB_TYPE),
      clusterList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(_const__WEBPACK_IMPORTED_MODULE_22__.CLUSTERS),
      accCardTypeList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(_const__WEBPACK_IMPORTED_MODULE_22__.ACC_CARD_TYPE),
      statusList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(_const__WEBPACK_IMPORTED_MODULE_22__.SPECIFICATION_STATUS),
      sceneTypeList: [{
        k: 'public',
        v: this.$t('resourcesManagement.public')
      }, {
        k: 'exclusive',
        v: this.$t('resourcesManagement.exclusive')
      }],
      isSpecExclusiveList: [{
        k: 'public',
        v: this.$t('resourcesManagement.commonUseSpec')
      }, {
        k: 'exclusive',
        v: this.$t('resourcesManagement.exclusiveSpec')
      }],
      resourceList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(_const__WEBPACK_IMPORTED_MODULE_22__.COMPUTER_RESOURCES),
      networkTypeList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(_const__WEBPACK_IMPORTED_MODULE_22__.NETWORK_TYPE_VALUE),
      specsList: []
    };
  },
  watch: {
  ...
  methods: {
    resetDataInfo: function resetDataInfo() {
      this.dataInfo = {
        SceneName: '',
        JobType: '',
        SceneType: '',
    ...
    getResSpecificationList: function getResSpecificationList() {
      var _this = this;
      ...
      return (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.getResSpecificationListAll)(params).then(function (res) {
        res = res.data;
        ...
        if (res.Code === 0) {
          ...
          var data = list.map(function (item) {
            var NGPU = "".concat(item.ComputeResource, ":").concat(item.AccCardsNum + '*' + (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this.accCardTypeList, item.AccCardType));
            var statusStr = item.Status != '2' ? "<span style=\"color:rgb(245, 34, 45)\">(".concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this.statusList, item.Status.toString()), ")</span>") : '';
            var queueName = item.QueueName ? "\u3010".concat(item.QueueName, "\u3011") : '';
            var queueType = item.QueueType ? "\u3010".concat(item.QueueType, "\u3011") : '';
            return _objectSpread(_objectSpread({}, item), {}, {
              StatusStr: statusStr,
              QueueStr: "".concat(item.QueueCode).concat(queueName).concat(queueType, "(").concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this.clusterList, item.Cluster), " - ").concat(item.AiCenterName, ")"),
              QueueIsExclusiveStr: item.IsQueueExclusive ? "<span style=\"color:rgb(245, 34, 45);font-weight:bold\">(".concat(_this.$t('resourcesManagement.exclusiveTxt'), ")</span>") : '',
              SpecStr: "".concat(NGPU, "(").concat(_this.$t('resourcesManagement.gpuMem'), ":").concat(item.GPUMemGiB, "GB), CPU:").concat(item.CpuCores, ", ").concat(_this.$t('resourcesManagement.mem'), ":").concat(item.MemGiB, "GB, ").concat(_this.$t('resourcesManagement.shareMem'), ":").concat(item.ShareMemGiB, "GB"),
              PriceStr: ", ".concat(_this.$t('resourcesManagement.unitPrice'), ":").concat(item.UnitPrice.toFixed(2)).concat(_this.$t('resourcesManagement.point_hr')),
              NetworkTypeStr: ", ".concat(_this.$t('cloudbrainObj.networkType'), ":").concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this.networkTypeList, item.HasInternet)),
              VisualizationStr: ", ".concat(_this.$t('cloudbrainObj.visualization'), ":").concat(item.EnableVisualization ? _this.$t('resourcesManagement.enable') : _this.$t('resourcesManagement.notEnable'))
            });
          });

          (_this$specsList = _this.specsList).splice.apply(_this$specsList, [0, Infinity].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(data)));
        }
      })["catch"](function (err) {
        console.log(err);
      });
    },
    changeSceneType: function changeSceneType() {
      this.dataInfo.IsSpecExclusive = '';
      this.changeIsSpecExclusive();
    },
    changeIsSpecExclusive: function changeIsSpecExclusive() {
      this.dataInfo.ExclusiveOrg = '';
    },
    changeCluster: function changeCluster() {
      this.dataInfo.SpecIds = [];
      this.specsList.splice(0, Infinity);
      this.getResSpecificationList();
    },
    changeResource: function changeResource() {
      this.dataInfo.SpecIds = [];
      this.specsList.splice(0, Infinity);
      this.getResSpecificationList();
    },
    open: function open() {
      ...
      if (this.type === 'add') {//
        ...
        Object.assign(this.dataInfo, {
          ...
          SpecIds: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_18___default()(this.data.SpecIds)
        });
      }
    ...
    confirm: function confirm() {
      ...
      if (!this.dataInfo.SceneName || !this.dataInfo.JobType || !this.dataInfo.SceneType || !this.dataInfo.SpecIds.length || this.dataInfo.IsSpecExclusive === 'exclusive' && !this.dataInfo.ExclusiveOrg || this.dataInfo.SceneType === 'exclusive' && !this.dataInfo.ExclusiveOrg) {
        this.$message({
          type: 'info',
      ...
      var setApi = this.type === 'add' ? _apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.addResScene : _apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.updateResScene;
      setApi(_objectSpread(_objectSpread({}, this.dataInfo), {}, {
        ...
        if (res.Code === 0) {
          ...
          _this2.$message({
            type: 'error',
            message: _this2.$t('submittedFailed')
          });
        }
      })["catch"](function (err) {
        console.log(err);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=script&lang=js":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_BaseDialog_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ~/components/BaseDialog.vue */ "./web_src/vuepages/components/BaseDialog.vue");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    BaseDialog: _components_BaseDialog_vue__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  data: function data() {
    return {
      dlgShow: false,
      tabIndex: '1',
      selectList: [],
      statusList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13___default()(_const__WEBPACK_IMPORTED_MODULE_15__.SPECIFICATION_STATUS)
    };
  },
  watch: {
    visible: function visible(val) {
    ...
    value: {
      ...
      handler: function handler(newVal) {
        ...
        this.selectList = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13___default()(newVal);
      }
    }
  },
  computed: {
    tableData1: function tableData1() {
      var map = {};

      for (var i = 0, iLen = this.specs.length; i < iLen; i++) {
        var spec = this.specs[i];
        var key = "".concat(spec.Cluster, "|").concat(spec.ComputeResource, "|").concat(spec.SourceSpecId || Math.random());

        var queue = _objectSpread(_objectSpread({}, spec), {}, {
        ...
        if (map[key]) {
          ...
          map[key] = _objectSpread(_objectSpread({}, spec), {}, {
            queues: [queue]
          });
        }
      }
    ...
    tableData2: function tableData2() {
      var map = {};

      for (var i = 0, iLen = this.specs.length; i < iLen; i++) {
        var spec = this.specs[i];
        var key = "".concat(spec.Cluster, "|").concat(spec.ComputeResource, "|").concat(spec.QueueId);

        var _spec = _objectSpread(_objectSpread({}, spec), {}, {
          QueueId: spec.QueueId,
          QueueCode: spec.QueueCode,
          AiCenterCode: spec.AiCenterCode,
          AiCenterName: spec.AiCenterName,
    ...
    tableDataShow: function tableDataShow() {
      var map = {};
  ...
  methods: {
    ...
    selectAll: function selectAll(list) {
      var _this = this;

      list.forEach(function (_item) {
        if (_this.selectList.indexOf(_item.ID) < 0) {
          _this.selectList.push(_item.ID);
        }
      });
    },
    clearSelectAll: function clearSelectAll(list) {
      var _this2 = this;

      list.forEach(function (_item) {
        var index = _this2.selectList.indexOf(_item.ID);

        if (index >= 0) {
          _this2.selectList.splice(index, 1);
        }
      });
    },
    open: function open() {
      this.$emit("open");
      this.selectList = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_13___default()(this.value);
      this.tabIndex = '1';
    },
    opened: function opened() {
      this.$emit("opened");
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_SceneDialog_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../components/SceneDialog.vue */ "./web_src/vuepages/pages/resources/components/SceneDialog.vue");
/* harmony import */ var _apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ~/apis/modules/resources */ "./web_src/vuepages/apis/modules/resources.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      taskTypeList: [{
        k: '',
        v: this.$t('resourcesManagement.allJobType')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.JOB_TYPE)),
      selIsSpecExclusive: '',
      IsSpecExclusiveList: [{
        k: '',
        v: this.$t('resourcesManagement.allExclusiveAndCommonUseSpec')
      }, {
        k: 'exclusive',
        v: this.$t('resourcesManagement.exclusiveSpec')
      }, {
      ...
      sceneTypeList: [{
        k: '',
        v: this.$t('resourcesManagement.allSceneType')
      }, {
        k: 'public',
        v: this.$t('resourcesManagement.public')
      }, {
      ...
      clusterList: [{
        k: '',
        v: this.$t('resourcesManagement.allCluster')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.CLUSTERS)),
      selAiCenter: '',
      aiCenterList: [{
        k: '',
        v: this.$t('resourcesManagement.allAiCenter')
      }],
      accCardTypeList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.ACC_CARD_TYPE),
      statusList: [{
        k: '',
        v: this.$t('resourcesManagement.allStatus')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.SPECIFICATION_STATUS)),
      selResource: '',
      resourceList: [{
        k: '',
        v: this.$t('resourcesManagement.allComputeResource')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.COMPUTER_RESOURCES)),
      selCardType: '',
      cardTypeList: [{
        k: '',
        v: this.$t('resourcesManagement.allAccCardType')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.ACC_CARD_TYPE)),
      selNetworkType: 0,
      networkTypeList: [{
        k: 0,
        v: this.$t('resourcesManagement.allNetworkType')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(_const__WEBPACK_IMPORTED_MODULE_22__.NETWORK_TYPE)),
      selIsEnableVisualization: 0,
      IsEnableVisualizationList: [{
        k: 0,
        v: this.$t('resourcesManagement.allIsEnableVisualization')
      }, {
        k: 1,
        v: this.$t('resourcesManagement.notEnable')
      }, {
        k: 2,
        v: this.$t('resourcesManagement.enable')
      }],
      loading: false,
      tableData: [],
      pageInfo: {
  ...
  components: {
    SceneDialog: _components_SceneDialog_vue__WEBPACK_IMPORTED_MODULE_20__["default"]
  },
  methods: {
    ...
    getAiCenterList: function getAiCenterList() {
      ...
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.getAiCenterList)().then(function (res) {
        res = res.data;

        if (res.Code === 0) {
          var _this$aiCenterList;
          ...
          (_this$aiCenterList = _this.aiCenterList).splice.apply(_this$aiCenterList, [1, Infinity].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_19___default()(data)));
        }
      })["catch"](function (err) {
        console.log(err);
      });
    ...
    getQueueList: function getQueueList() {
      ...
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.getResQueueCode)().then(function (res) {
        res = res.data;

        if (res.Code === 0) {
          var _this2$queueList;
          ...
          for (var i = 0, iLen = data.length; i < iLen; i++) {
            ...
            list.push({
              k: item.ID,
              v: "".concat(item.QueueCode).concat(queueName).concat(queueType, "(").concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this2.clusterList, item.Cluster), " - ").concat(item.AiCenterName, ") ").concat(item.ComputeResource, "(").concat(item.AccCardType, ")")
            });
          }

          (_this2$queueList = _this2.queueList).push.apply(_this2$queueList, list);
        }
      })["catch"](function (err) {
        console.log(err);
      });
    ...
    getTableData: function getTableData() {
      ...
      this.loading = true;
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.getResSceneList)(params).then(function (res) {
        ...
        if (res.Code === 0) {
          ...
          for (var i = 0, iLen = list.length; i < iLen; i++) {
            ...
            for (var j = 0, jLen = specs.length; j < jLen; j++) {
              var spec = specs[j];
              var NGPU = "".concat(spec.ComputeResource, ":").concat(spec.AccCardsNum + '*' + (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.accCardTypeList, spec.AccCardType));
              var statusStr = spec.Status != '2' ? "<span style=\"color:rgb(245, 34, 45)\">(".concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.statusList, spec.Status.toString()), ")</span>") : '';
              spec.specStr = "".concat(NGPU, "(").concat(_this3.$t('resourcesManagement.gpuMem'), ":").concat(spec.GPUMemGiB, "GB), CPU:").concat(spec.CpuCores, ", ").concat(_this3.$t('resourcesManagement.mem'), ":").concat(spec.MemGiB, "GB, ").concat(_this3.$t('resourcesManagement.shareMem'), ":").concat(spec.ShareMemGiB, "GB");
              spec.JobTypeStr = (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.taskTypeList, item.JobType);
              spec.SceneTypeStr = (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.sceneTypeList.slice(1, Infinity), item.SceneType);
              spec.IsSpecExclusiveStr = item.SceneType == 'exclusive' ? '--' : (0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.IsSpecExclusiveList.slice(1, Infinity), item.IsSpecExclusive);
              spec.statusStr = statusStr;
              spec.priceStr = ", ".concat(_this3.$t('resourcesManagement.unitPrice'), ":").concat(spec.UnitPrice.toFixed(2)).concat(_this3.$t('resourcesManagement.point_hr'));
              spec.networkTypeStr = ", ".concat(_this3.$t('cloudbrainObj.networkType'), ":").concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_22__.NETWORK_TYPE_VALUE, spec.HasInternet));
              spec.visualizationStr = ", ".concat(_this3.$t('cloudbrainObj.visualization'), ":").concat(spec.EnableVisualization ? _this3.$t('resourcesManagement.enable') : _this3.$t('resourcesManagement.notEnable'));
              spec._id_ = item.ID;
              var sourceSpecId = spec.SourceSpecId;

              if (sourceSpecIdMap[sourceSpecId]) {
                sourceSpecIdMap[sourceSpecId].push(_objectSpread({}, spec));
              } else {
                sourceSpecIdMap[sourceSpecId] = [_objectSpread(_objectSpread({}, item), spec)];
              }
            }

            for (var key in sourceSpecIdMap) {
              var _specs = sourceSpecIdMap[key];

              if (key) {
                var aiCenters = [];
                var queues = [];

                for (var k = 0, kLen = _specs.length; k < kLen; k++) {
                  var _spec = _specs[k];
                  var queueName = _spec.QueueName ? "\u3010".concat(_spec.QueueName, "\u3011") : '';
                  var queueType = _spec.QueueType ? "\u3010".concat(_spec.QueueType, "\u3011") : '';
                  queues.push({
                    ...
                    QueueStr: "".concat(_spec.QueueCode).concat(queueName).concat(queueType, "(").concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.clusterList, _spec.Cluster), " - ").concat(_spec.AiCenterName, ")"),
                ...
                data.push(_objectSpread(_objectSpread({}, _specs[0]), {}, {
                  aiCenters: aiCenters,
                  queues: queues
                }));
              } else {
                for (var _k = 0, _kLen = _specs.length; _k < _kLen; _k++) {
                  var _spec2 = _specs[_k];

                  var _queueName = _spec2.QueueName ? "\u3010".concat(_spec2.QueueName, "\u3011") : '';

                  var _queueType = _spec2.QueueType ? "\u3010".concat(_spec2.QueueType, "\u3011") : '';

                  data.push(_objectSpread(_objectSpread({}, _spec2), {}, {
                    queues: [{
                      QueueId: _spec2.QueueId,
                      QueueCode: _spec2.QueueCode,
                      QueueName: _spec2.QueueName,
                      QueueType: _spec2.QueueType,
                      AiCenterCode: _spec2.AiCenterCode,
                      AiCenterName: _spec2.AiCenterName,
                      QueueStr: "".concat(_spec2.QueueCode).concat(_queueName).concat(_queueType, "(").concat((0,_utils__WEBPACK_IMPORTED_MODULE_23__.getListValueWithKey)(_this3.clusterList, _spec2.Cluster), " - ").concat(_spec2.AiCenterName, ")"),
                      statusStr: _spec2.statusStr,
                      priceStr: _spec2.priceStr,
                      networkTypeStr: _spec2.networkTypeStr,
                      visualizationStr: _spec2.visualizationStr,
                      key: Math.random()
                    }]
                  }));
                }
          ...
          for (var _i = 0, _iLen = data.length; _i < _iLen; _i++) {
            ...
            if (data[_i]._id_ == data[_i - 1]._id_) {
              data[_i].rowspan = 0;
              rowspan++;
          ...
          _this3.pageInfo.total = res.Data.TotalSize;
        }
      })["catch"](function (err) {
        console.log(err);
        _this3.loading = false;
    ...
    deleteRow: function deleteRow(row) {
      ...
      this.$confirm(this.$t('resourcesManagement.resSceneDeleteConfirm'), this.$t('tips'), {
        ...
        (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_21__.updateResScene)({
          action: 'delete',
          ID: row._id_
        }).then(function (res) {
          res = res.data;
          ...
          if (res.Code === 0) {
            _this4.$message({
              type: 'success',
              message: _this4.$t('submittedSuccessfully')
            });
    ...
    showDialog: function showDialog(type, data) {
      ...
      this.sceneDialogData = data ? {
        ...
        SpecIds: data.Specs.map(function (item) {
          return item.ID;
        })
      } : {};
      this.sceneDialogShow = true;
    },
    sceneDialogConfirm: function sceneDialogConfirm() {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/resources/scene/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _SceneDialog_vue_vue_type_template_id_2c04a86d_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true */ "./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true");
/* harmony import */ var _SceneDialog_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SceneDialog.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=script&lang=js");
/* harmony import */ var _SceneDialog_vue_vue_type_style_index_0_id_2c04a86d_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less */ "./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _SceneDialog_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _SceneDialog_vue_vue_type_template_id_2c04a86d_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _SceneDialog_vue_vue_type_template_id_2c04a86d_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "2c04a86d",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/resources/components/SceneDialog.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _SpecSelect_vue_vue_type_template_id_0266aea4_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true */ "./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true");
/* harmony import */ var _SpecSelect_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SpecSelect.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=script&lang=js");
/* harmony import */ var _SpecSelect_vue_vue_type_style_index_0_id_0266aea4_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less */ "./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _SpecSelect_vue_vue_type_template_id_0266aea4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _SpecSelect_vue_vue_type_template_id_0266aea4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "0266aea4",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/resources/components/SpecSelect.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_1ce05ced_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=1ce05ced&scoped=true */ "./web_src/vuepages/pages/resources/scene/index.vue?vue&type=template&id=1ce05ced&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/resources/scene/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_1ce05ced_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less */ "./web_src/vuepages/pages/resources/scene/index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_1ce05ced_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_1ce05ced_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "1ce05ced",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/resources/scene/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=script&lang=js":
/*!*********************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SceneDialog_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SceneDialog.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SceneDialog_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=script&lang=js":
/*!********************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=script&lang=js ***!
  \********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/resources/scene/index.vue?vue&type=script&lang=js":
/*!**********************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/scene/index.vue?vue&type=script&lang=js ***!
  \**********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less":
/*!******************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less ***!
  \******************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_SceneDialog_vue_vue_type_style_index_0_id_2c04a86d_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=style&index=0&id=2c04a86d&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less":
/*!*****************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less ***!
  \*****************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_SpecSelect_vue_vue_type_style_index_0_id_0266aea4_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=style&index=0&id=0266aea4&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/resources/scene/index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less":
/*!*******************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/scene/index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less ***!
  \*******************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1ce05ced_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=style&index=0&id=1ce05ced&scoped=true&lang=less");
...
/***/ "./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true":
/*!***************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true ***!
  \***************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SceneDialog_vue_vue_type_template_id_2c04a86d_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SceneDialog_vue_vue_type_template_id_2c04a86d_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SceneDialog_vue_vue_type_template_id_2c04a86d_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true":
/*!**************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true ***!
  \**************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SpecSelect_vue_vue_type_template_id_0266aea4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SpecSelect_vue_vue_type_template_id_0266aea4_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SpecSelect_vue_vue_type_template_id_0266aea4_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/resources/scene/index.vue?vue&type=template&id=1ce05ced&scoped=true":
/*!****************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/resources/scene/index.vue?vue&type=template&id=1ce05ced&scoped=true ***!
  \****************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1ce05ced_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1ce05ced_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1ce05ced_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=1ce05ced&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=template&id=1ce05ced&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SceneDialog.vue?vue&type=template&id=2c04a86d&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _c(
        "BaseDialog",
        {
          attrs: {
            ...
            title:
              _vm.type === "add"
                ? _vm.$t("resourcesManagement.addResScene")
                : _vm.$t("resourcesManagement.editResScene")
          },
          on: {
            "update:visible": function($event) {
              _vm.dialogShow = $event
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title required" }, [
                    _c("span", [
                      _vm._v(_vm._s(_vm.$t("resourcesManagement.resSceneName")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c("el-input", {
                        attrs: { placeholder: "", maxlength: "255" },
                        model: {
                          value: _vm.dataInfo.SceneName,
                          callback: function($$v) {
                            _vm.$set(_vm.dataInfo, "SceneName", $$v)
                          },
                          expression: "dataInfo.SceneName"
                        }
                      })
                    ],
                    1
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title required" }, [
                    _c("span", [
                      _vm._v(_vm._s(_vm.$t("resourcesManagement.jobType")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c(
                        "el-select",
                        {
                          ...
                          model: {
                            value: _vm.dataInfo.JobType,
                            callback: function($$v) {
                              _vm.$set(_vm.dataInfo, "JobType", $$v)
                            },
                            expression: "dataInfo.JobType"
                          }
                        },
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title required" }, [
                    _c("span", [
                      _vm._v(_vm._s(_vm.$t("resourcesManagement.sceneType")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c(
                        "el-select",
                        {
                          on: { change: _vm.changeSceneType },
                          model: {
                            value: _vm.dataInfo.SceneType,
                            callback: function($$v) {
                              _vm.$set(_vm.dataInfo, "SceneType", $$v)
                            },
                            expression: "dataInfo.SceneType"
                          }
                        },
                ...
                _vm._v(" "),
                _vm.dataInfo.SceneType == "public"
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title required" }, [
                        _c("span", [
                          _vm._v(
                            _vm._s(
                              _vm.$t("resourcesManagement.isExclusiveSpec")
                            )
                          )
                        ])
                      ]),
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "el-select",
                            {
                              on: { change: _vm.changeIsSpecExclusive },
                              model: {
                                value: _vm.dataInfo.IsSpecExclusive,
                                callback: function($$v) {
                                  _vm.$set(_vm.dataInfo, "IsSpecExclusive", $$v)
                                },
                                expression: "dataInfo.IsSpecExclusive"
                              }
                            },
                            _vm._l(_vm.isSpecExclusiveList, function(item) {
                              return _c("el-option", {
                                key: item.k,
                                attrs: { label: item.v, value: item.k }
                              })
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm.dataInfo.IsSpecExclusive === "exclusive" ||
                _vm.dataInfo.SceneType == "exclusive"
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title required" }, [
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.$t("resourcesManagement.exclusiveOrg"))
                          )
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c("el-input", {
                            attrs: {
                              placeholder: _vm.$t(
                                "resourcesManagement.exclusiveOrgTips"
                              ),
                              maxlength: "255"
                            },
                            model: {
                              value: _vm.dataInfo.ExclusiveOrg,
                              callback: function($$v) {
                                _vm.$set(_vm.dataInfo, "ExclusiveOrg", $$v)
                              },
                              expression: "dataInfo.ExclusiveOrg"
                            }
                          })
                        ],
                        1
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title required" }, [
                    _c("span", [
                      _vm._v(
                        _vm._s(_vm.$t("resourcesManagement.computeCluster"))
                      )
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          attrs: { disabled: _vm.type === "edit" },
                          on: { change: _vm.changeCluster },
                          model: {
                            value: _vm.dataInfo.Cluster,
                            callback: function($$v) {
                              _vm.$set(_vm.dataInfo, "Cluster", $$v)
                            },
                            expression: "dataInfo.Cluster"
                          }
                        },
                        _vm._l(_vm.clusterList, function(item) {
                          return _c("el-option", {
                            key: item.k,
                            attrs: { label: item.v, value: item.k }
                          })
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          attrs: { disabled: _vm.type === "edit" },
                          on: { change: _vm.changeResource },
                          model: {
                            value: _vm.dataInfo.Resource,
                            callback: function($$v) {
                              _vm.$set(_vm.dataInfo, "Resource", $$v)
                            },
                            expression: "dataInfo.Resource"
                          }
                        },
                ...
                _vm._v(" "),
                _c("SpecSelect", {
                  attrs: { specs: _vm.specsList },
                  model: {
                    value: _vm.dataInfo.SpecIds,
                    callback: function($$v) {
                      _vm.$set(_vm.dataInfo, "SpecIds", $$v)
                    },
                    expression: "dataInfo.SpecIds"
                  }
                }),
                _vm._v(" "),
                _c(
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true":
/*!*****************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/components/SpecSelect.vue?vue&type=template&id=0266aea4&scoped=true ***!
  \*****************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "form-row" }, [
      _c("div", { staticClass: "title required" }, [
        _c("span", [
          _vm._v(_vm._s(_vm.$t("resourcesManagement.resourceSpecification")))
        ])
      ]),
      _vm._v(" "),
      ...
      _c("div", { staticClass: "select-btn" }, [
        _c(
          ...
          [_vm._v(_vm._s(_vm.$t("resourcesManagement.selectSpec")))]
        )
      ]),
      _vm._v(" "),
      _c(
          ...
          _c(
            "BaseDialog",
            {
              attrs: {
                visible: _vm.dlgShow,
                width: "1200px",
                title: _vm.$t("resourcesManagement.selectSpec"),
                appendToBody: true
              },
              on: {
                "update:visible": function($event) {
                ...
                _c("div", { staticClass: "left-area" }, [
                  _c("div", { staticClass: "tabs" }, [
                    _c(
                      ...
                      [
                        _vm._v(
                          _vm._s(_vm.$t("resourcesManagement.accordingSpec"))
                        )
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        _vm._v(
                          _vm._s(_vm.$t("resourcesManagement.accordingQueue"))
                        )
                      ]
                    )
                  ]),
                            ...
                            _c("div", { staticClass: "header row" }, [
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.$t("resourcesManagement.resQueue")
                                    )
                                  )
                                ]
                              )
                                ...
                                return _c(
                                  ...
                                  [
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._l(item.queues, function(_item) {
                                          return _c(
                                            "div",
                                            {
                                              key: _item.ID,
                                                  ...
                                                  _c("span", {
                                                    domProps: {
                                                      innerHTML: _vm._s(
                                                        _item.QueueStr +
                                                          _item.PriceStr +
                                                          _item.NetworkTypeStr +
                                                          _item.VisualizationStr +
                                                          _item.StatusStr +
                                                          _item.QueueIsExclusiveStr
                                                      )
                                                    }
                                                  })
                                                ]
                      ...
                      ? _c("div", [
                          _c("div", { staticClass: "header row" }, [
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(_vm.$t("resourcesManagement.resQueue"))
                                )
                              ]
                            ),
                            _vm._v(" "),
                              ...
                              return _c(
                                ...
                                [
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm._l(item.specs, function(_item) {
                                        return _c(
                                          "div",
                                          {
                                            key: _item.ID,
                                      ...
                                      _c("div", { staticClass: "btn-c" }, [
                                        _c(
                                          "button",
                                          {
                                            on: {
                                              click: function($event) {
                                                return _vm.selectAll(item.specs)
                                              }
                                            }
                                          },
                                        ...
                                        _c(
                                          ...
                                          [_vm._v(_vm._s(_vm.$t("selectNone")))]
                                        )
                                      ])
                                    ],
                                    2
      ...
      _c("div", { staticClass: "table-c" }, [
        _c("div", [
          _c("div", { staticClass: "header row" }, [
            _c(
              "div",
              { staticClass: "row-l", staticStyle: { width: "400px" } },
              [
                _vm._v(
                  _vm._s(_vm.$t("resourcesManagement.resourceSpecification"))
                )
              ]
            ),
            _vm._v(" "),
            _c("div", { staticClass: "row-r", staticStyle: { flex: "1" } }, [
              _vm._v(_vm._s(_vm.$t("resourcesManagement.resQueue")))
            ])
          ]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "table-content" },
            _vm._l(_vm.tableDataShow, function(item, index) {
              return _c("div", { key: index, staticClass: "row" }, [
                ...
                _c(
                  "div",
                  { staticClass: "row-r", staticStyle: { flex: "1" } },
                  _vm._l(item.queues, function(_item, _index) {
                    return _c("div", { key: _index }, [
                      _c("span", {
                        domProps: {
                          innerHTML: _vm._s(
                            _item.QueueStr +
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=template&id=1ce05ced&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/resources/scene/index.vue?vue&type=template&id=1ce05ced&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "title" }, [
        _c("span", [
          _vm._v(_vm._s(_vm.$t("resourcesManagement.resSceneManagement")))
        ])
      ]),
      _vm._v(" "),
          ...
          [
            _c(
              "el-select",
              {
                ...
                model: {
                  value: _vm.selTaskType,
                  callback: function($$v) {
                    _vm.selTaskType = $$v
                  },
                  expression: "selTaskType"
                }
              },
              _vm._l(_vm.taskTypeList, function(item) {
                return _c("el-option", {
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selSceneType,
                  callback: function($$v) {
                    _vm.selSceneType = $$v
                  },
                  expression: "selSceneType"
                }
              },
              _vm._l(_vm.sceneTypeList, function(item) {
                return _c("el-option", {
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selIsSpecExclusive,
                  callback: function($$v) {
                    _vm.selIsSpecExclusive = $$v
                  },
                  expression: "selIsSpecExclusive"
                }
              },
              _vm._l(_vm.IsSpecExclusiveList, function(item) {
                return _c("el-option", {
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selCluster,
                  callback: function($$v) {
                    _vm.selCluster = $$v
                  },
                  expression: "selCluster"
                }
              },
              _vm._l(_vm.clusterList, function(item) {
                return _c("el-option", {
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selAiCenter,
                  callback: function($$v) {
                    _vm.selAiCenter = $$v
                  },
                  expression: "selAiCenter"
                }
              },
            ...
            _c(
              ...
              _vm._l(_vm.queueList, function(item) {
                return _c("el-option", {
                  key: item.k,
                  attrs: { label: item.v, value: item.k }
                })
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selResource,
                  callback: function($$v) {
                    _vm.selResource = $$v
                  },
                  expression: "selResource"
                }
              },
              _vm._l(_vm.resourceList, function(item) {
                return _c("el-option", {
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selCardType,
                  callback: function($$v) {
                    _vm.selCardType = $$v
                  },
                  expression: "selCardType"
                }
              },
              _vm._l(_vm.cardTypeList, function(item) {
                return _c("el-option", {
                  key: item.k,
                  attrs: { label: item.v, value: item.k }
                })
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selNetworkType,
                  callback: function($$v) {
                    _vm.selNetworkType = $$v
                  },
                  expression: "selNetworkType"
                }
              },
              _vm._l(_vm.networkTypeList, function(item) {
                return _c("el-option", {
                  key: item.k,
                  attrs: { label: item.v, value: item.k }
                })
            ...
            _c(
              "el-select",
              {
                ...
                on: { change: _vm.selectChange },
                model: {
                  value: _vm.selIsEnableVisualization,
                  callback: function($$v) {
                    _vm.selIsEnableVisualization = $$v
                  },
                  expression: "selIsEnableVisualization"
                }
              },
              _vm._l(_vm.IsEnableVisualizationList, function(item) {
                return _c("el-option", {
                  key: item.k,
                  attrs: { label: item.v, value: item.k }
                })
          ...
          [
            _c(
              ...
              [
                _vm._v(
                  "\n        " +
                    _vm._s(_vm.$t("resourcesManagement.addResSceneBtn"))
                )
              ]
            )
          ],
            ...
            _c(
              ...
              [
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "SceneName",
                    label: _vm.$t("resourcesManagement.resSceneName"),
                    align: "center",
                    "header-align": "center"
                  }
                }),
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "JobTypeStr",
                    label: _vm.$t("resourcesManagement.jobType"),
                    align: "center",
                    "header-align": "center",
                    width: "120"
                  }
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "SceneTypeStr",
                    label: _vm.$t("resourcesManagement.sceneType"),
                    align: "center",
                    "header-align": "center",
                    width: "120"
                  },
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "IsSpecExclusiveStr",
                    label: _vm.$t("resourcesManagement.isExclusiveSpec"),
                    align: "center",
                    "header-align": "center",
                    width: "120"
                  },
                        ...
                        return [
                          _c(
                            "span",
                            {
                              style: {
                                color:
                                  scope.row.IsSpecExclusive == "exclusive"
                                    ? "red"
                                    : ""
                              }
                            },
                            [
                              _vm._v(
                                "\n              " +
                                  _vm._s(scope.row.IsSpecExclusiveStr) +
                                  "\n            "
                              )
                            ]
                          )
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "ExclusiveOrg",
                    label: _vm.$t("resourcesManagement.exclusiveOrg"),
                    align: "center",
                    "header-align": "center"
                  },
                  scopedSlots: _vm._u([
                  ...
                  scopedSlots: _vm._u([
                    {
                      ...
                      fn: function(scope) {
                        return [
                          _c("span", {
                            domProps: { innerHTML: _vm._s(scope.row.specStr) }
                          })
                        ]
                      }
                    }
                  ...
                  scopedSlots: _vm._u([
                    {
                      ...
                      fn: function(scope) {
                        return [
                          !scope.row.queues.length
                            ? _c("div", [_vm._v("--")])
                            : _vm._e(),
                          _vm._v(" "),
                          _vm._l(scope.row.queues, function(item) {
                            return _c("div", { key: item.key }, [
                              _c("span", [_vm._v(_vm._s(item.AiCenterName))])
                            ])
                          })
                        ]
                      }
                ...
                _c("template", { slot: "empty" }, [
                  _c("span", { staticStyle: { "font-size": "12px" } }, [
                    _vm._v(
                      _vm._s(_vm.loading ? _vm.$t("loading") : _vm.$t("noData"))
                    )
                  ])
                ])
              ],
      ...
      _c("SceneDialog", {
        attrs: {
          visible: _vm.sceneDialogShow,
          type: _vm.sceneDialogType,
          data: _vm.sceneDialogData
        },
        on: {
          "update:visible": function($event) {
            _vm.sceneDialogShow = $event
          },
          confirm: _vm.sceneDialogConfirm
        }
      })
    ],
    1
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/resources/scene/vp-resources-scene.js"); })
