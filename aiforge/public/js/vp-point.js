...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _apis_modules_point__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ~/apis/modules/point */ "./web_src/vuepages/apis/modules/point.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils */ "./web_src/vuepages/pages/reward/point/utils.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getSummaryInfo: function getSummaryInfo() {
      ...
      (0,_apis_modules_point__WEBPACK_IMPORTED_MODULE_5__.getPointAccount)().then(function (res) {
        if (res.data && res.data.Code === 0) {
          var data = res.data.Data;
          _this.summaryInfo.available = data.Balance;
          _this.summaryInfo.gain = data.TotalEarned;
          _this.summaryInfo.used = data.TotalConsumed;
        }
      })["catch"](function (err) {
        console.log(err);
      });
    ...
    getTableData: function getTableData() {
      ...
      this.loading = true;
      (0,_apis_modules_point__WEBPACK_IMPORTED_MODULE_5__.getPointList)({
        Operate: this.tabIndex === 0 ? 'INCREASE' : 'DECREASE',
        Page: this.pageInfo.curpage // pageSize: this.pageInfo.pageSize,
        ...
        if (res.data && res.data.Code === 0) {
          ...
          for (var i = 0, iLen = records.length; i < iLen; i++) {
            ...
            tableData.push((0,_utils__WEBPACK_IMPORTED_MODULE_6__.getRewardPointRecordInfo)(record));
          }

          (_this2$tableData = _this2.tableData).splice.apply(_this2$tableData, [0, Infinity].concat(tableData));

          _this2.pageInfo.total = data.Total;
        }
      })["catch"](function (err) {
        console.log(err);
        _this2.loading = false;

        _this2.tableData.splice(0, Infinity);
      });
    }
  },
  mounted: function mounted() {
    ...
    var _window$config = window.config,
        AppSubUrl = _window$config.AppSubUrl,
        AppVer = _window$config.AppVer,
        NotificationSettings = _window$config.NotificationSettings;

    if (NotificationSettings.EventSourceUpdateTime > 0 && !!window.EventSource && !!window.SharedWorker) {
      var _worker = new SharedWorker("".concat(AppSubUrl, "/static/eventsource.sharedworker.js?v=").concat(AppVer), 'notification-worker');

      _worker.port.postMessage({
        type: 'start',
        url: "".concat(window.location.origin).concat(AppSubUrl, "/user/events")
      });

      _worker.port.addEventListener('message', /*#__PURE__*/function () {
        var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(event) {
...
/* harmony export */   getPointAccount: function() { return /* binding */ getPointAccount; },
/* harmony export */   getPointList: function() { return /* binding */ getPointList; },
/* harmony export */   setPointOperate: function() { return /* binding */ setPointOperate; }
/* harmony export */ });
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../service */ "./web_src/vuepages/apis/service.js");
 // 算力积分概要

var getPointAccount = function getPointAccount() {
...
var getPointList = function getPointList(params) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
var setPointOperate = function setPointOperate(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getRewardPointRecordInfo: function() { return /* binding */ getRewardPointRecordInfo; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
...
var getSourceType = function getSourceType(key) {
  var find = _const__WEBPACK_IMPORTED_MODULE_7__.SOURCE_TYPE.filter(function (item) {
    return item.k === key;
  });
  return find.length ? find[0].v : key;
};

var getConsumeStatus = function getConsumeStatus(key) {
  var find = _const__WEBPACK_IMPORTED_MODULE_7__.CONSUME_STATUS.filter(function (item) {
    return item.k === key;
  });
  return find.length ? find[0].v : key;
};

var getPointAction = function getPointAction(key) {
  var find = _const__WEBPACK_IMPORTED_MODULE_7__.POINT_ACTIONS.filter(function (item) {
    return item.k === key;
  });
  return find.length ? find[0].v : key;
};

var getJobType = function getJobType(key) {
  var find = _const__WEBPACK_IMPORTED_MODULE_7__.JOB_TYPE.filter(function (item) {
    return item.k === key;
  });
  return find.length ? find[0].alias : key;
};

var jobLinkGenerators = {
  MODELEXPERIENCE: function MODELEXPERIENCE(id) {
    return "/modelbase/experience/detail/".concat(id);
  },
  FINETUNE: function FINETUNE(id) {
    return "/modelbase/nlp/sft/detail/".concat(id);
  },
  SDFINETUNE: function SDFINETUNE(id) {
    return "/modelbase/cv/sft/detail//".concat(id);
  },
  ComfyuiExperience: function ComfyuiExperience(id) {
    return "/modelbase/cv/comfyui/detail/".concat(id);
  },
  EVAL: function EVAL(id) {
    return "/modelbase/eval/evaluate/detail/".concat(id);
  },
  DEFAULT: function DEFAULT(id) {
    return "/cloudbrains/detail/".concat(id);
  }
};

var getJobTypeLink = function getJobTypeLink(record, type) {
  var _record$Action;

  var cloudbrain = type === 'INCREASE' ? (_record$Action = record.Action) === null || _record$Action === void 0 ? void 0 : _record$Action.Cloudbrain : record.Cloudbrain;
  console.log("cloudbrain", cloudbrain);
  var generateJobLink = jobLinkGenerators[cloudbrain === null || cloudbrain === void 0 ? void 0 : cloudbrain.JobType] || jobLinkGenerators.DEFAULT;
  return generateJobLink(cloudbrain === null || cloudbrain === void 0 ? void 0 : cloudbrain.ID);
};

var renderSpecStr = function renderSpecStr(spec, showPoint) {
  var ngpu = "".concat(spec.ComputeResource, ": ").concat(spec.AccCardsNum + '*' + (0,_utils__WEBPACK_IMPORTED_MODULE_9__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_7__.ACC_CARD_TYPE, spec.AccCardType));
  var gpuMemStr = spec.GPUMemGiB != 0 ? "(".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('resourcesManagement.gpuMem'), ": ").concat(spec.GPUMemGiB, "GB)") : '';
  var memStr = spec.MemGiB != 0 ? ", ".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('resourcesManagement.mem'), ": ").concat(spec.MemGiB, "GB") : '';
  var sharedMemStr = spec.ShareMemGiB != 0 ? ", ".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('resourcesManagement.shareMem'), ": ").concat(spec.ShareMemGiB, "GB") : '';
  var workServerNum = spec.workServerNumber;
  var workServerNumStr = showPoint && workServerNum != 1 && spec.UnitPrice != 0 ? '*' + workServerNum + _langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('resourcesManagement.node') : '';
  var pointStr = showPoint ? ", ".concat(spec.UnitPrice == 0 ? _langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('resourcesManagement.free') : spec.UnitPrice.toFixed(2) + _langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('resourcesManagement.point_hr') + workServerNumStr) : '';
  var specStr = "".concat(ngpu).concat(gpuMemStr, ", CPU: ").concat(spec.CpuCores).concat(memStr).concat(sharedMemStr).concat(pointStr);
  return specStr;
};

var getRewardPointRecordInfo = function getRewardPointRecordInfo(record) {
  var _record$Cloudbrain, _record$Cloudbrain2, _record$Cloudbrain3, _record$Action2, _record$Action2$Cloud, _record$Action3, _record$Action3$Cloud, _record$Action4, _record$Action4$Cloud, _record$Action5, _record$Action5$Cloud, _record$Action6, _record$Action6$Cloud, _record$Cloudbrain4, _record$Cloudbrain5, _record$Cloudbrain6, _record$Cloudbrain7, _record$Cloudbrain8, _record$Action8, _record$Action9, _record$Action10, _record$Action11, _record$Action11$Clou, _record$Action12, _record$Action12$Clou, _record$Action$Datase3, _record$Action$Datase4, _record$Action$Aimode, _record$Action$Aimode2, _record$Action$Aimode3, _record$Action$Aimode4;

  var out = {
    sn: record.SerialNo,
    date: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_6__.formatDate)(new Date(record.LastOperateDate * 1000), 'yyyy-MM-dd HH:mm:ss'),
    ...
    duration: (record === null || record === void 0 ? void 0 : (_record$Cloudbrain = record.Cloudbrain) === null || _record$Cloudbrain === void 0 ? void 0 : _record$Cloudbrain.Duration) || '--',
    taskName: (record === null || record === void 0 ? void 0 : (_record$Cloudbrain2 = record.Cloudbrain) === null || _record$Cloudbrain2 === void 0 ? void 0 : _record$Cloudbrain2.DisplayJobName) || '--',
    taskId: record === null || record === void 0 ? void 0 : (_record$Cloudbrain3 = record.Cloudbrain) === null || _record$Cloudbrain3 === void 0 ? void 0 : _record$Cloudbrain3.ID,
    action: (record === null || record === void 0 ? void 0 : record.SourceTemplateId) ? getPointAction(record.SourceTemplateId) : '--',
    remark: record.Remark,
    amount: record.Amount
  };

  if (((_record$Action2 = record.Action) === null || _record$Action2 === void 0 ? void 0 : (_record$Action2$Cloud = _record$Action2.Cloudbrain) === null || _record$Action2$Cloud === void 0 ? void 0 : _record$Action2$Cloud.JobType) === 'BRAINSCORE' || ((_record$Action3 = record.Action) === null || _record$Action3 === void 0 ? void 0 : (_record$Action3$Cloud = _record$Action3.Cloudbrain) === null || _record$Action3$Cloud === void 0 ? void 0 : _record$Action3$Cloud.JobType) === 'SNN4IMAGENET' || ((_record$Action4 = record.Action) === null || _record$Action4 === void 0 ? void 0 : (_record$Action4$Cloud = _record$Action4.Cloudbrain) === null || _record$Action4$Cloud === void 0 ? void 0 : _record$Action4$Cloud.JobType) === 'SNN4ECOSET' || ((_record$Action5 = record.Action) === null || _record$Action5 === void 0 ? void 0 : (_record$Action5$Cloud = _record$Action5.Cloudbrain) === null || _record$Action5$Cloud === void 0 ? void 0 : _record$Action5$Cloud.JobType) === 'SIM2BRAIN_SNN' || ((_record$Action6 = record.Action) === null || _record$Action6 === void 0 ? void 0 : (_record$Action6$Cloud = _record$Action6.Cloudbrain) === null || _record$Action6$Cloud === void 0 ? void 0 : _record$Action6$Cloud.JobType) === 'MODELSAFETY') {
    var _record$Action7, _record$Action7$Cloud;

    record.Action.Cloudbrain.oJobType = (_record$Action7 = record.Action) === null || _record$Action7 === void 0 ? void 0 : (_record$Action7$Cloud = _record$Action7.Cloudbrain) === null || _record$Action7$Cloud === void 0 ? void 0 : _record$Action7$Cloud.JobType;
    record.Action.Cloudbrain.JobType = 'BENCHMARK';
  }

  if ((record === null || record === void 0 ? void 0 : (_record$Cloudbrain4 = record.Cloudbrain) === null || _record$Cloudbrain4 === void 0 ? void 0 : _record$Cloudbrain4.JobType) === 'BRAINSCORE' || (record === null || record === void 0 ? void 0 : (_record$Cloudbrain5 = record.Cloudbrain) === null || _record$Cloudbrain5 === void 0 ? void 0 : _record$Cloudbrain5.JobType) === 'SNN4IMAGENET' || (record === null || record === void 0 ? void 0 : (_record$Cloudbrain6 = record.Cloudbrain) === null || _record$Cloudbrain6 === void 0 ? void 0 : _record$Cloudbrain6.JobType) === 'SNN4ECOSET' || (record === null || record === void 0 ? void 0 : (_record$Cloudbrain7 = record.Cloudbrain) === null || _record$Cloudbrain7 === void 0 ? void 0 : _record$Cloudbrain7.JobType) === 'SIM2BRAIN_SNN' || (record === null || record === void 0 ? void 0 : (_record$Cloudbrain8 = record.Cloudbrain) === null || _record$Cloudbrain8 === void 0 ? void 0 : _record$Cloudbrain8.JobType) === 'MODELSAFETY') {
    var _record$Cloudbrain9;

    record.Cloudbrain.oJobType = record === null || record === void 0 ? void 0 : (_record$Cloudbrain9 = record.Cloudbrain) === null || _record$Cloudbrain9 === void 0 ? void 0 : _record$Cloudbrain9.JobType;
  ...
  if (record.OperateType === 'INCREASE') {
    if (record.SourceType === 'ADMIN_OPERATE') {
      ...
      switch (record === null || record === void 0 ? void 0 : record.SourceTemplateId) {
        case 'CreatePublicRepo':
          // 创建公开项目 - 创建了项目OpenI/aiforge
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('createdRepository'), "<a href=\"").concat(record.Action.RepoLink, "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'CreateIssue':
          // 每日提出任务 - 创建了任务PCL-Platform.Intelligence/AISynergy#19
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('openedIssue'), "<a href=\"").concat(record.Action.RepoLink, "/issues/").concat(record.Action.IssueInfos[0], "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "#").concat(record.Action.IssueInfos[0], "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'CreatePullRequest':
          // 每日提出PR - 创建了合并请求OpenI/aiforge#1
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('createdPullRequest'), "<a href=\"").concat(record.Action.RepoLink, "/pulls/").concat(record.Action.IssueInfos[0], "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "#").concat(record.Action.IssueInfos[0], "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'CommentIssue':
          // 发表评论 - 评论了任务PCL-Platform.Intelligence/AISynergy#19
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('commentedOnIssue'), "<a href=\"").concat(record.Action.CommentLink, "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "#").concat(record.Action.IssueInfos[0], "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'UploadAttachment':
          // 上传数据集文件 - 上传了数据集文件MMISTData.zip
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('uploadDataset'), "<a href=\"").concat(record.Action.RepoLink, "/datasets\" rel=\"nofollow\">").concat((_record$Action8 = record.Action) === null || _record$Action8 === void 0 ? void 0 : _record$Action8.RefName, "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'CreateNewModelTask':
          // 导入新模型 - 导入了新模型resnet50_qx7l
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('createdNewModel'), "<a href=\"").concat(record.Action.RepoLink, "/modelmanage/model_readme_tmpl?name=").concat((_record$Action9 = record.Action) === null || _record$Action9 === void 0 ? void 0 : _record$Action9.RefName, "\" rel=\"nofollow\">").concat((_record$Action10 = record.Action) === null || _record$Action10 === void 0 ? void 0 : _record$Action10.RefName, "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'BindWechat':
          // 完成微信扫码验证 - 首次绑定微信奖励
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('firstBindingWechatRewards')) : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('userAccountWasDel'), ")");
          break;

        case 'CreateCloudbrainTask':
          // 每日运行云脑任务 - 创建了(CPU/GPU/NPU)类型(调试/训练/推理/评测)任务tangl202204131431995
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('created')).concat((_record$Action11 = record.Action) === null || _record$Action11 === void 0 ? void 0 : (_record$Action11$Clou = _record$Action11.Cloudbrain) === null || _record$Action11$Clou === void 0 ? void 0 : _record$Action11$Clou.ComputeResource).concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('type')).concat(getJobType((_record$Action12 = record.Action) === null || _record$Action12 === void 0 ? void 0 : (_record$Action12$Clou = _record$Action12.Cloudbrain) === null || _record$Action12$Clou === void 0 ? void 0 : _record$Action12$Clou.JobType), " <a href=\"").concat(getJobTypeLink(record, 'INCREASE'), "\" rel=\"nofollow\">").concat(record.Action.RefName, "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'DatasetRecommended':
          // 数据集被平台推荐 - 数据集XXX被设置为推荐数据集
          if (record.Action.Dataset) {
            var _record$Action$Datase, _record$Action$Datase2;

            out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('dataset'), "<a href=\"/datasets/detail/").concat(record.Action.Dataset.OwnerName, "/").concat(record.Action.Dataset.Name, "\" rel=\"nofollow\"> ").concat(((_record$Action$Datase = record.Action.Dataset) === null || _record$Action$Datase === void 0 ? void 0 : _record$Action$Datase.Alias) ? (_record$Action$Datase2 = record.Action.Dataset) === null || _record$Action$Datase2 === void 0 ? void 0 : _record$Action$Datase2.Alias : record.Action.Dataset.Name, " </a>").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('setAsRecommendedDataset')) : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
            break;
          } else {
            out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('dataset'), "<a href=\"javascript:void(0)\" rel=\"nofollow\">").concat(record.Action.Content && record.Action.Content.split('|')[1], "</a>").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('setAsRecommendedDataset')) : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
            break;
          }

        case 'TaskCreateDataset':
          // 创建数据集 - 创建了数据集xxxxx
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('dailyCreateDataset1'), " <a href=\"/datasets/detail/").concat(record.Action.Dataset.OwnerName, "/").concat(record.Action.Dataset.Name, "\" rel=\"nofollow\">").concat(((_record$Action$Datase3 = record.Action.Dataset) === null || _record$Action$Datase3 === void 0 ? void 0 : _record$Action$Datase3.Alias) ? (_record$Action$Datase4 = record.Action.Dataset) === null || _record$Action$Datase4 === void 0 ? void 0 : _record$Action$Datase4.Alias : record.Action.Dataset.Name, "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;
        //

        case 'TaskAimodelRecommended':
          // 模型被平台推荐 - 模型XXX被设置为推荐数据集
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repos.model'), "<a href=\"/models/detail/").concat(record.Action.Aimodel.OwnerName, "/").concat(record.Action.Aimodel.Name, "\" rel=\"nofollow\"> ").concat(((_record$Action$Aimode = record.Action.Aimodel) === null || _record$Action$Aimode === void 0 ? void 0 : _record$Action$Aimode.Alias) ? (_record$Action$Aimode2 = record.Action.Aimodel) === null || _record$Action$Aimode2 === void 0 ? void 0 : _record$Action$Aimode2.Alias : record.Action.Aimodel.Name, " </a>").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('setAsRecommendedAimodel')) : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'TaskCreateAimodel':
          // 创建模型 - 创建了模型xxxxx
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('dailyCreateAimodel1'), " <a href=\"/models/detail/").concat(record.Action.Aimodel.OwnerName, "/").concat(record.Action.Aimodel.Name, "\" rel=\"nofollow\">").concat(((_record$Action$Aimode3 = record.Action.Aimodel) === null || _record$Action$Aimode3 === void 0 ? void 0 : _record$Action$Aimode3.Alias) ? (_record$Action$Aimode4 = record.Action.Aimodel) === null || _record$Action$Aimode4 === void 0 ? void 0 : _record$Action$Aimode4.Alias : record.Action.Aimodel.Name, "</a>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          break;

        case 'CreateImage':
          // 提交新公开镜像 - 提交了镜像jiangxiang_ceshi_tang03
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('committedImage'), "<span style=\"font-weight:bold;\">").concat(record.Action.Content && record.Action.Content.split('|')[1], "</span>") : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('userAccountWasDel'), ")");
          break;

        case 'ImageRecommend':
          // 镜像被平台推荐 - 镜像XXX被设置为推荐镜像
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('image'), "<span style=\"font-weight:bold;\">").concat(record.Action.Content && record.Action.Content.split('|')[1], "</span>").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('setAsRecommendedImage')) : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('userAccountWasDel'), ")");
          break;

        case 'ChangeUserAvatar':
          // 首次更换头像 - 更新了头像
          out.remark = record.Action ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('updatedAvatar')) : "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('userAccountWasDel'), ")");
          break;

        case 'TaskInviteFriendRegister':
          // 邀请好友
          if (record.Action) {
            var _record$Action$Data;

            out.remark = record.Action.Data && record.Action.Data.InvitedUserNotExists == false ? "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('invitedFriend'), "<a href=\"/").concat(record.Action.Data.InvitedUserName, "\" rel=\"nofollow\">").concat(record.Action.Data.InvitedUserName, "</a>") : "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('invitedFriend')).concat((_record$Action$Data = record.Action.Data) === null || _record$Action$Data === void 0 ? void 0 : _record$Action$Data.InvitedUserName, "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('userAccountWasDel'), ")");
          } else {
            out.remark = "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('userAccountWasDel'), ")");
          }

          break;

        case 'PushCommits':
          // 每日commit - 推送了xxxx分支的代码到OpenI/aiforge
          if (record === null || record === void 0 ? void 0 : record.Action) {
            var opType = record.Action.OpType;

            if (opType == 5) {
              var words = record.Action.RefName.split('/');
              var branch = words[words.length - 1];
              out.remark = "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('pushedBranch', {
                branch: "<a href=\"".concat(record.Action.RepoLink, "/src/branch/").concat(branch, "\" rel=\"nofollow\">").concat(branch, "</a>")
              }), "<a href=\"").concat(record.Action.RepoLink, "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "</a>");
            } else if (opType == 9) {
              var _words = record.Action.RefName.split('/');

              var tag = _words[_words.length - 1];
              out.remark = "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('pushedTag', {
                tag: "<a href=\"".concat(record.Action.RepoLink, "/src/tag/").concat(tag, "\" rel=\"nofollow\">").concat(tag, "</a>")
              }), "<a href=\"").concat(record.Action.RepoLink, "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "</a>");
            } else if (opType == 16) {
              var _words2 = record.Action.RefName.split('/');

              var _tag = _words2[_words2.length - 1];
              out.remark = "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('deleteTag', {
                repo: "<a href=\"".concat(record.Action.RepoLink, "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "</a>"),
                tag: _tag
              }));
            } else if (opType == 17) {
              var _words3 = record.Action.RefName.split('/');

              var _branch = _words3[_words3.length - 1];
              out.remark = "".concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('deleteBranch', {
                repo: "<a href=\"".concat(record.Action.RepoLink, "\" rel=\"nofollow\">").concat(record.Action.ShortRepoFullDisplayName, "</a>"),
                branch: _branch
              }));
            }
          } else {
            out.remark = "".concat(getPointAction(record.SourceTemplateId), "(").concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('repositoryWasDel'), ")");
          }
    ...
    if (record.LossAmount !== 0) {
      ...
      out.remark += "".concat(out.remark ? _langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t(';') : '').concat(_langs__WEBPACK_IMPORTED_MODULE_8__.i18n.t('dailyMaxTips'));
    }
    ...
    if (record.SourceType === 'ADMIN_OPERATE') {
      ...
      var _record$Cloudbrain10, _record$Cloudbrain11;

      out.taskName = "<a href=\"".concat(getJobTypeLink(record, 'DECREASE'), "\" rel=\"nofollow\">").concat(record === null || record === void 0 ? void 0 : (_record$Cloudbrain10 = record.Cloudbrain) === null || _record$Cloudbrain10 === void 0 ? void 0 : _record$Cloudbrain10.DisplayJobName, "</a>"); // if (!record.Cloudbrain?.RepoFullName && record.Cloudbrain?.RepoID) {
      ...
      var resourceSpec = record === null || record === void 0 ? void 0 : (_record$Cloudbrain11 = record.Cloudbrain) === null || _record$Cloudbrain11 === void 0 ? void 0 : _record$Cloudbrain11.ResourceSpec;

      if (resourceSpec) {
        var _record$Cloudbrain12, _record$Cloudbrain13;

        resourceSpec.workServerNumber = (record === null || record === void 0 ? void 0 : (_record$Cloudbrain12 = record.Cloudbrain) === null || _record$Cloudbrain12 === void 0 ? void 0 : _record$Cloudbrain12.WorkServerNumber) || 1;
        out.remark = "\u3010".concat(getJobType(record === null || record === void 0 ? void 0 : (_record$Cloudbrain13 = record.Cloudbrain) === null || _record$Cloudbrain13 === void 0 ? void 0 : _record$Cloudbrain13.JobType), "\u3011\u3010").concat(renderSpecStr(resourceSpec, true), "\u3011");
      }
    }
  }
...
/* harmony import */ var _vp_point_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vp-point.vue */ "./web_src/vuepages/pages/reward/point/vp-point.vue");
...
new vue__WEBPACK_IMPORTED_MODULE_6__["default"]({
  ...
  render: function render(h) {
    return h(_vp_point_vue__WEBPACK_IMPORTED_MODULE_5__["default"]);
  }
}).$mount('#__vue-root');
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vp_point_vue_vue_type_template_id_5683bbf8_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vp-point.vue?vue&type=template&id=5683bbf8&scoped=true */ "./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=template&id=5683bbf8&scoped=true");
/* harmony import */ var _vp_point_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vp-point.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=script&lang=js");
/* harmony import */ var _vp_point_vue_vue_type_style_index_0_id_5683bbf8_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less */ "./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _vp_point_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _vp_point_vue_vue_type_template_id_5683bbf8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _vp_point_vue_vue_type_template_id_5683bbf8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "5683bbf8",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/reward/point/vp-point.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=script&lang=js":
/*!**********************************************************************************!*\
  !*** ./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=script&lang=js ***!
  \**********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_vp_point_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./vp-point.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_vp_point_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less":
/*!*******************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less ***!
  \*******************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_vp_point_vue_vue_type_style_index_0_id_5683bbf8_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=style&index=0&id=5683bbf8&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=template&id=5683bbf8&scoped=true":
/*!****************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=template&id=5683bbf8&scoped=true ***!
  \****************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_vp_point_vue_vue_type_template_id_5683bbf8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_vp_point_vue_vue_type_template_id_5683bbf8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_vp_point_vue_vue_type_template_id_5683bbf8_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./vp-point.vue?vue&type=template&id=5683bbf8&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=template&id=5683bbf8&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=template&id=5683bbf8&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/reward/point/vp-point.vue?vue&type=template&id=5683bbf8&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    ...
    _c("div", { staticClass: "__reward-pointer-c __content-box" }, [
      _c(
        "div",
        {
          ...
          staticStyle: { width: "80%", "min-width": "1200px" }
        },
        [
          _c("div", { staticClass: "__r_p_header" }, [
            _c("div", [
              _c("p", { staticClass: "__title" }, [
                _vm._v(_vm._s(_vm.$t("calcPointDetails")))
              ])
            ]),
            _vm._v(" "),
            _c(
              "div",
              { staticStyle: { padding: "0 5px", "font-size": "14px" } },
              [
                _c("span", [
                  _c("i", {
                  ...
                  _c(
                    ...
                    {
                      staticStyle: { color: "rgba(3, 102, 214, 1)" },
                      attrs: { href: "/reward/point/rule", target: "_blank" }
                    },
                    [_vm._v(_vm._s(_vm.$t("calcPointAcquisitionInstructions")))]
                  )
                ])
              ]
            )
          ...
          _c("div", { staticClass: "__r_p_summary" }, [
            _c(
              "div",
              {
                staticClass: "__r_p_summary_item-c __flex-1",
                staticStyle: { position: "relative" }
              },
              [
                _c("div", { staticClass: "__val" }, [
                  _vm._v(_vm._s(_vm.summaryInfo.available.toFixed(2)))
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "__exp" }, [
                  _vm._v(_vm._s(_vm.$t("CurrAvailableCalcPoints")))
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "__r_p_summary_line" })
              ]
            ),
            _vm._v(" "),
            _c("div", { staticClass: "__r_p_summary_item-c __flex-1" }, [
              _c("div", { staticClass: "__val" }, [
                _vm._v(_vm._s(_vm.summaryInfo.gain.toFixed(2)))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "__exp" }, [
                _vm._v(_vm._s(_vm.$t("totalGainCalcPoints")))
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "__r_p_summary_item-c __flex-1" }, [
              _c("div", { staticClass: "__val" }, [
                _vm._v(_vm._s(_vm.summaryInfo.used.toFixed(2)))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "__exp" }, [
                _vm._v(_vm._s(_vm.$t("totalConsumeCalcPoints")))
              ])
            ])
          ]),
          _vm._v(" "),
          ...
          _c("div", { staticClass: "__r_p_table" }, [
              ...
              [
                _vm.tableData.length
                  ...
                  : _c("el-empty", {
                      attrs: {
                        "image-size": 140,
                        description: _vm.$t("noPointGainRecord")
                      }
                    })
              ],
              1
            ...
            _c(
              ...
              [
                _c("div", {
                  staticClass: "__r_p_consume_descr",
                  domProps: { innerHTML: _vm._s(_vm.$t("consumeDescr")) }
                }),
                _vm._v(" "),
                _vm.tableData.length
                  ? _c(
                                ...
                                fn: function(scope) {
                                  return [
                                    _c(
                                      "span",
                                      {
                                        style: { color: scope.row.statusColor }
                                      },
                            ...
                            [
                              {
                                ...
                                fn: function(scope) {
                                  return [
                                    _c("span", {
                                      domProps: {
                                        innerHTML: _vm._s(scope.row.taskName)
                                      }
                                    })
                                  ]
                                }
                  ...
                  : _c("el-empty", {
                      attrs: {
                        "image-size": 140,
                        description: _vm.$t("noPointConsumeRecord")
                      }
                    })
              ],
              1
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/reward/point/vp-point.js"); })
