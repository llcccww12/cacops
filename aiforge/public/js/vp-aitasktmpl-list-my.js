...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      isZh: _langs__WEBPACK_IMPORTED_MODULE_21__.lang == 'zh-CN',
      tabList: [{
        key: 'created',
      ...
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_16___default()(_pages_aitasktmpl_tools__WEBPACK_IMPORTED_MODULE_20__.TmplTaskTypes)),
      resourceList: [{
        k: '',
        v: this.$t('resourcesManagement.allComputeResource')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_16___default()(_pages_aitasktmpl_tools__WEBPACK_IMPORTED_MODULE_20__.TmplComputerResouces)),
      sortList: [
  ...
  methods: {
    ...
    changeCondition: function changeCondition() {
      this.search();
    },
    ...
    checkRowSelectable: function checkRowSelectable(row) {
    ...
    getListData: function getListData() {
      ...
      this.loading = true;
      (0,_apis_modules_aitasktmpl__WEBPACK_IMPORTED_MODULE_17__.getAiTaskTmplList)({
        type: this.conds.tab,
        ...
        if (res.code == 0) {
          res = res.data;
          _this2.pageParams.total = res.Total;
          _this2.tableData = (res.Templates || []).map(function (item) {
            return _objectSpread(_objectSpread({}, item), {}, {
              ...
              CreatedUnixStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_18__.formatDate)(new Date(item.CreatedUnix * 1000), 'yyyy-MM-dd HH:mm:ss'),
              UpdatedUnixStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_18__.formatDate)(new Date(item.UpdatedUnix * 1000), 'yyyy-MM-dd HH:mm:ss')
            });
          });
        } else {
          _this2.tableData = [];
          _this2.pageParams.total = 0;
        }
      })["catch"](function (err) {
        console.log(err);
        _this2.loading = false;
    ...
    opRun: function opRun(data) {
      window.location.href = "/cloudbrains/create?tmpl=".concat(data.ID);
    },
    opEdit: function opEdit(data) {
      window.location.href = "/ai_task_tmpl/edit/".concat(data.ID);
    },
    opDel: function opDel(data) {
      var _this3 = this;
      ...
      this.$confirm(this.$t('taskTmplObj.deleteTaskTmplConfirmTips'), this.$t('tips'), {
        ...
        (0,_apis_modules_aitasktmpl__WEBPACK_IMPORTED_MODULE_17__.deleteAiTaskTmpl)({
          id: data.ID
        }).then(function (res) {
          res = res.data;
          ...
          if (res.code == 0) {
            if (_this3.pageParams.total % _this3.pageParams.pageSize == 1 && _this3.pageParams.page > 1) {
              _this3.page -= 1;
            }
            ...
            _this3.$message({
              type: 'error',
              message: res.msg || _this3.$t('operationFailed')
            });
          }
        })["catch"](function (err) {
          _this3.operating = false;
    ...
    opCancelCollect: function opCancelCollect(data) {
      var _this4 = this;

      if (this.operating) return;
      this.operating = true;
      (0,_apis_modules_aitasktmpl__WEBPACK_IMPORTED_MODULE_17__.deleteCollectAiTaskTmpl)({
        id: data.ID
      }).then(function (res) {
        res = res.data;
        ...
        if (res.code == '0') {
          if (_this4.pageParams.total % _this4.pageParams.pageSize == 1 && _this4.pageParams.page > 1) {
            _this4.page -= 1;
          }

          _this4.$message.success(_this4.$t('datasets.unstarSuccess'));

          _this4.getListData();
        } else {
          _this4.$message.error(res.msg || _this4.$t('operationFailed'));
        }
      })["catch"](function (err) {
        console.log(err);
        _this4.operating = false;
...
/***/ "./web_src/vuepages/pages/aitasktmpl/list-my/vp-aitasktmpl-list-my.js":
/*!****************************************************************************!*\
  !*** ./web_src/vuepages/pages/aitasktmpl/list-my/vp-aitasktmpl-list-my.js ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue":
/*!*************************************************************!*\
  !*** ./web_src/vuepages/pages/aitasktmpl/list-my/index.vue ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_340358f9_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=340358f9&scoped=true */ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=template&id=340358f9&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_340358f9_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less */ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_340358f9_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_340358f9_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "340358f9",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/aitasktmpl/list-my/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=script&lang=js":
/*!*************************************************************************************!*\
  !*** ./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=script&lang=js ***!
  \*************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less":
/*!**********************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less ***!
  \**********************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_340358f9_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=style&index=0&id=340358f9&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=template&id=340358f9&scoped=true":
/*!*******************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=template&id=340358f9&scoped=true ***!
  \*******************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_340358f9_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_340358f9_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_340358f9_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=340358f9&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=template&id=340358f9&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=template&id=340358f9&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/aitasktmpl/list-my/index.vue?vue&type=template&id=340358f9&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "content" }, [
            ...
            [
              ...
              _c(
                "el-select",
                {
                  on: { change: _vm.changeCondition },
                  model: {
                    value: _vm.conds.resource,
                    callback: function($$v) {
                      _vm.$set(_vm.conds, "resource", $$v)
                    },
                    expression: "conds.resource"
                  }
                },
    ...
    _c(
      "div",
      { staticClass: "table-c table-container", class: _vm.isZh ? "zh" : "" },
      [
        _c(
          "el-table",
          {
          ...
          [
            _c("el-table-column", {
              attrs: {
                label: _vm.$t("taskTmplObj.tmplName"),
                align: "left",
                "header-align": "center",
                "min-width": "240",
                    ...
                    return [
                      _c(
                        "a",
                        {
                          ...
                          attrs: {
                            target: "_blank",
                            href: "/ai_task_tmpl/detail/" + scope.row.ID
                          }
                        },
                        [
                          _c(
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(scope) {
                    return [
                      _c(
                        "div",
                        { staticClass: "cb-job", class: scope.row.JobType },
                        [_c("span", [_vm._v(_vm._s(scope.row.JobTypeStr))])]
                      )
                    ]
                  }
                }
                  ...
                  fn: function(scope) {
                    return [
                      _c("span", [
                        _vm._v(
                          "\n            " +
                            _vm._s(scope.row.ComputeSourceStr) +
                            "\n          "
                        )
                      ])
                    ]
            ...
            _c("el-table-column", {
              attrs: {
                label: _vm.$t("taskTmplObj.modelDatasetAndRepo"),
                align: "left",
                "header-align": "center",
                "min-width": "280"
              },
                    ...
                    return [
                      _c("div", { staticClass: "row" }, [
                        ...
                        _c(
                          ...
                          { staticClass: "row-r" },
                          [
                            _vm._l(scope.row.ModelLists || [], function(model) {
                              return _c(
                                "div",
                                {
                                  key: model.ModelID,
                      ...
                      _c("div", { staticClass: "row" }, [
                        ...
                        _c(
                          ...
                          { staticClass: "row-r" },
                          [
                            _vm._l(scope.row.DatasetLists || [], function(
                              dataset
                            ) {
                              return _c(
                                "div",
                      ...
                      _c("div", { staticClass: "row" }, [
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "row-r nowrap" }, [
                          scope.row.RepoOwnerName && scope.row.RepoName
                            ? _c(
                                "span",
                                {
                                  attrs: {
                                    title:
                                      scope.row.RepoOwnerName +
                                      "/" +
                                      scope.row.RepoName
                                  }
                                },
                      ...
                      scope.row.Owner
                        ? _c(
                            "a",
                            {
                              ...
                              attrs: {
                                title:
                                  scope.row.Owner.FullName ||
                                  scope.row.Owner.Name,
                                href: "/" + scope.row.Owner.Name
                              }
                            },
                            [
                              _c("img", {
                                staticClass: "avatar",
                                attrs: { src: scope.row.Owner.RelAvatarLink }
                              })
                            ]
                          )
                        : _vm._e()
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(scope) {
                    return [
                      _c("span", [_vm._v(_vm._s(scope.row.CreatedUnixStr))])
                    ]
                  }
                }
              ])
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(scope) {
                    return [
                      _c("span", [_vm._v(_vm._s(scope.row.UpdatedUnixStr))])
                    ]
                  }
                }
              ])
            ...
            _c("el-table-column", {
              attrs: {
                label: _vm.$t("taskTmplObj.accessRight"),
                align: "center",
                "header-align": "center",
                width: "145"
              },
            ...
            _c("el-table-column", {
              attrs: {
                label: _vm.$t("taskTmplObj.collectedNum"),
                align: "center",
                "header-align": "center",
                width: "145"
              },
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(scope) {
                    return [
                      _c("span", [_vm._v(_vm._s(scope.row.NumCollections))])
                    ]
                  }
                }
              ])
            ...
            _c("el-table-column", {
              attrs: {
                label: _vm.$t("taskTmplObj.runTimes"),
                align: "center",
                "header-align": "center",
                width: "140"
              },
              scopedSlots: _vm._u([
                {
                  key: "default",
                  fn: function(scope) {
                    return [_c("span", [_vm._v(_vm._s(scope.row.UseCount))])]
                  }
                }
              ])
            }),
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(scope) {
                    return [
                      _c("div", { staticClass: "op-c" }, [
                        _c(
                          "div",
                          {
                            staticClass: "btn run-btn",
                            on: {
                              click: function($event) {
                                return _vm.opRun(scope.row)
                              }
                            }
                          },
                          [
                        ...
                        _vm._v(" "),
                        scope.row.CanEdit && _vm.conds.tab == "created"
                          ? _c(
                              "a",
                              {
                          ...
                          : _vm._e(),
                        _vm._v(" "),
                        scope.row.CanDelete && _vm.conds.tab == "created"
                          ? _c(
                              "div",
                              {
                                staticClass: "btn del-btn",
                                on: {
                                  click: function($event) {
                                    return _vm.opDel(scope.row)
                                  }
                                }
                              },
                              [
                        ...
                        _vm.conds.tab == "collected"
                          ? _c(
                              "div",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.opCancelCollect(scope.row)
                                  }
                                }
                              },
                              [
        ...
        [
          _c("el-pagination", {
            attrs: {
              ...
              "page-sizes": _vm.pageParams.pageSizes,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/aitasktmpl/list-my/vp-aitasktmpl-list-my.js"); })
