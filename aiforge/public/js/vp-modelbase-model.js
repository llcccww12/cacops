...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/components/TopHeader.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/components/TopHeader.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "TopHeader",
  props: {// menu: { type: String, default: '' },
  },
  components: {},
  data: function data() {
    return {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/model/index.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/model/index.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_TopHeader_vue__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../components/TopHeader.vue */ "./web_src/vuepages/pages/modelbase/components/TopHeader.vue");
/* harmony import */ var _components_cloudbrain_LoadingMask_vue__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../components/cloudbrain/LoadingMask.vue */ "./web_src/vuepages/pages/modelbase/components/cloudbrain/LoadingMask.vue");
/* harmony import */ var _apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ~/apis/modules/modelbase */ "./web_src/vuepages/apis/modules/modelbase.js");
...
var TrainJobFinalState = ['STOPPED', 'CREATE_FAILED', 'UNAVAILABLE', 'DELETED', 'RESIZE_FAILED', 'SUCCEEDED', 'IMAGE_FAILED', 'SUBMIT_FAILED', 'DELETE_FAILED', 'KILLED', 'COMPLETED', 'FAILED', 'CANCELED', 'LOST', 'START_FAILED', 'SUBMIT_MODEL_FAILED', 'DEPLOY_SERVICE_FAILED', 'CHECK_FAILED'];
var DeployStateMap = {
  'BUILDING': 'WAITING',
  'WAITING': 'WAITING',
  'DEPLOYING': 'RUNNING',
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    TopHeader: _components_TopHeader_vue__WEBPACK_IMPORTED_MODULE_18__["default"],
    LoadingMask: _components_cloudbrain_LoadingMask_vue__WEBPACK_IMPORTED_MODULE_19__["default"]
  },
  methods: {
    getTableData: function getTableData() {
      ...
      (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.getFinetuneList)({
        userName: this.userName
      }).then(function (res) {
        res = res.data;
        _this.loading = false;
        _this.maxJobNum = res.maxJobNum || _this.maxJobNum;
        var data = res.fineTuneJobs;
        _this.tableData = data.map(function (item) {
          var taskJob = _objectSpread(_objectSpread({}, item), {}, {
            jobCategoryStr: (0,_utils__WEBPACK_IMPORTED_MODULE_21__.getListValueWithKey)(_this.list, item.job_category, 'key', '_name'),
            createdTimeStr: dayjs__WEBPACK_IMPORTED_MODULE_17___default()(item.created_unix * 1000).format('YYYY-MM-DD HH:mm:ss')
          });

          _this.checkOperation(taskJob);

          return taskJob;
        });

        _this.startRefreshTaskTimer();
      })["catch"](function (err) {
        console.log(err);
        _this.loading = false;
      });
    },
    checkOperation: function checkOperation(taskJob) {
      taskJob.canStopTrain = ['RUNNING', 'WAITING'].includes(taskJob.status);
      taskJob.canDelete = ['STOPPED', 'FAILED', 'START_FAILED', 'KILLED', 'COMPLETED', 'SUCCEEDED', 'CREATE_FAILED'].includes(taskJob.status) && ['', 'STOP', 'FAILED'].includes(taskJob.deploy_status);
    ...
    startRefreshTaskTimer: function startRefreshTaskTimer() {
      var _this2 = this;

      this.refreshTimer = setInterval(function () {
        for (var i = 0, iLen = _this2.tableData.length; i < iLen; i++) {
          var taskJob = _this2.tableData[i];

          _this2.refreshTaskStatus(taskJob);
        }
      }, 6 * 1000);
    },
    refreshTaskStatus: function refreshTaskStatus(taskJob, notCheck) {
      var _this3 = this;

      if (notCheck || !TrainJobFinalState.includes(taskJob.status)) {
        (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.getJobStatus)({
          userName: this.userName,
      ...
      if (notCheck || ['BUILDING', 'WAITING', 'DEPLOYING', 'SUCCEEDED'].includes(taskJob.deploy_status)) {
        (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.getFinetuneServiceStatus)({
          userName: this.userName,
          jobId: taskJob.job_id
        }).then(function (res) {
          var data = res.data;
    ...
    stopTrain: function stopTrain(taskJob) {
      var _this4 = this;
      ...
      (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.stopTrainJob)({
        userName: this.userName,
        jobId: taskJob.job_id
      }).then(function (res) {
        ...
        _this4.refreshTaskStatus(taskJob, true);

        setTimeout(function () {
          _this4.checkOperation(taskJob);
        }, 200);
      })["catch"](function (err) {
        _this4.isOperating = false;
        _this4.maskLoading = false;
    ...
    deleteTask: function deleteTask(taskJob) {
      var _this5 = this;
      ...
      this.$confirm("\u60A8\u786E\u8BA4\u5220\u9664\u8BE5\u4EFB\u52A1\u4E48\uFF1F\u6B64\u4EFB\u52A1\u4E00\u65E6\u5220\u9664\u4E0D\u53EF\u6062\u590D\u3002", '提示', {
        ...
        type: 'warning'
      }).then( /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_15___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_13___default().mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_13___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this5.isOperating = true;
                _this5.maskLoadingTips = '任务删除中，请稍后';
                _this5.maskLoading = true;
                (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.deleteTrainJob)({
                  userName: _this5.userName,
                  jobId: taskJob.job_id,
                  id: taskJob.id
                }).then(function (res) {
                  _this5.isOperating = false;
                  _this5.maskLoading = false;
    ...
    deploy: function deploy(taskJob) {
      var _this6 = this;
      ...
      this.maskLoading = true;
      (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.setFinetuneService)({
        userName: this.userName,
        jobId: taskJob.job_id
      }).then(function (res) {
        _this6.isOperating = false;
        _this6.maskLoading = false;
        res = res.data;
        ...
        _this6.refreshTaskStatus(taskJob, true);
      })["catch"](function (err) {
        console.log(err);
        _this6.isOperating = false;
        _this6.maskLoading = false;
    ...
    updateDeploy: function updateDeploy(taskJob, type) {
      var _this7 = this;
      ...
      this.maskLoading = true;
      (0,_apis_modules_modelbase__WEBPACK_IMPORTED_MODULE_20__.updateFinetuneService)({
        userName: this.userName,
        jobId: taskJob.job_id,
        status: type
      }).then(function (res) {
        _this7.isOperating = false;
        _this7.maskLoading = false;
        res = res.data;
        ...
        _this7.refreshTaskStatus(taskJob, true);
      })["catch"](function (err) {
        console.log(err);
        _this7.isOperating = false;
        _this7.maskLoading = false;
    ...
    startInference: function startInference(taskJob) {
      if (this.isOperating) return;
      window.open("/extension/modelbase/pangufinetune/inference?jobid=".concat(taskJob.job_id, "&type=").concat(taskJob.type, "&jobcategory=").concat(taskJob.job_category));
    }
  },
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/modelbase/model/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/components/TopHeader.vue?vue&type=style&index=0&id=72b99b46&scoped=true&lang=less":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/components/TopHeader.vue?vue&type=style&index=0&id=72b99b46&scoped=true&lang=less ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/model/index.vue?vue&type=style&index=0&id=210ac6c2&scoped=true&lang=less":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/model/index.vue?vue&type=style&index=0&id=210ac6c2&scoped=true&lang=less ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _TopHeader_vue_vue_type_template_id_72b99b46_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TopHeader.vue?vue&type=template&id=72b99b46&scoped=true */ "./web_src/vuepages/pages/modelbase/components/TopHeader.vue?vue&type=template&id=72b99b46&scoped=true");
/* harmony import */ var _TopHeader_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "bg-04" }, [
      _c("div", { staticClass: "bg-04-1" }),
      _vm._v(" "),
      _c("div", { staticClass: "bg-04-2" }),
      _vm._v(" "),
      _c("div", { staticClass: "bg-04-3" }),
      _vm._v(" "),
      _c("div", { staticClass: "bg-04-4" }),
      _vm._v(" "),
      _c("div", { staticClass: "bg-04-5" }),
      _vm._v(" "),
      _c("div", { staticClass: "bg-04-6" })
    ])
  }
]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/model/index.vue?vue&type=template&id=210ac6c2&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase/model/index.vue?vue&type=template&id=210ac6c2&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("TopHeader", [
        _c("div", { staticClass: "title" }, [
          _c("div", { staticClass: "title-1" }, [
            _vm._v("鹏城·脑海(原鹏城·盘古)大模型")
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "title-2" }, [
            _vm._v(
              "以中文为核心的鹏城·脑海大语言模型，更强的任务理解与处理能力。"
            )
          ]),
          _vm._v(" "),
            ...
            _c(
              "a",
              {
                attrs: {
                  target: "_blank",
                  href:
                    "https://openi.pcl.ac.cn/PCL-Platform.Intelligence/pcl_pangu"
                }
              },
              [_vm._v("项目主页")]
            )
      ...
      _vm._v(" "),
      _c("div", { staticClass: "type-list-container" }, [
            ...
            _vm._l(_vm.list, function(item, index) {
              return _c(
                ...
                [
                  ...
                  _c(
                    "div",
                    { staticClass: "item-descr", attrs: { title: item.descr } },
                    [_vm._v(_vm._s(item.descr))]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "item-op" }, [
                    _c(
                      "a",
                      {
                        staticClass: "item-op-btn",
      ...
      _c("div", [
        _c("div", { staticClass: "ui container" }, [
                        ...
                        fn: function(scope) {
                          return [
                            _c(
                              ...
                              [_vm._v(" " + _vm._s(scope.row.display_job_name))]
                            )
                          ]
                        }
                      }
                    ...
                    scopedSlots: _vm._u([
                      {
                        ...
                        fn: function(scope) {
                          return [
                            _c("div", { staticClass: "job-status-c" }, [
                              _c("i", {
                                staticClass: "job-status-icon",
                          ...
                          return [
                            _c("div", { staticClass: "job-status-c" }, [
                              _c("i", {
                                staticClass: "job-status-icon",
                                class: [
                                  scope.row.deploy_status,
                                  _vm.deployStateMap[scope.row.deploy_status]
                                ]
                              }),
                              _vm._v(" "),
                              _c("span", [
                                _vm._v(_vm._s(scope.row.deploy_status))
                              ])
                            ])
                          ]
                        }
                                    ...
                                    "a",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          return _vm.startInference(scope.row)
                                        }
                                      }
                                    },
                                    [_vm._v("体验")]
                              ...
                              scope.row.canStopTrain
                                ? _c(
                                    "a",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          return _vm.stopTrain(scope.row)
                                        }
                                      }
                                    },
                                    [_vm._v("停止")]
          ...
          _vm._v(" "),
          _c("div", { staticClass: "table-tips" }, [
            _vm._v(
              "* 最多创建 5 条任务，超过 30 天的任务将不能部署或者再次启动。"
            )
          ])
        ])
      ]),
      _vm._v(" "),
      _c("LoadingMask", {
        attrs: { loading: _vm.maskLoading, tips: _vm.maskLoadingTips }
      })
    ],
    1
  )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "content-tips" }, [
      _c("span", [
        _vm._v(
          "* 社区提供了三个示例场景，用户可以使用提供的示例数据集新建微调任务，也可以上传自己的数据集，定制符合自己的应用场景的鹏城·脑海大模型。"
        )
      ]),
      _vm._v(" "),
      _c(
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/modelbase/model/vp-modelbase-model.js"); })
