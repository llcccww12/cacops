...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./constant.js */ "./web_src/vuepages/pages/model/wenxin/constant.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      caseIndex: 0,
      caseText: _constant_js__WEBPACK_IMPORTED_MODULE_12__.ERNIE_CASE_IMG,
      searchValue: "",
      loading: false,
      showResult: false,
      resultLoading: false,
  ...
  computed: {
    tipCase: function tipCase() {
      return _constant_js__WEBPACK_IMPORTED_MODULE_12__.ERNIE_CASE[this.caseIndex];
    }
  },
  methods: {
    initCopy: function initCopy() {
      var clipboard = new (clipboard__WEBPACK_IMPORTED_MODULE_11___default())('.wenxin_img_copy', {
        text: function text(e) {
          return e.getAttribute('data-text');
        }
      });
      clipboard.on('success', function (e) {
        element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.success('复制成功');
      });
      clipboard.on('error', function (e) {
        element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error('复制失败');
      });
    },
    changeCase: function changeCase() {
      if (this.caseIndex === _constant_js__WEBPACK_IMPORTED_MODULE_12__.ERNIE_CASE.length - 1) {
        this.caseIndex = 0;
      } else {
        this.caseIndex++;
      }
    },
    erniePaint: function erniePaint() {
      var _this = this;
      ...
      if (!this.startFlag) {
        ...
        if (params.has('prompt')) {
          window.location.href = "/user/login?redirect_to=".concat(encodeURIComponent(location.href));
        } else {
          window.location.href = "/user/login?redirect_to=".concat(encodeURIComponent(location.href), "?prompt=").concat(this.searchValue);
        }
      ...
      if (!this.searchValue.split(" ").join("").length) {
        element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error('输入不能为空');
        return;
      }

      this.loading = true;
      this.resultLoading = true;
      (0,_apis_modules_desensitization__WEBPACK_IMPORTED_MODULE_13__.getERNIEPaintCount)().then(function (res) {
        if (res.data >= 200) {
          element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error('已达最大生成图片量');
        ...
        _this.getPaintResult();
      })["catch"](function (err) {
        element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error(err);
      });
    },
    copyText: function copyText(value) {
      this.searchValue = value;
    },
    getPaintResult: function getPaintResult() {
      var _this2 = this;

      var params = {
        'textDesc': this.searchValue
      };
      this.showResult = true;
      (0,_apis_modules_desensitization__WEBPACK_IMPORTED_MODULE_13__.postERNIEPaintNew)(params).then(function (res) {
        if (res.data.result == -1) {
          element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error(res.data.msg);
          _this2.showResult = false;
          _this2.loading = false;
          _this2.resultLoading = false;
          _this2.resultLoading = false;
          return;
        } else {
          var _res$data = res.data,
              ...
              wait = _res$data.wait;
          _this2.waitTime = wait;

          _this2.main(result, wait, params.textDesc);
        }
      })["catch"](function (err) {
        element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error(err);
        _this2.showResult = false;
    ...
    main: function main(id, count, textDesc) {
      // 示例2- 通过轮询次数结束轮询
      var vm = this;
      var countRequest = 0;
      var thread = new _constant_js__WEBPACK_IMPORTED_MODULE_12__.Thread({
        start: function start() {
          (0,_apis_modules_desensitization__WEBPACK_IMPORTED_MODULE_13__.postERNIEPaintResult)({
            ...
            if (res.data.Status === 0) {
              ...
              element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error(res.data.Picture || '发生错误');
              vm.showResult = false;
              vm.resultLoading = false;
              vm.loading = false;
              thread.stop();
        ...
        stop: function stop() {
          if (countRequest === Math.ceil(count / 2) - 1) {
            element_ui__WEBPACK_IMPORTED_MODULE_14__.Message.error('请求超时，请稍后再试');
            vm.showResult = false;
            vm.resultLoading = false;
            vm.loading = false;
          }
    ...
    downloadImg: function downloadImg() {
      var time = new Date();
      var nowTime = _constant_js__WEBPACK_IMPORTED_MODULE_12__["default"].timestampToTime(time.toLocaleString('en-US', {
        hours12: false
      }).split(' '));
      var fileName = nowTime + '_' + this.resultImgName;
      _constant_js__WEBPACK_IMPORTED_MODULE_12__["default"].downloadFile(this.resultImg, fileName, 'jpeg');
    }
  },
  mounted: function mounted() {
    this.initCopy();
    var signEl = document.querySelector("#isSignd");
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/model/wenxin/index.vue");



new vue__WEBPACK_IMPORTED_MODULE_2__["default"]({
  i18n: _langs__WEBPACK_IMPORTED_MODULE_0__.i18n,
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_1ec8f1e4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=1ec8f1e4 */ "./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=template&id=1ec8f1e4");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_1ec8f1e4__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_1ec8f1e4__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/model/wenxin/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=script&lang=js":
/*!*******************************************************************************!*\
  !*** ./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=script&lang=js ***!
  \*******************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=template&id=1ec8f1e4":
/*!*************************************************************************************!*\
  !*** ./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=template&id=1ec8f1e4 ***!
  \*************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1ec8f1e4__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1ec8f1e4__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1ec8f1e4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=1ec8f1e4 */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=template&id=1ec8f1e4");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=template&id=1ec8f1e4":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/model/wenxin/index.vue?vue&type=template&id=1ec8f1e4 ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "ui container wenxin_model_wrap",
      staticStyle: { "margin-top": "2rem" }
    },
    [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "wenxin_search_wrap" }, [
        _c("div", { staticStyle: { width: "94%" } }, [
          _c("input", {
            directives: [
              {
                name: "model",
            ...
            ref: "inputSearch",
            staticClass: "wenxin_search_input",
            attrs: {
              autocomplete: "off",
              maxlength: "100",
              type: "text",
              placeholder:
                "请用中文输入Prompt，参考形式：画面主体，细节描述，修饰词"
            },
      ...
      _vm._v(" "),
      _c("div", { staticClass: "wenxin_tips_wrap" }, [
        _c("div", { staticClass: "wenxin_tip_box" }, [
              ...
              "span",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.copyText(_vm.tipCase)
                  }
                }
              },
              [_vm._v(_vm._s(_vm.tipCase))]
            )
          ]),
          _vm._v(" "),
          _c(
            "span",
            {
              staticClass: "wenxin_replace_tip",
        ...
        _vm._v(" "),
        _c("div", { staticClass: "wenxin_button_box" }, [
          _c(
            "button",
            {
              staticClass: "wenxin_button_content",
              style: { cursor: _vm.loading ? "not-allowed" : "pointer" },
              attrs: { disabled: _vm.loading },
              on: { click: _vm.erniePaint }
            },
            [
              !_vm.loading
                ? _c("span", [_vm._v("立即生成")])
                : _c("div", { staticClass: "ui active primary inline loader" })
            ]
          )
        ])
      ]),
      ...
      _vm.showResult
        ? _c("div", [
            _vm.resultLoading
              ? _c("div", { staticClass: "wenxin_wait" }, [
                  _vm._v(
                    "\n            正在生成中，预计需要 " +
                      _vm._s(_vm.waitTime) +
                      "s\n        "
              ...
              : _vm._e(),
            _vm._v(" "),
            _c("div", { staticClass: "wenxin_result_wrap scale-in-ver-top" }, [
              _c("div", { staticClass: "wenxin_result_left" }, [
                _c("div", [
                  _c("div", { staticClass: "content" }, [
                    _c("div", { staticClass: "desc_header" }, [
                      _vm._v("创意灵感：")
                    ]),
                    _vm._v(" "),
                ...
                _vm._v(" "),
                _c("div", { staticClass: "wenxin_use_content" }, [
                  _c("span", [
                    _c("span", [_vm._v(_vm._s(_vm.userCount) + "/200")]),
                    _vm._v(" "),
                    _c("span", { staticStyle: { color: "#ff5e00" } }, [
                      _vm._v("限量体验200次")
                    ])
                  ])
                ])
              ...
              _vm._v(" "),
              _c("div", { staticClass: "wenxin_result_right" }, [
                _vm.resultLoading
                  ? _c("img", {
                      staticStyle: {
                        width: "100%",
                      ...
                      attrs: { src: "/img/model/loading.gif" }
                    })
                  : _c("div", [
                      _c("div", { staticClass: "gallery" }, [
                        _c("img", {
                          ...
                          attrs: {
                            src: "data:image/Jpeg;base64," + _vm.resultImg,
                            alt: ""
                          }
                        })
                      ]),
                      _vm._v(" "),
                      _c("span", { staticClass: "wenxin_mask" }, [
                        _c(
                          "span",
                          {
                            staticClass: "wenxin_down_wrap",
                            on: { click: _vm.downloadImg }
                          },
                          [
                            _c("span", { staticClass: "download_img" }, [
                              _vm._v(
                                "\n                                下载\n                            "
                              )
                            ])
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "wenxin_example_wrap gallery" }, [
        _c("p", [_vm._v("ERNIE-ViLG应用场景示例")]),
        _vm._v(" "),
        _c("div", { staticClass: "ui stackable four column grid" }, [
          _c("div", { staticClass: "column" }, [
            _vm._m(2),
            _vm._v(" "),
            _c("div", { staticClass: "wenxin_img_desc" }, [
              _c(
                "span",
                {
                  staticClass: "wenxin_img_tips",
                  attrs: { title: _vm.caseText[0] }
                },
                [_vm._v(_vm._s(_vm.caseText[0]))]
              ),
              _vm._v(" "),
              _c(
                "span",
                {
                  staticClass: "wenxin_img_copy",
                  attrs: { "data-text": _vm.caseText[0] }
                },
                [_vm._v("复制")]
              )
            ])
          ...
          _c("div", { staticClass: "column" }, [
            ...
            _c("div", { staticClass: "wenxin_img_desc" }, [
              _c(
                ...
                {
                  staticClass: "wenxin_img_tips",
                  attrs: { title: _vm.caseText[1] }
                },
                [_vm._v(_vm._s(_vm.caseText[1]))]
              ),
              _vm._v(" "),
              _c(
                "span",
                {
                  staticClass: "wenxin_img_copy",
                  attrs: { "data-text": _vm.caseText[1] }
                },
                [_vm._v("复制")]
              )
            ])
          ...
          _c("div", { staticClass: "column" }, [
            ...
            _c("div", { staticClass: "wenxin_img_desc" }, [
              _c(
                ...
                {
                  staticClass: "wenxin_img_tips",
                  attrs: { title: _vm.caseText[2] }
                },
                [_vm._v(_vm._s(_vm.caseText[2]))]
              ),
              _vm._v(" "),
              _c(
                "span",
                {
                  staticClass: "wenxin_img_copy",
                  attrs: { "data-text": _vm.caseText[2] }
                },
                [_vm._v("复制")]
              )
            ])
          ...
          _c("div", { staticClass: "column" }, [
            ...
            _c("div", { staticClass: "wenxin_img_desc" }, [
              _c(
                "span",
                {
                  staticClass: "ui wenxin_img_tips",
                  attrs: { title: _vm.caseText[3] }
                },
                [_vm._v(_vm._s(_vm.caseText[3]))]
              ),
              _vm._v(" "),
              _c(
                "span",
                {
                  staticClass: "wenxin_img_copy",
                  attrs: { "data-text": _vm.caseText[3] }
                },
                [_vm._v("复制")]
              )
            ])
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("div", { staticClass: "wenxin_title_wrap" }, [
        _c("h1", [_vm._v("基于国产算力的ERNIE-ViLG AI 作画大模型")]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
            "全球规模最大的中文跨模态生成模型，可通过自然语言实现图像生成与编辑，由鹏城云脑Ⅱ提供算力支持 。"
          )
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "content" }, [
      _c("div", { staticClass: "desc_header" }, [_vm._v("规格：")]),
      _vm._v(" "),
      _c("div", { staticClass: "desc_text" }, [_vm._v("1024 x 1024")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ui segment wenxin_img_box" }, [
      _c("img", { attrs: { src: "/img/model/wenxin1.jpeg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ui segment wenxin_img_box" }, [
      _c("img", { attrs: { src: "/img/model/wenxin2.jpeg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ui segment wenxin_img_box" }, [
      _c("img", { attrs: { src: "/img/model/wenxin3.jpeg" } })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ui segment wenxin_img_box" }, [
      _c("img", { attrs: { src: "/img/model/wenxin4.jpeg" } })
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "wenxin_alert_wrap" }, [
      _c("span", [
        _c("a", { attrs: { href: "/home/model_privacy", target: "_blank" } }, [
          _vm._v("《免责声明和服务使用规范》")
        ])
      ]),
      _vm._v(" "),
      _c("span", [
        ...
        _c(
          ...
          {
            attrs: {
              href: "https://wenxin.baidu.com/ernie-vilg",
              target: "_blank"
            }
          },
          [_vm._v(" ERNIE-ViLG AI")]
        ),
        _vm._v(" 作画大模型的内容")
      ])
    ])
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/model/wenxin/vp-model-wenxin.js"); })
