...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=script&lang=js":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _apis_modules_resources__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ~/apis/modules/resources */ "./web_src/vuepages/apis/modules/resources.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return {
      ...
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(_const__WEBPACK_IMPORTED_MODULE_5__.COMPUTER_RESOURCES)),
      selCenter: '',
      centerList: [{
        k: '',
      ...
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(_const__WEBPACK_IMPORTED_MODULE_5__.ACC_CARD_TYPE)),
      selCardsNum: -1,
      cardsNumList: [{
        k: -1,
        v: this.$t('resourcesManagement.allCardsNum')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()([0, 1, 2, 4, 6, 8, 16, 32, 64].map(function (item) {
        return {
          k: item,
      ...
      operationTypeList: [{
        k: '',
        v: this.$t('logManagement.allOperationType')
      }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(_const__WEBPACK_IMPORTED_MODULE_5__.OPERATION_TYPE)),
      accCardTypeList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(_const__WEBPACK_IMPORTED_MODULE_5__.ACC_CARD_TYPE),
      durationTime: '',
      clusterList: _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(_const__WEBPACK_IMPORTED_MODULE_5__.CLUSTERS),
      loading: false,
      tableData: [],
      pageInfo: {
        curpage: 1,
  ...
  methods: {
    getCenterList: function getCenterList() {
      ...
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_6__.getAiCenterCode)().then(function (res) {
        res = res.data;
    ...
    getQueueList: function getQueueList() {
      ...
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_6__.getResQueueCode)().then(function (res) {
        res = res.data;
        ...
        if (res.Code === 0) {
          ...
          for (var i = 0, iLen = data.length; i < iLen; i++) {
            ...
            list.push({
              k: item.ID,
              v: "".concat(item.QueueCode).concat(queueName).concat(queueType, "(").concat((0,_utils__WEBPACK_IMPORTED_MODULE_7__.getListValueWithKey)(_this3.clusterList, item.Cluster), " - ").concat(item.AiCenterName, ") ").concat(item.ComputeResource, "(").concat(item.AccCardType, ")")
            });
          }
    ...
    getTableData: function getTableData() {
      var _this$selCardsNum,
          _this4 = this;

      var _ref = this.durationTime || [],
          _ref2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_3___default()(_ref, 2),
          startMs = _ref2[0],
          endMs = _ref2[1]; // 转换为秒级时间戳


      var start_time = startMs ? Math.floor(startMs / 1000) : undefined;
      var end_time = endMs ? Math.floor(endMs / 1000) : undefined;
      var params = {
        page: this.pageInfo.curpage,
        page_size: this.pageInfo.pageSize,
        compute_resource: this.selResource || undefined,
        ai_center_code: this.selCenter || undefined,
        resource_queue_id: this.selQueue || undefined,
        acc_card_type: this.selCardType || undefined,
        acc_card_num: (_this$selCardsNum = this.selCardsNum) !== null && _this$selCardsNum !== void 0 ? _this$selCardsNum : undefined,
        OperateType: this.selOperationType || undefined,
        start_time: start_time,
        end_time: end_time
      };
      this.loading = true;
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_6__.getResSpecificationShelfLogList)(params).then(function (res) {
        ...
        if (res.Code === 0) {
          ...
          var data = list.map(function (item) {
            var OperationType = (0,_utils__WEBPACK_IMPORTED_MODULE_7__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_5__.OPERATION_TYPE, item.operate_type);
            var Spec = item.ResourceSpec;
            var Queue = item.ResourceQueue;
            var AccCardNum = item.AccCardNum;
            var Comment = item.comment;
            var Creator = item.created_by_name;
            var CreatedTime = (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_8__.formatDate)(new Date(item.created_time * 1000), 'yyyy-MM-dd HH:mm:ss');
            var NGPU = "".concat(Queue.ComputeResource, ":").concat(Spec.AccCardsNum + '*' + (0,_utils__WEBPACK_IMPORTED_MODULE_7__.getListValueWithKey)(_this4.accCardTypeList, Queue.AccCardType));
            ...
            return {
              ...
              QueueInfo: "".concat(Queue.QueueCode).concat(queueName).concat(queueType, "(").concat((0,_utils__WEBPACK_IMPORTED_MODULE_7__.getListValueWithKey)(_this4.clusterList, Queue.Cluster), " - ").concat(Queue.AiCenterName, ")"),
          ...
          _this4.pageInfo.total = res.Data.total;
        }
      })["catch"](function (err) {
        console.log(err);
        _this4.loading = false;
...
/***/ "./web_src/vuepages/pages/log/operation/vp-log-operation.js":
/*!******************************************************************!*\
  !*** ./web_src/vuepages/pages/log/operation/vp-log-operation.js ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/log/operation/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/log/operation/index.vue":
/*!********************************************************!*\
  !*** ./web_src/vuepages/pages/log/operation/index.vue ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_509b74a7_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=509b74a7&scoped=true */ "./web_src/vuepages/pages/log/operation/index.vue?vue&type=template&id=509b74a7&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/log/operation/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_509b74a7_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less */ "./web_src/vuepages/pages/log/operation/index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_509b74a7_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_509b74a7_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "509b74a7",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/log/operation/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/log/operation/index.vue?vue&type=script&lang=js":
/*!********************************************************************************!*\
  !*** ./web_src/vuepages/pages/log/operation/index.vue?vue&type=script&lang=js ***!
  \********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/log/operation/index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less":
/*!*****************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/log/operation/index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less ***!
  \*****************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_509b74a7_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=style&index=0&id=509b74a7&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/log/operation/index.vue?vue&type=template&id=509b74a7&scoped=true":
/*!**************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/log/operation/index.vue?vue&type=template&id=509b74a7&scoped=true ***!
  \**************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_509b74a7_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_509b74a7_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_509b74a7_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=509b74a7&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=template&id=509b74a7&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=template&id=509b74a7&scoped=true":
/*!*****************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/log/operation/index.vue?vue&type=template&id=509b74a7&scoped=true ***!
  \*****************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "title" }, [
      _c("span", [_vm._v(_vm._s(_vm.$t("logManagement.operationLog")))])
    ]),
    _vm._v(" "),
        ...
        [
          ...
          _c(
            "el-select",
            {
              ...
              on: { change: _vm.selectChange },
              model: {
                value: _vm.selOperationType,
                callback: function($$v) {
                  _vm.selOperationType = $$v
                },
                expression: "selOperationType"
              }
            },
            _vm._l(_vm.operationTypeList, function(item) {
              return _c("el-option", {
                key: item.k,
                attrs: { label: item.v, value: item.k }
              })
    ...
    _c("div", { staticClass: "table-container" }, [
      _c(
        "div",
        { staticStyle: { "min-height": "600px", "overflow-x": "auto" } },
        [
          _c(
            "el-table",
            {
            ...
            [
              _c("el-table-column", {
                attrs: {
                  prop: "OperationType",
                  label: _vm.$t("logManagement.operationType"),
                  align: "center",
                  "header-align": "center"
                }
              }),
              ...
              _c("el-table-column", {
                attrs: {
                  prop: "Comment",
                  label: _vm.$t("logManagement.operationReason"),
                  align: "center",
                  "header-align": "center"
                }
              }),
              ...
              _c("el-table-column", {
                attrs: {
                  prop: "Creator",
                  label: _vm.$t("logManagement.operator"),
                  align: "center",
                  "header-align": "center",
                  width: "120"
                }
              ...
              _c("el-table-column", {
                attrs: {
                  prop: "CreatedTime",
                  label: _vm.$t("logManagement.operationTime"),
                  align: "center",
                  "header-align": "center"
                }
              }),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/log/operation/vp-log-operation.js"); })
