...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=script&lang=js":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=script&lang=js ***!
  \*************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _apis_modules_notobook__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ~/apis/modules/notobook */ "./web_src/vuepages/apis/modules/notobook.js");
/* harmony import */ var _apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ~/apis/modules/cloudbrain */ "./web_src/vuepages/apis/modules/cloudbrain.js");
/* harmony import */ var element_ui__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! element-ui */ "./node_modules/element-ui/lib/element-ui.common.js");
/* harmony import */ var element_ui__WEBPACK_IMPORTED_MODULE_26___default = /*#__PURE__*/__webpack_require__.n(element_ui__WEBPACK_IMPORTED_MODULE_26__);
...
var timerCb1, timerCb2;
var AppSubUrl = window.config.AppSubUrl;
var finalState = ["STOPPED", "CREATE_FAILED", "UNAVAILABLE", "DELETED", "RESIZE_FAILED", "SUCCEEDED", "IMAGE_FAILED", "SUBMIT_FAILED", "DELETE_FAILED", "KILLED", "COMPLETED", "FAILED", "CANCELED", "LOST", "START_FAILED", "SUBMIT_MODEL_FAILED", "DEPLOY_SERVICE_FAILED", "CHECK_FAILED", "STOPPING", "CREATED_FAILED"];
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    selectResource: function selectResource(index) {
    ...
    getPointInfo: function getPointInfo() {
      if (this.notebookInfo.cloudBrainPaySwitch && this.notebookInfo.PointAccount) {
        var blance = this.notebookInfo.PointAccount.Balance;
    ...
    getNpuImages: function getNpuImages(specId) {
      var _this = this;

      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_25__.getAiTaskImgesBySpec)({
        ...
        if (res.code == 0) {
          ...
          _this.npuImageList = ((_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.images) || [];
          var imageId = new URLSearchParams(window.location.search).has("image");

          if (imageId && _this.npuImageList.map(function (item) {
            return item.image_id;
          }).includes(imageId)) {
            _this.selectedImage = imageId;
          } else {
            if (_this.npuImageList[0]) {
              _this.selectedImage = _this.npuImageList[0].image_id;
            }
          }
        }
      })["catch"](function (err) {
    ...
    getNotebookInfo: function getNotebookInfo() {
      var _this2 = this;
      ...
      (0,_apis_modules_notobook__WEBPACK_IMPORTED_MODULE_24__.getFileNotebook)().then(function (res) {
        if (res.data.code == 0) {
          _this2.notebookInfo = res.data;

          if (_this2.activeLoadFirst) {
            _this2.getNpuImages(_this2.notebookInfo.specNpu.id);
          }

          _this2.getPointInfo();
        } else {
          element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(res.data.message);
        }

        _this2.loading = false;
        _this2.activeLoadFirst = false;
      })["catch"](function (err) {
        element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(err);
        _this2.loading = false;
        _this2.activeLoadFirst = false;
      });
    },
    getCb1NotebookInfo: function getCb1NotebookInfo(id, index, data) {
      var _this3 = this;

      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_25__.getAiTaskBrief)({
        id: id
      }).then(function (res) {
        res = res.data;
        ...
        if (res.code == 0) {
          ...
          if (_data.status === "RUNNING") {
            ...
            setTimeout(_this3.getFileInfoReadyNotebook(fileData, index), 0);
            clearInterval(timerCb1);
          }

          if (finalState.includes(_data.status)) {
            _this3.btnStatus[index] = 0;
            clearInterval(timerCb1);
          }
        }
      })["catch"](function (err) {
    ...
    getCb2NotebookInfo: function getCb2NotebookInfo(id, index, data) {
      var _this4 = this;
      ...
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_25__.getAiTaskBrief)({
        ...
        if (res.code == 0) {
          ...
          if (_data.status === "RUNNING") {
            ...
            setTimeout(_this4.getFileInfoReadyNotebook(fileData, 2), 0);
            clearInterval(timerCb2);
          }

          if (finalState.includes(_data.status)) {
            element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(_data.status);
            _this4.btnStatus[2] = 0;
            clearInterval(timerCb2);
          }
        }
      })["catch"](function (err) {
    ...
    getFileInfoReadyNotebook: function getFileInfoReadyNotebook(data, index) {
      var retryCount = 5;
      var self = this;
      ...
      function getStatus(data, index) {
        (0,_apis_modules_notobook__WEBPACK_IMPORTED_MODULE_24__.getFileInfoNotebook)(data).then(function (res) {
          retryCount--;
    ...
    goDebug: function goDebug(index) {
      var _this5 = this;

      var id = index === 2 ? this.deubgUrlNpu : this.deubgUrlGpu;
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_25__.getAiTaskDebugUrl)({
        id: id,
        repoOwnerName: this.fileInfo.sign_name,
        repoName: this.notebookInfo.projectName,
        file: "".concat(this.fileInfo.owner_name, "/").concat(this.fileInfo.project_name, "/").concat(this.fileInfo.branch_name, "/").concat(this.fileInfo.file)
      }).then(function (res) {
        res = res.data;
        ...
        if (res.code == 0) {
          ...
          element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(res.msg);
        }
      })["catch"](function (err) {
        _this5.btnStatus[index] = 0;
        element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(err);
      });
    },
    stopDebug: function stopDebug(index) {
      var _this6 = this;

      this.btnStatus[index] = 3;
      var id = index === 2 ? this.deubgUrlNpuStop : this.deubgUrlGpuStop;
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_25__.stopAiTask)({
        id: id,
        repoOwnerName: this.fileInfo.sign_name,
        repoName: this.notebookInfo.projectName
      }).then(function (res) {
        ...
        if (res.code == 0) {
          _this6.btnStatus[index] = 0;
          element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.success(_this6.$t("notebook.stopSuccess"));
        } else {
          _this6.btnStatus[index] = 0;
          element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(res.msg);
        }
    ...
    createTask: function createTask(index) {
      var _this7 = this;

      if (index === 2) {
        var selectedImage = this.npuImageList.filter(function (item) {
          return item.image_id == _this7.selectedImage;
        })[0];
        ...
        if (selectedImage) {
          ...
          element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(this.$t("cloudbrainObj.selectImage"));
          return;
        }
      }
      ...
      var repoPath = "repos/".concat(this.fileInfo.owner_name, "/").concat(this.fileInfo.project_name);
      this.btnStatus[index] = 1;
      (0,_apis_modules_notobook__WEBPACK_IMPORTED_MODULE_24__.createNotebook)(data).then(function (res) {
        if (res.data.code === 0 && res.status === 200) {
          if (index === 2) {
            timerCb2 = setInterval(function () {
              setTimeout(_this7.getCb2NotebookInfo(res.data.message, index, data), 0);
            }, 10000);
          } else {
            timerCb1 = setInterval(function () {
              setTimeout(_this7.getCb1NotebookInfo(res.data.message, index, data), 0);
            }, 10000);
          }

          _this7.alertCb = false;
        } else if (res.data.code == 2) {
          _this7.btnStatus[index] = 0;
          _this7.alertCb = true;
        } else {
          _this7.btnStatus[index] = 0;
          element_ui__WEBPACK_IMPORTED_MODULE_26__.Message.error(res.data.message);
        ...
        if (err.response.status === 403 && err.response.data.code === 1) {
          location.href = "".concat(AppSubUrl, "/authentication/wechat/bind");
        }

        if (err.response.status === 401) {
          location.href = "".concat(AppSubUrl, "/user/login?redirect_to=").concat(encodeURIComponent(location.origin + location.pathname + '?card=' + _this7.selectIndex + '&image=' + _this7.selectedImage));
          return;
        }
  ...
  computed: {
    cpuSpec: function cpuSpec() {
      var gpuMemStr = this.notebookInfo.specCpu.gpu_mem_gi_b !== 0 ? "(".concat(this.$t("notebook.graphicMemory"), ": ").concat(this.notebookInfo.specCpu.gpu_mem_gi_b, "GB)") : '';
      var cpu_spec = "".concat(this.$t("notebook.specification"), "\uFF1AGPU: ").concat(this.notebookInfo.specCpu.acc_cards_num, "*").concat(this.notebookInfo.specCpu.acc_card_type).concat(gpuMemStr, ", CPU: ").concat(this.notebookInfo.specCpu.cpu_cores);

      if (this.notebookInfo.specCpu.mem_gi_b !== 0) {
        cpu_spec += ", ".concat(this.$t("notebook.memory"), ": ").concat(this.notebookInfo.specCpu.mem_gi_b, "GB");
      }

      if (this.notebookInfo.specCpu.share_mem_gi_b !== 0) {
        cpu_spec += ", ".concat(this.$t("notebook.sharedMemory"), ": ").concat(this.notebookInfo.specCpu.share_mem_gi_b, "GB");
      }

      return cpu_spec;
    },
    npuSpec: function npuSpec() {
      var acc_card_type = '';
      ...
      var gpuMemStr = this.notebookInfo.specNpu.gpu_mem_gi_b !== 0 ? "(".concat(this.$t("notebook.graphicMemory"), ": ").concat(this.notebookInfo.specNpu.gpu_mem_gi_b, "GB)") : '';
      var npu_spec = "".concat(this.$t("notebook.specification"), "\uFF1ANPU: ").concat(this.notebookInfo.specNpu.acc_cards_num, "*").concat(acc_card_type).concat(gpuMemStr, ", CPU: ").concat(this.notebookInfo.specNpu.cpu_cores);

      if (this.notebookInfo.specNpu.mem_gi_b !== 0) {
        npu_spec += ", ".concat(this.$t("notebook.memory"), ": ").concat(this.notebookInfo.specNpu.mem_gi_b, "GB");
      }

      if (this.notebookInfo.specNpu.share_mem_gi_b !== 0) {
        npu_spec += ", ".concat(this.$t("notebook.sharedMemory"), ": ").concat(this.notebookInfo.specNpu.share_mem_gi_b, "GB");
      }

      return npu_spec;
    },
    npuImageType: function npuImageType() {
      return this.notebookInfo.imageNpuDescription;
    },
    gpuSpec: function gpuSpec() {
      var gpuMemStr = this.notebookInfo.specGpu.gpu_mem_gi_b !== 0 ? "(".concat(this.$t("notebook.graphicMemory"), ": ").concat(this.notebookInfo.specGpu.gpu_mem_gi_b, "GB)") : '';
      var gpu_spec = "".concat(this.$t("notebook.specification"), "\uFF1AGPU: ").concat(this.notebookInfo.specGpu.acc_cards_num, "*").concat(this.notebookInfo.specGpu.acc_card_type).concat(gpuMemStr, ", CPU: ").concat(this.notebookInfo.specGpu.cpu_cores);

      if (this.notebookInfo.specGpu.mem_gi_b !== 0) {
        gpu_spec += ", ".concat(this.$t("notebook.memory"), ": ").concat(this.notebookInfo.specGpu.mem_gi_b, "GB");
      }

      if (this.notebookInfo.specGpu.share_mem_gi_b !== 0) {
        gpu_spec += ", ".concat(this.$t("notebook.sharedMemory"), ": ").concat(this.notebookInfo.specGpu.share_mem_gi_b, "GB");
      }
  ...
  beforeDestroy: function beforeDestroy() {
    clearInterval(timerCb1);
    clearInterval(timerCb2);
    document.querySelector("#notebook-debug").removeEventListener("click", this.handler);
  },
  mounted: function mounted() {
    var selfData = document.querySelector('#__vue-self-data');
    ...
    document.querySelector("#notebook-debug").addEventListener("click", this.handler);
  }
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createNotebook: function() { return /* binding */ createNotebook; },
/* harmony export */   getCb1Notebook: function() { return /* binding */ getCb1Notebook; },
/* harmony export */   getCb2Notebook: function() { return /* binding */ getCb2Notebook; },
/* harmony export */   getFileInfoNotebook: function() { return /* binding */ getFileInfoNotebook; },
/* harmony export */   getFileNotebook: function() { return /* binding */ getFileNotebook; },
/* harmony export */   stopNotebook: function() { return /* binding */ stopNotebook; }
/* harmony export */ });
...
var getFileNotebook = function getFileNotebook() {
...
var createNotebook = function createNotebook(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_1__["default"])({
...
var getCb1Notebook = function getCb1Notebook(path, jobid) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_1__["default"])({
    url: "/api/v1/".concat(path, "/cloudbrain/").concat(jobid),
    method: "get",
    params: {}
  });
}; // Notebook获取云脑II调试任务状态

var getCb2Notebook = function getCb2Notebook(path, jobid) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_1__["default"])({
    url: "/api/v1/".concat(path, "/modelarts/notebook/").concat(jobid),
    method: "get",
    params: {}
  });
...
var getFileInfoNotebook = function getFileInfoNotebook(data) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_1__["default"])({
...
var stopNotebook = function stopNotebook(url) {
  return (0,_service__WEBPACK_IMPORTED_MODULE_1__["default"])({
    url: url,
    method: "post",
    params: {}
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/notebook/debug/index.vue");





vue__WEBPACK_IMPORTED_MODULE_4__["default"].use(element_ui__WEBPACK_IMPORTED_MODULE_0__.Dialog);
vue__WEBPACK_IMPORTED_MODULE_4__["default"].use(element_ui__WEBPACK_IMPORTED_MODULE_0__.Loading.directive);
new vue__WEBPACK_IMPORTED_MODULE_4__["default"]({
  i18n: _langs__WEBPACK_IMPORTED_MODULE_2__.i18n,
  render: function render(h) {
    return h(_index_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
  }
}).$mount('#__vue-root');

/***/ }),

/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_1711e74a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=1711e74a&scoped=true */ "./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=template&id=1711e74a&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_1711e74a_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less */ "./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_1711e74a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_1711e74a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "1711e74a",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/notebook/debug/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=script&lang=js":
/*!*********************************************************************************!*\
  !*** ./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=script&lang=js ***!
  \*********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less":
/*!******************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less ***!
  \******************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1711e74a_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=style&index=0&id=1711e74a&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=template&id=1711e74a&scoped=true":
/*!***************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=template&id=1711e74a&scoped=true ***!
  \***************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1711e74a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1711e74a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1711e74a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=1711e74a&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=template&id=1711e74a&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=template&id=1711e74a&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/notebook/debug/index.vue?vue&type=template&id=1711e74a&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          attrs: {
            title: _vm.$t("notebook.createNewNotebook"),
            ...
            [
              _c(
                "div",
                {
                  ...
                  staticClass: "ui message alert-info"
                },
                [
                  _c(
                    "div",
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.$t("notebook.sameTaskTips1")) + " "
                              ),
                              _c(
                                "span",
                                {
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm.$t("notebook.sameTaskTips2"))
                                  )
                                ]
                              ),
                              _vm._v(
                                "\n              " +
                                  _vm._s(_vm.$t("notebook.sameTaskTips3"))
                              )
                            ]
                          ),
                          _vm._v(" "),
                          _c("div", { staticStyle: { color: "#939393" } }, [
                            _vm._v(
                              _vm._s(_vm.$t("notebook.sameTaskTips4")) + " “"
                            ),
                            _c(
                              "a",
                              {
                              ...
                              [
                                _vm._v(
                                  _vm._s(_vm.$t("notebook.sameTaskTips5")) +
                                    " > " +
                                    _vm._s(_vm.$t("notebook.sameTaskTips6"))
                                )
                              ]
                            ),
                            _vm._v(
                              "”\n              " +
                                _vm._s(_vm.$t("notebook.sameTaskTips7"))
                            )
                          ])
                        ]
                      )
              ...
              _c(
                "div",
                {
                  staticClass: "three-resource-type",
                  class: { active: _vm.selectIndex == 0 },
                  on: {
                    click: function($event) {
                      return _vm.selectResource(0)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "resource-child-node" }, [
                    _c(
                      "div",
                      { staticClass: "resource-type-icon background-C" },
                      [_c("span", { staticClass: "text" }, [_vm._v("C")])]
                    ),
                    _vm._v(" "),
                    _c("div", { staticClass: "resource-type-detail" }, [
                      _c("div", { staticClass: "detail-title" }, [
                        _c("span", [_vm._v(_vm._s(_vm.$t("notebook.cpuEnv")))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "detail-spec" }, [
                        _c("span", [_vm._v(_vm._s(_vm.cpuSpec))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "detail-spec" }, [
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.$t("image")) +
                              "：" +
                              _vm._s(_vm.notebookInfo.imageCpuDescription)
                          )
                        ])
                      ])
                    ]),
                    ...
                    _c(
                      "div",
                      {
                        ...
                        style: _vm.notebookInfo.cloudBrainPaySwitch
                          ? { marginBottom: "10px" }
                          : ""
                      },
                      [
                        _vm.selectIndex === 0
                          ? _c("i", {
                              staticClass: "ri-checkbox-circle-line green",
                              class: {
                                "slide-in-bottom":
                                  !_vm.slideActive && !_vm.initSelect
                              }
                            })
                          : _vm._e(),
                        _vm._v(" "),
                        _c("i", {
                          staticClass: "ri-checkbox-blank-circle-line gray",
                          class: { "fade-out": _vm.selectIndex === 0 }
                        })
                      ]
                    ),
                    _vm._v(" "),
                    _vm.notebookInfo.cloudBrainPaySwitch && !_vm.loading
                      ? _c("div", { staticClass: "resource-unit-price" }, [
                          _vm._v(
                            _vm._s(
                              _vm.notebookInfo.specCpu.unit_price.toFixed(2)
                            ) +
                              " " +
              ...
              _c(
                ...
                {
                  staticClass: "three-resource-type",
                  class: { active: _vm.selectIndex == 2 },
                  on: {
                    click: function($event) {
                      return _vm.selectResource(2)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "resource-child-node" }, [
                    _c(
                      "div",
                      { staticClass: "resource-type-icon background-N" },
                      [_c("span", { staticClass: "text" }, [_vm._v("N")])]
                    ),
                    _vm._v(" "),
                    _c("div", { staticClass: "resource-type-detail" }, [
                      _c("div", { staticClass: "detail-title" }, [
                        _c("span", [_vm._v(_vm._s(_vm.$t("notebook.npuEnv")))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "detail-spec" }, [
                        _c("span", [_vm._v(_vm._s(_vm.npuSpec))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "detail-spec" }, [
                        _c("div", { staticClass: "select-image" }, [
                          ...
                          _c(
                            "select",
                            {
                              ...
                              staticClass: "select-image-label",
                              on: {
                                click: function($event) {
                                ...
                                change: function($event) {
                                  ...
                                  _vm.selectedImage = $event.target.multiple
                                    ? $$selectedVal
                                    : $$selectedVal[0]
                                }
                              }
                            },
                            _vm._l(_vm.npuImageList, function(item) {
                              return _c(
                                "option",
                                {
                                  key: item.image_id,
                                  domProps: { value: item.image_id }
                                },
                                [
                                  _vm._v(
                                    "\n                    " +
                                      _vm._s(item.image_name) +
                                      "\n                  "
                                  )
                                ]
                              )
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("i", {
                          staticClass: "ri-checkbox-blank-circle-line gray",
                          class: { "fade-out": _vm.selectIndex === 2 }
                        })
                      ]
                    ),
                    _vm._v(" "),
                    _vm.notebookInfo.cloudBrainPaySwitch && !_vm.loading
                      ? _c("div", { staticClass: "resource-unit-price" }, [
                          _vm._v(
                            _vm._s(
                              _vm.notebookInfo.specNpu.unit_price.toFixed(2)
                            ) +
                              " " +
                              _vm._s(_vm.$t("resourcesManagement.point_hr"))
                          )
              ...
              _c(
                ...
                {
                  staticClass: "three-resource-type",
                  class: { active: _vm.selectIndex == 1 },
                  on: {
                    click: function($event) {
                      return _vm.selectResource(1)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "resource-child-node" }, [
                    _c(
                      "div",
                      { staticClass: "resource-type-icon background-G" },
                      [_c("span", { staticClass: "text" }, [_vm._v("G")])]
                    ),
                    _vm._v(" "),
                    _c("div", { staticClass: "resource-type-detail" }, [
                      _c("div", { staticClass: "detail-title" }, [
                        _c("span", [_vm._v(_vm._s(_vm.$t("notebook.gpuEnv")))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "detail-spec" }, [
                        _c("span", [_vm._v(_vm._s(_vm.gpuSpec))])
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "detail-spec" }, [
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.$t("image")) +
                              "：" +
                              _vm._s(_vm.notebookInfo.imageGpuDescription)
                          )
                        ])
                      ])
                    ]),
                    ...
                    _c(
                      ...
                      [
                        _vm.selectIndex === 1 && !_vm.initSelect
                          ? _c("i", {
                              staticClass: "ri-checkbox-circle-line green",
                              class: {
                                "slide-in-top":
                        ...
                        _c("i", {
                          staticClass: "ri-checkbox-blank-circle-line gray",
                          class: { "fade-out": _vm.selectIndex === 1 }
                        })
                      ]
                    ),
                    _vm._v(" "),
                    _vm.notebookInfo.cloudBrainPaySwitch && !_vm.loading
                      ? _c("div", { staticClass: "resource-unit-price" }, [
                          _vm._v(
                            _vm._s(
                              _vm.notebookInfo.specGpu.unit_price.toFixed(2)
                            ) +
                              " " +
                              _vm._s(_vm.$t("resourcesManagement.point_hr"))
                          )
              ...
              _vm._v(" "),
              _c("div", { staticClass: "resource-footer" }, [
                _vm.selectIndex == 0
                  ? _c("div", { staticClass: "resource-operate" }, [
                      _vm.btnStatus[0] === 0
                        ? _c("div", [
                            _c(
                              "button",
                              {
                                staticClass: "ui green small button",
                                on: {
                                  click: function($event) {
                                    return _vm.createTask(0)
                                  }
                                }
                              },
                              [_vm._v(_vm._s(_vm.$t("notebook.newTask")))]
                            ),
                            _vm._v(" "),
                            _vm.notebookInfo.waitCountGpu == 0
                              ? _c("span", { staticClass: "text" }, [
                                  _vm._v(_vm._s(_vm.$t("notebook.noQuene")))
                                ])
                              : _c("span", { staticClass: "text" }, [
                                  _vm._v(
                                    _vm._s(_vm.$t("notebook.queneTips1")) + " "
                                  ),
                                  _c(
                                    "span",
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.notebookInfo.waitCountGpu + 1
                                        )
                                      )
                                    ]
                                  ),
                                  _vm._v(
                                    " " + _vm._s(_vm.$t("notebook.queneTips2"))
                                  )
                                ])
                          ])
                        : _vm.btnStatus[0] === 1
                        ? _c("div", [
                            _c(
                              "button",
                              {
                                staticClass: "ui disabled small button",
                            ...
                            _vm._v(" "),
                            _c("span", { staticClass: "text" }, [
                              _vm._v(_vm._s(_vm.$t("notebook.watiResource")))
                            ])
                          ])
                        : _vm.btnStatus[0] === 2
                        ? _c("div", [
                            _c(
                              "button",
                              {
                                ...
                                staticStyle: { "background-color": "#1684fc" },
                                on: {
                                  click: function($event) {
                                    return _vm.goDebug(0)
                                  }
                                }
                              },
                              [
                                _c(
                                  ...
                                  [_vm._v(_vm._s(_vm.$t("notebook.debug")))]
                                )
                              ]
                            ),
                            _vm._v(" "),
                            _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.stopDebug(0)
                                  }
                                }
                              },
                              [_vm._v(_vm._s(_vm.$t("notebook.stop")))]
                            ),
                            _vm._v(" "),
                            _c("span", { staticClass: "text" }, [
                              _vm._v(_vm._s(_vm.$t("notebook.notebookRunning")))
                            ])
                          ])
                        : _c("div", [
                            _c(
                              ...
                              [
                                ...
                                _vm._v(_vm._s(_vm.$t("notebook.stopping")))
                              ]
                            )
                          ])
                    ])
                  ...
                  ? _c("div", { staticClass: "resource-operate" }, [
                      _vm.btnStatus[2] === 0
                        ? _c("div", [
                            ...
                            _vm._v(" "),
                            _vm.notebookInfo.waitCountNpu == 0
                              ? _c("span", { staticClass: "text" }, [
                                  _vm._v(_vm._s(_vm.$t("notebook.noQuene")))
                                ])
                              : _c("span", { staticClass: "text" }, [
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.notebookInfo.waitCountNpu + 1
                                        )
                                      )
                                    ]
                                  ),
                ...
                _c("div", { staticStyle: { "margin-left": "15px" } }, [
                  _vm.notebookInfo.cloudBrainPaySwitch &&
                  _vm.notebookInfo.PointAccount &&
                  !_vm.loading
                    ? _c("div", { staticClass: "text" }, [
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.$t("notebook.balanceOfPoints")) +
                              "\n              "
                          ),
                          _c(
                            "span",
                            ...
                            [
                              _vm._v(
                                _vm._s(
                                  _vm.notebookInfo.PointAccount.Balance.toFixed(
                                    2
                                  )
                                )
                              )
                              ...
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: _vm.useUnitPrice > 0,
                                  expression: "useUnitPrice > 0"
                                }
                              ]
                            },
                            [
                              _vm._v(
                                _vm._s(_vm.$t("notebook.expected_time")) +
                                  "\n                "
                              ),
                              _c(
                                "span",
                                { staticStyle: { color: "rgb(250, 140, 22)" } },
                                [_vm._v(" " + _vm._s(_vm.useTime) + " ")]
                              ),
                              _vm._v(
                                "\n                " +
                                  _vm._s(_vm.$t("notebook.hours"))
                              )
                            ]
                          )
                        ]),
                        ...
                        _c(
                          ...
                          [
                            _vm._v(
                              _vm._s(_vm.$t("calcPointAcquisitionInstructions"))
                            )
                          ]
                        )
                      ])
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/notebook/debug/vp-notebook-debug.js"); })
