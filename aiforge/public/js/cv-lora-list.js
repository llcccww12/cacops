"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["cv-lora-list"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _components_Header_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../components/Header.vue */ "./web_src/vuepages/pages/modelbase-portal/components/Header.vue");
/* harmony import */ var _pages_cloudbrain_tools__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ~/pages/cloudbrain/tools */ "./web_src/vuepages/pages/cloudbrain/tools.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ~/apis/modules/cloudbrain */ "./web_src/vuepages/apis/modules/cloudbrain.js");
...
/* harmony import */ var _apis_modules_llmchat__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ~/apis/modules/llmchat */ "./web_src/vuepages/apis/modules/llmchat.js");
...
var cloudBrainTools = new _pages_cloudbrain_tools__WEBPACK_IMPORTED_MODULE_15__.CloudBrainTools();
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Header: _components_Header_vue__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  methods: {
    getTableData: function getTableData() {
      ...
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_18__.getMyAiTasks)(params).then(function (res) {
        _this.loading = false;
        res = res.data;
        ...
        if (res.code == 0) {
          ...
          data.tasks.forEach(function (item) {
            ...
            task.clusterName = (0,_utils__WEBPACK_IMPORTED_MODULE_16__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_17__.CLUSTERS, task.cluster);
            task.accCardTypeShow = (0,_utils__WEBPACK_IMPORTED_MODULE_16__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_17__.ACC_CARD_TYPE, task.acc_card_type);
            ...
            task.jobTypeShow = (0,_utils__WEBPACK_IMPORTED_MODULE_16__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_17__.JOB_TYPE, task.job_type);
    ...
    calcFromNow: function calcFromNow(unix) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_16__.timeSinceUnix)(unix, Date.now() / 1000);
    },
    dateFormat: function dateFormat(unix) {
      return dayjs__WEBPACK_IMPORTED_MODULE_13___default()(unix * 1000).format('YYYY-MM-DD HH:mm:ss');
    },
    goCreate: function goCreate() {
      this.$router.push(this.$route.path + '/create');
    },
    goDetail: function goDetail(row) {
      this.$router.push("/cv/sft/detail/".concat(row.task.id));
    },
    opOnline: function opOnline(row) {
      ...
      this.operating = true;
      (0,_apis_modules_llmchat__WEBPACK_IMPORTED_MODULE_20__.getLoraStage)({
        task_id: row.task.id
      }).then(function (res) {
    ...
    opStop: function opStop(row) {
      ...
      if (this.operating) return;
      this.operating = true;
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_18__.stopAiTask)({
        id: row.task.id
      }).then(function (res) {
    ...
    opDelete: function opDelete(row) {
      ...
      this.$confirm(this.$t('cloudbrainObj.deleteConfirmTips'), this.$t('tips'), {
        ...
        (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_18__.deleteAiTask)({
    ...
    opDebug: function opDebug(row) {
      ...
      if (this.operating) return;
      this.operating = true;
      (0,_apis_modules_cloudbrain__WEBPACK_IMPORTED_MODULE_18__.getAiTaskDebugUrl)({
        repoOwnerName: row.task.repoOwnerName,
        repoName: row.task.repoName,
        id: row.task.id
      }).then(function (res) {
  ...
  beforeMount: function beforeMount() {
    ...
    this.getTableData();
    (0,_apis_modules_common__WEBPACK_IMPORTED_MODULE_19__.getPromoteData)('model/sdfinetune.json').then(function (res) {
      // this.loading = false;
      try {
        var data = JSON.parse(res.data);
        _this6.taskCreateInfo = _objectSpread({}, data);
        _this6.modelList = _this6.taskCreateInfo.model_name;
      } catch (err) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue":
/*!**********************************************************************************!*\
  !*** ./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue ***!
  \**********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Lora_vue_vue_type_template_id_716d4e56_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Lora.vue?vue&type=template&id=716d4e56&scoped=true */ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=template&id=716d4e56&scoped=true");
/* harmony import */ var _Lora_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Lora.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=script&lang=js");
/* harmony import */ var _Lora_vue_vue_type_style_index_0_id_716d4e56_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less */ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Lora_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Lora_vue_vue_type_template_id_716d4e56_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Lora_vue_vue_type_template_id_716d4e56_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "716d4e56",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Lora_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Lora.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=script&lang=js");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_3_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Lora_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less":
/*!*******************************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less ***!
  \*******************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_Lora_vue_vue_type_style_index_0_id_716d4e56_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../../../node_modules/less-loader/dist/cjs.js!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=style&index=0&id=716d4e56&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=template&id=716d4e56&scoped=true":
/*!****************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=template&id=716d4e56&scoped=true ***!
  \****************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Lora_vue_vue_type_template_id_716d4e56_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Lora_vue_vue_type_template_id_716d4e56_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Lora_vue_vue_type_template_id_716d4e56_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Lora.vue?vue&type=template&id=716d4e56&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=template&id=716d4e56&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=template&id=716d4e56&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelbase-portal/views/finetuning/cvlora/Lora.vue?vue&type=template&id=716d4e56&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "btn-content" }, [
                    ...
                    _vm._v(" "),
                    _c("span", [
                      _vm._v(_vm._s(_vm.$t("modelSquare.newLoraFinetune")))
                    ])
                  ])
                ]
              )
      ...
      _c("div", {
        staticClass: "tips",
        domProps: { innerHTML: _vm._s(_vm.$t("modelFinetune.maxTaskTips")) }
      }),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "header-img-card" },
        _vm._l(_vm.modelList, function(model) {
          return _c("div", { key: model.alias, staticClass: "card-box" }, [
            _c("img", {
              attrs: { src: "/img/model/" + model.alias + "-w.png", alt: "" }
            })
          ])
        }),
        0
                  ...
                  [
                    ...
                    _c("el-table-column", {
                      attrs: {
                        ...
                        align: "left",
                        width: _vm.$isMobile && _vm.isSubscriber ? 300 : "",
                        "min-width": "200",
                        "header-align": "center",
                        fixed: "right"
                      },
                              ...
                              _c("div", { staticClass: "op-wrap" }, [
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      _vm._s(
                                        _vm.$t("modelManage.onlineLoraTrain")
                                      )
                                    )
                                  ]
                                ),
