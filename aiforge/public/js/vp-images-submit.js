...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/images/submit/index.vue?vue&type=script&lang=js":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/images/submit/index.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _apis_modules_common__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ~/apis/modules/common */ "./web_src/vuepages/apis/modules/common.js");
/* harmony import */ var _apis_modules_images__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ~/apis/modules/images */ "./web_src/vuepages/apis/modules/images.js");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      pageType: window._PageType,
      // submit|submitAdmin|edit|apply
      pageFrom: window._PageFrom,
      // submit|imageSquare|imageAdmin|apply
      pageSubmitLink: window._PageSubmitLink,
      pageRepoLink: window._PageRepoLink,
      pageAiCenter: window._ImageAiCenter || '',
      isXJUCenter: (window._ImageAiCenter || '').indexOf('xju') == 0,
      // 新大中心
      originData: {},
      form: {
        type: window._ImageType || '2',
        // 0启智GPU|2智算GPU
        tag: '',
        trainType: [],
      ...
      typeList: [{
        k: '0',
        v: _langs__WEBPACK_IMPORTED_MODULE_27__.i18n.t('imagesObj.openIGPU')
      }, {
        k: '2',
        v: _langs__WEBPACK_IMPORTED_MODULE_27__.i18n.t('imagesObj.c2netGPU')
      }],
      computeResourceList: [],
      trainTypeList: [],
      topicLoading: false,
  ...
  components: {},
  computed: {
    trainCopyTypeList: function trainCopyTypeList() {
      var _this = this;

      if (['GCU', 'GPU'].includes(this.form.compute_resource)) {
        return this.trainTypeList;
      } else {
        return this.trainTypeList.map(function (item) {
          if (item.k == 'Notebook') {
            return {
              k: item.k,
              v: _this.$t('TaskTypeTitle.Notebook1')
            };
          } else {
    ...
    displayJobName: function displayJobName() {
  ...
  methods: {
    ...
    checkTag: function checkTag() {
      ...
      var reg = /^[a-zA-Z][a-zA-Z0-9_.\-]{0,49}$/;
      this.errors.tag = !reg.test(this.form.tag);
      return this.errors.tag;
    },
    checkNull: function checkNull(key) {
    ...
    checkThirdPackages: function checkThirdPackages() {
      var last = this.form.thirdPackages.slice(-1) == '\n' ? '\n' : '';
      var lines = this.form.thirdPackages.split('\n');
      this.form.thirdPackages = lines.map(function (item) {
        return item.trim();
      }).filter(function (item) {
        return item;
      }).slice(0, 10).join('\n') + last;
    },
    changeComputeResource: function changeComputeResource() {
    ...
    changeFramework: function changeFramework(framework) {
      var versions = (this.condtionsData['framework_version'][framework] || []).map(function (item) {
        return {
          k: item,
          v: item
        };
    ...
    topicRemoteMethod: function topicRemoteMethod(query) {
      var _this2 = this;

      if (query !== '') {
        this.topicLoading = true;
        (0,_apis_modules_images__WEBPACK_IMPORTED_MODULE_26__.searchImageTopics)({
          q: query
        }).then(function (res) {
          _this2.topicLoading = false;
          res = res.data;

          if (res.topics) {
            _this2.topicList = [];
            var find = res.topics.find(function (item) {
              return item.topic_name === query;
            });
            find && _this2.topicList.push({
              k: find.topic_name,
              v: find.topic_name
            });

            for (var i = 0, iLen = res.topics.length; i < iLen; i++) {
              var topic = res.topics[i];

              if (!find || topic.topic_name !== find.topic_name) {
                _this2.topicList.push({
                  k: topic.topic_name,
                  v: topic.topic_name
                });
              }
    ...
    submit: function submit() {
      ...
      (0,_apis_modules_images__WEBPACK_IMPORTED_MODULE_26__.submitImage)(subData).then(function (res) {
        res = res.data;
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.pageType == 'submit') {
      this.typeList = this.typeList.filter(function (item) {
        return item.k == _this4.form.type;
      });
    }
    ...
    (0,_apis_modules_common__WEBPACK_IMPORTED_MODULE_25__.getStaticFile)('/images_version.json').then(function (res) {
      var data = res.data;

      if (data) {
        _this4.condtionsData = data;
        _this4.frameworkList = (data.framework || []).map(function (item) {
          return {
            k: item,
            v: item
          };
        });
        _this4.form.framework = _this4.frameworkList.length ? _this4.frameworkList[0].k : '';

        if (_this4.form.compute_resource == 'NPU') {
          _this4.form.framework = 'MindSpore';
        }

        _this4.changeFramework(_this4.form.framework);

        _this4.cudaList = (data.cuda || []).map(function (item) {
          return {
            k: item,
            v: "Cuda ".concat(item)
          };
        });
        _this4.form.cuda = _this4.cudaList.length ? _this4.cudaList[0].k : '';
        _this4.dtkList = (data.dtk || []).map(function (item) {
          return {
            k: item,
            v: "Dtk ".concat(item)
          };
        });
        _this4.form.dtk = _this4.dtkList.length ? _this4.dtkList[0].k : '';
        _this4.cannList = (data.cann || []).map(function (item) {
          return {
            k: item,
            v: "Cann ".concat(item)
          };
        });
        _this4.form.cann = _this4.cannList.length ? _this4.cannList[0].k : '';
        _this4.pythonList = (data.python || []).map(function (item) {
          return {
            k: item,
            v: "Python ".concat(item)
          };
        });
        _this4.form.python = _this4.pythonList.length ? _this4.pythonList[0].k : '';

        if (_this4.pageType == 'edit' || _this4.pageType == 'apply') {
          var _image = window._Image || {};

          _this4.form.framework = _image.framework;

          _this4.changeFramework(_this4.form.framework);

          _this4.form.framework_version = _image.frameworkVersion;
          _this4.form.cuda = _image.cudaVersion;
          _this4.form.dtk = _image.dtkVersion;
          _this4.form.cann = _image.cannVersion;
          _this4.form.python = _image.pythonVersion;
        }

        _this4.computeResourceList = (data.compute_resource || []).map(function (item) {
          return {
            k: item,
            v: _this4.$t('computeResourceTitle.' + item) || item
          };
        });
        console.log("data", data);
        _this4.trainTypeList = (data.trainType || []).map(function (item) {
          return {
            k: item,
            v: _this4.$t('TaskTypeTitle.' + item) || item
          };
        });

        if (_this4.trainTypeList.length) {
          if (_this4.form.trainType.length === 0) {
            _this4.form.trainType.push(_this4.trainTypeList[0].k);
          }
        }
      }
    })["catch"](function (err) {
  ...
  mounted: function mounted() {
    ...
    var urlParams = (0,_utils__WEBPACK_IMPORTED_MODULE_28__.getUrlSearchParams)();
    ...
    if (urlParams.trainType) {
      ...
      urlParams.trainType.split('_').forEach(function (item) {
        console.log(item, _this5.form.trainType);

        if (!_this5.form.trainType.includes(item)) {
          _this5.form.trainType.push(item);
        }
      });
    }
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/images/submit/index.vue");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_1461c01a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=1461c01a&scoped=true */ "./web_src/vuepages/pages/images/submit/index.vue?vue&type=template&id=1461c01a&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/images/submit/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_1461c01a_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=1461c01a&scoped=true&lang=less */ "./web_src/vuepages/pages/images/submit/index.vue?vue&type=style&index=0&id=1461c01a&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_1461c01a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_1461c01a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "1461c01a",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/images/submit/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/images/submit/index.vue?vue&type=script&lang=js":
/*!********************************************************************************!*\
  !*** ./web_src/vuepages/pages/images/submit/index.vue?vue&type=script&lang=js ***!
  \********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/images/submit/index.vue?vue&type=style&index=0&id=1461c01a&scoped=true&lang=less":
/*!*****************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/images/submit/index.vue?vue&type=style&index=0&id=1461c01a&scoped=true&lang=less ***!
  \*****************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_1461c01a_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=1461c01a&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/images/submit/index.vue?vue&type=style&index=0&id=1461c01a&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/images/submit/index.vue?vue&type=template&id=1461c01a&scoped=true":
/*!**************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/images/submit/index.vue?vue&type=template&id=1461c01a&scoped=true ***!
  \**************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1461c01a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1461c01a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_1461c01a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=1461c01a&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/images/submit/index.vue?vue&type=template&id=1461c01a&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/images/submit/index.vue?vue&type=template&id=1461c01a&scoped=true":
/*!*****************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/images/submit/index.vue?vue&type=template&id=1461c01a&scoped=true ***!
  \*****************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "form-head" }, [
            _vm.pageType == "edit"
              ? _c("h4", [_vm._v(_vm._s(_vm.$t("imagesObj.editImage")))])
              : _vm._e(),
            _vm._v(" "),
            _vm.pageType == "submit" || _vm.pageType == "submitAdmin"
              ? _c("h4", [_vm._v(_vm._s(_vm.$t("imagesObj.submitImage")))])
              : _vm._e(),
            _vm._v(" "),
            _vm.pageType == "apply"
              ? _c("h4", [_vm._v(_vm._s(_vm.$t("imagesObj.appyImage")))])
              : _vm._e()
          ]),
          _vm._v(" "),
              ...
              [
                _c(
                  "div",
                  {
                    ...
                    staticClass: "form-row form-row-cluster"
                  },
                  [
                    _c("div", { staticClass: "title align-items-center" }, [
                      _c("span", { staticClass: "required" }, [
                        _vm._v(_vm._s(_vm.$t("modelManage.useCluster")))
                      ])
                    ]),
                    _vm._v(" "),
                        ...
                        _vm._l(_vm.typeList, function(item) {
                          return _c(
                            "a",
                            {
                              key: item.k,
                              staticClass: "item",
                              class: _vm.form.type == item.k ? "focus" : "",
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title" }, [
                    _c("span", { staticClass: "required" }, [
                      _vm._v(_vm._s(_vm.$t("imagesObj.imageTag")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c("el-input", {
                        ...
                        attrs: {
                          disabled:
                            _vm.pageType != "submit" &&
                            _vm.pageType != "submitAdmin",
                          maxlength: 50,
                          placeholder: _vm.$t("imagesObj.imageTagPlaceholder"),
                          autofocus: true
                        },
                        on: { blur: _vm.checkTag, input: _vm.checkTag },
                        model: {
                          value: _vm.form.tag,
                          callback: function($$v) {
                      ...
                      _c("div", { staticClass: "tips" }, [
                        _vm._v(_vm._s(_vm.$t("imagesObj.imageTagInputTips")))
                      ])
                    ],
                    1
                  )
                ...
                _c(
                  ...
                  [
                    _c("div", { staticClass: "title" }, [
                      _c("span", { staticClass: "required" }, [
                        _vm._v(_vm._s(_vm.$t("imagesObj.imageTaskType")))
                      ])
                    ]),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        _c(
                          "el-select",
                          {
                            ...
                            attrs: {
                              multiple: "",
                              disabled: _vm.pageType != "submitAdmin"
                            },
                            on: {
                              change: function($event) {
                                return _vm.checkNull("trainType")
                              }
                            },
                            model: {
                              value: _vm.form.trainType,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "trainType", $$v)
                              },
                              expression: "form.trainType"
                            }
                          },
                          _vm._l(_vm.trainCopyTypeList, function(item) {
                            return _c("el-option", {
                              key: item.k,
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass: "field-input",
                          attrs: { disabled: _vm.pageType != "submitAdmin" },
                          on: { change: _vm.changeComputeResource },
                          model: {
                            value: _vm.form.compute_resource,
                            callback: function($$v) {
                              _vm.$set(_vm.form, "compute_resource", $$v)
                            },
                            expression: "form.compute_resource"
                          }
                        },
                  ...
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title" }, [
                        _c(
                          ...
                          {
                            class:
                              _vm.form.compute_resource == "GPU"
                                ? "required"
                                : ""
                          },
                          [_vm._v(_vm._s(_vm.$t("imagesObj.imageAdress")))]
                        )
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c("el-input", {
                            ...
                            attrs: {
                              maxlength: 300,
                              placeholder: _vm.$t(
                                "imagesObj.imageAdressPlaceholder"
                              )
                            },
                            on: {
                              blur: function($event) {
                                return _vm.checkNull("place")
                              },
                ...
                _vm._v(" "),
                _vm.pageType == "submitAdmin" ||
                (_vm.pageType == "edit" && _vm.pageFrom == "imageAdmin")
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title" }, [
                        _c("span", [
                        ...
                        [
                          _c("el-input", {
                            ...
                            attrs: {
                              ...
                              rows: 3,
                              placeholder: _vm.$t(
                                "imagesObj.imageAiCenterPlaceholder"
                              )
                            },
                            model: {
                              value: _vm.form.aICenterImage,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "aICenterImage", $$v)
                              },
                              expression: "form.aICenterImage"
                            }
                          })
                        ],
                        1
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "left" }, [
                    _c("div", { staticClass: "title" }, [
                      _c("span", { staticClass: "required" }, [
                        _vm._v(_vm._s(_vm.$t("imagesObj.frameworkName")))
                      ])
                    ]),
                    _vm._v(" "),
                    _c(
                      ...
                      {
                        staticClass: "content",
                        class: _vm.errors.framework ? "error" : ""
                      },
                      [
                        _c(
                          "el-select",
                          {
                            staticClass: "field-input",
                            on: { change: _vm.changeFramework },
                            model: {
                              value: _vm.form.framework,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "framework", $$v)
                              },
                              expression: "form.framework"
                            }
                          },
                          _vm._l(_vm.frameworkList, function(item) {
                            return _c("el-option", {
                              key: item.k,
                              attrs: { value: item.k, label: item.v }
                            })
                  ...
                  _c("div", { staticClass: "right" }, [
                    _c(
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: _vm.frameworkVersionList.length,
                            expression: "frameworkVersionList.length"
                          }
                        ],
                        staticClass: "title"
                      },
                      [
                        _c("span", { staticClass: "required" }, [
                          _vm._v(_vm._s(_vm.$t("imagesObj.version")))
                        ])
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      "div",
                      {
                        ...
                        staticClass: "content",
                        class: _vm.errors.framework_version ? "error" : ""
                      },
                      [
                        _c(
                          "el-select",
                          {
                            ...
                            on: {
                              change: function($event) {
                                return _vm.checkNull("framework_version")
                              }
                            },
                            model: {
                              value: _vm.form.framework_version,
                              callback: function($$v) {
                                _vm.$set(_vm.form, "framework_version", $$v)
                              },
                              expression: "form.framework_version"
                            }
                          },
                          _vm._l(_vm.frameworkVersionList, function(item) {
                            return _c("el-option", {
                              key: item.k,
                              attrs: { value: item.k, label: item.v }
                            })
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title" }, [
                    _c("span", { staticClass: "required" }, [
                      _vm._v(_vm._s(_vm.$t("imagesObj.pyVersion")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c(
                        "el-select",
                        {
                          ...
                          on: {
                            change: function($event) {
                              return _vm.checkNull("python")
                            }
                          },
                          model: {
                            value: _vm.form.python,
                            callback: function($$v) {
                              _vm.$set(_vm.form, "python", $$v)
                            },
                            expression: "form.python"
                          }
                        },
                ...
                _vm.form.compute_resource == "GPU"
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title" }, [
                        _c("span", { staticClass: "required" }, [
                          _vm._v(_vm._s(_vm.$t("imagesObj.cudaVersion")))
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              on: {
                                change: function($event) {
                                  return _vm.checkNull("cuda")
                                }
                              },
                              model: {
                                value: _vm.form.cuda,
                                callback: function($$v) {
                                  _vm.$set(_vm.form, "cuda", $$v)
                                },
                                expression: "form.cuda"
                              }
                            },
                            _vm._l(_vm.cudaList, function(item) {
                              return _c("el-option", {
                                key: item.k,
                                attrs: { value: item.k, label: item.v }
                              })
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm.form.compute_resource == "NPU"
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title" }, [
                        _c("span", { staticClass: "required" }, [
                          _vm._v(_vm._s(_vm.$t("imagesObj.cannVersion")))
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              on: {
                                change: function($event) {
                                  return _vm.checkNull("cann")
                                }
                              },
                              model: {
                                value: _vm.form.cann,
                                callback: function($$v) {
                                  _vm.$set(_vm.form, "cann", $$v)
                                },
                                expression: "form.cann"
                              }
                            },
                            _vm._l(_vm.cannList, function(item) {
                              return _c("el-option", {
                                key: item.k,
                                attrs: { value: item.k, label: item.v }
                              })
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm.form.compute_resource == "DCU"
                  ? _c("div", { staticClass: "form-row" }, [
                      _c("div", { staticClass: "title" }, [
                        _c("span", { staticClass: "required" }, [
                          _vm._v(_vm._s(_vm.$t("imagesObj.dtkVersion")))
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c(
                            "el-select",
                            {
                              ...
                              on: {
                                change: function($event) {
                                  return _vm.checkNull("dtk")
                                }
                              },
                              model: {
                                value: _vm.form.dtk,
                                callback: function($$v) {
                                  _vm.$set(_vm.form, "dtk", $$v)
                                },
                                expression: "form.dtk"
                              }
                            },
                            _vm._l(_vm.dtkList, function(item) {
                              return _c("el-option", {
                                key: item.k,
                                attrs: { value: item.k, label: item.v }
                              })
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "left" }, [
                    _c("div", { staticClass: "title" }, [
                      _c("span", [
                        _vm._v(_vm._s(_vm.$t("imagesObj.operationSystemName")))
                      ])
                    ]),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        _c("el-input", {
                          ...
                          attrs: {
                            maxlength: 100,
                            placeholder: _vm.$t(
                              "imagesObj.operationSystemNamePlaceholder"
                            )
                          },
                          model: {
                            value: _vm.form.operationSystem,
                            callback: function($$v) {
                              _vm.$set(_vm.form, "operationSystem", $$v)
                            },
                            expression: "form.operationSystem"
                          }
                        })
                      ],
                      1
                  ...
                  _c("div", { staticClass: "right" }, [
                    _c("div", { staticClass: "title" }, [
                      _c("span", [_vm._v(_vm._s(_vm.$t("imagesObj.version")))])
                    ]),
                    _vm._v(" "),
                    _c(
                      "div",
                      ...
                      [
                        _c("el-input", {
                          ...
                          attrs: {
                            maxlength: 50,
                            placeholder: _vm.$t(
                              "imagesObj.operationSystemVersionPlaceholder"
                            )
                          },
                          model: {
                            value: _vm.form.operationSystemVersion,
                            callback: function($$v) {
                              _vm.$set(_vm.form, "operationSystemVersion", $$v)
                            },
                            expression: "form.operationSystemVersion"
                          }
                        })
                      ],
                      1
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title" }, [
                    _c("span", [
                      _vm._v(_vm._s(_vm.$t("imagesObj.thirdPackages")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c("el-input", {
                        ...
                        attrs: {
                          ...
                          rows: 3,
                          placeholder: _vm.$t(
                            "imagesObj.thirdPackagesPlaceholder"
                          ),
                          maxlength: 1000
                        },
                        on: { blur: _vm.checkThirdPackages },
                        model: {
                          value: _vm.form.thirdPackages,
                          callback: function($$v) {
                            _vm.$set(_vm.form, "thirdPackages", $$v)
                          },
                          expression: "form.thirdPackages"
                        }
                      })
                    ],
                    1
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title" }, [
                    _c("span", [_vm._v(_vm._s(_vm.$t("imagesObj.topic")))])
                  ]),
                  _vm._v(" "),
                  _c(
                    "div",
                    ...
                    [
                      _c(
                        "el-select",
                        {
                          staticClass: "field-input topic-input",
                          attrs: {
                            "popper-class": "popper-topic-input",
                            remote: "",
                            "remote-method": _vm.topicRemoteMethod,
                            loading: _vm.topicLoading,
                            multiple: "",
                            filterable: "",
                            "allow-create": "",
                            "default-first-option": "",
                            clearable: "",
                            placeholder: _vm.$t("imagesObj.topicPlaceholder")
                          },
                          model: {
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "tips tips-ext" }, [
                        _c("i", { staticClass: "ri-error-warning-line" }),
                        _vm._v(" "),
                        _c("span", {
                          domProps: {
                            innerHTML: _vm._s(_vm.$t("imagesObj.topicTips"))
                          }
                        })
                      ])
                    ],
                ...
                _c("div", { staticClass: "form-row" }, [
                  _c("div", { staticClass: "title" }, [
                    _c("span", { staticClass: "required" }, [
                      _vm._v(_vm._s(_vm.$t("imagesObj.descr")))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    {
                      staticClass: "content",
                      class: _vm.errors.description ? "error" : ""
                    },
                    [
                      _c("el-input", {
                        staticClass: "field-input",
                        attrs: {
                          type: "textarea",
                          rows: 3,
                          placeholder: _vm.$t("imagesObj.descrPlaceholder"),
                          maxlength: 1000
                        },
                        on: {
                          blur: function($event) {
                            return _vm.checkNull("description")
                          },
                          input: function($event) {
                            return _vm.checkNull("description")
                          }
                        ...
                        _c(
                          ...
                          [
                            _c(
                              ...
                              {
                                model: {
                                  value: _vm.form.isRecommend,
                                  callback: function($$v) {
                                    _vm.$set(_vm.form, "isRecommend", $$v)
                                  },
                                  expression: "form.isRecommend"
                                }
                              },
                              [
                                _c("el-radio", { attrs: { label: "true" } }, [
                                  _vm._v(_vm._s(_vm.$t("imagesObj.recommend")))
                                ]),
                                _vm._v(" "),
                                _c("el-radio", { attrs: { label: "false" } }, [
                                  _vm._v(
                                    _vm._s(_vm.$t("imagesObj.notRecommend"))
                                  )
                                ])
                              ],
                              1
                ...
                _vm.pageType == "submit"
                  ? [
                      _vm.form.compute_resource == "GPU" || _vm.isXJUCenter
                        ? _c(
                            "div",
                            {
                              staticClass: "form-row",
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.form.compute_resource == "NPU" && !_vm.isXJUCenter
                        ? _c(
                            "div",
                            {
                              staticClass: "form-row",
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.form.compute_resource == "DCU" && !_vm.isXJUCenter
                        ? _c(
                            "div",
                            {
                              staticClass: "form-row",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "title" }, [_c("span")])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/images/submit/vp-images-submit.js"); })
