...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/LeftLabels.vue?vue&type=script&lang=js":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/LeftLabels.vue?vue&type=script&lang=js ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    selectItem: function selectItem(type, item) {
      this.localFilters = this.localFilters.map(function (filter) {
        if (filter.type === type) {
          // 更新选中状态（单选模式）
          return _objectSpread(_objectSpread({}, filter), {}, {
            items: filter.items.map(function (i) {
    ...
    // 更新选中值集合
    updateSelectedFilters: function updateSelectedFilters() {
      var selected = {};
      this.localFilters.forEach(function (filter) {
        var activeItem = filter.items.find(function (item) {
          return item.active;
        });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/Recommend.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/Recommend.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
/* harmony import */ var _pages_aitasktmpl_tools__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ~/pages/aitasktmpl/tools */ "./web_src/vuepages/pages/aitasktmpl/tools.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: {
    ...
    type: {
      type: String,
      "default": 'dataset' // dataset,aimodel,ai_task_template
  ...
  data: function data() {
    return {
      ...
      swiperHandler: null,
      showFlag: false,
      lang: _langs__WEBPACK_IMPORTED_MODULE_21__.lang
    };
  },
  methods: {
    getDatasetShowList: function getDatasetShowList() {
      var _arguments = arguments,
          _this = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_17___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_15___default().mark(function _callee() {
        var type, key, response, res;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_15___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                type = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 'dataset';
                _context.prev = 1;

                if (type === 'dataset') {
                  key = 'home_v2/dataset.json';
                } else if (type === 'aimodel') {
                  key = 'home_v2/model.json';
                } else if (type == 'ai_task_template') {
                  key = 'home_v2/ai_task_template.json';
                }

                _context.next = 5;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_18__.getPromoteDataset)({
                  key: key
                });
                ...
                if (res.code === 0) {
                  ...
                  if (_this.list.length) {
                    _this.list.forEach(function (item) {
                      ...
                      if (item.Label) {
                        item.labels = item.Label.trim().split(/\s+/);
                      }

                      if (item.Engine != null) {
                        item.engineName = (0,_utils__WEBPACK_IMPORTED_MODULE_20__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_19__.MODEL_ENGINES, item.Engine);
                      }

                      if (type == 'dataset') {
                        item.link = "/datasets/detail/".concat(item.OwnerName, "/").concat(item.Name);
                        item.bgColor = 'rgba(0, 102, 255, 1)';
                      }

                      if (type == 'aimodel') {
                        item.link = "/models/detail/".concat(item.OwnerName, "/").concat(item.Name);
                        item.bgColor = 'rgba(96, 0, 203, 1)';
                      }

                      if (type == 'ai_task_template') {
                        var jobTypeStr = (0,_utils__WEBPACK_IMPORTED_MODULE_20__.getListValueWithKey)(_pages_aitasktmpl_tools__WEBPACK_IMPORTED_MODULE_22__.TmplTaskTypes, item.JobType);
                        var computeSourceStr = (0,_utils__WEBPACK_IMPORTED_MODULE_20__.getListValueWithKey)(_pages_aitasktmpl_tools__WEBPACK_IMPORTED_MODULE_22__.TmplComputerResouces, item.ComputeSource);
                        item.Alias = item.Name;
                        item.labels = [jobTypeStr, computeSourceStr];
                        item.link = "/ai_task_tmpl/detail/".concat(item.ID);
    ...
    initSwiper: function initSwiper() {
      if (this.swiperHandler) {
        this.swiperHandler.destroy();
      } // Merge default options with props


      var options = _objectSpread({}, this.swiperOptions);

      this.swiperHandler = new Swiper('.swiper-container', options);
    }
  },
  mounted: function mounted() {
    console.log("label", this.type);
    this.getDatasetShowList(this.type);
  },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightCards.vue?vue&type=script&lang=js":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightCards.vue?vue&type=script&lang=js ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Recommend_vue__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./Recommend.vue */ "./web_src/vuepages/components/square/Recommend.vue");
/* harmony import */ var _RightList_vue__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./RightList.vue */ "./web_src/vuepages/components/square/RightList.vue");
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_23___default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    RightList: _RightList_vue__WEBPACK_IMPORTED_MODULE_26__["default"],
    Recommend: _Recommend_vue__WEBPACK_IMPORTED_MODULE_25__["default"]
  },
  computed: {
    mergedSortList: function mergedSortList() {
      return [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_24___default()(this.baseSorts), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_24___default()(this.extraSorts));
    },
    canChangeFav: function canChangeFav() {
      var _this = this;

      var data = this.tabList.find(function (item) {
        return item.key === _this.tabIndex;
      });
      return data.favFlag;
    },
    reloadFlag: function reloadFlag() {
      ...
      var data = this.tabList.find(function (item) {
        console.log(item.key, _this2.tabIndex);
        return item.key === _this2.tabIndex;
      });
      return !!data.reloadFlag;
    },
    operaFlag: function operaFlag() {
      var _this3 = this;

      var data = this.tabList.find(function (item) {
        return item.key === _this3.tabIndex;
      });
      return data.operaFlag;
    },
    createBtnText: function createBtnText() {
      var _this4 = this;

      var data = this.tabList.find(function (item) {
        return item.key === _this4.tabIndex;
      });
  ...
  methods: {
    ...
    parseQueryString: function parseQueryString(key) {
      var path = key.split('?')[0];
      var queryString = key.includes('?') ? key.split('?')[1] : '';
      var queryParams = {};
    ...
    changeTab: function changeTab(item) {
      ...
      this.selectedFilters.page = 1;
      var index = this.tabList.findIndex(function (item) {
        return item.key === _this5.tabIndex;
      });
    ...
    changeSort: function changeSort(item) {
      console.log(item); // this.sort = item

      this.selectedFilters.order_by = item;
      this.changeParams();
    },
    changeOnline: function changeOnline() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _RightItem_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RightItem.vue */ "./web_src/vuepages/components/square/RightItem.vue");
/* harmony import */ var _RightOwnerItem_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./RightOwnerItem.vue */ "./web_src/vuepages/components/square/RightOwnerItem.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    RightItem: _RightItem_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    RightOwnerItem: _RightOwnerItem_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      iPageSizes: [30],
  ...
  watch: {
    // canChangeFav(val){
    // },
    pageParams: function pageParams(val) {
  ...
  methods: {
    reloadPage: function reloadPage() {
      var isLastPage = this.iPage === Math.ceil(this.total / this.iPageSize);
      var isSingleItemOnPage = this.list.length === 1;
      var newPage = this.iPage;

      if (isLastPage && isSingleItemOnPage && this.iPage > 1) {
        newPage = this.iPage - 1;
      }

      this.$emit("changePage", newPage); // Update the current page if it changed
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=script&lang=js":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _Icons_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Icons.vue */ "./web_src/vuepages/components/square/Icons.vue");
...
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Icons: _Icons_vue__WEBPACK_IMPORTED_MODULE_13__["default"]
  },
  data: function data() {
    return {
      isCollected: false,
      ...
      isSetting: false,
      hasOnlineUrl: 0,
      lang: _langs__WEBPACK_IMPORTED_MODULE_16__.lang
    };
  },
  watch: {
    data: function data(val, oVal) {
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 8;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_15__.unsetFavorite)(params, _this.type);
              ...
              case 11:
                _context.next = 13;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_15__.setFavorite)(params, _this.type);
    ...
    uploadClick: function uploadClick(data, type) {
      var safeId = "".concat(data.owner_name, "/").concat(data.name);

      if (type === 'dataset') {
        window.open("/datasets/detail/".concat(safeId, "?tab=files"));
      } else {
        window.open("/models/detail/".concat(safeId, "?tab=files"));
      }
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=script&lang=js":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=script&lang=js ***!
  \*****************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_url__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! core-js/modules/web.url */ "./node_modules/core-js/modules/web.url.js");
/* harmony import */ var core_js_modules_web_url__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_url__WEBPACK_IMPORTED_MODULE_23__);
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/slicedToArray.js");
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_25__);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28__);
/* harmony import */ var _components_square_LeftLabels_vue__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ~/components/square/LeftLabels.vue */ "./web_src/vuepages/components/square/LeftLabels.vue");
/* harmony import */ var _components_square_RightCards_vue__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ~/components/square/RightCards.vue */ "./web_src/vuepages/components/square/RightCards.vue");
/* harmony import */ var _components_square_DeleteConfirmModal_vue__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ~/components/square/DeleteConfirmModal.vue */ "./web_src/vuepages/components/square/DeleteConfirmModal.vue");
/* harmony import */ var _apis_modules_modelsquare__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ~/apis/modules/modelsquare */ "./web_src/vuepages/apis/modules/modelsquare.js");
/* harmony import */ var _apis_modules_dataset__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ~/apis/modules/dataset */ "./web_src/vuepages/apis/modules/dataset.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ~/const */ "./web_src/vuepages/const/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ~/utils */ "./web_src/vuepages/utils/index.js");
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
/* harmony import */ var _langs__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ~/langs */ "./web_src/vuepages/langs/index.js");
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_26___default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var isWorkspacePage = window.MENU_CONFIG.activeTopMenu == 'workspace';
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      isWorkspacePage: isWorkspacePage,
      tab: isWorkspacePage ? '/owned?aimodel_type=' : '/public?recommend=all&aimodel_type=',
      tabList1: [{
        key: '/public?recommend=all&aimodel_type=',
        label: "\u2B55 ".concat(this.$t('modelObj.model_public')),
        favFlag: true
      }, {
        key: '/public?recommend=only&aimodel_type=',
        label: "\uD83C\uDFC6 ".concat(this.$t('modelObj.model_recommend')),
        favFlag: true
      }, {
        key: '/public?recommend=all&aimodel_type=2',
        label: "\u2708\uFE0F ".concat(this.$t('modelObj.model_migrate')),
        favFlag: true,
        btnUrl: '/repo/model_migrate',
        btnText: this.$t('modelObj.migrate_external_model')
      }, {
        key: '/modelscope',
        label: '\uD83C\uDF10 魔塔社区',
        favFlag: false,
      ...
      tabList2: [{
        key: '/owned?aimodel_type=',
        label: this.$t('modelObj.model_my'),
        favFlag: false,
        operaFlag: true
      }, {
        key: '/collaborated?aimodel_type=',
        label: this.$t('modelObj.model_collaborate'),
        favFlag: false
      }, {
        key: '/collected?aimodel_type=',
        label: this.$t('modelObj.model_collected'),
        favFlag: true,
        reloadFlag: true
      }, {
        key: '/involved?aimodel_type=2',
      ...
      name: '',
      delLoading: false,
      codeUsePromotePath: "home_v2/model_square".concat(_langs__WEBPACK_IMPORTED_MODULE_37__.lang == 'zh-CN' ? '' : '_en', ".json")
    };
  },
  components: {
    LeftLabels: _components_square_LeftLabels_vue__WEBPACK_IMPORTED_MODULE_29__["default"],
    RightCards: _components_square_RightCards_vue__WEBPACK_IMPORTED_MODULE_30__["default"],
    DeleteConfirmModal: _components_square_DeleteConfirmModal_vue__WEBPACK_IMPORTED_MODULE_31__["default"]
  },
  methods: {
    changeModalOverlay: function changeModalOverlay(val) {
      this.showFilter = val;
    },
    selectItem: function selectItem(type, clickedItem) {
      // 1. 找到对应的筛选组
      var filterGroup = this.filtersConfig.find(function (f) {
        return f.type === type;
      });
    ...
    resetFilters: function resetFilters() {
      ...
      this.filtersConfig.forEach(function (group) {
        _this.params[group.type] = '';
    ...
    getCardList: function getCardList() {
      ...
      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().mark(function _callee() {
        var requestParams, _requestParams$url$sp, _requestParams$url$sp2, path, query, urlParams, urlRecommend, newQuery, response, _res, list;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _this2.loading = true;
                if (_this2.params.url === '/modelscope') {
                  _context.next = 3;
                  return fetch("/api/v1/modelscope/models?page=".concat(_this2.params.page || 1, "&page_size=").concat(_this2.params.page_size || 30, "&q=").concat(encodeURIComponent(_this2.params.q || ''), "&order_by=").concat(encodeURIComponent(_this2.params.order_by || '')));
                }
                _context.next = 8;
                break;
              case 3:
                response = _context.sent;
                return _context.abrupt("return", response.json().then(function (payload) {
                  _this2.loading = false;
                  if (payload.code === 0) {
                    var res = payload.data || {};
                    _this2.list = (res.models || []).map(function (item) {
                      return _objectSpread(_objectSpread({}, item), {}, {
                        labels: item.tags ? String(item.tags).trim().split(/\s+/).filter(Boolean) : [],
                        tags: '',
                        licenses: item.licenses || '',
                        engineName: (0,_utils__WEBPACK_IMPORTED_MODULE_36__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_35__.MODEL_ENGINES, item.engine),
                        updateTimeStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_33__.formatDate)(new Date(item.updated_unix * 1000), 'yyyy-MM-dd')
                      });
                    });
                    _this2.pageParams = {
                      page: +res.page || 1,
                    ...
                    _this2.$message.error(payload.msg || '加载魔塔社区模型失败');
                  }
                }));
              case 8:
                requestParams = _objectSpread({}, _this2.params); // 如果URL中有参数，提取出来

                if (requestParams.url.includes('?')) {
                  _requestParams$url$sp = requestParams.url.split('?'), _requestParams$url$sp2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_25___default()(_requestParams$url$sp, 2), path = _requestParams$url$sp2[0], query = _requestParams$url$sp2[1];
                  urlParams = new URLSearchParams(query); // 优先使用URL中的参数

                  if (urlParams.has('recommend')) {
                    urlRecommend = urlParams.get('recommend');
                    requestParams.recommend = urlRecommend; // 从URL中删除recommend参数，避免重复

                    urlParams["delete"]('recommend');
                  } // 重新构建URL


                  newQuery = urlParams.toString();
                  requestParams.url = newQuery ? "".concat(path, "?").concat(newQuery) : path;
                }

                _context.next = 6;
                return (0,_apis_modules_modelsquare__WEBPACK_IMPORTED_MODULE_32__.getModelList)(requestParams);
              ...
              case 6:
                ...
                if (response.data.code === 0) {
                  ...
                  list = (_res.aimodels || []).map(function (item) {
                    return _objectSpread(_objectSpread({}, item), {}, {
                      labels: item.tags ? item.tags.trim().split(/\s+/) : [],
                      tags: '',
                      licenses: '',
                      engineName: (0,_utils__WEBPACK_IMPORTED_MODULE_35__.getListValueWithKey)(_const__WEBPACK_IMPORTED_MODULE_34__.MODEL_ENGINES, item.engine),
                      updateTimeStr: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_36__.formatDate)(new Date(item.updated_unix * 1000), 'yyyy-MM-dd')
                    });
                  }); // this.total = +res.total || 0;

                  _this2.pageParams = {
                    page: +_res.page || 0,
                    page_size: +_res.page_size || 0,
                    total: +_res.total || 0
                  };
                  _this2.list = list;
              ...
              case 12:
                ...
                _this2.$message.error(_context.t0);
    ...
    changeFilter: function changeFilter(obj) {
      this.params = _objectSpread(_objectSpread({}, this.params), obj);
      this.getCardList();
    },
    changeParams: function changeParams(obj) {
      this.params = _objectSpread(_objectSpread({}, this.params), obj);
      console.log(this.params);
      this.getCardList();
    },
    getDatasetTags: function getDatasetTags() {
      var _this3 = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().mark(function _callee2() {
        var response, _res2, _ref, _ref$frame, frame, _ref$label, label, createTagArray, frameTag, labelTag;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_33__.getPromoteDataset)({
                  key: _this3.codeUsePromotePath
                });
              ...
              case 3:
                ...
                if (response.data.code === 0) {
                  _res2 = JSON.parse(response.data.data || '{}') || {};
                  _ref = _res2.tagInformation || {}, _ref$frame = _ref.frame, frame = _ref$frame === void 0 ? {} : _ref$frame, _ref$label = _ref.label, label = _ref$label === void 0 ? {} : _ref$label;

                  createTagArray = function createTagArray(source, keyPrefix) {
                  ...
                  frameTag = createTagArray(frame);
                  labelTag = createTagArray(label);
                  _this3.filtersConfig = [{
                    type: 'engine',
                    titleKey: 'modelManage.modelEngine',
                    items: frameTag,
                    clearFlag: false,
                    styleClass: 'first-style'
                  }, {
                    type: 'label',
                    titleKey: 'modelManage.modelLabel',
                    items: labelTag,
                    clearFlag: false,
                    styleClass: 'second-style'
                  }];
                  console.log(_this3.filtersConfig);
                } else {
              ...
              case 7:
                ...
                _this3.$message.error(_context2.t0);
    ...
    handleDeleteModel: function handleDeleteModel(_ref2) {
      var _this4 = this;

      return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().mark(function _callee3() {
        var type, data, callback, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_24___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                type = _ref2.type, data = _ref2.data, callback = _ref2.callback;
                _context3.prev = 1;
                _context3.next = 4;
                return (0,_apis_modules_dataset__WEBPACK_IMPORTED_MODULE_33__.delDataset)({
                  aimodel_id: data.id
                }, 'aimodel');
              ...
              case 4:
                ...
                if (response.data.code === 0) {
                  callback({
                    success: true,
                    message: _this4.$t('imagesObj.deleteSuccessTips')
                  });
                } else {
                  callback({
                    success: false,
...
/***/ "./web_src/vuepages/pages/modelsquare/square/vp-model-square.js":
/*!**********************************************************************!*\
  !*** ./web_src/vuepages/pages/modelsquare/square/vp-model-square.js ***!
  \**********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/modelsquare/square/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightCards.vue?vue&type=style&index=0&id=726e3106&scoped=true&lang=less":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightCards.vue?vue&type=style&index=0&id=726e3106&scoped=true&lang=less ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=style&index=0&id=780644f4&scoped=true&lang=less":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=style&index=0&id=780644f4&scoped=true&lang=less ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=style&index=0&id=34e6c600&scoped=true&lang=less":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=style&index=0&id=34e6c600&scoped=true&lang=less ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=style&index=0&id=7a7a3331&scoped=true&lang=less":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=style&index=0&id=7a7a3331&scoped=true&lang=less ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/components/square/LeftLabels.vue":
/*!***********************************************************!*\
  !*** ./web_src/vuepages/components/square/LeftLabels.vue ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _LeftLabels_vue_vue_type_template_id_a219d788_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LeftLabels.vue?vue&type=template&id=a219d788&scoped=true */ "./web_src/vuepages/components/square/LeftLabels.vue?vue&type=template&id=a219d788&scoped=true");
/* harmony import */ var _LeftLabels_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LeftLabels.vue?vue&type=script&lang=js */ "./web_src/vuepages/components/square/LeftLabels.vue?vue&type=script&lang=js");
/* harmony import */ var _LeftLabels_vue_vue_type_style_index_0_id_a219d788_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LeftLabels.vue?vue&type=style&index=0&id=a219d788&scoped=true&lang=less */ "./web_src/vuepages/components/square/LeftLabels.vue?vue&type=style&index=0&id=a219d788&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _LeftLabels_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _LeftLabels_vue_vue_type_template_id_a219d788_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _LeftLabels_vue_vue_type_template_id_a219d788_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "a219d788",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/components/square/LeftLabels.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/components/square/Recommend.vue":
/*!**********************************************************!*\
  !*** ./web_src/vuepages/components/square/Recommend.vue ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Recommend_vue_vue_type_template_id_2cd41bd6_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Recommend.vue?vue&type=template&id=2cd41bd6&scoped=true */ "./web_src/vuepages/components/square/Recommend.vue?vue&type=template&id=2cd41bd6&scoped=true");
/* harmony import */ var _Recommend_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Recommend.vue?vue&type=script&lang=js */ "./web_src/vuepages/components/square/Recommend.vue?vue&type=script&lang=js");
/* harmony import */ var _Recommend_vue_vue_type_style_index_0_id_2cd41bd6_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Recommend.vue?vue&type=style&index=0&id=2cd41bd6&scoped=true&lang=less */ "./web_src/vuepages/components/square/Recommend.vue?vue&type=style&index=0&id=2cd41bd6&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Recommend_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _Recommend_vue_vue_type_template_id_2cd41bd6_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Recommend_vue_vue_type_template_id_2cd41bd6_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "2cd41bd6",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/components/square/Recommend.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages
_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_RightList_vue_vue_type_template_id_780644f4_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./RightList.vue?vue&type=template&id=780644f4&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=template&id=780644f4&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=template&id=34e6c600&scoped=true":
/*!*********************************************************************************************************!*\
  !*** ./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=template&id=34e6c600&scoped=true ***!
  \*********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_RightOwnerItem_vue_vue_type_template_id_34e6c600_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_RightOwnerItem_vue_vue_type_template_id_34e6c600_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_RightOwnerItem_vue_vue_type_template_id_34e6c600_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./RightOwnerItem.vue?vue&type=template&id=34e6c600&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=template&id=34e6c600&scoped=true");


/***/ }),

/***/ "./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=template&id=7a7a3331&scoped=true":
/*!*******************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=template&id=7a7a3331&scoped=true ***!
  \*******************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_7a7a3331_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_7a7a3331_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_7a7a3331_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=7a7a3331&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=template&id=7a7a3331&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/LeftLabels.vue?vue&type=template&id=a219d788&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/LeftLabels.vue?vue&type=template&id=a219d788&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return !_vm.isWorkspacePage
    ? _c("div", { staticClass: "content-l" }, [
        _c(
          "div",
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.localFilters, function(filter, index) {
              return _c("div", { key: index, staticClass: "block-c" }, [
                _c("div", { staticClass: "title-c" }, [
                  _c("span", { staticClass: "title" }, [
                    _vm._v(_vm._s(_vm.$t(filter.titleKey)))
                  ]),
                  _vm._v(" "),
                  filter.clearFlag
                    ? _c(
                        "span",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.clearFilter(filter.type)
                            }
                          }
                        },
                        [
                ...
                _c(
                  "div",
                  { staticClass: "list" },
                  _vm._l(filter.items, function(item, idx) {
                    var _obj
                    return _c(
                      "div",
                      {
                        ...
                        class:
                          ...
                          (_obj[filter.styleClass] = true),
                          _obj),
                        on: {
                          click: function($event) {
                            return _vm.selectItem(filter.type, item)
                          }
                        }
                      },
                      [_vm._v("\n          " + _vm._s(item.v) + "\n        ")]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/Recommend.vue?vue&type=template&id=2cd41bd6&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/Recommend.vue?vue&type=template&id=2cd41bd6&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _vm.showFlag
    ? _c("div", { staticClass: "recommend-container" }, [
                            ...
                            [
                              ...
                              _c("g", [
                                ...
                                _c("path", {
                                  attrs: {
                                    d:
                                      "M34 12V20V21C31.0449 21 28.3892 22.2818 26.5585 24.3198C24.9678 26.0906 24 28.4323 24 31C24 31.5789 24.0492 32.1463 24.1436 32.6983C24.6579 35.7046 26.5143 38.2529 29.0741 39.7046C26.4116 40.5096 22.8776 41 19 41C10.7157 41 4 38.7614 4 36V28V20V12",
                                    fill: "none",
                                    stroke: "#ffffff0a",
                                    "stroke-width": "4",
                                    "stroke-linecap": "round",
                                ...
                                _c("path", {
                                  attrs: {
                                    d:
                                      "M34 12C34 14.7614 27.2843 17 19 17C10.7157 17 4 14.7614 4 12C4 9.23858 10.7157 7 19 7C27.2843 7 34 9.23858 34 12Z",
                                    fill: "none",
                                    stroke: "#ffffff0a",
                                    "stroke-width": "4",
                                    "stroke-linecap": "round",
                                ...
                                _c("path", {
                                  attrs: {
                                    d:
                                      "M4 28C4 30.7614 10.7157 33 19 33C20.807 33 22.5393 32.8935 24.1436 32.6983",
                                    fill: "none",
                                    stroke: "#ffffff0a",
                                    "stroke-width": "4",
                                    "stroke-linecap": "round",
                                ...
                                _c("path", {
                                  attrs: {
                                    d:
                                      "M4 20C4 22.7614 10.7157 25 19 25C21.7563 25 24.339 24.7522 26.5585 24.3198",
                                    fill: "none",
                                    stroke: "#ffffff0a",
                                    "stroke-width": "4",
                                    "stroke-linecap": "round",
                                ...
                                _c("path", {
                                  attrs: {
                                    d:
                                      "M44 31C44 36.5228 39.5228 41 34 41C32.2091 41 30.5281 40.5292 29.0741 39.7046C26.5143 38.2529 24.6579 35.7046 24.1436 32.6983C24.0492 32.1463 24 31.5789 24 31C24 28.4323 24.9678 26.0906 26.5585 24.3198C28.3892 22.2818 31.0449 21 34 21C39.5228 21 44 25.4772 44 31Z",
                                    fill: "none",
                                    stroke: "#ffffff0a",
                                    "stroke-width": "4",
                                    "stroke-linecap": "round",
                      ...
                      _c("div", { staticClass: "item" }, [
                        _c("div", { staticClass: "name" }, [
                          _c("span", { staticClass: "nowrap" }, [
                            _vm._v(
                              _vm._s(
                                _vm.lang == "en-US" ? item.Name : item.Alias
                              )
                            )
                          ]),
                          _vm._v(" "),
                        ...
                        _c(
                          ...
                          [
                            _vm._l(item.Tags, function(tag, index) {
                              return _c(
                                "span",
                                { key: tag, staticClass: "label" },
                                [
                                  _vm._v(
                                    "# " + _vm._s(_vm.$t("datasets." + tag))
                                  )
                                ]
                              )
                            }),
                            _vm._v(" "),
                            _vm._l(item.Tasks, function(task, index) {
                              return _c(
                                "span",
                                { key: task, staticClass: "label" },
                                [
                                  _vm._v(
                                    "# " + _vm._s(_vm.$t("datasets." + task))
                                  )
                                ]
                              )
                            }),
                            ...
                            item.licenses
                              ...
                              : _vm._e(),
                            _vm._v(" "),
                            item.engineName || item.Engine
                              ? _c("span", { staticClass: "label" }, [
                                  _vm._v(
                                    "# " +
                                      _vm._s(item.engineName || item.Engine)
                                  )
                                ])
                              : _vm._e(),
                            _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightCards.vue?vue&type=template&id=726e3106&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightCards.vue?vue&type=template&id=726e3106&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "filter-c-m" }, [
        _c("span", { staticClass: "title" }, [
          _vm._v(
            _vm._s(
              _vm.type === "dataset" ? _vm.$t("dataset") : _vm.$t("repos.model")
            )
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "right-m" }, [
          _c(
            "div",
            { staticClass: "icon-box", on: { click: _vm.createDataset } },
          ...
          !_vm.showSearch
            ...
            : _c(
                "div",
                {
                  staticClass: "ui small icon input",
                  staticStyle: { height: "32px", "margin-left": "6px" }
                },
                [
                  _c("input", {
                    directives: [
                    ...
                    attrs: {
                      ...
                      placeholder:
                        _vm.type === "dataset"
                          ? _vm.$t("org.searchDatasets")
                          : _vm.$t("modelObj.model_search")
                    },
          ...
          !_vm.isWorkspacePage
            ? _c(
                "div",
                {
                  staticClass: "icon-box filter-btn",
                  class: { active: _vm.showFilter },
                  on: { click: _vm.toggleFilter }
                },
                [_c("i", { staticClass: "ri-filter-line" })]
              )
            : _vm._e()
        ])
      ]),
      _vm._v(" "),
      _vm.isWorkspacePage
        ? _c("div", { staticClass: "workspace-t" }, [
            _c("span", [_vm._v(_vm._s(_vm.$t(_vm.title)))])
          ])
        : _vm._e(),
      _vm._v(" "),
      !_vm.isWorkspacePage
        ? _c("Recommend", { attrs: { type: _vm.type } })
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "filter-c" }, [
        _c(
          "div",
          { staticClass: "tab-c" },
          _vm._l(_vm.tabList, function(item) {
            return _c(
              ...
              {
                key: item.key,
                staticClass: "tab-item nowrap",
                class: _vm.tabIndex == item.key ? "active" : "",
                on: {
                  click: function($event) {
        ...
        _c(
          ...
          [
            ...
            _c(
              ...
              _vm._l(_vm.mergedSortList, function(item) {
                return _c("el-option", {
                  key: item.key,
            ...
            _c(
              "div",
              { staticClass: "btn-add", on: { click: _vm.createDataset } },
              [
                _c(
                  "svg",
                  {
                  ...
                  [
                    ...
                    _c("g", [
                      _c("path", {
                        attrs: {
                          d:
                            "M5.333 4h21.333c0.736 0 1.333 0.597 1.333 1.333v0 21.333c0 0.736-0.597 1.333-1.333 1.333v0h-21.333c-0.736 0-1.333-0.597-1.333-1.333v0-21.333c0-0.736 0.597-1.333 1.333-1.333v0zM6.667 6.667v18.667h18.667v-18.667h-18.667zM14.667 14.667v-5.333h2.667v5.333h5.333v2.667h-5.333v5.333h-2.667v-5.333h-5.333v-2.667h5.333z"
                        }
                      })
                    ])
                  ]
                ...
                _c("span", { staticStyle: { "margin-left": "6px" } }, [
                  _vm._v(_vm._s(_vm.createBtnText))
                ])
              ]
            )
          ],
      ...
      _c("right-list", {
        ...
        attrs: {
          ...
          canChangeFav: _vm.canChangeFav,
          reloadFlag: _vm.reloadFlag,
          isWorkspacePage: _vm.isWorkspacePage,
          operaFlag: _vm.operaFlag
        },
        on: { changePage: _vm.changePage, deleteEvent: _vm.deleteEvent }
      })
    ],
    1
  )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=template&id=780644f4&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightList.vue?vue&type=template&id=780644f4&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=template&id=34e6c600&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/components/square/RightOwnerItem.vue?vue&type=template&id=34e6c600&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
          ...
          [
            _c("Icons", {
              ...
              attrs: {
                ...
                modelType: _vm.data.aimodel_type
              }
            }),
            _vm._v(" "),
            _c("div", { staticClass: "name-c" }, [
              _c("div", { staticClass: "name nowrap" }, [
                _c(
                  "span",
                  {
                    attrs: {
                      title:
                        _vm.lang == "en-US" ? _vm.data.name : _vm.data.alias
                    }
                  },
                  [
                    _vm._v(
              ...
              [
                _c(
                  "div",
                  {
                    staticClass: "fav-c r-item",
                    class:
                      _vm.canChangeFav || _vm.isSetting ? "" : "fav-disabled",
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        $event.stopPropagation()
                  ...
                  ? [
                      ...
                      _c(
                        "span",
                        {
                          staticClass: "r-item",
                          attrs: {
                            title: _vm.$t("modelManage.derivativeTimes")
                          }
                        },
                        [
                          _c("i", { staticClass: "ri-git-merge-line" }),
                          _vm._v(" "),
                          _c("span", [
                            _vm._v(_vm._s(_vm.data.derivative_count))
                          ])
                        ]
                      )
                    ]
          ...
          ? _c("div", { staticClass: "footer-r" }, [
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c(
                        ...
                        [
                          _c("path", {
                            attrs: { d: "M48 0H0V48H48V0Z", fill: "#0066ff" }
                          })
                        ]
                      ),
                      _c(
                        "g",
                        { attrs: { mask: "url(#icon-04f8237f10b972)" } },
                        [
                          _c("path", {
                            attrs: {
                  ...
                  _vm._v(" "),
                  _c("span", { staticStyle: { "line-height": "1px" } }, [
              ...
              _c(
                "div",
                {
                  staticClass: "delete-bth",
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      return _vm.deleteClick(_vm.data)
                    }
                  }
                },
                [
                  ...
                  _vm._v(" "),
                  _c("span", { staticStyle: { "line-height": "1px" } }, [
                    _vm._v(_vm._s(_vm.$t("modelManage.delete")))
                  ])
                ]
              )
            ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=template&id=7a7a3331&scoped=true":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/modelsquare/square/index.vue?vue&type=template&id=7a7a3331&scoped=true ***!
  \**********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c("left-labels", {
        ...
        on: { "trigger-search": _vm.changeFilter }
      }),
      _vm._v(" "),
      _c("right-cards", {
        ref: "rightCards",
        attrs: {
          title: "repos.model",
          loading: _vm.loading,
          tabList: _vm.isWorkspacePage ? _vm.tabList2 : _vm.tabList1,
          isWorkspacePage: _vm.isWorkspacePage,
          showCheckbox: true,
          tab: _vm.tab,
          extraSorts: _vm.extraSorts,
          type: "aimodel",
          list: _vm.list,
          pageParams: _vm.pageParams
        },
        on: {
          changeParams: _vm.changeParams,
          changeModalOverlay: _vm.changeModalOverlay,
          deleteEvent: _vm.deleteEvent
        }
      }),
      _vm._v(" "),
            ...
            _c("div", { staticClass: "filter-panel" }, [
              _c("div", { staticClass: "filter-section" }, [
                _c(
                  ...
                  _vm._l(_vm.filtersConfig, function(filter, index) {
                    return _c("div", { key: index, staticClass: "block-c" }, [
                      _c("div", { staticClass: "title-c" }, [
                        _c("span", { staticClass: "title" }, [
                          _vm._v(_vm._s(_vm.$t(filter.titleKey)))
                ...
                _c("div", { staticClass: "filter-buttons" }, [
                  ...
                  _c(
                    "div",
                    {
                      staticClass: "search-button btn",
                      on: { click: _vm.searchFilters }
                    },
      ...
      _c("delete-confirm-modal", {
        ref: "deleteModal",
        attrs: { type: "modelObj", "data-obj": _vm.dataObj },
        on: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/modelsquare/square/vp-model-square.js"); })
