...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _opRoleDialog_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./opRoleDialog.vue */ "./web_src/vuepages/pages/user/role/opRoleDialog.vue");
/* harmony import */ var _resourceRoleDialog_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./resourceRoleDialog.vue */ "./web_src/vuepages/pages/user/role/resourceRoleDialog.vue");
/* harmony import */ var _storageRoleDialog_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./storageRoleDialog.vue */ "./web_src/vuepages/pages/user/role/storageRoleDialog.vue");
/* harmony import */ var _apis_modules_resources__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ~/apis/modules/resources */ "./web_src/vuepages/apis/modules/resources.js");
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      roleList: [{
        k: '',
        v: this.$t('userRole.allRoleType')
      }, {
        k: 0,
        v: this.$t('userRole.opCategory')
      }, {
        k: 1,
        v: this.$t('userRole.reCategory')
      }, {
        k: 2,
        v: this.$t('userRole.stCategoryRole')
      }],
      rolePlay: '',
      commonList: [{
        k: '',
        v: this.$t('userRole.isItDefault')
      }, {
        k: 1,
  ...
  components: {
    opRoleDialog: _opRoleDialog_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    resourceRoleDialog: _resourceRoleDialog_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    storageRoleDialog: _storageRoleDialog_vue__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  computed: {
    filtedData: function filtedData() {
      ...
      return this.tableData.filter(function (item) {
        return _this.rolePlay === item.Type || _this.rolePlay === '';
      }).filter(function (item) {
        return _this.isCommon === item.IsCommon || _this.isCommon === '';
      });
    }
  },
  watch: {
    filtedData: function filtedData(val) {
      if (val.length) {
        this.pageTotal = val.length; // this.currentPage = 1
      }
    },
  ...
  methods: {
    ...
    handleSizeChange: function handleSizeChange(val) {
      this.currentPage = 1;
      this.pageSize = val; // this.initRoleList()
    },
    currentChange: function currentChange(val) {
      this.currentPage = val; // this.initRoleList()
    },
    showOperRoleDialog: function showOperRoleDialog(type) {
      this.opRoleDialogShow = true;
      this.opRoleDialogType = type;
    },
    showResourceRoleDialog: function showResourceRoleDialog(type) {
      this.resourceRoleDialogShow = true;
      this.resourceRoleDialogType = type;
    },
    showStorageRoleDialog: function showStorageRoleDialog(type) {
    ...
    initRoleList: function initRoleList(params) {
      var _this2 = this;

      this.loading = true;
      (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_10__.listAiforgeRole)(params).then(function (res) {
        _this2.loading = false;
        var data = res.data;
        _this2.pageTotal = data.length || 0;
        _this2.tableData = data.map(function (item, index) {
          ...
          jsonData.forEach(function (element) {
            ...
            var hasRepeatTaskType = taskTypeArray.indexOf(element.taskType);
            var hasRepeatSpecId = specIdArray.indexOf(element.specId);
          ...
          return {
            CreateTime: (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_11__.formatDate)(new Date(item.CreatedUnix * 1000), 'yyyy-MM-dd HH:mm:ss'),
            UpdatedTime: item.UpdatedUnix ? (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_11__.formatDate)(new Date(item.UpdatedUnix * 1000), 'yyyy-MM-dd HH:mm:ss') : '--',
            Type: item.Type,
            Name: item.Name,
            ID: item.ID,
    ...
    deleteRow: function deleteRow(item) {
      ...
      if (item.IsCommon) {
        tips = this.$t('userRole.deleteRoleConfirm1', {
          name: item.Name
        });
      } else {
        tips = "<span style=\"color:red\">".concat(this.$t('userRole.deleteRoleConfirm'), "</span>") + this.$t('userRole.deleteRoleConfirm1', {
          name: item.Name
        });
      }
      ...
      this.$confirm(tips, this.$t('tips'), {
        ...
        (0,_apis_modules_resources__WEBPACK_IMPORTED_MODULE_10__.delAiforgeRole)({
          id: item.ID
        }).then(function (res) {
          if (res.data.code === '0') {
            _this3.$message.success(_this3.$t('imagesObj.deleteSuccessTips'));
    ...
    editDialog: function editDialog(type, item) {
      var dialogConfig = {
        0: {
      ...
      var config = dialogConfig[item.Type] || dialogConfig["default"];
    ...
    getTypeName: function getTypeName(val) {
      ...
      return (_labels$val = labels[val]) !== null && _labels$val !== void 0 ? _labels$val : '--';
    }
  },
  mounted: function mounted() {
    this.initRoleList({});
...
/***/ "./web_src/vuepages/directive/tableSticky.js":
/*!***************************************************!*\
  !*** ./web_src/vuepages/directive/tableSticky.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
 ...
 */
var setStickyStyle = function setStickyStyle(element, _ref) {
  var top = _ref.top,
      left = _ref.left,
      right = _ref.right,
  ...
  if (top !== undefined) element.style.top = typeof top === 'number' ? "".concat(top, "px") : top;
  if (left !== undefined) element.style.left = typeof left === 'number' ? "".concat(left, "px") : left;
  if (right !== undefined) element.style.right = typeof right === 'number' ? "".concat(right, "px") : right;
};
/**
 * 计算顶部距离
 * @param {*} value - 指令的值
...
var calculateTop = function calculateTop(value) {
  // 如果是数字，直接返回px单位
  ...
  if (typeof value === 'string') {
    ...
    if (element) {
      ...
      return "".concat(rect.top + rect.height, "px");
    }
  }
...
var handleFixedColumns = function handleFixedColumns(fixedColumns, headerWrapper, top) {
  var direction = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'left';
  if (!fixedColumns || !fixedColumns.length) return;
  var accumulatedWidth = 0;
  var columns = direction === 'left' ? fixedColumns : _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_20___default()(fixedColumns).reverse();
  columns.forEach(function (column, index) {
    var columnWidth = column.width || column.realWidth || column.minWidth;
    var cell = headerWrapper.querySelector("th.".concat(column.id));
...
var findTableComponent = function findTableComponent(children, targetEl) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if ((_child$$children = child.$children) === null || _child$$children === void 0 ? void 0 : _child$$children.length) {
        var found = findTableComponent(child.$children, targetEl);
...
var fixFixedColumnClasses = function fixFixedColumnClasses(headerWrapper) {
  var hiddenThs = headerWrapper.querySelectorAll('th.is-hidden');
  hiddenThs.forEach(function (th) {
    return th.classList.remove('is-hidden');
  });
};
/**
 * 主函数：设置粘性表头
...
var stickyThead = function stickyThead(el, binding, vnode) {
  var top = calculateTop(binding.value); // 设置表格容器样式

  el.style.overflow = 'visible'; // 获取表头包装器并设置粘性

  var headerWrapper = el.querySelector('.el-table__header-wrapper');
  if (!headerWrapper) return;
  setStickyStyle(headerWrapper, {
    top: top
  });
  fixFixedColumnClasses(headerWrapper); // 查找表格组件实例

  var table = findTableComponent(vnode.context.$children, el);
  if (!table) return; // 处理左右固定列
...
var ObserverManager = /*#__PURE__*/function () {
  function ObserverManager() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_18___default()(this, ObserverManager);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_19___default()(ObserverManager, [{
    key: "observe",
...
/* harmony default export */ __webpack_exports__["default"] = ({
  inserted: function inserted(el, binding, vnode) {
    // 观察表格本身的变化
    observerManager.observe(el, function () {
      return stickyThead(el, binding, vnode);
    }); // 如果绑定值是选择器，观察目标元素的变化

    if (typeof binding.value === 'string') {
      var targetElement = document.querySelector(binding.value);

      if (targetElement) {
        observerManager.observe(targetElement, function () {
          return stickyThead(el, binding, vnode);
        });
      }
    } // 初始执行一次
  ...
  unbind: function unbind(el, binding) {
    // 停止观察表格本身
    observerManager.unobserve(el); // 如果绑定值是选择器，停止观察目标元素
...
/***/ "./web_src/vuepages/pages/user/role/vp-role-management.js":
/*!****************************************************************!*\
  !*** ./web_src/vuepages/pages/user/role/vp-role-management.js ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/user/role/index.vue");
/* harmony import */ var _directive_tableSticky__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ~/directive/tableSticky */ "./web_src/vuepages/directive/tableSticky.js");
...
vue__WEBPACK_IMPORTED_MODULE_7__["default"].directive('tableSticky', _directive_tableSticky__WEBPACK_IMPORTED_MODULE_6__["default"]);
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/user/role/index.vue":
/*!****************************************************!*\
  !*** ./web_src/vuepages/pages/user/role/index.vue ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_7b55e305_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=7b55e305&scoped=true */ "./web_src/vuepages/pages/user/role/index.vue?vue&type=template&id=7b55e305&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/user/role/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_7b55e305_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less */ "./web_src/vuepages/pages/user/role/index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_7b55e305_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_7b55e305_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "7b55e305",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/user/role/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./web_src/vuepages/pages/user/role/index.vue?vue&type=script&lang=js":
/*!****************************************************************************!*\
  !*** ./web_src/vuepages/pages/user/role/index.vue?vue&type=script&lang=js ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/user/role/index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less":
/*!*************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/user/role/index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less ***!
  \*************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_7b55e305_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=style&index=0&id=7b55e305&scoped=true&lang=less");
...
/***/ "./web_src/vuepages/pages/user/role/index.vue?vue&type=template&id=7b55e305&scoped=true":
/*!**********************************************************************************************!*\
  !*** ./web_src/vuepages/pages/user/role/index.vue?vue&type=template&id=7b55e305&scoped=true ***!
  \**********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_7b55e305_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_7b55e305_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_7b55e305_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=7b55e305&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=template&id=7b55e305&scoped=true");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=template&id=7b55e305&scoped=true":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/user/role/index.vue?vue&type=template&id=7b55e305&scoped=true ***!
  \*************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "title" }, [
        _c("span", [_vm._v(_vm._s(_vm.$t("userRole.userRoleManagement")))])
      ]),
      _vm._v(" "),
      _c(
        "div",
        ...
        [
          _c(
            "el-input",
            {
              ...
              attrs: {
                placeholder: _vm.$t("userRole.pleaseEnterRoleContent"),
                size: "medium"
              },
              nativeOn: {
        ...
        _c(
          ...
          [
            ...
            _c(
              ...
              _vm._l(_vm.commonList, function(item) {
                return _c("el-option", {
                  key: item.k,
                  attrs: { label: item.v, value: item.k }
                })
              ...
              "el-button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.showOperRoleDialog("add")
                  }
                }
              },
              [_vm._v("\n        " + _vm._s(_vm.$t("userRole.newOpRole")))]
            ),
            _vm._v(" "),
            _c(
              "el-button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.showResourceRoleDialog("add")
                  }
                }
              },
              [_vm._v("\n        " + _vm._s(_vm.$t("userRole.newReRole")))]
            ),
            _vm._v(" "),
            _c(
              "el-button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.showStorageRoleDialog("add")
                  }
                }
              },
              [_vm._v("\n        " + _vm._s(_vm.$t("userRole.newStorageRole")))]
            )
          ],
          1
        )
            ...
            _c(
              "el-table",
              {
                directives: [
                  ...
                  { name: "tableSticky", rawName: "v-tableSticky" }
                ],
                staticStyle: { width: "100%" },
                attrs: {
                  border: "",
                  data: _vm.filtedData.slice(
              ...
              [
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "Description",
                    label: _vm.$t("userRole.roleDescription"),
                    align: "center",
                    width: "320"
                  }
                }),
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "IsCommon",
                    label: _vm.$t("userRole.isItDefault"),
                    align: "center",
                    width: "120"
                  },
                  scopedSlots: _vm._u([
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "CreateTime",
                    label: _vm.$t("modelManage.createTime"),
                    align: "center",
                    width: "200"
                  }
                }),
                ...
                _c("el-table-column", {
                  attrs: {
                    prop: "CreatedUserId",
                    label: _vm.$t("modelManage.creator"),
                    align: "center",
                    width: "140"
                  }
                }),
                        ...
                        return [
                          _c(
                            "span",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.editDialog("view", scope.row)
                                }
                              }
                            },
                            [_vm._v(_vm._s(_vm.$t("userRole.viewDetail")))]
                          ),
                          _vm._v(" "),
                          _c(
                            "span",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.editDialog("edit", scope.row)
                                }
                              }
                            },
                            [_vm._v(_vm._s(_vm.$t("modelManage.edit")))]
                          ),
                          _vm._v(" "),
                          _c(
                            "span",
      ...
      _c("opRoleDialog", {
        attrs: {
          ...
          type: _vm.opRoleDialogType,
          data: _vm.opRoleDialogData
        },
        on: {
          refresh: function($event) {
            return _vm.initRoleList({})
          },
          "update:visible": function($event) {
      ...
      _vm._v(" "),
      _c("resourceRoleDialog", {
        attrs: {
          visible: _vm.resourceRoleDialogShow,
          type: _vm.resourceRoleDialogType,
          data: _vm.resourceRoleDialogData
        },
        on: {
          refresh: function($event) {
            return _vm.initRoleList({})
          ...
          "update:visible": function($event) {
            _vm.resourceRoleDialogShow = $event
          }
        }
      }),
      _vm._v(" "),
      _c("storageRoleDialog", {
        attrs: {
          visible: _vm.storageRoleDialogShow,
          type: _vm.storageRoleDialogType,
          data: _vm.storageRoleDialogData
        },
        on: {
          refresh: function($event) {
            return _vm.initRoleList({})
          ...
          "update:visible": function($event) {
            _vm.storageRoleDialogShow = $event
          }
        }
      })
    ],
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/user/role/vp-role-management.js"); })
