...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-3.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ~/apis/modules/computingpower */ "./web_src/vuepages/apis/modules/computingpower.js");
/* harmony import */ var element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! element-ui/lib/utils/date-util */ "./node_modules/element-ui/lib/utils/date-util.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      sortList: [{
        key: 'card',
        label: '使用时长',
        theader: '使用时长（卡时）<span>说明：卡时=云脑任务运行时长*卡数</span>',
        unit: '卡时'
      }, {
        key: 'user',
        label: '使用用户数',
      ...
      cards: [{
        name: '华为昇腾Ascend 910',
        icon: manufacturerIconMap.ascend,
        descr: ['昇腾（HUAWEI Ascend) 910是业界算力最强的AI处理器，基于自研华为达芬奇架构3D Cube技术，实现业界最佳AI性能与能效，架构灵活伸缩，支持云边端全栈全场景应用。算力方面，昇腾910完全达到设计规格，半精度（FP16）算力达到320 TFLOPS，整数精度（INT8）算力达到640 TOPS，功耗310W。'],
        features: [{
          title: '产品特点',
          list: ['- 自研华为达芬奇架构NPU', '- 640 TOPS@INT8，320TFLOPS@FP16', '- 最大功耗310W']
        }],
        table: {
          title: '关键特性',
          fields: [{
            title: 'Architecture',
            value: 'HUAWEI Da Vinci'
          }, {
            title: 'Computing Engine',
            value: '3D Cube'
          }, {
            title: 'Performance',
            value: '320 TFLOPS @FP16 and 640 TOPS @INT8'
          }, {
            title: 'Max Power',
            value: '310W'
          }, {
      ...
      },*/
      {
        ...
        icon: manufacturerIconMap.enflame,
        descr: ['云燧T20是基于邃思2.0芯片打造的面向数据中心的第二代人工智能训练加速卡，具有模型覆盖面广、性能强、软件生态开放等特点，可支持多种人工智能训练场景。同时具备灵活的可扩展性，提供业界领先的人工智能算力集群方案。产品优势特点如下：'],
        features: [{
          title: '澎湃算力 高精训练',
          list: ['- 领先的TF32等浮点AI算力', '- 基于HBM2E的高吞吐低延时', '- 动态性特征支持']
        }, {
          title: '专属通道 算力扩展',
          list: ['- 独立的高带宽通道，加速卡间通信', '- 独家的机内4卡全互联方案', '- 增强的单机8卡互联方案']
        }, {
          title: '广泛支持 生态友好',
          list: ['- C++和Python开发接口', '- 主流框架支持，国产框架适配加速', '- 算子与模型广泛支持']
        }, {
          title: '工具开放 高效开发',
        ...
        icon: manufacturerIconMap.enflame,
        descr: ['云燧I20是基于邃思2.5芯片打造的面向数据中心的第二代人工智能推理加速卡，具有高性能高能效、模型覆盖面广、易部署易运维等特点，可广泛应用于计算机视觉、语音识别与合成、自然语言处理、搜索与推荐等推理场景。产品优势特点如下：'],
        features: [{
          title: '计算引擎',
          list: ['- 支持FP32、FP16、BF16、INT8等多种数据精度，提供全精度支持和模型性能', '- 高可编程性，支持矢量、张量等多种计算类型，支持超越函数计算加速']
        }, {
          title: '存储引擎',
          list: ['- 3层存储结构设计，基于深度学习推理计算负载进行了深度效率优化', '- 国内首张支持HBM2E存储方案的推理加速卡，提供超大存储带宽']
        }, {
          title: '数据引擎',
          list: ['- 面向张量AI数据流计算加速的数据引擎，支持切分/逆切分、维度变换、拼接、降采样、镜像、常量填充等', '- 支持融合型张量操作', '- 支持数据多地址广播', '- 硬件多重循环指令，降低同步开销']
        }, {
          title: '工具开放 高效开发',
        ...
        name: '寒武纪MLU290',
        icon: manufacturerIconMap.cambricon,
        descr: ['MLU290-M5智能加速卡搭载寒武纪首颗训练芯片思元290，采用台积电7nm先进制程工艺，采用MLUv02扩展架构。MLU290-M5智能加速卡采用开放加速模块OAM设计，具备64个MLU Core，1.23TB/s内存带宽以及全新MLU-Link芯片间互联技术，全面支持AI训练、推理或混合型人工智能计算加速任务。'],
        table: {
          title: '思元290-M5 产品规格',
          fields: [{
            title: '产品名称',
            ...
            title: '核心架构',
            value: 'Cambricon MLUv02 Extended'
          }, {
            title: '制程工艺',
            value: '7nm'
          }, {
            title: '自适应精度训练算力',
            value: '512 TOPS(INT8)<br>256 TOPS(INT16)<br>64 TOPS(CINT32)'
          }, {
            title: 'DirectCV<sup>TM</sup>视频解码',
            value: '128 Streams 全高清视频'
          }, {
            title: 'DirectCV<sup>TM</sup>图片解码',
            value: '3200 Frames/s 全高清图片'
          }, {
            title: '内存类型',
            value: 'HBM2高带宽内存'
          }, {
            ...
            title: 'MLU-Link<sup>TM</sup>接口',
            value: '6 Ports, 48 Lanes, 50 Gbps'
          }, {
            title: 'MLU-Link<sup>TM</sup>带宽',
            value: '聚合带宽600GB/s Bi-direction'
          }, {
            title: '最大热功耗',
            value: '350W'
          }, {
        ...
        name: '天垓100（BI -V100）',
        icon: manufacturerIconMap.iluvatar,
        descr: ['天垓100通用GPU训练加速卡，产品特点如下：'],
        features: [{
          title: '应用覆盖广',
          list: ['天垓100聚焦高性能、通用性和灵活性，支持200余种人工智能模型（数量持续增加），支持通用计算、科学计算、大模型、支持业界前沿新算法模型。模型适配速度快，从容面对未来的算法变迁，为人工智能及通用计算和相关垂直应用行业提供匹配行业高速发展的计算力。']
        }, {
          title: '性能可预期',
          list: ['天垓100基于通用GPU架构设计，拥有丰富的自研指令集全方位支持标量、矢量、张量运算，提供业界领先的高算力和高能效比，在百余个算法模型的测试平均性能可媲美主流产品。']
        }, {
          title: '开发易迁移',
          list: ['适配主流 CPU 芯片 / 服务器厂商，能够支持国内外主流软硬件生态和各种深度学习框架、算法模型和加速库，并通过标准化的软硬件生态接口为行业解决产品使用难、开发平台迁移成本大等痛点，应用迁移成本低、耗时短、无需重新开发，大幅缩短适配验证周期，使客户业务系统几乎无感知地使用天垓 100 产品。']
        }, {
          title: '全栈可定制',
        ...
        name: '智铠100（MR-V100）',
        icon: manufacturerIconMap.iluvatar,
        descr: ['智铠100系列通用GPU推理加速卡，产品特点如下：'],
        features: [{
          title: '计算性能高',
          list: ['支持FP32、FP16、INT8等多精度推理混合计算，实现了指令集增强、算力密度提升、计算存储再平衡，相较于市场上现有主流产品，智铠100将提供2-3倍的实际使用性能。']
        }, {
          title: '应用覆盖广',
          list: ['智铠100系列加速卡基于通用GPU架构，支持多种视频规格解码、800+通用指令集、国内外主流深度学习开发框架，拥有丰富编程接口拓展和高性能函数库，可以灵活支持各种算法模型，便于客户自定义开发。']
        }, {
          title: '使用成本低',
          list: ['兼容CUDA生态，支持市场主流生态，高达128路视频接入，单路视频性价比高灵活的编程能力，超强的性能及富有吸引力的性价比，为高性能计算和人工智能应用的开发和部署提供了便利。平均迁移时间相较市场主流产品下降50%以上，生态应用迁移迅速。']
        }, {
          title: '落地支持强',
        ...
        features: [{
          ...
          title: '卓越的视频处理能力',
          list: ['- 多种视频格式兼容且支持8K分辨率', '- 超高密度视频编解码，在基于视频+AI的场景极具性价比']
        }, {
          title: '高带宽，低延时',
          list: ['- 集成HBM2E 高带宽内存', '- 率先支持PCIe5.0']
        }, {
          title: '成熟易用的软件栈',
          list: ['- 兼容ONNX、Opencv、FFmpeg等主流框架', '- 完善的Model Zoo和应用示例，开箱即用']
        }],
        table: {
          title: '曦思N100人工智能推理GPU产品规格',
          fields: [{
            title: 'AI算力',
            value: '160TOPS INT8; 80TFLOPS FP16/BF16'
          }, {
            title: '显存',
            value: '16GB HBM2E, 带宽460GB/s'
          }, {
            title: '视频解码',
            value: '120x1080P30, H.264/H.265/AV1/AVS2, 支持8K分辨率'
          }, {
            title: '视频编码',
            value: '120x1080P30, H.264/H.265/AV1, 支持8K分辨率'
          }, {
            title: 'PCIe接口',
            value: 'PCIe5.0/4.0/3.0 x16'
          }, {
            title: '虚拟化',
            value: '单卡可支持1/2/4个用户实例'
          }, {
            title: '功耗',
            value: '最大70W'
          }, {
        ...
        name: '海光DCU',
        icon: manufacturerIconMap.hygon,
        descr: ['DCU深算处理器是由海光信息技术有限公司开发的一款高性能通用异构处理器。', 'DCU深度计算处理器（DCU Z100）基于通用图形处理器理念设计，更加适合为人工智能计算提供强大的算力。DCU Z100拥有64组计算单元，共计8192个计算核心，超高速32GB HBM2内存和高达1TB/s的内存带宽，可以完美支持深度学习训练场景，轻松应对复杂神经网络训练。', 'DCU Z100拥有10.8T的双精度浮点运算能力，是高性能计算业务的不二之选。优异的架构设计和超高计算能力，可为生命科学、能源勘探、工业设计、航空航天、分子动力学计算等行业提供更高性价比的计算方案。'],
        table: {
          title: 'DCU Z100规格参数',
          fields: [{
            title: 'Category',
            ...
            title: 'Streaming Multiprocessors(SMs/CUs)',
            value: '64'
          }, {
            title: 'FP32 Units / SM (CU)',
            value: '64'
          }, {
            title: 'FP32 Units (Vector)',
            value: '4096'
          }, {
            title: 'FP64 Units (Vector)',
            value: '4096'
          }, {
            title: 'Tensor Core/Matrix Units',
            value: '-'
          }, {
            title: 'Threads / Warp',
            value: '64'
          }, {
            title: 'Max Warps / SM (CU)',
            value: '40'
          }, {
            title: 'Max Threads / SM (CU)',
            value: '2560'
          }, {
            title: 'Sparse Matrix',
            value: 'No'
          }, {
            title: 'Peak FP64 Perf. (TFLOPs)',
            value: '10.8'
          }, {
            title: 'Peak FP32 Perf. (TFLOPs)',
            value: '14.7'
          }, {
            title: 'Peak FP16 Perf. (TFLOPs)',
            value: '29.5'
          }, {
            title: 'Boost Core Clock Speed (MHz)',
            value: '1319'
          }, {
            title: 'HBM2/HBM2E Memory (GB)',
            value: '16/32'
          }, {
            title: 'DIE Size (mm<sup>2</sup>)',
            value: '356'
          }, {
            title: 'TDP (W)',
            value: '350'
        ...
        name: '壁砺™ 106M',
        icon: manufacturerIconMap.biren,
        descr: ['壁仞科技通用GPU产品壁砺系列，由多款产品组成，基于壁仞科技原创的训推一体芯片架构，具有高算力、高能效比、高通用性的优势，能够为包括人工智能训练与推理在内的诸多通用计算场景提供强大的算力。壁砺™ 106M产品形态为风冷 OAM 模组，单卡峰值功耗 400W,强大的算力和高速互连能力，可为广泛的人工智能训练与推理场景，提供高能效比的算力解决方案。'],
        features: [{
          title: '通用智算，训推平衡',
          list: ['壁砺™166系列产品可广泛应用于AI模型训练、微调与推理场景，赋能大模型应用高效落地。壁砺™106M 支持PCIe5.0 X8 主机互连接口技术，并通过自研UBB 主板实现单机8 卡互连。']
        }, {
          title: '原创设计，软硬协同',
          list: ['BIRENSUPA™是一个具有完整功能架构的软件开发平台，包括硬件抽象层、壁仞原创BIRENSUPA™编程模型和BRCC编译器，深度学习和通用计算加速库、工具链，支持主流深度学习框架和自研推理加速引擎，并配备针对不同场景的应用SDK等，能够为开发者提供高效的应用开发平台，软硬件协同，探索未来的无限可能。']
        }, {
          title: '异构聚合，技术创新',
          list: ['业界首次支持4种异构GPU千卡规模混合训练同一个大模型，异构协同训练效率超过98.5%，助力最终客户实现多种异构算力聚合，最大化提升异构GPU集群利用效率，引领国家标准和行业发展。', '目前，壁砺系列成功在华北、华东、华南等多地的智算中心与终端应用客户处落地，支持包括互联网、能源、金融、教育等众多应用场景。在AI大模型训练与推理场景中，壁仞科技也已经与众多合作伙伴开展落地合作，并完成了主流大模型的适配与调优。']
        }, {
          title: '智算一体机',
          list: ['基于壁仞科技 芯片产品与服务器整机厂商合作推出 大模型一体机，已在政务、能源、运营商、科技、金融等行业领域实现广泛应用，具体应用场景包括企业知识库助手、公文报告生成、智慧运维、智慧合规审查、代码助手等。软硬件深度融合，应用高效迁移，产品开箱即用，助力企业快速部署与落地。']
        }]
      }]
    };
  },
  components: {},
  computed: {
    sortObj: function sortObj() {
      var _this = this;

      return this.sortList.filter(function (itm) {
        return itm.key == _this.sortType;
      })[0] || {};
    }
  },
  methods: {
    ...
    transformNumber: function transformNumber(value, unit) {
      var param = {};
      var k = 10000;
      var sizes = ['', '万', '亿', '万亿'];
      var i;
    ...
    getData: function getData() {
      ...
      this.loading = true;
      (0,_apis_modules_computingpower__WEBPACK_IMPORTED_MODULE_15__.getDomesticCardData)({
        type: this.tabIndex,
        ...
        if (res.code == 0) {
          var data = (res.data || []).map(function (itm, index) {
          ...
          if (data.length) {
            ...
            _this2.useShrink = first && second && first / second >= 10;
            data.map(function (item, index) {
              ...
              item.countShow = _this2.transformNumber(item.count, _this2.sortObj.unit);
            });
            _this2.updateTime = (0,element_ui_lib_utils_date_util__WEBPACK_IMPORTED_MODULE_16__.formatDate)(new Date(data[0].updated_unix * 1000), 'yyyy-MM-dd HH:mm:ss');
          } else {}
...
/***/ "./web_src/vuepages/pages/computingpower/domestic/vp-computingpower-domestic.js":
/*!**************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/domestic/vp-computingpower-domestic.js ***!
  \**************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.vue */ "./web_src/vuepages/pages/computingpower/domestic/index.vue");
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_24644767_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=24644767&scoped=true */ "./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=template&id=24644767&scoped=true");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_24644767_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less */ "./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_24644767_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_24644767_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "24644767",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "web_src/vuepages/pages/computingpower/domestic/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=script&lang=js":
/*!******************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=script&lang=js ***!
  \******************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less":
/*!***************************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less ***!
  \***************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_4_use_2_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_24644767_scoped_true_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!../../../../../node_modules/less-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-4.use[2]!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=style&index=0&id=24644767&scoped=true&lang=less");


/***/ }),

/***/ "./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=template&id=24644767&scoped=true":
/*!************************************************************************************************************!*\
  !*** ./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=template&id=24644767&scoped=true ***!
  \************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_24644767_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_24644767_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_24644767_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=24644767&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=template&id=24644767&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=template&id=24644767&scoped=true":
/*!***************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./web_src/vuepages/pages/computingpower/domestic/index.vue?vue&type=template&id=24644767&scoped=true ***!
  \***************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "ui container" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "sort-field" }, [
      _c("div", { staticClass: "sort-conds" }, [
        _c(
          "div",
          { staticClass: "sort-tab-c" },
          _vm._l(_vm.tabList, function(item) {
            return _c(
              "div",
              {
                key: item.key,
                staticClass: "tab",
                class: item.key == _vm.tabIndex ? "active" : "",
                on: {
        ...
        _c(
          "div",
          { staticClass: "sort-type-c" },
          [
            _c(
              "el-select",
              {
                attrs: { size: _vm.useSmall ? "small" : "default" },
                ...
                scopedSlots: _vm._u([
                  {
                    ...
                    fn: function() {
                      return [
                        _c("div", {
                          domProps: { innerHTML: _vm._s(_vm.sortObj.theader) }
                        })
                      ]
                    },
                    proxy: true
                  },
                  {
                    ...
                    fn: function(scope) {
                      return [
                        _c("div", { staticClass: "table-bar" }, [
                          _c("div", { staticClass: "bar-c" }, [
                            _c(
                              "div",
                              {
                                staticClass: "bar",
                                style:
                                  ...
                                  scope.row.barWith +
                                  "%;" +
                                  (scope.row.barWith > 0 ? "min-width:1px" : "")
                              },
                              [
                                scope.$index == 0 && _vm.useShrink
                                  ? [
                                      _c("div"),
                                      _vm._v(" "),
                                      _c("div"),
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "bar-value" }, [
                            _vm._v(_vm._s(scope.row.countShow))
                          ])
                        ])
                      ]
                    }
    ...
    _c("div", { staticClass: "partners-field" }, [
      ...
      _c(
        "div",
        { staticClass: "partners-c" },
        _vm._l(_vm.partners, function(item, index) {
          return _c("div", { key: index, staticClass: "img-c" }, [
    ...
    _c(
      ...
      [
        _vm._l(_vm.cards, function(card, cardIndex) {
          return _c("div", { key: cardIndex, staticClass: "card" }, [
            _c("div", { staticClass: "title-c" }, [
              _c("div", { staticClass: "title" }, [_vm._v(_vm._s(card.name))]),
              _vm._v(" "),
            ...
            card.descr
              ? _c(
                  "div",
                  { staticClass: "descr-c" },
                  _vm._l(card.descr, function(descr, descrIndex) {
                    return _c("p", { key: descrIndex }, [
                      _vm._v(" " + _vm._s(descr))
                    ])
                  }),
                  0
            ...
            card.features
              ? _c(
                  "div",
                  { staticClass: "feature-c" },
                  _vm._l(card.features, function(feature, featureIndex) {
                    return _c(
                      "div",
                      { key: featureIndex, staticClass: "feature" },
                      [
                        _c("p", { staticClass: "title" }, [
                          _vm._v(_vm._s(feature.title))
                        ]),
                        _vm._v(" "),
                        _vm._l(feature.list, function(item, itemIndex) {
                          return _c(
                            "p",
                            { key: itemIndex, staticClass: "item" },
                            [_vm._v(" " + _vm._s(item))]
                          )
                        })
                      ],
            ...
            card.table
              ? _c("div", { staticClass: "table-c" }, [
                  _c(
                    "table",
                    { staticClass: "table", class: card.table.tableClass },
                    [
                      _c("tr", [
                        _c(
                          "td",
                          { staticClass: "title", attrs: { colspan: "2" } },
                          [_vm._v(_vm._s(card.table.title))]
                        )
                      ]),
                      _vm._v(" "),
                      _vm._l(card.table.fields, function(row, rowIndex) {
                        return _c("tr", { key: rowIndex }, [
                          _c("td", {
                            staticClass: "field-title",
                            domProps: { innerHTML: _vm._s(row.title) }
                          }),
                          _vm._v(" "),
                          _c("td", {
            ...
            card.useExample
              ? _c(
                  "div",
                  { staticClass: "use-example-c" },
                  [
                    _c("div", { staticClass: "title" }, [
                      _vm._v(_vm._s(card.useExample.title))
                    ]),
                    _vm._v(" "),
                    _vm._l(card.useExample.list, function(link, linkIndex) {
                      return _c("div", { key: linkIndex }, [
        ...
        _vm._v(" "),
        _vm.cards.length % 2 == 1
          ? _c("div", { staticClass: "card placeholder" })
          : _vm._e()
      ],
      2
    )
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor-libs"], function() { return __webpack_require__("./web_src/vuepages/pages/computingpower/domestic/vp-computingpower-domestic.js"); })
