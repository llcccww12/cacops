...
// New creates a new osredm provider and sets up important connection details.
// You should always call `osredm.New` to get a new provider.  Never try to
// create one manually.
...
func NewCustomisedURL(clientKey, secret, callbackURL, authURL, tokenURL, profileURL string, scopes ...string) *Provider {
	p := &Provider{
		...
		providerName: setting.OsredmConfig.Provider,
...
func (p *Provider) FetchUser(session goth.Session) (goth.User, error) {
	...
	log.Warn("osredm:" + p.profileURL + "?access_token=" + url.QueryEscape(sess.AccessToken))
...
func userFromReader(r io.Reader, user *goth.User) error {
	...
	user.Provider = setting.OsredmConfig.Provider
