...
type CreateOrgForm struct {
	...
	DatasetAdminChangeTeamAccess bool
	AimodelAdminChangeTeamAccess bool
}
...
type SubmitDatasetOfTagForm struct {
	Datasetids string
}

type SubmitModelOfTagForm struct {
	Modelids string
}
