...
type UpdateProfileForm struct {
	...
	FullName         string `binding:"AlphaDashDotChinese;MaxSize(100)"`
...
type AvatarDiffusionForm struct {
	GenerateType int // 0 animal  1 landscape  2 human-random   3female 4 male
}

type AvatarDiffusionUpdateForm struct {
	ImageBase64 string
}
...
type WechatForm struct {
	LoginId string `binding:"Required;MaxSize(255)"`
}
