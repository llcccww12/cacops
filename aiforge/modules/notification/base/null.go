...
func (*NullNotifier) NotifyDatasetRegistryRecommend(optUser *models.User, dataset *models.DatasetRegistry) {
}
...
func (*NullNotifier) NotifyAlmostEndingAIDebugTask(cloudbrain *models.Cloudbrain, duration time.Duration) {
}

func (*NullNotifier) NotifyCreateDataset(doer *models.User, u *models.User, dataset *models.DatasetRegistry) {

}
func (*NullNotifier) NotifyDeleteDataset(doer *models.User, u *models.User, repo *models.DatasetRegistry) {

}

func (*NullNotifier) NotifyCreateAimodel(doer *models.User, u *models.User, aimodel *models.AiModelManage) {
}

func (*NullNotifier) NotifyDeleteAimodel(doer *models.User, u *models.User, aimodel *models.AiModelManage) {

}

func (*NullNotifier) NotifyAimodelRecommend(optUser *models.User, aimodel *models.AiModelManage) {
}
