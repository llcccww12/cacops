...
type Notifier interface {
	...
	NotifyDatasetRegistryRecommend(optUser *models.User, dataset *models.DatasetRegistry)
	...
	NotifyAlmostEndingAIDebugTask(cloudbrain *models.Cloudbrain, duration time.Duration)

	NotifyCreateDataset(doer *models.User, u *models.User, repo *models.DatasetRegistry)
	NotifyDeleteDataset(doer *models.User, u *models.User, repo *models.DatasetRegistry)

	NotifyCreateAimodel(doer *models.User, u *models.User, aimodel *models.AiModelManage)
	NotifyDeleteAimodel(doer *models.User, u *models.User, aimodel *models.AiModelManage)
	NotifyAimodelRecommend(optUser *models.User, aimodel *models.AiModelManage)
}
