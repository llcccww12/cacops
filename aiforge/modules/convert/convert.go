...
func ToOrganization(org *models.User) *api.Organization {
	return &api.Organization{
		...
		DatasetAdminChangeTeamAccess: org.DatasetAdminChangeTeamAccess,
...
func ToTeam(team *models.Team) *api.Team {
	return &api.Team{
		...
		IncludesAllDatasets:     team.IncludesAllDatasets,
		IncludesAllAimodels:     team.IncludesAllAimodels,
		CanCreateOrgRepo:        team.CanCreateOrgRepo,
		CanCreateOrgDataset:     team.CanCreateOrgDataset,
		CanCreateOrgAimodel:     team.CanCreateOrgAimodel,
		Permission:              team.Authorize.String(),
		DatasetPermission:       team.DatasetAuthorize.String(),
		AimodelPermission:       team.AimodelAuthorize.String(),
...
func ToAuthenticatedUser(user *models.User, scopeList []models.GrantScope, authed bool) *api.User {
	result := &api.User{
		ID:        user.ID,
		UserName:  user.Name,
		AvatarURL: user.AvatarLink(),
	...
	for _, scope := range scopeList {
		if scope == models.ScopeUserEmail {
			result.Email = user.Email
		} else if scope == models.ScopeUserPhone {
