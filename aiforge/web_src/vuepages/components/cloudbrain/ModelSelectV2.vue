  ...
  <div class="form-row">
    <div class="left-area">
      <div class="title" v-if="showTitle">
        <span :class="required ? 'required' : ''"> {{ $t('repos.model') }}</span>
      </div>
      <div class="content">
    ...
    <el-dialog class="model-dlg" :visible.sync="dlgShow"  width="1100px"
      ...
      <div class="dlg-content">
        <div class="dlg-left-area" v-loading="dlgLoading">
          <div class="header-c">
            <span class="header-text">{{$t('modelObj.model_select')}}</span>
          ...
          <div class="model-tabs-c">
            <el-tabs class="model-tabs" v-model="dlgActiveName" @tab-click="dlgTabClick">
              ...
              <el-tab-pane :label="$t('modelObj.model_collaborate')" name="third"></el-tab-pane>
              <el-tab-pane :label="$t('modelObj.model_collected')" name="fourth"></el-tab-pane>
              <el-tab-pane :label="$t('modelObj.model_my_migrate')" name="five"></el-tab-pane>
            </el-tabs>
              ...
              <span class="item-wrap">
                <div class="item-c nowrap">
                  <span class="item nowrap" style="max-width: 93%">
                    <Icons style="flex-shrink: 0;width:16px;height:16px;" type="aimodel" :isPrivate="data.is_private" :modelType="data.aimodel_type"></Icons>
                ...
                <a :href="`/models/detail/${data.owner_name}/${data.name}`" target="_blank">
  ...
  methods: {
    ...
    searchModelData() {
      ...
      getModelList(params).then(res => {
        ...
        if(res.data.code === 0){
            const data = res.data?.data?.aimodels || [];
