<template>
  <div class="profile-dataset" v-loading="loading">
    <Filters
...
import { getProfileDataset, getProfileDatasetPublic } from "~/apis/modules/dataset";
...
export default {
  ...
  methods: {
    getList() {
      ...
      const request = this.isLogin ? getProfileDataset(params) : getProfileDatasetPublic(params)
